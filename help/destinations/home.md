...
seo-description: 대상은 실시간 고객 데이터 플랫폼에서 데이터를 원활하게 활성화할 수 있도록 대상 플랫폼과의 사전 구축된 통합입니다. 실시간 고객 데이터 플랫폼의 대상을 사용하여 크로스 채널 마케팅 캠페인, 이메일 캠페인, 타깃팅된 광고 및 기타 많은 사용 사례에 대해 알려진 데이터와 알 수 없는 데이터를 활성화할 수 있습니다.
...
* 실시간 CDP에서 사용할 수 있는 모든 대상의 [셀프 서비스 카탈로그](./catalog/overview.md) 중에서 선택할 수 있습니다.
* 대상을 **[!UICONTROL 사용하여]** 프로필 또는 세그먼트를 [활성화하고](./ui/activate-destinations.md) 마케팅 자동화 플랫폼, 디지털 광고 플랫폼 등으로 보낼 수 있습니다.
* 데이터 내보내기를 주기적으로 원하는 대상으로 예약합니다.

## 컨트롤 {#controls}

대상 작업 영역의 [컨트롤을](./ui/destinations-workspace.md) 사용하여 다음을 수행할 수 있습니다.
...
자세한 내용은 [대상 유형 및 카테고리 개요를 참조하십시오](./destination-types.md).
...
[!DNL Data Governance] 마케팅 사용 사례 [및 데이터 정책 위반](../rtcdp/privacy/data-governance-overview.md#destinations) 해결에 대한 자세한 내용은 실시간 CDP 설명서를 참조하십시오 [](../rtcdp/privacy/data-governance-overview.md#enforcement).
...
세그먼트 활성화 워크플로우의 데이터 정책 위반에 대한 자세한 내용은 프로필과 세그먼트를 대상으로 [활성화의 검토 단계를 참조하십시오](./ui/activate-destinations.md#review).