...
>[!IMPORTANT]
>
>다음 [!DNL HTTP] 플랫폼의 대상은 현재 알파에 있습니다. 설명서 및 기능은 변경될 수 있습니다.

## 개요 {#overview}

다음 [!DNL HTTP] 대상이 됨 [!DNL Adobe Experience Platform] 프로필 데이터를 타사 사용자에게 전송하는 데 도움이 되는 스트리밍 대상 [!DNL HTTP] 엔드포인트.
