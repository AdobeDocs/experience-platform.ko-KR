---
title: 허용 목록에 추가하다 파일 기반 클라우드용 IP 주소 스토리지 대상
type: Documentation
description: 이 페이지에서는 Experience Platform에서 클라우드 스토리지 대상으로 데이터를 안전하게 내보내기 위해 허용 목록에 추가하다에 추가할 수 있는 IP 범위를 제공합니다.
...
>[!IMPORTANT]
>
>이 페이지에 설명된 IP 범위는 *,*, [!UICONTROL Azure Blob] 및 Microsoft Azure에서 호스팅되는 SFTP 서버인 파일 기반 클라우드 저장소 대상에 대해 [!UICONTROL Azure Data Lake Storage Gen2]지원되지 않음[!UICONTROL Data Landing Zone]입니다.
