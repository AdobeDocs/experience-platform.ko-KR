...
Experience Platform은 두 가지 유형의 Snowflake 대상을 제공합니다. [Snowflake 스트리밍](snowflake.md) 및 [Snowflake 일괄 처리](../cloud-storage/snowflake-batch.md).

아래 표는 각 데이터 공유 방법이 가장 적합한 시나리오를 요약하여 사용할 대상을 결정하는 데 도움이 됩니다.

|  | 필요한 경우 [Snowflake 일괄 처리](../cloud-storage/snowflake-batch.md) 선택 | 필요할 때 [Snowflake 스트리밍](snowflake.md)을 선택하세요. |
|--------|-------------------|----------------------|
...
일괄 데이터 공유에 대한 자세한 내용은 [Snowflake 일괄 연결](../cloud-storage/snowflake-batch.md) 설명서를 참조하십시오.
