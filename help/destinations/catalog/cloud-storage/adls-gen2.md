---
title: Azure Data Lake 스토리지 Gen2 연결
...
* **[!UICONTROL Tenant]**: 응용 프로그램이 포함된 테넌트 정보입니다.
* **[!UICONTROL Service principal ID]**: 응용 프로그램의 클라이언트 ID입니다.
* **[!UICONTROL Service principal key]**: 응용 프로그램의 키입니다.
