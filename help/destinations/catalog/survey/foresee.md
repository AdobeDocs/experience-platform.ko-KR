...
title: Foresee 확장 대상
description: Foresee 확장은 Adobe Experience Platform의 설문 조사 대상입니다. 확장 기능에 대한 자세한 내용은 Exchange Adobe의 확장 페이지를 참조하십시오.
...
태그를 사용하여 [!DNL ForeSee] 제품 배포를 구성합니다.

[!DNL Foresee] 는 Adobe Experience Platform의 설문 조사 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100164.html)에서 확장 페이지를 참조하십시오.
...
[!DNL Foresee] 확장을 설치하려면 다음을 수행하십시오.
