...
# [!DNL InMoment] 확장 기능 {#inmoment-extension}
...
[!DNL InMoment]은(는) Adobe Experience Platform의 설문 조사 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100847.html)의 확장 페이지를 참조하십시오.
