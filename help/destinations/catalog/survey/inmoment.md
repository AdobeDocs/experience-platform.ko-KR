...
[!DNL InMoment] Launch 통합을 사용하면 디지털 절편 제품을 통해 온라인 피드백을 빠르고 쉽게 활성화할 수 있습니다. 앱에서 CXI Cloud Admin을 통해 가로채기를 구성 및 관리할 수 있으므로 CX 관리자가 프로그램을 보다 효율적으로 제어할 수 있습니다.
