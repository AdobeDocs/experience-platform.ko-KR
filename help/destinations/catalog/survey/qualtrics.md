...
[!DNL Qualtrics Website Feedback] 를 사용하면 적절한 시간에 적절한 메시지로 웹 사이트 방문자의 참여를 유도합니다. 웹 사이트 피드백 설문 조사를 통해 방문자 경험을 개선하거나 전환을 늘릴지 여부 [!DNL Qualtrics Website Feedback] 이(가) 귀하를 보호했습니다.
...
[!DNL Qualtrics Website Feedback] 는 Adobe Experience Platform의 설문 조사 확장 프로그램입니다. 확장 기능에 대한 자세한 내용은 의 확장 페이지를 참조하십시오 [Adobe 교환](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html).
...
을(를) 설치하려면 [!DNL Qualtrics Website Feedback] 확장:
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 [Adobe Exchange의 Qualtrics 웹 사이트 피드백 페이지](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html).
