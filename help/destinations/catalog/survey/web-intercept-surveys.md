...
[!DNL QuestionPro Intercept Surveys] 는 Adobe Experience Platform의 설문 조사 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html)의 확장 페이지를 참조하십시오.
...
![QuestionPro 출구 설문 조사 확장](../../assets/catalog/survey/web-intercept-surveys/catalog.png)
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html)의 [QuestionPro 출구 설문 조사 페이지를 참조하십시오.
