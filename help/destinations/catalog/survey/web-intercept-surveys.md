...
title: QuestionPro Intercept Surveys 확장
description: QuestionPro Intercept Surveys 확장은 Adobe Experience Platform의 설문 조사 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
...
# [!DNL QuestionPro Intercept Surveys] 확장 기능 {#questionpro-extension}

## 개요 {#overview}

[!DNL QuestionPro Intercept Surveys]은(는) 트랜잭션 지점 또는 사용자가 웹 사이트를 입력/종료할 때 설문 조사를 배포하고 상태 데이터를 수집하는 플랫폼입니다.

[!DNL QuestionPro Intercept Surveys]은(는) [!DNL Adobe Experience Platform]의 설문 조사 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html)의 확장 페이지를 참조하십시오.

이 대상은 태그 확장입니다. Experience Platform에서 태그 확장이 작동하는 방법에 대한 자세한 내용은 [태그 확장 개요](../launch-extensions/overview.md)를 참조하십시오.

![QuestionPro 절편 설문 조사 확장](../../assets/catalog/survey/web-intercept-surveys/catalog.png)
...
[!DNL QuestionPro Intercept Surveys] 확장을 설치하려면:
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 Adobe Exchange의 [QuestionPro Intercept Surveys 페이지](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html)를 참조하십시오.
