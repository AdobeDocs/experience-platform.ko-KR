...
* [[!DNL Mailchimp]](https://login.mailchimp.com/) 계정으로 이동합니다. 그런 다음 **[!DNL Audience]** 페이지로 이동합니다. 그런 다음 **[!DNL Manage Contacts]** 메뉴를 확장하고 **[!DNL Groups]**&#x200B;을(를) 선택합니다.
...
### [!DNL Mailchimp] 상태 및 오류 코드 {#mailchimp-status-error-codes}
