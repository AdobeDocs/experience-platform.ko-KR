...
대상 데이터를 [!DNL Oracle Responsys]에 보내려면 먼저 Adobe Experience Platform에서 [대상에 연결](#connect-destination)한 다음 저장소 위치에서 [(으)로 &#x200B;](#import-data-into-responsys)데이터 가져오기를 설정[!DNL Oracle Responsys]해야 합니다.
