...
그런 다음 후속 창에서 [!UICONTROL Allow]을(를) 선택하여 **Adobe Experience Platform** 앱에 [!DNL Salesforce Marketing Cloud Account Engagement] 계정에 액세스할 수 있는 권한을 부여합니다. *이 작업은 한 번만 수행해야 합니다*.
