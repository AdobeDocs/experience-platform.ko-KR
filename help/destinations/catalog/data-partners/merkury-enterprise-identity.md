...
| 사용자 정의 업로드 | 아니요 | CSV 파일에서 대상 [[가져옴]](https://experienceleague.adobe.com/ko/docs/experience-platform/segmentation/ui/overview#import-audience)을(를) Experience Platform으로 가져왔습니다. |
