---
keywords: 대상;experience cloud 솔루션 target;타겟 대상 ad cloud; advertising cloud; audience manager; adobe target 대상; target; audience manager 대상;
title: Adobe 대상 개요
...
광고 타겟팅, 개인화, 마케팅 자동화 등을 위해 Adobe Experience Platform의 데이터를 다른 Adobe Experience Cloud 솔루션에 연결하여 고객 경험을 관리합니다.
...
연결과 확장의 차이점을 이해하려면 대상 유형 및 카테고리 페이지에서 [확장](../../destination-types.md#extensions)을 참조하십시오.

- [Adobe Advertising Cloud 확장](../advertising/adobe-advertising-cloud.md)
- [Adobe Analytics 확장](../analytics/adobe-analytics.md)
- [Livefyre 확장 Adobe](../social/adobe-livefyre.md)
...
- [핵심 서비스 통합을 통해 Adobe Audience Manager, Adobe Advertising Cloud 및 Adobe Target과 세그먼트 공유 Experience Platform](https://experienceleague.adobe.com/docs/audience-manager/user-guide/implementation-integration-guides/integration-experience-platform/aam-aep-audience-sharing.html)
