---
keywords: 대상;experience cloud 솔루션;target;target 대상;ad cloud;광고;audience manager;adobe target 대상;target;audience manager 대상;
title: Adobe 대상 개요
...
광고 타기팅, 개인화, 마케팅 자동화 등을 위해 [!DNL Adobe Experience Platform]의 데이터를 다른 [!DNL Adobe Experience Cloud] 솔루션에 연결하여 고객 경험을 관리합니다.
...
* [Adobe Advertising 확장](../advertising/adobe-advertising-cloud.md)
...
* [핵심 서비스 통합을 통해 Adobe Audience Manager, Adobe Advertising 및 Adobe Target과 공유하는 Experience Platform 대상](https://experienceleague.adobe.com/docs/audience-manager/user-guide/implementation-integration-guides/integration-experience-platform/aam-aep-audience-sharing.html?lang=ko)
