...
대상을 Adobe Analytics으로 보내려면 먼저 [Analytics 및 Audience Manager에 대한 Experience Cloud ID 서비스를 구현](https://experienceleague.adobe.com/docs/id-service/using/implementation/setup-aam-analytics.html?lang=en)해야 합니다.
