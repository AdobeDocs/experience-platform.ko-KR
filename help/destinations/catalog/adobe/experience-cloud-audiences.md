...
> * 위의 [섹션](#share-segments-with-other-solutions)에서 언급한 Adobe Advertising Cloud, Adobe Target, Marketo 및 기타 Experience Cloud 솔루션과 Real-Time CDP 대상을 공유하려면 *Audience Manager 라이선스가 필요하지 않습니다*.
