...
대상 연결에 대한 세부 정보 제공을 마쳤으면 다음&#x200B;**을 선택합니다**.

## 이 대상으로 데이터 세트 내보내기 {#export-datasets}

>[!IMPORTANT]
> 
>데이터를 활성화하려면 대상 보기 및 데이터 세트 대상 []&#x200B;**관리 및 활성화 액세스 제어 권한이(/help/access-control/home.md#permissions) 필요합니다**.**&#x200B;** [액세스 제어 개요를](/help/access-control/ui/overview.md) 읽거나 제품 관리자에게 문의하여 필요한 권한을 얻으십시오.
