...
Adobe Audience Manager Data Integration Library 확장(클라이언트측 구현)입니다. 참고: 이 확장은 Adobe Analytics 데이터의 서버측 전달(SSF)에 사용하기 위한 것이 아닙니다. SSF의 경우 Adobe Analytics 확장을 사용합니다. 중요 사항: 버전 8.0부터 DIL은 [!DNL Experience Cloud] ID 서비스, 버전 3.3 이상에 대한 하드 종속성이 있습니다. 전체 [!DNL Audience Manager] 데이터 통합 기능을 위해 [!DNL Experience Cloud] ID 서비스와 DIL을 모두 구현하십시오.

[!DNL Audience Manager] DIL은 Adobe Experience Platform의 DMP(데이터 관리 플랫폼) 확장입니다. 확장 기능에 대한 자세한 내용은 Experience Platform Launch 설명서의 [Audience Manager 확장 페이지](../../../tags/extensions/web/audience-manager/overview.md)를 참조하십시오.

이 대상은 [!DNL Experience Platform Launch] 확장입니다. Platform에서 Launch 확장이 작동하는 방식에 대한 자세한 내용은 [Experience Platform Launch 확장 개요](../launch-extensions/overview.md)를 참조하십시오.
...
[!DNL Audience Manager] DIL 확장을 설치하려면 다음을 수행하십시오.
...
확장 구성 옵션에 대한 자세한 내용은 [!DNL Experience Launch] 설명서의 [Audience Manager 확장 페이지](../../../tags/extensions/web/audience-manager/overview.md)를 참조하십시오.
