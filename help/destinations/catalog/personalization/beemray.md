...
# [!DNL Beemray] 확장 기능 {#beemray-extension}

## 개요 {#overview}

[!DNL Beemray]을(를) 사용하면 상황에 맞는 상황에 맞게 제품을 가속화할 수 있습니다. 통찰력을 얻고, 새로운 경험을 구축하고, 상호 작용을 촉진하고, 중요한 순간에 참여할 수 있도록 해줍니다. Beemray는 기계 학습을 사용하여 상황별 지능을 자동화합니다. Beemray는 [!DNL Adobe Experience Cloud] 및 기술 파트너에 연결합니다. 모든 것이 실시간으로 이루어집니다. 이 확장은 사이트에 [!DNL Beemray] SDK을 설치합니다.

Beemray는 [!DNL Adobe Experience Platform]의 개인화 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101063.beemray-human-context.html)의 확장 페이지를 참조하십시오.
