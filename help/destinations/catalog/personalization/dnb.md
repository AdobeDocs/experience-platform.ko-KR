...
description: D&B Visitor Intelligence 확장은 Adobe Experience Platform의 개인화 대상입니다. 확장 기능에 대한 자세한 내용은 Exchange Adobe의 확장 페이지를 참조하십시오.
...
D&amp;B Visitor Intelligence 확장을 설치하려면 다음을 수행하십시오.
