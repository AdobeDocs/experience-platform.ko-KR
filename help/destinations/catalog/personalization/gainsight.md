...
# [!DNL Gainsight] 확장 기능 {#gainsight-extension}

## 개요 {#overview}

[!DNL Gainsight]은(는) 사용자 행동을 깊이 이해하고 제품 채택을 유도하며 사용자 피드백을 수집할 수 있는 도구를 제품 소유자에게 제공합니다.

[!DNL Gainsight]은(는) [!DNL Adobe Experience Platform]의 개인화 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.103343.html)의 확장 페이지를 참조하십시오.
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 [Adobe Exchange의 Gainsight 페이지](https://www.adobeexchange.com/experiencecloud.details.103343.html)를 참조하세요.
