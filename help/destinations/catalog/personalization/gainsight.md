...
description: Gainsight 확장은 Adobe Experience Platform에서 개인화 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
seo-description: Gainsight 확장은 Adobe Experience Platform에서 개인화 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
...
[!DNL Gainsight] 제품 소유자가 사용자 행동을 심층적으로 파악하고 제품 채택률을 높이며 사용자 피드백을 수집할 수 있도록 지원합니다.

[!DNL Gainsight] 는 Adobe Experience Platform의 개인화 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.103343.html)의 확장 페이지를 참조하십시오.
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.103343.html)의 [Gainsight 페이지를 참조하십시오.
