...
이 확장은 [!DNL Experience Cloud] ID 서비스: 모든 방문자를 식별합니다 [!DNL Experience Cloud] 솔루션.

[!DNL Experience Cloud] ID 서비스는 Adobe Experience Platform의 개인화 확장 기능입니다. 확장 기능에 대한 자세한 내용은 [Experience Cloud ID 서비스 확장 페이지](../../../tags/extensions/client/id-service/overview.md) 를 참조하십시오.
...
이 확장을 사용하려면 Platform의 태그에 액세스해야 합니다. 태그는 부가가치 기능으로 포함되어 Adobe Experience Cloud 고객에게 제공됩니다. 데이터 수집 UI에 대한 액세스 권한을 얻으려면 조직 관리자에게 문의하여 권한을 부여하십시오. **[!UICONTROL manage_properties]** 확장을 설치할 수 있는 권한.

## 확장 설치 {#install-extension}

을(를) 설치하려면 [!DNL Experience Cloud] ID 서비스 확장:
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 [Experience Cloud ID 서비스 확장 페이지](../../../tags/extensions/client/id-service/overview.md) 를 참조하십시오.
