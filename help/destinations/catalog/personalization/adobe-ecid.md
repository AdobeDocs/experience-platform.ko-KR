...
[!DNL Experience Cloud] ID 서비스는 Adobe Experience Platform의 개인화 확장입니다. 확장 기능에 대한 자세한 내용은 태그 설명서에서 [Experience Cloud ID 서비스 확장 페이지](../../../tags/extensions/web/id-service/overview.md)을 참조하십시오.
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 태그 설명서의 [Experience Cloud ID 서비스 확장 페이지](../../../tags/extensions/web/id-service/overview.md)을 참조하십시오.
