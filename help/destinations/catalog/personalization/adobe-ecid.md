...
[!DNL Experience Cloud] ID 서비스는 Adobe Experience Platform의 개인화 확장입니다. 확장 기능에 대한 자세한 내용은 [!DNL Experience Platform Launch] 설명서의 [Experience Cloud ID 서비스 확장 페이지](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/id-service-extension/overview.html)를 참조하십시오.
...
![Adobe ECID 확장](../../assets/catalog/personalization/adobe-ecid/catalog.png)

## 전제 조건 {#prerequisites}

이 익스텐션은 플랫폼을 구입한 모든 고객의 대상 카탈로그에서 사용할 수 있습니다.

이 확장을 사용하려면 [!DNL Experience Platform Launch]에 액세스해야 합니다. [!DNL Experience Platform Launch] Adobe Experience Cloud 고객에게 제공되는 부가 가치 기능 조직 관리자에게 문의하여 [!DNL Launch]에 액세스할 수 있도록 **[!UICONTROL manage_properties]** 권한을 요청하십시오. 그러면 확장을 설치할 수 있습니다.

## 확장 설치 {#install-extension}

[!DNL Experience Cloud] ID 서비스 확장을 설치하려면:
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 [!DNL Experience Launch] 설명서의 [Experience Cloud ID 서비스 확장 페이지](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/id-service-extension/overview.html)를 참조하십시오.
