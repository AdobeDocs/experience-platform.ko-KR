...
[!DNL Experience Cloud] ID 서비스는 실시간 고객 데이터 플랫폼의 개인화 확장입니다. 확장 기능에 대한 자세한 내용은 설명서의 [Experience Cloud ID 서비스 확장 페이지를](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/id-service-extension/overview.html) 참조하십시오 [!DNL Experience Platform Launch] .
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 설명서의 [Experience Cloud ID 서비스 확장 페이지를](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/id-service-extension/overview.html) 참조하십시오 [!DNL Experience Launch] .
