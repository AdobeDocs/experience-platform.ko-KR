...
>[!IMPORTANT]
>
>사용자 지정 개인화 연결을 만들기 전에 다음 방법에 대한 안내서를 읽어 보는 것이 좋습니다 [동일한 페이지 및 다음 페이지 개인화를 위한 개인화 대상 구성](../../ui/configure-personalization-destinations.md). 이 안내서에서는 여러 Experience Platform 구성 요소에서 동일한 페이지 및 다음 페이지 개인화 사용 사례에 필요한 구성 단계를 안내합니다.
