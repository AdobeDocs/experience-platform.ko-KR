...
>[!IMPORTANT]
>
>프로필 속성에 중요한 데이터가 포함될 수 있습니다. 이 데이터를 보호하려면 다음을 사용해야 합니다 [Edge Network Server API](/help/server-api/overview.md) 구성 시 **[!UICONTROL 사용자 정의 개인화]** 속성 기반 개인화를 위한 대상. 모든 서버 API 호출은 [인증된 컨텍스트](../../../server-api/authentication.md).
>
