...
>[!IMPORTANT]
>
>프로필 속성에 중요한 데이터가 포함될 수 있습니다. 이 데이터를 보호하려면 다음을 사용해야 합니다 [Edge Network 서버 API](/help/server-api/overview.md) 구성 시 **[!UICONTROL 사용자 지정 Personalization]** 속성 기반 개인화를 위한 대상. 모든 서버 API 호출은 [인증된 컨텍스트](../../../server-api/authentication.md).
>
...
이 통합은 [Adobe Experience Platform 웹 SDK](/help/web-sdk/home.md) 또는 [Adobe Experience Platform Mobile SDK](https://developer.adobe.com/client-sdks/documentation/). 이 대상을 사용하려면 다음 SDK 중 하나를 사용해야 합니다.
...
을 사용하지 않는 경우 [태그](/help/tags/home.md) Experience Platform Web SDK를 배포하려면 다음을 사용합니다. [명령 응답](/help/web-sdk/commands/command-responses.md) 을 눌러 내보낸 데이터를 확인합니다.
...
### 에 대한 응답 예 [!UICONTROL 속성을 사용한 사용자 지정 Personalization]

사용 시 **[!UICONTROL 속성을 사용한 사용자 지정 Personalization]**, API 응답은 아래 예와 유사합니다.

차이점 **[!UICONTROL 속성을 사용한 사용자 지정 Personalization]** 및 **[!UICONTROL 사용자 지정 Personalization]** 은(는) 다음을 포함합니다. `attributes` 섹션에 있는 섹션을 참조하십시오.
