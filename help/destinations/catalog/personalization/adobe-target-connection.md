...
아래 표에는 구현 유형에 따라 [Web SDK](/help/web-sdk/home.md) 사용 여부와 [Edge 세그멘테이션](/help/segmentation/home.md#edge) 사용 여부에 따라 Adobe Target 대상에 대해 지원되는 사용 사례가 표시됩니다.
