...
확장 구성 옵션에 대한 자세한 내용은 [!DNL Experience Launch] 설명서의 [Adobe Target v2 확장 페이지](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/targetv2-extension/adobe-target-extension-v2.html)를 참조하십시오.
