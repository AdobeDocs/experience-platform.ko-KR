...
Adobe Target v2는 Adobe Experience Platform의 개인화 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe 교환](https://exchange.adobe.com/experiencecloud.details.102722.adobe-target-v2-launch-extension.html).
...
확장을 설치할 속성을 선택합니다. 새 속성을 만들 수도 있습니다. 속성은 규칙, 데이터 요소, 구성된 확장, 환경 및 라이브러리의 컬렉션입니다. 다음 문서를 참조하십시오. [속성](../../../tags/ui/administration/companies-and-properties.md#properties-page) 를 참조하십시오.

워크플로우는 설치를 완료하는 단계를 안내합니다.

확장 구성 옵션에 대한 자세한 내용은 [Adobe Target v2 확장 페이지](../../../tags/extensions/client/target-v2/overview.md) 태그 설명서에 추가했습니다.
