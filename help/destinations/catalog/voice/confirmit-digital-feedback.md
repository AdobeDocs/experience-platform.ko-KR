...
title: 디지털 피드백 확장 확인
description: 확인 디지털 피드백 확장은 Adobe Experience Platform에 있는 고객 대상의 음성입니다. 확장 기능에 대한 자세한 내용은 Exchange Adobe의 확장 페이지를 참조하십시오.
...
[!DNL Confirmit Digital Feedback] 솔루션은 웹 사이트 트래픽을 실시간 인사이트로 전환하는 데 도움이 됩니다. [!DNL Confirmit]을 사용하면 요구 사항에 따라 객관적이지 않고 고도로 타깃팅된 설문 조사를 표시할 수 있으므로 방문자가 다음과 같은 피드백을 제공할 수 있습니다.
...
[!DNL Confirmit] 디지털 피드백은 Adobe Experience Platform에서 고객 확장의 음성입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html)에서 확장 페이지를 참조하십시오.
...
[!DNL Confirmit] 디지털 피드백 확장을 설치하려면 다음을 수행하십시오.
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html)에서 [디지털 피드백 확인 페이지를 참조하십시오.
