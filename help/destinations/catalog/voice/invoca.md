...
[!DNL Invoca Tags]은(는) [!DNL Adobe Experience Platform]에서 고객 확장의 음성입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100067.invoca.html)의 확장 페이지를 참조하십시오.
