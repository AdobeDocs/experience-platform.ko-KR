...
keywords: 인보카;인보카
title: 호출 태그 확장
description: Invoca 태그 확장은 Adobe Experience Platform에서 고객 대상의 음성입니다. 확장 기능에 대한 자세한 내용은 Exchange Adobe의 확장 페이지를 참조하십시오.
...
[!DNL Invoca] 디지털 고객 여정에 콜 데이터 및 음성 인사이트를 제공합니다. [!DNL Invoca’s] 통화 인텔리전스 플랫폼을 통해 마케터는 마지막으로 호출 결과를 측정하고 오프라인 전환을 다시 디지털 소비에 연결할 수 있는 분석을 갖게 됩니다.

[!DNL Invoca Tags] 는 Adobe Experience Platform에서 고객 확장의 음성입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100067.invoca.html)에서 확장 페이지를 참조하십시오.

이 대상은 태그 확장입니다. Platform에서 태그 확장이 작동하는 방법에 대한 자세한 내용은 [태그 확장 개요](../launch-extensions/overview.md)를 참조하십시오.

![Invoca 확장](../../assets/catalog/voice/invoca/catalog.png)
...
[!DNL Invoca Tags] 확장을 설치하려면 다음을 수행하십시오.
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 Exchange](https://exchange.adobe.com/experiencecloud.details.100067.invoca.html)Adobe의 [태그 호출 페이지를 참조하십시오.
