---
keywords: Talk URL 받은 편지함;Talk URL 받은 편지함;Talk URL 받은 편지함;Talk URL 받은 편지함;Talk URL;Talk URL;Talk URL
title: Talk URL 받은 편지함 확장
description: Talk URL 받은 편지함 확장은 Adobe Experience Platform의 고객 대상 음성입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
...
# [!DNL Talk URL Inbox] 확장 기능 {#talk-url-extension}

웹 페이지 방문자로부터 음성 메시지를 수신합니다. 호스팅된 UI 및 클라우드 기반 머신 러닝을 포함하여 음성 메시지를 즉시 텍스트 인사이트로 트랜스크립션할 수 있습니다.

[!DNL Talk URL Inbox]은(는) [!DNL Adobe Experience Platform]에서 고객 확장의 음성입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100583.html)의 확장 페이지를 참조하십시오.

이 대상은 태그 확장입니다. Experience Platform에서 태그 확장이 작동하는 방법에 대한 자세한 내용은 [태그 확장 개요](../launch-extensions/overview.md)를 참조하십시오.

![Talk URL 받은 편지함 확장](../../assets/catalog/voice/talkurl/catalog.png)
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 Adobe Exchange의 [Talk URL 받은 편지함 페이지](https://exchange.adobe.com/experiencecloud.details.100583.html)를 참조하십시오.
