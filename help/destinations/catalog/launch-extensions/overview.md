...
# [!DNL Adobe Experience Platform]의 태그 확장

[!DNL Adobe Experience Platform]은(는) Adobe의 차세대 태그 관리 기능을 제공합니다. Experience Platform은 관련 고객 환경을 향상시키는 데 필요한 모든 분석, 마케팅 및 광고 태그를 배포하고 관리하는 간단한 방법을 제공합니다. 태그는 부가가치 기능으로 포함되어 [!DNL Adobe Experience Cloud] 고객에게 제공됩니다.
...
Experience Platform 인터페이스에서 확장을 찾으려면 **[!UICONTROL Destinations]** > **[!UICONTROL Catalog]**(으)로 이동한 다음 **[!UICONTROL Extensions]** 필터에서 **[!UICONTROL Types]**&#x200B;을(를) 선택합니다.
