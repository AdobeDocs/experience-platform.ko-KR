...
확장 구성 옵션에 대한 자세한 내용은 [Adobe Analytics 확장 페이지](https://experienceleague.adobe.com/docs/platform-learn/implement-in-websites/implement-solutions/analytics.html) 태그 설명서에 추가했습니다.
