...
Adobe Analytics은 Adobe Experience Platform의 analytics 확장 기능입니다. 확장 기능에 대한 자세한 내용은 [Adobe Analytics 확장 개요](/help/tags/extensions/client/analytics/overview.md) 를 참조하십시오.
...
확장 구성 옵션에 대한 자세한 내용은 [Adobe Analytics 확장 페이지](https://experienceleague.adobe.com/docs/platform-learn/implement-in-websites/implement-solutions/analytics.html) 태그 설명서.
