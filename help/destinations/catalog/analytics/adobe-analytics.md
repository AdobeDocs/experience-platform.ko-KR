...
Adobe Analytics은 Adobe Experience Platform의 분석 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100156.html)의 확장 페이지를 참조하십시오.
...
확장 구성 옵션에 대한 자세한 내용은 경험 [!DNL Launch] 설명서의 [Adobe Analytics 확장 페이지](https://experienceleague.adobe.com/docs/launch-learn/implementing-in-websites-with-launch/implement-solutions/analytics.html)를 참조하십시오.
