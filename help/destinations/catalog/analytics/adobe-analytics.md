...
확장 구성 옵션에 대한 자세한 내용은 경험 설명서의 [Adobe Analytics 확장 페이지](https://experienceleague.adobe.com/docs/launch-learn/implementing-in-websites-with-launch/implement-solutions/analytics.html) 를 [!DNL Launch] 참조하십시오.
