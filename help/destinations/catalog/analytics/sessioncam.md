...
title: SessionCam 확장
description: SessionCam 확장은 Adobe Experience Platform의 분석 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
...
# [!DNL SessionCam] 확장 기능 {#sessioncam-extension}

## 개요 {#overview}

[!DNL SessionCam]은(는) 사용자 동작을 표시하고 해결해야 할 가장 중요한 문제를 보여 주는 필수 도구 모음을 제공합니다.

[!DNL SessionCam]은(는) [!DNL Adobe Experience Platform]의 analytics 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100517.html)의 확장 페이지를 참조하십시오.
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 Adobe Exchange의 [SessionCam 페이지](https://exchange.adobe.com/experiencecloud.details.100517.html)를 참조하십시오.
