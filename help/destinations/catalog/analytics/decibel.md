---
keywords: 데시벨 확장;데시벨;데시벨 대상
title: Decibel 확장
description: Decibel 확장은 Adobe Experience Platform의 분석 대상입니다. 확장 기능에 대한 자세한 내용은 Exchange Adobe의 확장 페이지를 참조하십시오.
...
# [!DNL Decibel] 확장 {#decibel-extension}

## 개요 {#overview}

웹 속성에 [!DNL Decibel]을 빠르고 원활하게 배포합니다. 확장 프로그램을 통해 사용 가능한 작업을 사용하여 규칙을 사용하여 추가 고급 구성을 배포할 수도 있습니다.

[!DNL Decibel] 는 Adobe Experience Platform의 analytics 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100913.html)에서 확장 페이지를 참조하십시오.
...
![Decibel 확장](../../assets/catalog/analytics/decibel/catalog.png)
...
[!DNL Decibel] 확장을 설치하려면 다음을 수행하십시오.
...
확장 구성 옵션에 대한 자세한 내용은 Exchange Adobe의 [Decibel 확장 페이지](https://exchange.adobe.com/experiencecloud.details.100913.html)를 참조하십시오.
