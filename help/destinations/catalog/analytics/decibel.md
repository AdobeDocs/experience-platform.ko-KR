...
seo-description: Decibel 확장은 Adobe Experience Platform의 분석 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
...
웹 속성에 [!DNL Decibel]을(를) 빠르고 매끄럽게 배포합니다. 확장 기능을 통해 사용 가능한 작업을 사용하여 규칙을 사용하여 고급 구성을 추가로 배포할 수도 있습니다.

[!DNL Decibel] 는 Adobe Experience Platform의 분석 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100913.html)의 확장 페이지를 참조하십시오.
