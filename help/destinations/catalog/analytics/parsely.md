...
Parse.ly는 Adobe Experience Platform의 분석 확장입니다. 확장 기능에 대한 자세한 내용은 [Parse.ly Analytics](https://www.parse.ly/)를 참조하십시오.
...
![구문 분석.ly 분석 확장](../../assets/catalog/analytics/parsely/catalog.png)
