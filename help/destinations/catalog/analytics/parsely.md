---
keywords: 구문 분석합니다. ly;parselly;parselly;parse.ly;Parse.ly
title: Parse.ly Analytics 확장
description: Parse.ly Analytics 확장은 Adobe Experience Platform의 분석 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
...
# [!DNL Parse.ly Analytics] 확장 기능 {#parsely-analytics-extension}

## 개요 {#overview}

[!DNL Parse.ly Analytics]은(는) 2,500개 이상의 회사에서 데이터를 사용하여 온라인 대상자를 이해할 수 있도록 지원합니다. 이 확장은 방문자가 사이트의 콘텐츠와 상호 작용하는 방법을 추적하는 JavaScript 코드 조각을 설치합니다.

Parse.ly는 Adobe Experience Platform의 Analytics 확장 기능입니다. 확장 기능에 대한 자세한 내용은 [Parse.ly Analytics](https://www.parse.ly/)를 참조하십시오.
