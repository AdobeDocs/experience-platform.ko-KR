...
[!DNL Parse.ly Analytics] 는 2,500개 이상의 기업이 데이터를 사용하여 온라인 대상자를 이해할 수 있도록 지원합니다. 이 확장은 방문자가 사이트의 콘텐츠와 상호 작용하는 방법을 추적하는 JavaScript 코드 조각을 설치합니다.

Parse.ly는 Adobe Experience Platform의 Analytics 확장 기능입니다. 확장 기능에 대한 자세한 내용은 [Parse.ly 분석](https://www.parse.ly/).
