---
keywords: dialogtech 확장;dialogtech;dialogtech destination;DialogTech;DialogTech SourceTrak
title: DialogTech 확장
description: DialogTech 확장은 Adobe Experience Platform의 분석 대상입니다. 확장 기능에 대한 자세한 내용은 Exchange Adobe의 확장 페이지를 참조하십시오.
...
Adobe Launch에 [!DNL DialogTech SourceTrak] javascript 코드 조각을 포함합니다

[!DNL DialogTech] 는 Adobe Experience Platform의 analytics 확장입니다. 확장 기능에 대한 자세한 내용은 [Dialogtech 웹 사이트](https://www.dialogtech.com/)를 참조하십시오.
...
[!DNL DialogTech] 확장을 설치하려면 다음을 수행하십시오.
