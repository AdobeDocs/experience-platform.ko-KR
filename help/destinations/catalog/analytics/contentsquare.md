---
keywords: contentsquare 확장;contentsquare 대상;contentsquare
title: 콘텐츠 사각형 확장
description: Contentsquare 확장은 Adobe Experience Platform의 분석 대상입니다. 확장 기능에 대한 자세한 내용은 Exchange Adobe의 확장 페이지를 참조하십시오.
...
페이지 내 동작을 시각화하려면 고객이 포기하는 이유 및 개선할 수 있는 방법을 참조하십시오. 매출액을 각 Analytics 세그먼트 및 Target 테스트에 대한 UX 및 컨텐츠 요소에 기여합니다. [!DNL Contentsquare] 태그를 설치하고 사용자 지정 변수 및 이벤트를 설정합니다. 몇 번의 클릭으로 UX 분석을 위한 데이터 수집을 시작합니다.

[!DNL Contentsquare] 는 Adobe Experience Platform의 analytics 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100364.html)에서 확장 페이지를 참조하십시오.

이 대상은 태그 확장입니다. Platform에서 태그 확장이 작동하는 방법에 대한 자세한 내용은 [태그 확장 개요](../launch-extensions/overview.md)를 참조하십시오.

![콘텐츠 사각형 확장](../../assets/catalog/analytics/contentsquare/catalog.png)
...
[!DNL Contentsquare] 확장을 설치하려면 다음을 수행하십시오.
...
확장 구성 옵션에 대한 자세한 내용은 Adobe Exchange의 [Contentsquare 확장 페이지](https://exchange.adobe.com/experiencecloud.details.100364.html)를 참조하십시오.
