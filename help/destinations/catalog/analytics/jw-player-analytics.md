---
keywords: JW 플레이어;jw 플레이어;JW 플레이어;jw 확장;JW 확장
title: JW Player Analytics(Beta) 확장
description: JW Player Analytics(Beta) 확장은 Adobe Experience Platform의 분석 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
...
# [!DNL JW Player Analytics]&#x200B;(Beta) 확장 {#jw-player-analytics-extension}

## 개요 {#overview}

이 확장은 [!DNL JW Player] 이벤트를 Adobe Video Analytics에 연결하는 [!DNL JW Player] 어댑터를 설치합니다. Adobe Video Analytics의 기능을 활용하여 고객의 비디오 시청 습관을 이해할 수 있는 자세한 통찰력을 얻을 수 있습니다.

[!DNL JW Player Analytics]&#x200B;(Beta)은(는) [!DNL Adobe Experience Platform]의 analytics 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101523.jw-player-analytics-launch-extension.html)의 확장 페이지를 참조하십시오.
...
[!DNL JW Player Analytics]&#x200B;(Beta) 확장을 설치하려면:
...
확장 구성 옵션에 대한 자세한 내용은 Adobe Exchange의 [JW Player Analytics(Beta) 확장 페이지](https://exchange.adobe.com/experiencecloud.details.101523.jw-player-analytics-launch-extension.html)를 참조하십시오.
