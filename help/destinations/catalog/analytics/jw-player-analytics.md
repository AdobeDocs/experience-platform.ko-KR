...
확장 구성 옵션에 대한 자세한 내용은 Adobe Exchange의 [JW 플레이어 분석(베타) 확장 페이지를](https://exchange.adobe.com/experiencecloud.details.101523.jw-player-analytics-launch-extension.html) 참조하십시오.
