...
[!DNL Google's Global Site Tag] 또는 gtag.js를 통해 [!DNL Google Analytics], [!DNL Google Ads] 및 [!DNL Google Marketing Platform]에 데이터를 보냅니다. 제품당 여러 개의 계정을 구성할 수 있습니다.

[!DNL Google Global Site Tag]은(는) Adobe Experience Platform의 analytics 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101437.google-global-site-tag-gtag.html)의 확장 페이지를 참조하십시오.
