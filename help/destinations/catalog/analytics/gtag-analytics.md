---
keywords: Google 글로벌 사이트 태그;gtag;google gtag;google 확장 프로그램;google gtag 확장 프로그램;GTAG
title: Google 전역 사이트 태그 확장
description: Google 전역 사이트 태그 확장은 Adobe Experience Platform의 분석 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
...
# [!DNL Google Global Site Tag] 확장 기능 {#gtag-analytics-extension}

## 개요 {#overview}

[!DNL Google Analytics] 또는 gtag.js를 통해 [!DNL Google Ads], [!DNL Google Marketing Platform] 및 [!DNL Google's Global Site Tag]에 데이터를 보냅니다. 제품당 여러 개의 계정을 구성할 수 있습니다.

[!DNL Google Global Site Tag]은(는) [!DNL Adobe Experience Platform]의 analytics 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101437.google-global-site-tag-gtag.html)의 확장 페이지를 참조하십시오.

이 대상은 태그 확장입니다. Experience Platform에서 태그 확장이 작동하는 방법에 대한 자세한 내용은 [태그 확장 개요](../launch-extensions/overview.md)를 참조하십시오.

![Google 전역 사이트 태그 확장](../../assets/catalog/analytics/gtag-analytics/catalog.png)
...
[!DNL Google Global Site Tag] 확장을 설치하려면:
...
확장 구성 옵션에 대한 자세한 내용은 확장의 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101437.google-global-site-tag-gtag.html) 페이지를 참조하십시오.
