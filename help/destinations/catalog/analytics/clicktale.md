...
title: Clicktale 확장
description: Clicktale 확장 프로그램은 Adobe Experience Platform의 분석 대상입니다. 확장 기능에 대한 자세한 내용은 Exchange Adobe의 확장 페이지를 참조하십시오.
...
[!DNL Clicktale's] Experience Platform Launch과 통합하면  [!DNL Clicktale] 시각적 편집기를 사용하여 Launch 내에서  [!DNL Clicktale's] 코드를 배포하고 데이터 요소를 매핑하는 기능을 만들 수 있습니다.

[!DNL Clicktale] 는 Adobe Experience Platform의 analytics 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100082.html)에서 확장 페이지를 참조하십시오.
...
[!DNL Clicktale] 확장을 설치하려면 다음을 수행하십시오.
...
확장 구성 옵션에 대한 자세한 내용은 Adobe Exchange에서 [Clicktale 확장 페이지](https://exchange.adobe.com/experiencecloud.details.100082.html)를 참조하십시오.
