...
title: 오디오 및 비디오용 Adobe Medium 분석 확장
description: 오디오 및 비디오용 Adobe Medium 분석 확장 기능은 Adobe Experience Platform의 분석 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
...
# 오디오 및 비디오용 Adobe Medium 분석 확장 {#adobe-analytics-for-video-extension}

## 개요 {#overview}

Adobe Medium Analytics for Audio and Video는 클라이언트에게 비디오, 오디오 및 광고에 대한 강력한 측정을 제공하는 기본 Analytics 서비스의 추가 기능입니다.

Adobe Medium Analytics for Audio and Video는 Adobe Experience Platform의 Analytics 확장 기능입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100157.html)의 확장 페이지를 참조하십시오.
...
확장 구성 옵션에 대한 자세한 내용은 태그 설명서의 [오디오 및 비디오 확장 기능용 Adobe Medium 분석 페이지](../../../tags/extensions/client/media-analytics/overview.md)를 참조하십시오.
