...
오디오 및 비디오용 Adobe 미디어 분석은 Adobe Experience Platform의 분석 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100157.html)의 확장 페이지를 참조하십시오.
...
비디오용 Adobe Analytics 확장을 설치하려면:
...
확장 구성 옵션에 대한 자세한 내용은 [!DNL Experience Launch] 설명서의 [오디오 및 비디오용 미디어 분석 Adobe 확장 페이지](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/media-analytics-extension/overview.html)를 참조하십시오.
