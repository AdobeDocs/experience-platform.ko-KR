...
Adobe Medium Analytics for Audio and Video는 Adobe Experience Platform의 Analytics 확장 기능입니다. 확장 기능에 대한 자세한 내용은 의 확장 페이지를 참조하십시오 [Adobe 교환](https://exchange.adobe.com/experiencecloud.details.100157.html).
...
확장 구성 옵션에 대한 자세한 내용은 [Adobe Medium Analytics for Audio and Video 확장 페이지](../../../tags/extensions/client/media-analytics/overview.md) 를 참조하십시오.
