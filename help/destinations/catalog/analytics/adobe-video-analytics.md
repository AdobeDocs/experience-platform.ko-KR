...
확장 구성 옵션에 대한 자세한 내용은 설명서에서 [오디오 및 비디오용 Adobe 미디어 분석 확장 페이지](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/media-analytics-extension/overview.html) 를 [!DNL Experience Launch] 참조하십시오.
