...
# [!DNL TMMData] 확장 기능 {#tmmdata-extension}

## 개요 {#overview}

Adobe Marketing Cloud용 [!DNL TMMData's] Foundation 플랫폼은 마케팅 팀에게 자동화된 캠페인 설정과 Adobe 및 기타 분석 및 BI 도구에 대한 직접 가져오기를 통해 확실하고 포괄적인 크로스 채널 분석을 위해 모든 중요 데이터 소스(내부/외부 및 온라인/오프라인 데이터 포함)에 액세스하고 이를 혼합하는 도구를 제공합니다.

[!DNL TMMData]은(는) [!DNL Adobe Experience Platform]의 analytics 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100148.tmmdata-foundation-platform.html)의 확장 페이지를 참조하십시오.
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 Adobe Exchange의 [TMMData 페이지](https://exchange.adobe.com/experiencecloud.details.100148.tmmdata-foundation-platform.html)를 참조하십시오.
