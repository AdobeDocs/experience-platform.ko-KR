...
title: Quantum 지표 확장
description: Quantum Metric 확장은 Adobe Experience Platform의 분석 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
...
# [!DNL Quantum Metric] 확장 기능 {#quantum-metric-extension}

## 개요 {#overview}

[!DNL Quantum Metric] 태그 확장을 사용하면 [!DNL Quantum Metric's] 데이터 수집 기능을 원활하게 배포할 수 있습니다. 또한 이 확장은 [!DNL Quantum Metric] API의 유용한 정보를 포함하는 데이터 요소를 캡처하는 기능을 제공합니다.

[!DNL Quantum Metric]은(는) [!DNL Adobe Experience Platform]의 analytics 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html)의 확장 페이지를 참조하십시오.

이 대상은 태그 확장입니다. Experience Platform에서 태그 확장이 작동하는 방법에 대한 자세한 내용은 [태그 확장 개요](../launch-extensions/overview.md)를 참조하십시오.

![Quantum 지표 확장](../../assets/catalog/analytics/quantum-metric/catalog.png)
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 Adobe Exchange의 [Quantum 지표 페이지](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html)를 참조하십시오.
