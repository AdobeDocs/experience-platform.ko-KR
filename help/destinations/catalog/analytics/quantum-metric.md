...
title: Quantum 지표 확장
description: Quantum 지표 확장은 Adobe Experience Platform의 분석 대상입니다. 확장 기능에 대한 자세한 내용은 Exchange Adobe의 확장 페이지를 참조하십시오.
...
[!DNL Quantum Metric's] Adobe Launch와 통합하면  [!DNL Quantum Metric's] 데이터 수집 태그의 코델리스 배포를 용이하게 합니다. 또한 이 확장은 [!DNL Quantum Metric] API의 유용한 정보가 포함된 Launch 데이터 요소를 캡처하는 기능을 제공합니다.

[!DNL Quantum Metric] 는 Adobe Experience Platform의 analytics 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html)에서 확장 페이지를 참조하십시오.
...
[!DNL Quantum Metric] 확장을 설치하려면 다음을 수행하십시오.
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html)의 [Quantum 지표 페이지를 참조하십시오.
