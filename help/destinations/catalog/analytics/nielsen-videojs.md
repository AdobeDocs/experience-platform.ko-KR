---
keywords: Nielsen VideoJS 플레이어 핸들러;nielsen 비디오 js 플레이어;nielsen videojs 플레이어;Nielsen;Videojs 플레이어;Nielsen Digital SDK;nielsen 디지털 SDK
...
[!DNL Nielsen Digital SDK] launch 확장은 다음 디지털 측정 제품을 통해 대상 측정을 제공합니다.

DCR: 광고가 포함된 컨텐츠를 포함하여 비선형 디지털 컨텐츠에 대한 일별 측정을 제공하는 측정 솔루션을 사용하면 데스크탑, 모바일, 태블릿 및 연결된 장치에서 디지털 컨텐츠 대상 소비에 대한 포괄적인 보기를 사용할 수 있습니다.

DTVR: 이는 프로그래밍 소스에 참여하는 데스크탑 및 모바일 장치에서 발생하는 선형 TV 보기를 설명합니다. 이는 컴퓨터와 모바일 장치에서 보는 프로그래밍을 위한 TV 대상 측정에 기여함으로써 MRC로부터 인증을 받는 첫 번째 솔루션입니다.

[!DNL Nielsen VideoJS Player Handler] 는 Adobe Experience Platform의 analytics 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101361.nielsen-digital-sdk-extension.html)에서 확장 페이지를 참조하십시오.
...
![Nielsen VideoJS 플레이어 핸들러 확장](../../assets/catalog/analytics/nielsen-videojs/catalog.png)
...
[!DNL Nielsen VideoJS Player Handler] 확장을 설치하려면 다음을 수행하십시오.
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101361.nielsen-digital-sdk-extension.html)의 [Nielsen Digital SDK 페이지를 참조하십시오.
