...
DCR:광고가 포함된 컨텐츠를 포함하여 비선형 디지털 컨텐츠에 대한 일일 측정을 제공하는 측정 솔루션을 사용하면 데스크탑, 모바일, 태블릿 및 연결된 디바이스에서 디지털 컨텐츠 고객 소비를 포괄적으로 파악할 수 있습니다.

DTVR:프로그래밍 소스에 참여하는 데 데스크탑 및 모바일 장치에서 발생하는 선형 TV 시청에 대해 설명합니다. 이는 MRC로부터 컴퓨터 및 모바일 디바이스에서 볼 수 있는 프로그래밍을 위한 TV 대상 측정에 기여한 첫 번째 솔루션입니다.

[!DNL Nielsen VideoJS Player Handler] 는 Adobe Experience Platform의 분석 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101361.nielsen-digital-sdk-extension.html)의 확장 페이지를 참조하십시오.
...
[!DNL Nielsen VideoJS Player Handler] 확장을 설치하려면:
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101361.nielsen-digital-sdk-extension.html)의 [Nielsen 디지털 SDK 페이지를 참조하십시오.
