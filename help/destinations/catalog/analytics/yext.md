...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 Adobe Exchange의 [Yext 전환 추적 페이지](https://exchange.adobe.com/experiencecloud.details.103174.yext-conversion-tracking.html)를 참조하십시오.
