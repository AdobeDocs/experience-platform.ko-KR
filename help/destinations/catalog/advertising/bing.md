...
[ **[!UICONTROL 연결]** ] > **[!UICONTROL 대상]**&#x200B;에서 [!DNL Microsoft Bing]를 선택하고 구성을 **[!UICONTROL 선택합니다]**.
...
인증 [!UICONTROL 단계에서 대상] 연결 세부 사항을 입력해야 합니다.
...
대상 **[!UICONTROL 만들기를 클릭합니다]**. 이제 대상이 만들어집니다. 나중에 세그먼트를 활성화하려는 경우 [!UICONTROL 저장] 및 종료를 [!UICONTROL 클릭하거나] 다음을클릭하여 워크플로우를 계속하고 활성화할 세그먼트를 선택할 수 있습니다. 두 경우 모두 워크플로우의 나머지 [에 대해 다음 섹션, 세그먼트](#activate-segments)활성화를 참조하십시오.
