...
Google gtag는 [!DNL Adobe Experience Platform]의 광고 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.102805.google-gtag.html)의 확장 페이지를 참조하십시오.
