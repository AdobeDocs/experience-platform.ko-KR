...
# 기존 Adobe Advertising Cloud DSP 연결
...
온라인 retailer은 타깃팅에 쿠키를 사용하지 않고 디스플레이 캠페인을 통해 가치가 높은 고객을 다시 타깃팅하려고 합니다. retailer은 Adobe Real-Time Customer Data Platform(Real-Time CDP) 계정에서 DSP 계정으로 고가치 고객의 해시된 이메일 ID로 구성된 대상을 공유합니다. 그런 다음 DSP은 DSP과 LiveRamp 간의 파트너십을 통해 해시된 이메일 ID를 인증된 [!DNL RampIDs]&#x200B;(으)로 변환합니다. 결과 [!DNL RampIDs]은(는) 디스플레이 캠페인에서 대상자를 타겟팅하는 데 사용할 수 있습니다.
