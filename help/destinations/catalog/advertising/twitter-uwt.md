---
keywords: twitter;Twitter;범용 웹 사이트 twitter 태그;범용 웹 사이트 태그 Twitter;UWT 태그 Twitter;UWT Twitter;UWT twitter
...
[!DNL Twitter Universal Website Tag] twitter UWT 태그에 비콘을 전송하는 작업을 제공합니다.

[!DNL Twitter Universal Website Tag] 는 Adobe Experience Platform의 광고 확장 프로그램입니다. 확장 기능에 대한 자세한 내용은 [전환 추적](https://business.twitter.com/en/help/campaign-measurement-and-analytics/conversion-tracking-for-websites.html) twitter 설명서에서 확인할 수 있습니다.
...
을(를) 설치하려면 [!DNL Twitter Universal Website Tag] 확장:
