...
# [!DNL Twitter Universal Website Tag] 확장 기능 {#twitter-uwt-extension}

## 개요 {#overview}

[!DNL Twitter Universal Website Tag]은(는) Twitter UWT 태그로 비콘을 보내는 작업을 제공합니다.
...
![Twitter 유니버설 웹 사이트 태그 확장](../../assets/catalog/advertising/twitter-uwt/catalog.png)
...
[!DNL Twitter Universal Website Tag] 확장을 설치하려면:
