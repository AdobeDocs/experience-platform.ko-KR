...
title: Awin 광고주 Mastertag 확장
seo-title: Awin 광고주 Mastertag 확장
description: Win 광고주 마스터 태그 확장은 Adobe Experience Platform의 광고 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
seo-description: Win 광고주 마스터 태그 확장은 Adobe Experience Platform의 광고 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
...
[!DNL MasterTag]은 Win 추적 솔루션에 필요한 모든 기능을 포함하는 JavaScript 라이브러리로, 확인 페이지를 비롯하여 사이트의 모든 페이지에 조건 없이 추가해야 하지만 결제 정보를 표시하거나 처리하는 페이지는 제외합니다.

[!DNL Awin Advertiser Mastertag] 는 Adobe Experience Platform의 광고 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103176.awin-advertiser-mastertag.html)의 확장 페이지를 참조하십시오.

이 대상은 [!DNL Experience Platform Launch] 확장자입니다. Launch 확장 기능이 플랫폼에서 작동하는 방법에 대한 자세한 내용은 [Experience Platform Launch 확장 개요](../launch-extensions/overview.md)를 참조하십시오.

![UI의 Win 광고주 Mastertag 확장](../../assets/catalog/advertising/awin-mastertag/catalog.png)
...
[!DNL Awin Advertiser Mastertag] 확장을 설치하려면:
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103176.awin-advertiser-mastertag.html)의 [Win 광고주 마스터태그 페이지를 참조하십시오.
