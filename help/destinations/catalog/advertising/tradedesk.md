...
>title="사전 구성된 매핑 세트"
>abstract="4개의 매핑 세트가 사전 구성되어 있습니다. 데이터를 The Trade Desk에 활성화하면 이 대상이 여기에 표시된 대상 ID와 작동하므로 활성화된 대상에 적합한 프로필에는 4개의 ID가 모두 있을 필요는 없습니다. &lt;a href=&quot;https://experienceleague.adobe.com/ko/docs/experience-platform/destinations/catalog/advertising/tradedesk#preconfigured-mappings&quot;>미리 구성된 매핑</a>에 대해 자세히 알아보십시오."
