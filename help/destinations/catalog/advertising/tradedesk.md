...
[ **[!UICONTROL 연결]** ] > **[!UICONTROL 대상]**&#x200B;에서 [!DNL The Trade Desk]를 선택하고 구성을 **[!UICONTROL 선택합니다]**.

![무역부 대상 구성](../../assets/catalog/advertising/tradedesk/configure.png)
...
>
>![무역부 대상 활성화](../../assets/catalog/advertising/tradedesk/activate.png)

인증 [!UICONTROL 단계에서] 연결 [!DNL The Trade Desk] 세부 사항을 입력해야 합니다.
...
![Trade Desk Authentication Step](../../assets/catalog/advertising/tradedesk/authenticate.png)
