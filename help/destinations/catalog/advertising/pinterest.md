---
keywords: Pinterest;pinterest;Pinterest 전환 추적;핀트 전환 추적
...
홍보된 PIN을 본 후 웹 사이트에서 방문자 작업을 추적합니다. 광고 투자 수익률을 측정하고 타깃팅된 대상을 만듭니다. [여기](https://ads.pinterest.com/)에서 추가 정보를 확인하십시오.

[!DNL Pinterest Conversion Tracking] 는 Adobe Experience Platform의 광고 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100523.pinterest-conversion-tracking-for-adobe-launch.html)에서 확장 페이지를 참조하십시오.

이 대상은 태그 확장입니다. Platform에서 태그 확장이 작동하는 방법에 대한 자세한 내용은 [태그 확장 개요](../launch-extensions/overview.md)를 참조하십시오.

![Pinterest 전환 추적 확장](../../assets/catalog/advertising/pinterest/catalog.png)
...
[!DNL Pinterest Conversion Tracking] 확장을 설치하려면 다음을 수행하십시오.
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100523.pinterest-conversion-tracking-for-adobe-launch.html)의 [Pinterest 변환 추적 페이지를 참조하십시오.
