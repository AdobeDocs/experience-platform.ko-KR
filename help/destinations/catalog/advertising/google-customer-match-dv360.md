...
이 대상을 사용하여 자사 PII 기반 [[!DNL Google Customer Match]](https://support.google.com/google-ads/answer/6379332?hl=en) 목록을 [!DNL Search], [!DNL YouTube], [!DNL Gmail] 및 [!DNL Google Display Network]과(와) 같은 [!DNL Google Display & Video 360] 속성에 직접 활성화합니다.

Adobe Real-Time CDP과 같은 특정 Google 통합 서드파티는 [!DNL Google Audience Partner API]을(를) 사용하여 고객의 [!DNL Display & Video 360] 계정에서 직접 [!DNL Customer Match]개의 대상을 만들 수 있습니다.
...
운동복 브랜드는 [!DNL Google Search] 및 [!DNL Google Shopping]을(를) 통해 기존 고객에게 연락하여 과거 구매 및 검색 기록을 기반으로 오퍼와 항목을 개인화하려고 합니다. 의류 브랜드는 자체 CRM에서 Experience Platform으로 이메일 주소를 수집하고 자체 오프라인 데이터에서 대상을 구축할 수 있습니다. 그런 다음 이러한 대상을 [!DNL Search], [!DNL YouTube], [!DNL Gmail] 및 [!DNL Google Display Network]과(와) 같은 [!DNL Google Display & Video 360] 속성에서 사용할 [!DNL Google Customer Match + Display & Video 360] 대상으로 보낼 수 있습니다.
...
[!DNL Google Customer Match + Display & Video 360] 연결에 대한 모니터링 정보에는 각 데이터 흐름 및 데이터 흐름 실행에서 활성화, 제외 및 실패한 ID와 관련된 대상 수준 정보가 포함되어 있습니다. 기능에 대해 자세히 알아보십시오.
