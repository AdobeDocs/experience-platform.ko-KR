...
[!DNL Microsoft Ads Customer Match] 대상을 사용하여 이메일 주소로 고객을 일치시키고 검색 및 대상 광고를 포함하여 [!DNL Microsoft Advertising Network]에서 고객과 다시 교류하십시오. [!DNL Microsoft Advertising] 계정을 Real-Time CDP에 연결하여 Experience Platform에서 직접 고객 일치 목록 생성 및 관리를 자동화합니다.
...
자세한 내용은 [Microsoft Advertising 도움말 센터](https://help.ads.microsoft.com/)를 참조하세요.
