...
[!DNL Bing Ads Universal Event Tracking] (UET) 태그 확장은 사용자가 검색 광고를 클릭한 후 발생하는 내용을 추적하는 유용한 방법입니다. 단일 UET 태그를 사용하여 웹 사이트에서 고객이 수행하는 작업을 기록하면 해당 데이터를 활용하여 전환이나 리마케팅 목록을 사용하여 대상을 추적할 수 있습니다.
