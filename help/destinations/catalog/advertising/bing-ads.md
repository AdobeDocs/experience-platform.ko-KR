...
title: Bing Ads Universal Event Tracking (UET) 확장
description: Bing Ads UET(Universal Event Tracking) 확장은 Adobe Experience Platform의 광고 대상입니다. 확장 기능에 대한 자세한 내용은 Exchange Adobe의 확장 페이지를 참조하십시오.
...
[!DNL Bing Ads Universal Event Tracking] (UET) [!DNL Experience Platform Launch] 를 사용하면 사용자가 검색 광고를 클릭한 후 발생하는 내용을 추적하는 유용한 방법입니다. 단일 UET 태그를 사용하여 웹 사이트에서 고객이 수행하는 작업을 기록하면 해당 데이터를 활용하여 전환이나 리마케팅 목록을 사용하여 대상을 추적할 수 있습니다.

[!DNL Bing Ads Universal Event Tracking] (UET)는 Adobe Experience Platform의 광고 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100154.html)에서 확장 페이지를 참조하십시오.
...
[!DNL Bing Ads Universal Event Tracking] (UET) 확장을 설치하려면 다음을 수행하십시오.
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100154.html)Bing Ads Universal Event Tracking (UET) 페이지를 참조하십시오.[
