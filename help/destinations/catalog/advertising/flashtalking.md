---
keywords: Flashtalk OneTag 확장;Flashtalk OneTag 확장;Flashtalk OneTag 대상;Flashtalk OneTag;flashtalk onetag
title: Flashtalk OneTag 확장
description: Flashtalk OneTag 확장은 Adobe Experience Platform의 광고 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
...
# [!DNL Flashtalking OneTag] 확장 기능 {#flashtalking-extension}

## 개요 {#overview}

[!DNL Flashtalking OneTag] 태그 확장을 사용하면 사이트 작업을 표시, 비디오 및 모바일 광고 활동에 쉽게 연결할 수 있습니다. 태그를 사용하여 웹 속성에 [!DNL Flashtalking OneTag]을(를) 배포합니다.

[!DNL Flashtalking OneTag]은(는) [!DNL Adobe Experience Platform]의 광고 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html)의 확장 페이지를 참조하십시오.

이 대상은 태그 확장입니다. Experience Platform에서 태그 확장이 작동하는 방법에 대한 자세한 내용은 [태그 확장 개요](../launch-extensions/overview.md)를 참조하십시오.

![Flashtalk 확장](../../assets/catalog/advertising/flashtalking/catalog.png)
...
[!DNL Flashtalking OneTag] 확장을 설치하려면:
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 Adobe Exchange의 [Flashtalking OneTag 페이지](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html)를 참조하십시오.
