...
Experience Platform Launch용 [!DNL Flashtalking OneTag] 확장을 사용하면 사이트 작업을 표시, 비디오 및 모바일 광고 활동에 쉽게 표시할 수 있습니다. Launch를 사용하여 웹 속성에 [!DNL Flashtalking OneTag]을 배포합니다.
...
[!DNL Flashtalking OneTag] 확장을 설치하려면 다음을 수행하십시오.
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html)의 [Flashtalk OneTag 페이지를 참조하십시오.
