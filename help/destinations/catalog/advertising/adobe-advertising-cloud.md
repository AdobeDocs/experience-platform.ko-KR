...
title: Adobe Advertising 확장
description: Adobe Advertising 확장은 Adobe Experience Platform의 광고 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
...
# [!DNL Adobe Advertising] 확장 기능 {#adobe-advertising-cloud-extension}

## 개요 {#overview}

DSP 및 검색 모두에 대한 광고 전환 및 대상 태그를 구현하기 위한 [!DNL Adobe Advertising] 확장입니다(DCO는 현재 지원되지 않음).

[!DNL Adobe Advertising]은(는) [!DNL Adobe Experience Platform]의 광고 확장입니다.

이 대상은 태그 확장입니다. Experience Platform에서 태그 확장이 작동하는 방식에 대한 자세한 내용은 [태그 확장 개요](../launch-extensions/overview.md)를 참조하십시오.

![Adobe Advertising 확장](../../assets/catalog/advertising/adobe-advertising-cloud/catalog.png)

## 전제 조건 {#prerequisites}

이 확장은 Experience Platform을 구입한 모든 고객의 대상 카탈로그에서 사용할 수 있습니다.

이 확장을 사용하려면 Experience Platform의 태그에 액세스해야 합니다. 태그는 부가가치 기능으로 포함되어 [!DNL Adobe Experience Cloud] 고객에게 제공됩니다. 조직 관리자에게 문의하여 UI의 데이터 수집 기능에 액세스하고 확장을 설치할 수 있도록 **[!UICONTROL manage_properties]** 권한을 부여하도록 요청하십시오.

## 확장 설치 {#install-extension}

[!DNL Adobe Advertising] 확장을 설치하려면:
