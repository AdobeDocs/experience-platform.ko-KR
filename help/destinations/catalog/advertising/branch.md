...
# [!DNL Branch] 확장 기능 {#branch-extension}

## 개요 {#overview}

Branch는 모든 장치, 채널 및 플랫폼에서 를 획득하고, 참여하고, 측정할 수 있는 강력한 링크와 솔루션을 제공합니다.

Branch는 Adobe Experience Platform의 광고 확장 프로그램입니다. 확장 기능에 대한 자세한 내용은 분기 웹 사이트에서 [기능 페이지](https://branch.io/features/)를 참조하십시오.
