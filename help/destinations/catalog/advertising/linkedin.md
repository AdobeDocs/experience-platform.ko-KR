...
설치 [!DNL LinkedIn Insight Tag] 변환 추적, 리타겟팅 및 웹 사이트 인구 통계 기능을 사용하려면 .

[!DNL LinkedIn Insight Tag] 는 Adobe Experience Platform의 광고 확장 프로그램입니다. 확장 기능에 대한 자세한 내용은 [LinkedIn 인사이트 태그](https://business.linkedin.com/marketing-solutions/insight-tag).
...
을(를) 설치하려면 [!DNL LinkedIn Insight Tag] 확장:
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 [LinkedIn 인사이트 태그](https://business.linkedin.com/marketing-solutions/insight-tag).
