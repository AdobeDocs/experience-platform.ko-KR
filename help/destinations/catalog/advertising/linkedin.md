---
keywords: LinkedIn;linkedin;Linkedin;LinkedIn Insight 태그;insight 태그;Insight 태그
title: LinkedIn Insight 태그 확장
description: LinkedIn Insight 태그 확장은 Adobe Experience Platform의 광고 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
...
# [!DNL LinkedIn Insight Tag] 확장 기능 {#linkedin-insights-extension}

## 개요 {#overview}

전환 추적, 재타겟팅 및 웹 사이트 인구 통계 기능을 사용하려면 [!DNL LinkedIn Insight Tag]을(를) 설치하십시오.

[!DNL LinkedIn Insight Tag]은(는) [!DNL Adobe Experience Platform]의 광고 확장입니다. 확장 기능에 대한 자세한 내용은 [LinkedIn Insight 태그](https://business.linkedin.com/marketing-solutions/insight-tag)를 참조하십시오.

이 대상은 태그 확장입니다. Experience Platform에서 태그 확장이 작동하는 방법에 대한 자세한 내용은 [태그 확장 개요](../launch-extensions/overview.md)를 참조하십시오.

![LinkedIn Insight 태그 확장](../../assets/catalog/advertising/linkedin/catalog.png)
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 [LinkedIn Insight 태그](https://business.linkedin.com/marketing-solutions/insight-tag)를 참조하십시오.
