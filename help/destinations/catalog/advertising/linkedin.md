---
keywords: LinkedIn;linkedin;Linkedin;LinkedIn 인사이트 태그;인사이트 태그;인사이트 태그
title: LinkedIn 인사이트 태그 확장
description: linkedIn Insight Tag 확장은 Adobe Experience Platform의 광고 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
...
[!DNL LinkedIn Insight Tag]은(는) Adobe Experience Platform의 광고 확장입니다. 확장 기능에 대한 자세한 내용은 [LinkedIn 인사이트 태그](https://business.linkedin.com/marketing-solutions/insight-tag)를 참조하십시오.

이 대상은 태그 확장입니다. Platform에서 태그 확장이 작동하는 방식에 대한 자세한 내용은 [태그 확장 개요](../launch-extensions/overview.md)를 참조하십시오.

![LinkedIn Insight Tag 확장](../../assets/catalog/advertising/linkedin/catalog.png)
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 [LinkedIn Insight Tag](https://business.linkedin.com/marketing-solutions/insight-tag)를 참조하십시오.
