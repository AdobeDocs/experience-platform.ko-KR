...
[!DNL DoubleClick Floodlight]&#x200B;(Beta)은(는) Adobe Experience Platform의 광고 확장입니다. 확장 기능에 대한 자세한 내용은 [!DNL Google]DoubleClick Floodlight[에 대한 ](https://support.google.com/dcm/answer/2823388?hl=en) 지원 설명서를 참조하십시오.
