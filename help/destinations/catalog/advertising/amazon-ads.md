...
Amazon DSP과의 통합을 통해 Amazon 광고 광고주가 Adobe Experience Platform에서 Amazon의 DSP으로 advertiser CDP 세그먼트를 전달하여 광고 타깃팅을 위한 광고주 대상을 만들 수 있습니다. 긍정적인 타겟팅과 부정적인 타겟팅(제외)을 위해 Amazon DSP 내에서 대상을 선택할 수 있습니다.
