...
이 확장은 다음을 클릭하는 사용자의 전환을 추적합니다. [!DNL Google Ads]. 또한 gtag.js 확장 프로그램을 설치하고 라이브러리에 추가해야 합니다. [!DNL Google Ads] 상황에 따라 다릅니다.

[!DNL Google Ads] 는 Adobe Experience Platform의 광고 확장 프로그램입니다. 확장 기능에 대한 자세한 내용은 의 확장 페이지를 참조하십시오 [Adobe 교환](https://www.adobeexchange.com/experiencecloud.details.101383.google-ads.html).
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 [Adobe Exchange의 Google 광고 페이지](https://www.adobeexchange.com/experiencecloud.details.101383.google-ads.html).
