...
title: Google 광고 확장
description: Google 광고 확장 프로그램은 Adobe Experience Platform의 광고 대상입니다. 확장 기능에 대한 자세한 내용은 Exchange Adobe의 확장 페이지를 참조하십시오.
...
이 확장은 [!DNL Google Ads]을 클릭하는 사용자의 전환을 추적합니다. 또한 [!DNL Google Ads]이(가) 확장에 종속되므로 gtag.js 확장을 설치하고 라이브러리에 추가해야 합니다.

[!DNL Google Ads] 는 Adobe Experience Platform의 광고 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.101383.google-ads.html)에서 확장 페이지를 참조하십시오.
...
[!DNL Google Ads] 확장을 설치하려면 다음을 수행하십시오.
