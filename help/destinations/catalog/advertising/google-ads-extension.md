...
title: Google 광고 확장
description: Google Ads 확장은 Adobe Experience Platform의 광고 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
...
# [!DNL Google Ads] 확장 기능

## 개요 {#overview}

이 확장은 [!DNL Google Ads]을(를) 클릭하는 사용자의 전환을 추적합니다. [!DNL Google Ads]이(가) 종속되어 있으므로 gtag.js 확장 프로그램을 설치하고 라이브러리에 추가해야 합니다.

[!DNL Google Ads]은(는) Adobe Experience Platform의 광고 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.101383.google-ads.html)의 확장 페이지를 참조하십시오.
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 [Adobe Exchange의 Google 광고 페이지](https://www.adobeexchange.com/experiencecloud.details.101383.google-ads.html)를 참조하십시오.
