...
>[!NOTE]
>
>플랫폼에서 첫 번째 [!DNL Google Display & Video 360] 대상을 설정하기 전에 허용 목록이 필수입니다. 대상을 만들기 전에 [!DNL Google]이(가) 아래에 설명된 허용 목록 프로세스를 완료했는지 확인하십시오.
...
플랫폼에서 [!DNL Google Display & Video 360] 대상을 만들기 전에 허용된 데이터 공급자 목록에 Adobe을 추가하고 계정에 허용 목록에 추가하다를 추가해 달라고 요청하는 Google에 문의해야 합니다. Google에 연락하여 다음 정보를 제공하십시오.
