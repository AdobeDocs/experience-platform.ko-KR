...
[!DNL LiveRamp - Distribution]이(가) [지원](#supported-destinations)하는 각 대상을 사용하려면 특정 구성 옵션을 입력해야 합니다.
...
대상을 활성화하려면 LiveRamp에 [이전에 온보딩된](liveramp-onboarding.md)과(와) 동일한 **대상**&#x200B;을(를) 선택해야 합니다.
