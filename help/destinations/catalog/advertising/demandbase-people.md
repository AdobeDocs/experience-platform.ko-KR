...
마케터는 Adobe [!DNL Real-Time CDP]을(를) 사용하여 자사 연락처의 사람 목록을 만들고 Demandbase에서 활성화하여 수요 측 플랫폼(DSP) 및 LinkedIn과 같은 기타 채널에서 최적화되고 조정된 참여를 할 수 있습니다.
...
* **[!UICONTROL Bearer token]**: 대상에 인증하려면 전달자 토큰을 입력하십시오. 토큰을 얻는 방법에 대한 자세한 내용은 [필수 구성 요소](#prerequisites)를 참조하십시오.
