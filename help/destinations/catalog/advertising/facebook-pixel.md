...
# [!DNL Facebook Pixel] 확장 기능 {#facebook-pixel-extension}

## 개요 {#overview}

[!DNL Facebook Pixel]은(는) 사람들이 웹 사이트에서 취하는 동작을 이해하여 광고의 효과를 측정할 수 있는 분석 도구입니다.

[!DNL Facebook Pixel]은(는) Adobe Experience Platform의 광고 확장입니다. 확장 기능에 대한 자세한 내용은 [Facebook Pixel 웹 사이트](https://developers.facebook.com/docs/facebook-pixel/)를 참조하십시오.
