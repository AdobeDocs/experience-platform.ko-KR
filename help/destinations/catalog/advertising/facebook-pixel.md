---
keywords: facebook 픽셀 확장;facebook 픽셀 확장;facebook 픽셀 대상;facebook 픽셀
...
다음 [!DNL Facebook Pixel] 는 웹 사이트에서 사람들이 수행하는 작업을 파악하여 광고의 효과를 측정할 수 있는 분석 도구입니다.

[!DNL Facebook Pixel] 는 Adobe Experience Platform의 광고 확장 프로그램입니다. 확장 기능에 대한 자세한 내용은 [Facebook 픽셀 웹 사이트](https://developers.facebook.com/docs/facebook-pixel/).
...
을(를) 설치하려면 [!DNL Facebook Pixel] 확장:
