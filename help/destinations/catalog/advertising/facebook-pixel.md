...
description: facebook 픽셀 확장 프로그램은 Adobe Experience Platform의 광고 대상입니다. 확장 기능에 대한 자세한 내용은 Exchange Adobe의 확장 페이지를 참조하십시오.
...
[!DNL Facebook Pixel] 은 사람들이 웹 사이트에서 수행하는 작업을 이해하여 광고의 효과를 측정할 수 있는 분석 도구입니다.
...
[!DNL Facebook Pixel] 확장을 설치하려면 다음을 수행하십시오.
