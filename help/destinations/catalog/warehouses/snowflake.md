...
![Snowflake 개인 목록 수락 화면을 보여 주는 스크린샷](../../assets/catalog/warehouses/snowflake/snowflake-accept-listing.png)
...
[!DNL Adobe Experience Platform]은(는) 두 가지 유형의 [!DNL Snowflake] 대상을 제공합니다. [Snowflake 스트리밍](snowflake.md) 및 [Snowflake 일괄 처리](snowflake-batch.md).
...
스트리밍 데이터 공유는 세그먼트 변경, ID 맵 변경 또는 속성 변경에 따른 지속적인 업데이트를 제공하므로 짧은 지연 시간이 중요한 경우에 적합합니다.
...
* [!DNL Snowflake] 계정이 비공개 목록을 구독하고 있습니다. 귀하 또는 [!DNL Snowflake]에 대한 계정 관리자 권한이 있는 회사의 누군가가 이를 구성할 수 있습니다.
* 대상에 연결할 때 드롭다운에서 선택할 [!DNL Snowflake] 계정 지역을 알고 있습니다.
...
| 내보내기 빈도 | **[!UICONTROL Streaming]** | 스트리밍 대상은 &quot;항상&quot; API 기반 연결입니다. 대상 평가를 기반으로 [!DNL Adobe Experience Platform]에서 프로필이 업데이트되는 즉시 커넥터가 업데이트 다운스트림을 대상 플랫폼으로 보냅니다. [스트리밍 대상](/help/destinations/destination-types.md#streaming-destinations)에 대해 자세히 알아보세요. |
...
![대상에 인증하는 방법을 보여 주는 샘플 스크린샷](../../assets/catalog/warehouses/snowflake/authenticate-destination.png)
...
![대상에 대한 세부 정보를 채우는 방법을 보여 주는 샘플 스크린샷](../../assets/catalog/warehouses/snowflake/configure-destination-details.png)
...
![Snowflake 대상에 대한 매핑 화면을 표시하는 Experience Platform 사용자 인터페이스 이미지입니다.](../../assets/catalog/warehouses/snowflake/mapping.png)

대상 특성은 **[!UICONTROL Attribute name]** 필드에 입력한 특성 이름을 사용하여 Snowflake에서 자동으로 만들어집니다.

## 내보낸 데이터/데이터 내보내기 유효성 검사 {#exported-data}

데이터는 공유 테이블을 통해 Snowflake 계정에 공유됩니다. Snowflake 계정을 확인하여 데이터가 올바르게 내보내졌는지 확인하십시오.
