...
**참고**: 이 예제에서 첫 번째 세그먼트(`5b998cb9-9488-4ec3-8d95-fa8338ced490`)는 대상에 매핑되고 `name` 필드를 포함합니다. 두 번째 세그먼트(`354e086f-2e11-49a2-9e39-e5d9a76be683`)는 대상에 매핑되지 않으며 `name` 옵션이 활성화되어 있더라도 **[!UICONTROL Include Segment Names]** 필드를 포함하지 않습니다.
