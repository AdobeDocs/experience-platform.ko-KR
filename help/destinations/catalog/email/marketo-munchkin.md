...
리드 관리에서 계정 기반 마케팅까지, [!DNL Marketo Engagement Platform] 은 고객 및 잠재 고객의 모든 경험 단계에서 고객 및 잠재 고객과의 참여를 계획하고, 조정하고, 측정하는 방법을 간소화합니다.

[!DNL Marketo’s Munchkin][!DNL Marketo] JavaScript를 사용하면 랜딩 페이지 및 외부 웹 페이지에 대한 최종 사용자 페이지 방문 수 및 클릭 수를 추적할 수 있습니다.

[!DNL Marketo Munchkin] 는 Adobe Experience Platform의 이메일 확장입니다. Marketo Munchkin에 대한 자세한 내용은 [잠재 고객 추적](https://developers.marketo.com/javascript-api/lead-tracking/) Marketo 설명서에서 확인할 수 있습니다.
...
을(를) 설치하려면 [!DNL Marketo Munchkin] 확장:
