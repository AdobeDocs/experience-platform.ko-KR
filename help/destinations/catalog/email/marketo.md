...
1. [Experience Platform 인터페이스](https://platform.adobe.com/)에서 **[!UICONTROL Destinations]** > **[!UICONTROL Catalog]**(으)로 이동합니다.
2. 카탈로그에서 확장을 선택하거나 검색 창을 사용합니다.
3. 대상을 선택한 다음 오른쪽 레일에서 **[!UICONTROL Configure]**&#x200B;을(를) 선택합니다. **[!UICONTROL Configure]** 컨트롤이 회색으로 표시되어 있으면 **[!UICONTROL manage_properties]** 권한이 없습니다. [필수 구성 요소](#prerequisites)를 참조하십시오.
