...
[!DNL Bizible] 은 Adobe Experience Platform의 이메일 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101055.bizible-analytics.html)의 확장 페이지를 참조하십시오.
...
![Biz가능 확장](../../assets/catalog/email/bizible/catalog.png)
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101055.bizible-analytics.html)의 [Bizable 페이지를 참조하십시오.
