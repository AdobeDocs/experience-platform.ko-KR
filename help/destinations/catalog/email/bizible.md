...
[!DNL Bizible]은(는) [!DNL Adobe Experience Platform]의 전자 메일 확장입니다. Bizible에 대한 자세한 내용은 Bizible 개요 리소스에서 [마케팅 속성](https://experienceleague.adobe.com/docs/bizible/using/introduction-to-bizible/overview-resources/marketing-attribution.html)을 참조하십시오.
