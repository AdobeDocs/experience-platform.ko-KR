...
seo-description: Adobe Livefyre 확장은 Adobe Experience Platform의 소셜 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
...
# Adobe Livefyre 확장 {#adobe-livefyre-extension}

## 개요 {#overview}

Adobe Livefyre를 사용하면 사용자 생성 콘텐츠를 검색, 구성 및 웹 사이트에 게시하여 개인화된 진정성 있는 경험을 만들 수 있습니다.

Adobe Livefyre는 Adobe Experience Platform의 소셜 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100464.html)의 확장 페이지를 참조하십시오.
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100464.html)의 [Adobe Livefyre 페이지를 참조하십시오.
