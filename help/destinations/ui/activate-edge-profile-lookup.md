...
[!DNL Adobe Experience Platform]은(는) [실시간 고객 프로필](../../profile/home.md)을(를) 모든 프로필 데이터에 대한 신뢰할 수 있는 단일 소스로 사용합니다. 빠른 실시간 데이터 검색을 위해 [Edge Network](../../profile/edge-profiles.md)에 배포되는 간단한 프로필인 [Edge 프로필](../../collection/home.md)을 사용합니다. 이를 통해 빠르고 실시간 개인화 사용 사례를 만들 수 있습니다.
