...
3. 삭제하려는 계정 이름 옆의 생략 부호(`...`)를 선택합니다. **[!UICONTROL Activate audiences]**, **[!UICONTROL Edit details]** 및 **[!UICONTROL Delete]** 계정에 옵션을 제공하는 팝업 패널이 나타납니다. ![삭제 단추](/help/images/icons/delete.png) **[!UICONTROL Delete]** 단추를 선택하여 원하는 계정을 삭제합니다.

   ![대상 계정 삭제](../assets/ui/delete-accounts/delete-accounts.png)

4. 마지막 확인 대화 상자가 나타나면 **[!UICONTROL Delete]**&#x200B;을(를) 선택하여 프로세스를 완료합니다.

![계정 삭제 확인](../assets/ui/delete-accounts/confirm-account-deletion.png)

## 다음 단계 {#next-steps}

대상 작업 영역을 사용하여 기존 계정을 삭제했습니다.
