...
각 필드 및 값에 대한 구분 기호를 설정합니다. 사용 가능한 옵션은 다음과 같습니다.
...
구분 기호가 값의 일부일 수 있는 따옴표 붙은 값을 이스케이프 처리하는 데 사용되는 단일 문자를 설정합니다.

### 문자 이스케이프 처리

이미 인용한 값 내에서 따옴표를 이스케이프 처리하는 데 사용되는 단일 문자를 설정합니다.
...
출력 예 **[!UICONTROL null]** 선택됨: `male,NULL,TestLastName`
출력 예 **&quot;&quot;** 선택됨: `male,"",TestLastName`
출력 예 **[!UICONTROL 빈 문자열]** 선택됨: `male,,TestLastName`

### 압축 포맷

파일에 데이터를 저장할 때 사용할 압축 코덱을 설정합니다. 지원되는 옵션은 GZIP 및 NONE입니다.
