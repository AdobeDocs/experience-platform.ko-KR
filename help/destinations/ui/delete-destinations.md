...
[!DNL Adobe Experience Platform] 사용자 인터페이스에서 대상에 대한 기존 연결을 삭제할 수 있습니다.

대상을 삭제하면 해당 대상에 대한 기존 데이터 흐름이 모두 제거됩니다. 삭제한 대상에 활성화된 모든 대상은 데이터 흐름이 삭제되기 전에 매핑되지 않습니다.

[!DNL Experience Platform] [!DNL UI]에서 대상을 삭제할 수 있는 방법에는 두 가지가 있습니다. 다음과 같은 작업을 수행할 수 있습니다.

* [[!UICONTROL Browse] 탭에서 대상 삭제](#delete-browse-tab)
...
4. 오른쪽 레일에서 **[!UICONTROL Delete]** 선택

   ![대상 삭제](../assets/ui/delete-destinations/delete-destinations-button.png)

5. 확인 대화 상자에서 **[!UICONTROL Delete]**&#x200B;을(를) 선택하여 대상을 제거합니다.
