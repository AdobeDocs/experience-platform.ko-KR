...
>[!TIP]
>
>**[!UICONTROL 배열, 맵 및 개체 내보내기]** 컨트롤이 해제되어 있는 대상 연결에 대해 **[!UICONTROL 계산된 필드 추가]** 컨트롤을 사용할 수 없습니다. [자세히 보기](/help/destinations/ui/export-arrays-calculated-fields.md#export-arrays-maps-objects-toggle).
