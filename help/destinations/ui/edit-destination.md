...
다음은 [Amazon S3](../catalog/cloud-storage/amazon-s3.md), [Azure 이벤트 허브](../catalog/cloud-storage/azure-event-hubs.md) 및 [Google 광고](../catalog/advertising/google-ads-destination.md) 대상에 대해 업데이트할 수 있는 설정의 예입니다.
...
<div style="display: flex; gap: 12px; justify-content: flex-start; align-items: flex-start;">
  ...
  <img class="modal-image" src="../assets/ui/edit-destinations/edit-eventhubs-connection.png" alt="Azure EventHubs 대상에 대한 대상 편집 화면입니다." style="max-width: 200px; height: auto; border: 1px solid #ccc;">
...
## 기타 편집 옵션 {#other-editing-options}
...
**[!UICONTROL destinations]** 작업 영역을 사용하여 기존 대상 연결을 업데이트했습니다.
