...
| [!UICONTROL Delete] | 이 데이터 흐름을 삭제하고 이전에 활성화된 모든 대상을 매핑 해제합니다. |
...
>[!NOTE]
>
>대상 세부 정보 페이지에 대한 자세한 내용은 [대상 포털 개요](../../segmentation/ui/audience-portal.md#audience-details)를 참조하십시오.
