...
1. 왼쪽 상단의 필터 아이콘 ![Filter-icon](../assets/ui/details-page/filter.png)을(를) 선택하여 정렬 패널을 시작합니다. 정렬 패널에서는 모든 대상의 목록을 제공합니다. 목록에서 두 개 이상의 대상을 선택하여 선택한 대상과 연관된 데이터 흐름의 필터링된 선택을 확인할 수 있습니다.

   ![대상 필터링](../assets/ui/details-page/filter-destinations.png)

1. 추가 정보를 표시할 대상 행을 선택합니다. 이렇게 하면 대상 ID, 대상 연결을 만든 사용자 및 기타 정보를 포함한 대상에 대한 정보가 있는 오른쪽 레일이 표시됩니다.

   ![오른쪽 레일의 대상 ID](../assets/ui/details-page/right-rail-info-including-destination-id.png)

1. 또는 보려는 *대상 이름*&#x200B;을 선택하여 대상에 대한 다른 정보를 표시할 수 있습니다.

   ![대상 선택](../assets/ui/details-page/destination-select.png)

1. 대상에 대한 세부 정보 페이지가 오른쪽 레일에 표시되어 사용 가능한 컨트롤을 표시합니다.
