...
### 데이터 흐름의 종료 날짜 업데이트 {#update-end-date}
...
예약 단계에 대한 자세한 내용은 [데이터 세트 내보내기 UI 자습서](/help/destinations/api/export-datasets.md#export-datasets-by-using-the)를 참조하십시오.

## API를 사용하여 종료 날짜 업데이트 {#use-api}

### 업데이트가 필요한 데이터 흐름 찾기 {#find-dataflows-api}

### 데이터 흐름의 종료 날짜 업데이트 {#update-end-date-api}
