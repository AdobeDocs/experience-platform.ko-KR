...
대상 카드에는 기본 및 보조 제어 옵션이 있습니다. 기본 컨트롤은 다음과 같습니다 [!UICONTROL 설정], [!UICONTROL 활성화], [!UICONTROL 대상자 활성화], 또는 [!UICONTROL 데이터 세트 내보내기]. 보조 컨트롤을 사용하여 옵션을 볼 수 있습니다. 이러한 컨트롤은 아래에 설명되어 있습니다.
...
>[!TIP]
>
> * 줄임표(`...`)에 있는 [!UICONTROL 플랫폼] 열 및 사용 ![컨트롤 활성화](../assets/ui/workspace/add-data-symbol.png)**[!UICONTROL 활성화&#x200B;]**/**[!UICONTROL &#x200B;대상자 활성화&#x200B;]**/**[!UICONTROL &#x200B;데이터 세트 내보내기&#x200B;]**대상이나 데이터 세트를 해당 대상으로 내보내도록 제어합니다.
...
다음 **[!UICONTROL 찾아보기]** 탭에는 연결을 설정한 대상이 표시됩니다. 대상이 있는 대상 **[!UICONTROL 활성화/비활성화]** 켜기/끄기 각각 대상을 활성 또는 비활성화로 설정합니다. 을(를) 선택하여 데이터 흐름이 있는 대상을 볼 수도 있습니다 **[!UICONTROL 대상]** > **[!UICONTROL 찾아보기]** 및 검사할 대상 선택. 의 각 대상에 대해 제공되는 모든 정보는 아래 표를 참조하십시오. [!UICONTROL 찾아보기] 탭:

>[!TIP]
>
> * 줄임표(`...`)에 있는 [!UICONTROL 이름] 열 및 사용 ![대상자 컨트롤 활성화](../assets/ui/workspace/add-data-symbol.png)**[!UICONTROL 활성화&#x200B;]**대상이나 데이터 세트를 해당 대상으로 내보내도록 제어합니다.
...
| [!UICONTROL 활성화 데이터] | 이 대상에 대해 활성화 중인 대상 수를 나타냅니다. 활성화된 대상자에 대한 자세한 내용을 확인하려면 이 컨트롤을 선택하십시오. 을(를) 참조하십시오 [활성화 데이터](/help/destinations/ui/destination-details-page.md#activation-data) 활성화된 대상에 대한 자세한 내용은 대상 세부 사항 페이지에서 확인할 수 있습니다. |
...
대상 이름을 선택하여 이 대상에 활성화된 대상에 대한 정보를 확인합니다. 클릭 **[!UICONTROL 활성화 편집]** 을(를) 수정하거나 이 대상으로 전송되는 대상자에 추가합니다.
