...
[!DNL Adobe Experience Platform]의 왼쪽 탐색 모음에서 **[!UICONTROL Destinations]**&#x200B;을(를) 선택하여 [!UICONTROL Destinations] 작업 영역에 액세스합니다.
...
| 컨트롤 | 설명 |
|---------|----------|
| [!UICONTROL Set up] | 대상에 대한 연결을 만듭니다. |
| [!UICONTROL Activate] | 대상에 대한 연결을 설정한 후 대상을 활성화하거나 데이터 세트를 이 대상으로 내보냅니다. |
| [!UICONTROL Activate audiences] | 대상에 대한 연결을 설정한 후 이 대상에 대한 대상을 활성화합니다. |
| [!UICONTROL Export datasets] | 대상에 대한 연결을 설정한 후 데이터 세트를 이 대상으로 내보냅니다. |
...
대상 ID, 설명, 활성화된 대상 수 등과 같은 대상에 대한 자세한 정보를 오른쪽 레일에서 보려면 대상 행을 선택하십시오.

![대상 행 클릭](../assets/ui/workspace/click-destination-row.png)

대상 이름을 선택하여 이 대상에 활성화된 대상에 대한 정보를 확인합니다. **[!UICONTROL Edit destination]**&#x200B;을(를) 선택하여 [대상 설정을 수정](/help/destinations/ui/edit-destination.md)하거나 **[!UICONTROL Activate audiences]**&#x200B;을(를) 선택하여 데이터 흐름에 새 대상을 추가합니다.
...
* 현재 활성화된 모든 필터 보기
* 각 필터 태그에서 `X` 아이콘을 선택하여 개별 필터 제거
...
**[!UICONTROL Accounts]** 탭에는 다양한 대상으로 설정한 연결에 대한 세부 정보가 표시됩니다. 이 탭에서 기존 계정 세부 사항을 업데이트하거나 삭제할 수 있습니다. 각 대상 계정에 대해 사용할 수 있는 모든 정보는 아래 표를 참조하십시오.
...
**[!UICONTROL System View]** 탭에는 [!DNL Adobe Experience Platform]에서 설정한 활성화 흐름이 그래픽으로 표시됩니다.

![데이터 흐름1](../assets/ui/workspace/system-view-dataflows.png)

페이지에 표시된 대상을 선택하고 **[!UICONTROL View dataflows]**&#x200B;을(를) 선택하여 각 대상에 대해 설정한 모든 연결에 대한 정보를 확인합니다.
