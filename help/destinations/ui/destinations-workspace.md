...
* 연결 및/ **[!UICONTROL 또는 확장]** 기능을 보려면 **[!UICONTROL 선택합니다]**. 두 카테고리 간의 차이를 이해하려면 [대상 유형과 카테고리를 참조하십시오](../destination-types.md).
...
각 대상에 대한 대상 카테고리 및 정보에 대한 자세한 내용은 [대상 카탈로그](../catalog/overview.md) 및 [대상 유형 및 카테고리를 참조하십시오](../destination-types.md).
...
>[!TIP]
>
>[ ![플랫폼](../assets/ui/workspace/add-data-symbol.png) ] 열의 [데이터 추가] 단추 **** 단추를 사용하여 해당 계정에 대한 새 대상 연결을 만듭니다.
...
| [!UICONTROL 사용자 이름] | 연결 대상 마법사에서 선택한 [사용자 이름입니다](../catalog/email-marketing/overview.md#connect-destination). |
| [!UICONTROL 대상] | 대상에 대해 만들어진 기본 정보와 연결된 고유한 성공한 대상 흐름 수를 나타냅니다. |
| [!UICONTROL 인증됨] | 이 대상에 대한 연결이 승인된 날짜입니다. |

또한 계정 정보를 편집하거나 업데이트할 수 있습니다. [ ![플랫폼](../assets/ui/workspace/pencil-icon.png) ] 열에서 [계정 편집] 단추 **** 를 선택하여 계정 정보를 편집합니다.
...
>[!TIP]
>
>이름 ![열의 데이터 추가 단추](../assets/ui/workspace/add-data-symbol.png) 단추 **[!UICONTROL 를]** 사용하여 해당 대상에 대한 추가 세그먼트를 활성화합니다.
...
| [!UICONTROL 상태] | `Active` 또는 `Inactive`. 데이터가 현재 이 대상에 활성화되고 있는지 여부를 나타냅니다. 상태를 편집하려면 활성화 [비활성화를 참조하십시오](./activate-destinations.md#disable-activation). |
