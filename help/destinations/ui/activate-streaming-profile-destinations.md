...
* **[!UICONTROL Segmentation Service]**: 세분화 서비스에 의해 Experience Platform 내에서 생성된 대상자입니다. 자세한 내용은 [Audience Portal 설명서](../../segmentation/ui/audience-portal.md)를 참조하십시오.
...
**[!UICONTROL Mapping]** 단계에서 대상 대상으로 보낼 프로필 특성을 선택합니다.
...
1. **[!UICONTROL Schema field]** 항목 오른쪽에 있는 화살표를 선택합니다.
