...
### 대상 세부 사항 페이지에서 대상 활성화 {#activate-segment-details}

대상자 세부 정보 페이지에서 대상을 대상으로 활성화할 수 있습니다. 다음을 참조하십시오 [세그먼트 세부 정보](../../segmentation/ui/overview.md#segment-details) 추가 정보.
