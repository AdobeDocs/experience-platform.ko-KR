...
이 문서를 읽고 나면 이제 자격 증명 끝점을 사용할 시점과 `/authoring/credentials` API 끝점을 사용하여 자격 증명 구성을 설정하는 방법을 알 수 있습니다. [Destination SDK을 사용하여 대상을 구성하는 방법](../guides/configure-destination-instructions.md)을 읽고 이 단계가 대상 구성 프로세스에 맞는 위치를 파악할 수 있습니다.
