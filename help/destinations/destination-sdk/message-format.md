...
* **XDM(경험 데이터 모델)**. [XDM 개요](https://experienceleague.adobe.com/docs/experience-platform/xdm/home.html?lang=ko) 및  [Adobe Experience Platform에서 XDM 스키마를 만드는 방법](https://experienceleague.adobe.com/docs/experience-platform/xdm/tutorials/create-schema-ui.html?lang=ko).
