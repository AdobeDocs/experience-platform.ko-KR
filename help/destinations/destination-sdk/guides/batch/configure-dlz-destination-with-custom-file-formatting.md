...
이 페이지에서는 Destination SDK을 사용하여 [!DNL Data Landing Zone] 사용자 지정 대상 [파일 서식 옵션](configure-file-formatting-options.md) 및 사용자 지정 [파일 이름 구성](../../functionality/destination-configuration/batch-configuration.md#file-name-configuration).
...
아래 페이로드에는 일반 항목이 포함되어 있습니다 [!DNL Data Landing Zone] 구성, 사용자 지정 사용 [CSV 파일 형식](../../functionality/destination-server/file-formatting.md) 사용자가 Experience Platform UI에서 정의할 수 있는 구성 매개 변수입니다.
...
![선택한 대상 카드가 있는 대상 카탈로그 페이지를 표시하는 화면 기록](../../assets/guides/batch/dlz-destination-card.gif)
