---
description: Destination SDK을 사용하여 사용자 지정 파일 형식 지정 옵션 및 사용자 지정 파일 이름 구성으로 DLZ(데이터 랜딩 영역) 대상을 구성하는 방법을 알아봅니다.
...
이제 Destination SDK을 사용하여 사용자 지정 [!DNL Data Landing Zone] 대상을 작성하는 방법을 알 수 있습니다. 그런 다음 팀은 [파일 기반 대상에 대한 활성화 워크플로](../../../ui/activate-batch-profile-destinations.md)를 사용하여 데이터를 대상으로 내보낼 수 있습니다.
