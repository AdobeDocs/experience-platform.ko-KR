...
이 페이지에서는 Destination SDK을 사용하여 사용자 지정 Amazon S3 대상을 구성하는 방법을 설명합니다 [파일 서식 옵션](configure-file-formatting-options.md) 및 사용자 지정 [파일 이름 구성](../../functionality/destination-configuration/batch-configuration.md#file-name-configuration).
...
아래 페이로드에는 사용자 지정 기능이 있는 일반 Amazon S3 구성이 포함되어 있습니다 [CSV 파일 형식](../../functionality/destination-server/file-formatting.md) 사용자가 Experience Platform UI에서 정의할 수 있는 구성 매개 변수입니다.
