...
title: (베타) 사용자 지정 파일 형식 옵션 및 사용자 지정 파일 이름 구성으로 Azure Data Lake 저장소 대상을 구성합니다.
...
# (베타) 구성 [!DNL Azure Data Lake Storage] 사용자 지정 파일 형식 옵션 및 사용자 지정 파일 이름 구성이 있는 대상
...
이 페이지에서는 Destination SDK을 사용하여 [!DNL Azure Data Lake Storage] 사용자 지정 대상 [파일 서식 옵션](../../server-and-file-configuration.md#file-configuration) 및 사용자 지정 [파일 이름 구성](../../file-based-destination-configuration.md#file-name-configuration).
...
아래 페이로드에는 일반 항목이 포함되어 있습니다 [!DNL Azure Data Lake Storage] 구성, 사용자 지정 사용 [CSV 파일 형식](../../server-and-file-configuration.md#file-configuration) 사용자가 Experience Platform UI에서 정의할 수 있는 구성 매개 변수입니다.
...
![선택한 대상 카드가 있는 대상 카탈로그 페이지를 표시하는 화면 기록](../../assets/adls-destination-card.gif)
