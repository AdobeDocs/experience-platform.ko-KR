...
# [!DNL Adobe Experience Platform]에서 대상을 문서화합니다.
...
[!DNL Adobe Experience Platform]에 오신 것을 환영합니다. 여기에 오신 것을 환영합니다!
대상을 문서화하는 작업은 [!DNL Adobe Experience Platform]에서 라이브로 설정되기 전에 마지막 단계입니다.
...
* Adobe과의 통합은 [!DNL Adobe Experience Platform]의 스테이징 환경에 배포된 대상과의 테스트 단계에 있어야 합니다.
...
설명서 페이지를 만드는 데 도움이 되도록 Adobe에서 [설명서 템플릿](./self-service-template.md)을(를) 미리 채웠습니다. 아래에서 템플릿을 편집하고 가져오기 요청을 여는 방법에 대한 지침을 확인할 수 있습니다. Adobe 설명서 팀이 새 대상에 대한 설명서를 검토하고 게시합니다.
...
GitHub 웹 인터페이스 또는 로컬 환경을 사용하여 [!DNL Adobe Experience Platform]에서 새 대상에 대한 설명서를 만들 수 있습니다. 아래 링크에서 두 옵션에 대한 지침을 확인하십시오.
