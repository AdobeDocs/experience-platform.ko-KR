...
1. 다음을 기반으로 대상 페이지의 콘텐츠를 만듭니다. [설명서 셀프서비스 템플릿](./self-service-template.md). **[다운로드](../assets/docs-framework/yourdestination-template.zip)** 템플릿을 푼 다음 압축을 풀어 `.md` 파일 템플릿.
...
![파일 생성 확인](../assets/docs-framework/ssd-confirm-file-creation.png)
