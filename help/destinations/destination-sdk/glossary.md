...
Destination SDK에서 사용되는 용어에 대한 정의는 이 용어집 을 참조하십시오. 다른 [!DNL Adobe Experience Platform]개 용어에 대해서는 [Experience Platform 용어집](/help/landing/glossary.md)을 참조하세요.
