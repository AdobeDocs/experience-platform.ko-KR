...
따라서 Experience Platform UI의 **[!UICONTROL Source field]** 섹션과 **[!UICONTROL Target field]** 섹션이 모두 회색으로 표시됩니다.
...
따라서 Experience Platform UI의 **[!UICONTROL Target field]** 섹션은 회색으로 표시되고 **[!UICONTROL Source field]** 섹션은 활성 상태이며 사용자는 이 섹션과 상호 작용할 수 있습니다. **[!UICONTROL Mandatory key]** 및 **[!UICONTROL Deduplication key]** 옵션이 활성화되어 있으므로 사용자가 변경할 수 없습니다.
