...
이 문서를 읽으면 이제 [!DNL Adobe Experience Platform]에서 지원하는 OAuth 2 권한 부여 패턴을 이해하고 OAuth 2 권한 부여 지원을 통해 대상을 구성하는 방법을 알 수 있습니다. 그런 다음 Destination SDK을 사용하여 OAuth 2 지원 대상을 설정할 수 있습니다. 다음 단계를 위해 [Destination SDK을 사용하여 대상 구성](../../guides/configure-destination-instructions.md)을 참조하십시오.
