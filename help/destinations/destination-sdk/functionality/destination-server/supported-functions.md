...
[!DNL Pebble]에서 제공한 기본 버전에 비해 Experience Platform [!DNL Pebble] 구현에는 몇 가지 변경 사항이 있습니다. 또한 [!DNL Pebble]에서 제공하는 기본 함수 외에 Adobe에서 Destination SDK에 사용할 수 있는 몇 가지 추가 함수를 만들었습니다.
...
Experience Platform에서 대상으로 내보낸 데이터에 대해 [메시지 변환 템플릿을 만들기](../../testing-api/streaming-destinations/create-template.md)할 때 이 페이지의 아래에 나열된 지원되는 함수를 사용합니다.
...
[!DNL Pebble] 함수 섹션에서 Adobe은 *범위* 함수를 지원하지 [않습니다](https://pebbletemplates.io/wiki/function/range/).
