...
* API 자습서 {#api}
   * [스트리밍 대상에 연결하고 API 호출을 사용하여 데이터 활성화](./api/streaming-destinations.md)
   * [이메일 마케팅 대상에 연결하고 API 호출을 사용하여 데이터 활성화](./api/email-marketing.md)
* UI 안내서 {#ui}
...
* 대상 카탈로그 {#catalog}
   ...
   * 소셜 네트워크 대상{#social}
      ...
      * [Facebook 확장](./catalog/social/facebook.md)
   * 설문 조사 대상 {#survey}
