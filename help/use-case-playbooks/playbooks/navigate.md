...
이 문서를 읽고 나면 영감을 주는 샌드박스를 설정하는 방법을 알아보고 Platform 내에서 사용 사례 플레이북에 액세스하는 다양한 방법을 숙지해야 합니다. 다음 단계로, 방법 을 읽어 보십시오. [선택](/help/use-case-playbooks/playbooks/choose.md) 올바른 플레이북입니다.
