...
데이터를 수집해야 하는 경우 [데이터 수집 튜토리얼 비디오](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-ingestion/create-datasets-and-ingest-data.html?lang=ko)에서 데이터 세트 생성, 스키마 매핑, 수집 및 유효성 검사에 대한 개요를 검토하십시오. 자세한 정보와 다른 학습 리소스에 대한 링크는 [수집 개요 설명서](../../ingestion/home.md)를 참조하십시오.
