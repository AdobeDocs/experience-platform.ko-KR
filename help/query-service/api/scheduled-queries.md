...
| `schedule.schedule` | 쿼리의 크론 일정입니다. cron 예약에 대한 자세한 내용은 [cron 표현식 형식](http://www.quartz-scheduler.org/documentation/quartz-2.3.0/tutorials/crontrigger.html) 설명서를 참조하십시오. 이 예에서 &quot;30 * * * *&quot;는 쿼리가 30분 표시에서 매시간마다 실행됨을 의미합니다. |
