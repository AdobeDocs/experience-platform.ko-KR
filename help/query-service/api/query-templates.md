...
조직에 대한 GET 요청을 수행하여 조직의 모든 쿼리 템플릿 목록을 검색할 수 있습니다 `/query-templates` 엔드포인트.
...
다음 요청은 조직에 대해 만들어진 최신 쿼리 템플릿을 검색합니다.
...
성공적인 응답은 지정된 조직에 대한 쿼리 템플릿 목록과 함께 HTTP 상태 200을 반환합니다. 다음 응답은 조직에 대해 작성된 최신 쿼리 템플릿을 반환합니다.
