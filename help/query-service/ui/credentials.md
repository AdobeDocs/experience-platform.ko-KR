...
>abstract="JWT 자격 증명은 2025년 6월 30일 이후에 작동이 중지되므로 이 마이그레이션이 필요합니다. 약 30~40초 정도 소요되며 한 번 시작하면 취소할 수 없습니다. 모든 기존 작업 및 통합은 마이그레이션 후에도 OAuth에서 계속 작동합니다. 이 화면을 종료하고 언제든지 다시 돌아와 상태를 확인할 수 있습니다."
