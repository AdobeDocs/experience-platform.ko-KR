...
예약된 쿼리 설정의 일부로 쿼리 경고에 가입할 수도 있습니다. 즉, 쿼리 상태가 변경되면 알림을 받습니다. 경고는 팝업 알림 또는 이메일로 받을 수 있습니다. 사용 가능한 쿼리 상태 경고 옵션에는 시작, 성공 및 실패가 포함됩니다. 예약된 쿼리의 해당 상태에 대한 경고를 구독하려면 확인란을 선택합니다.
