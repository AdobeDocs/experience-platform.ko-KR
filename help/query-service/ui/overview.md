...
Adobe Experience Platform [!DNL Query Service] 은 쿼리를 작성 및 실행하고, 이전에 실행된 쿼리를 보고, 조직 내의 사용자가 저장한 쿼리에 액세스하는 데 사용할 수 있는 사용자 인터페이스를 제공합니다. 내에서 UI에 액세스하려면 [Adobe Experience Platform](https://platform.adobe.com), 선택 **[!UICONTROL 쿼리]** 을 클릭합니다.
