...
>[!AVAILABILITY]
>
>데이터 세트 탐색 레일은 Data Distiller 고객만 사용할 수 있습니다. Platform UI에 왼쪽 데이터 세트 탐색 레일이 포함되어 있지 않을 수 있습니다.  이 문서의 다른 이미지는 데이터 세트 탐색 레일을 반영하지 않을 수 있습니다. 자세한 내용은 Adobe 담당자에게 문의하십시오.
