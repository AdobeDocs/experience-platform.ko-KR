...
>title="향상된 편집기 토글"
>abstract="쿼리 편집기의 기존 버전과 향상된 버전 간을 전환합니다. 향상된 버전이 더 나은 접근성 및 다중 테마 지원을 제공하긴 하지만 레거시 버전은 기본적으로 활성화되어 있습니다. 이러한 변경 사항에 대해 자세히 알아보려면 설명서를 참조하십시오."

UI 토글을 사용하면 쿼리 편집기의 기존 버전과 향상된 버전 간을 전환할 수 있습니다. 향상된 버전이 더 나은 접근성 및 다중 테마 지원을 제공하긴 하지만 레거시 버전은 기본적으로 활성화되어 있습니다. 향상된 버전을 활성화하여 쿼리 편집기 설정에 액세스할 수 있습니다.
