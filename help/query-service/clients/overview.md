...
>[!IMPORTANT]
>
>Power BI 및 Tableau 사용자는 쿼리 서비스 자격 증명 탭에 제공된 자격 증명을 사용하여 Customer Journey Analytics을 BI 도구에 연결할 수 있습니다. [BI 도구를 Customer Journey Analytics에 연결](../ui/credentials.md#connect-to-customer-journey-analytics)하는 방법에 대한 지침은 자격 증명 설명서를 참조하세요.
