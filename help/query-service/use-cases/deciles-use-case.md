---
title: 십분위수 기반 파생 속성 사용 사례
description: 이 안내서에서는 프로필 데이터에 사용할 십분위수 기반 파생 특성을 만들기 위해 쿼리 서비스를 사용하는 데 필요한 단계를 보여줍니다.
...
위에 제공된 예제 사용 사례에서는 실시간 고객 프로필에서 십분위수 속성을 사용할 수 있도록 하는 단계를 강조표시합니다. 이렇게 하면 사용자 인터페이스 또는 RESTful API를 통해 세분화 서비스가 이러한 십분위수 버킷을 기반으로 대상을 생성할 수 있습니다. 다음을 참조하십시오. [세그먼테이션 서비스 개요](../../segmentation/home.md) 세그먼트를 만들고, 평가하고, 액세스하는 방법에 대한 정보를 제공합니다.
