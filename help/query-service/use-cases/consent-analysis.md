...
동의 분석 안내서에서는 Real-Time CDP 데이터에 대한 다양한 마케팅 사용 사례에 대한 동의 대시보드를 작성하는 방법을 자세히 설명합니다. 동의 분석 대시보드를 작성하여 사용자 동의의 경향을 추적하는 방법에 대해 알아보려면 [동의 분석 대시보드 안내서](../../dashboards/insights-use-cases/consent-analysis.md)를 참조하세요.
