...
IMS 조직의 샌드박스를 관리하려면 샌드박스 관리 권한이 있어야 합니다. 액세스 권한이 없는 사용자는 [사용 가능한 샌드박스 끝점](./available.md) 현재 사용자의 활성 샌드박스를 나열하려면 다음을 수행하십시오. 자세한 내용은 [액세스 제어 개요](../../access-control/home.md) 을 참조하십시오.
