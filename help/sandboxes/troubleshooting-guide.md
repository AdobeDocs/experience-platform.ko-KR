...
이 문서에서는 Adobe Experience Platform의 샌드박스에 대한 FAQ에 대한 답변을 제공합니다. 다른 플랫폼 서비스와 관련된 질문과 문제 해결은 [Experience Platform 문제 해결 가이드](../landing/troubleshooting.md)를 참조하십시오.
...
Admin Console 내 샌드박스 및 권한 관리에 대한 자세한 내용은 [액세스 제어 사용 안내서](../access-control/ui/overview.md)를 참조하세요.
