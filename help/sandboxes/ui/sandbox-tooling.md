...
| [!DNL Adobe Journey Optimizer] | 메시지 | 여정에 사용된 메시지는 종속 객체로 복사할 수 있습니다. 여정 필드에 사용된 채널 작업 활동으로, 메시지의 개인화에 사용되며 완성도가 확인되지 않습니다. 콘텐츠 블록은 복사되지 않습니다. |
...
| [!DNL Adobe Journey Optimizer] | 작업 | 여정에 사용된 작업 및 작업 세부 사항이 복사됩니다. 대상 샌드박스에서 항상 새 버전이 생성됩니다. |
