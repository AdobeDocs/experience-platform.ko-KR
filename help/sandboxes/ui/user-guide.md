...
Experience Platform UI에서 왼쪽 탐색 **[!UICONTROL 에서 샌드박스를]** 선택하여 **[!UICONTROL 샌드박스]** 대시보드를 엽니다. 대시보드에는 샌드박스 유형(프로덕션 또는 개발) 및 상태(활성, 생성, 삭제 또는 실패)를 비롯하여 조직에 사용할 수 있는 모든 샌드박스가 나열됩니다.
...
샌드박스 **[!UICONTROL 만들기]** 대화 상자가 나타나고 샌드박스의 표시 제목과 이름을 제공하라는 메시지가 표시됩니다. 표시 제목 **** 은 사람이 읽을 수 있도록 하기 위한 것으로 쉽게 식별할 수 있도록 설명적이어야 합니다. 샌드박스 **[!UICONTROL 이름]** 은 API 호출에서 사용할 수 있는 소문자 식별자이며, 따라서 고유하고 간결해야 합니다. 샌드박스 **[!UICONTROL 이름]** 은 영숫자 및 하이픈(-) ****&#x200B;만 사용해야 하며 문자로 시작해야 하며 최대 256자까지 사용할 수 있습니다.

완료되면 **[!UICONTROL 만들기를 선택합니다]**.
...
UI에서 샌드박스를 재설정하려면 왼쪽 탐색 도구에서 **[!UICONTROL 샌드박스]** 를 선택한 다음 재설정할 샌드박스를 선택합니다. 화면 오른쪽에 표시되는 대화 상자에서 샌드박스 **[!UICONTROL 재설정을 선택합니다]**.

![](../images/ui/reset-sandbox.png)

선택을 확인하라는 대화 상자가 나타납니다. 계속하려면 **[!UICONTROL 재설정을]** 선택합니다.

![](../images/ui/reset-confirm.png)

확인 메시지가 나타나고 샌드박스의 상태가 &quot;**[!UICONTROL 재설정]&quot;으로 변경됩니다**. 시스템에 의해 프로비저닝된 후 상태는 **&quot;[!UICONTROL Active]&quot;****또는[!UICONTROL &quot;Failed]&quot;로**&#x200B;업데이트됩니다.
...
UI에서 샌드박스를 삭제하려면 왼쪽 탐색 도구에서 **[!UICONTROL 샌드박스]** 를 선택한 다음 삭제할 샌드박스를 선택합니다. 화면 오른쪽에 표시되는 대화 상자에서 샌드박스 **[!UICONTROL 삭제를 선택합니다]**.

![](../images/ui/delete-sandbox.png)

선택을 확인하라는 대화 상자가 나타납니다. 계속하려면 **[!UICONTROL 삭제를]** 선택합니다.
