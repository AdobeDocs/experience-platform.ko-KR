...
>[!NOTE]
>
>이 안내서는 Experience Platform에서 데이터가 사용되거나 활성화되는 방법에 대한 정책을 설정하고 적용하는 방법에 중점을 둡니다. 조직 내의 특정 Platform 사용자에 대해 데이터 자체로 **액세스**&#x200B;를 제한하려는 경우 대신 [특성 기반 액세스 제어](../access-control/abac/end-to-end-guide.md)에 대한 전체 안내서를 참조하십시오. 속성 기반 액세스 제어도 레이블과 정책을 사용하지만, 데이터 거버넌스와는 다른 사용 사례에 사용됩니다.
...
왼쪽 탐색에서 **[!UICONTROL Adobe]**&#x200B;을(를) 선택하여 조직에서 정의한 핵심 정책 목록과 이전에 만든 사용자 지정 정책을 확인합니다.
