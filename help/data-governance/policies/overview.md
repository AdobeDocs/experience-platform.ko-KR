...
>[!NOTE]
>
>사용 중인 경우 [!DNL Real-time Customer Data Platform]를 설정하는 경우 대상에서 마케팅 사용 사례를 설정하여 정책 집행을 자동화할 수 있습니다. 다음 문서를 참조하십시오. [실시간 CDP의 데이터 거버넌스](../../rtcdp/privacy/data-governance-overview.md) 추가 정보.
