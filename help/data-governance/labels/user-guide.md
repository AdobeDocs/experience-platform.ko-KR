...
>title="플랫폼의 데이터 사용 관리"
>abstract="<h2>설명</h2><p>Experience Platform의 데이터 거버넌스 프레임워크를 사용하면 데이터 사용 제한에 따라 속성 및 데이터 세트에 레이블을 지정하고 특정 마케팅 작업에 대해 이러한 제한 사항을 식별하고 적용하는 정책을 설정할 수 있습니다.</p>"
...
>title="지침"
>abstract="<ul><li>선택 <a href="https://experienceleague.adobe.com/docs/experience-platform/data-governance/labels/user-guide.html">데이터 세트</a> 왼쪽 탐색에서 제한할 데이터가 있는 데이터 세트를 선택합니다.</li><li>데이터 세트 세부 사항 보기에서 <b>데이터 거버넌스</b> 탭.</li><li>제한할 데이터 세트 필드를 선택한 다음 을 선택합니다 <b>거버넌스 레이블 편집</b> 사용 제한에 따라 데이터에 레이블을 지정합니다.</li><li>데이터에 레이블을 지정한 후 을(를) 선택합니다. <a href="https://experienceleague.adobe.com/docs/experience-platform/data-governance/policies/overview.html?lang=ko">정책</a> 왼쪽 탐색에서 를 선택하고 <b>정책 만들기</b>.</li><li>만들기 선택 <a href="https://experienceleague.adobe.com/docs/experience-platform/data-governance/policies/user-guide.html#create-governance-policy">데이터 거버넌스 정책</a>그런 다음 정책에 적용할 데이터 사용 레이블을 선택합니다.</li><li>정책이 해당 레이블이 포함된 데이터에 대해 거부할 마케팅 작업을 선택합니다. 정책이 만들어지면 목록에서 해당 정책을 선택하고 오른쪽 레일의 토글을 사용하여 활성화합니다.</li><li>활성화된 각 정책에 대해, 플랫폼은 지정된 레이블이 포함된 데이터를 정의된 마케팅 작업에 사용하지 못하도록 합니다. 이러한 적용은 관련 마케팅 작업(사용 사례)이 있는 대상에 레이블이 지정된 데이터를 활성화하려고 할 때 자동으로 수행됩니다.</li></ul>"
