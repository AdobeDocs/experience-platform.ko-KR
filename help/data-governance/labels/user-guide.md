...
![데이터 세트 활동 페이지](../images/labels/dataset_activity.png)
...
[!DNL Experience Platform] UI의 **[!UICONTROL 정책]** 작업 공간 내에 사용자 지정 사용 레이블을 만들 수 있습니다. 왼쪽 탐색에서 **[!UICONTROL 정책]**&#x200B;을 선택하고 **[!UICONTROL 레이블]**&#x200B;을 선택하여 기존 레이블 목록을 봅니다. 여기에서 **[!UICONTROL 레이블 만들기]**&#x200B;를 선택합니다.
