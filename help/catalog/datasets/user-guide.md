...
다음에서 [!DNL Experience Platform] UI, 선택 **[!UICONTROL 데이터 세트]** 을(를) 왼쪽 탐색에서 열어 **[!UICONTROL 데이터 세트]** 대시보드입니다. 대시보드에는 조직에서 사용 가능한 모든 데이터 세트가 나열됩니다. 이름, 데이터 세트가 준수하는 스키마, 가장 최근 수집 실행 상태 등 나열된 각 데이터 세트에 대한 세부 사항이 표시됩니다.

![왼쪽 탐색 막대 내의 데이터 세트 항목을 강조 표시하는 이미지입니다.](../images/datasets/user-guide/browse-datasets.png)

기본적으로 수집한 데이터 세트만 표시됩니다. 시스템에서 생성한 데이터 세트를 보려면 **[!UICONTROL 시스템 데이터 세트 표시]** 토글. 시스템에서 생성한 데이터 세트는 다른 구성 요소를 처리하는 데만 사용됩니다. 예를 들어 시스템에서 생성한 프로필 내보내기 데이터 세트는 프로필 대시보드를 처리하는 데 사용됩니다.

![시스템 데이터 세트를 표시할지 여부를 선택할 수 있는 토글이 강조 표시됩니다.](../images/datasets/user-guide/system-datasets.png)

액세스할 데이터 세트 이름 선택 **[!UICONTROL 데이터 세트 활동]** 선택한 데이터 세트에 대한 세부 정보를 표시합니다. 활동 탭에는 사용 중인 메시지 비율을 시각화하는 그래프와 성공 및 실패한 일괄 처리 목록이 포함되어 있습니다.
...
다음에서 **[!UICONTROL 데이터 세트 활동]** 화면, 선택 **[!UICONTROL 데이터 세트 미리 보기]** 화면의 오른쪽 상단 모서리 근처에서 최대 100개의 데이터 행을 미리 볼 수 있습니다. 데이터 세트가 비어 있으면 미리보기 링크가 비활성화되고 대신 미리보기를 사용할 수 없다고 표시됩니다.

![데이터 세트 미리보기 버튼이 강조 표시됩니다.](../images/datasets/user-guide/select-preview.png)

미리보기 창에서 데이터 세트에 대한 스키마의 계층적 보기가 오른쪽에 표시됩니다.

![데이터 세트의 미리보기가 표시됩니다. 구조뿐만 아니라 샘플 값에 대한 정보도 표시됩니다.](../images/datasets/user-guide/preview-dataset.png)
...
프로필에 대한 데이터 세트를 활성화하려면 해당 데이터 세트에 액세스 **[!UICONTROL 데이터 세트 활동]** 을(를) 스크린하고 **[!UICONTROL 프로필]** 내에서 전환 **[!UICONTROL 속성]** 열. 활성화되면 데이터 세트에 수집된 데이터는 고객 프로필을 채우는 데에도 사용됩니다.
...
먼저 데이터 세트에 액세스하여 데이터 세트를 삭제할 수 있습니다 **[!UICONTROL 데이터 세트 활동]** 화면. 그런 다음 을 선택합니다. **[!UICONTROL 데이터 세트 삭제]** 삭제.
...
배치를 삭제하려면 을(를) 선택하여 삭제할 수 있습니다. **[!UICONTROL 일괄 처리 삭제]** 대시보드 오른쪽 상단 근처에 있습니다. 이렇게 하면 배치가 원래 수집된 데이터 세트에서도 해당 레코드가 제거됩니다.
