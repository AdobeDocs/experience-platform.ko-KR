...
* [[!DNL 데이터 거버넌스]](../../data-governance/home.md):고객 데이터 사용과 관련된 규정, 제한 사항 및 정책을 준수할 수 있습니다.
...
데이터 *[!UICONTROL 집합 활동]* 화면에서 화면 오른쪽 상단 근처에 있는 데이터 집합 **** 미리 보기를 클릭하여 최대 100개의 데이터 행을 미리 봅니다. 데이터 세트가 비어 있으면 미리 보기 링크가 비활성화되고 대신 미리 보기를 사용할 수 **[!UICONTROL 없다고 표시됩니다]**.
...
DULE(Data Usage Lawring and Enforcement)는 데이터 거버넌스의 핵심 메커니즘입니다 [!DNL Experience Platform]. DULE 레이블을 사용하면 데이터 세트와 필드를 해당 데이터에 적용되는 사용 정책에 따라 분류할 수 있습니다. 레이블에 대한 자세한 내용은 [데이터 거버넌스 개요를](../../data-governance/home.md) 참조하거나 [데이터 세트에 레이블을 적용하는 방법에 대한 지침은 데이터 사용 레이블 사용자 안내서](../../data-governance/labels/overview.md) 를 참조하십시오.
