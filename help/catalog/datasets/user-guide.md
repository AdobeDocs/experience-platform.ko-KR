...
기본적으로는 수집한 데이터 세트만 표시됩니다. 시스템에서 생성한 데이터 세트를 보려면 **[!UICONTROL 시스템 데이터 세트 표시]** 토글. 시스템에서 생성한 데이터 세트는 다른 구성 요소를 처리하는 데만 사용됩니다. 예를 들어 시스템에서 생성한 프로필 내보내기 데이터 세트는 프로필 대시보드를 처리하는 데 사용됩니다.

![시스템 데이터 세트를 표시할지 여부를 선택할 수 있는 토글이 강조 표시됩니다.](../images/datasets/user-guide/system-datasets.png)

액세스할 데이터 세트 이름 선택 **[!UICONTROL 데이터 세트 활동]** 선택한 데이터 세트에 대한 세부 정보를 표시합니다. 활동 탭에는 메시지 사용률을 시각화한 그래프와 성공/실패한 일괄 처리 집합 목록이 있습니다.
