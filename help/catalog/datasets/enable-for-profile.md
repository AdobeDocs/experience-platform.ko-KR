...
실시간 고객 프로필 및 ID 서비스를 만들 때 즉시 또는 데이터 세트를 만든 후 언제든지 데이터 세트를 활성화할 수 있습니다. 이미 생성된 데이터 세트를 사용하려면 이 문서의 뒷부분에 있는 [기존 데이터 세트 구성](#configure-an-existing-dataset)에 대한 단계를 따르십시오.
...
프로필에 대해 활성화된 데이터 집합을 만들려면 `/dataSets` 종단점에 대한 POST 요청을 사용할 수 있습니다.
