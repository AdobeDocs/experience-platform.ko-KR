...
>[!NOTE]
>
>SPA용 Visual Experience Composer를 사용하려면 [Adobe Target VEC Helper Chrome Extension을 설치해야 합니다](https://chrome.google.com/webstore/detail/adobe-target-vec-helper/ggjpideecfnbipkacplkhhaflkdjagak).
