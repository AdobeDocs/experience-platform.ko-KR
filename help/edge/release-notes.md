...
* 에 대한 지원이 추가되었습니다 [`onBeforeLinkClickSend`](fundamentals/configuring-the-sdk.md#onBeforeLinkClickSend) link click callback.
* Adobe Journey Optimizer 클릭 추적 지원이 추가되었습니다.

**수정 사항 및 개선 사항**

* 이제 링크 수집에 링크 이름 및 방문자 영역이 포함됩니다.
* 실패한 URL 대상에 대한 콘솔 오류가 제거되었습니다.

## 버전 2.14.0 - 2023년 1월 25일

* (베타) Adobe Journey Optimizer 표면 및 프로모션에 대한 지원을 추가했습니다.
...
* 에 대한 지원이 추가되었습니다 [페이지별 전체 마이그레이션](home.md#migrating-to-web-sdk). 이제 방문자가 at.js와 Web SDK 페이지 간을 이동할 때 Adobe Target 프로필이 유지됩니다.
