...
Adobe 타사 쿠키 설정을 활성화합니다. SDK에는 방문자 ID를 타사 컨텍스트에서 유지하여 여러 사이트에서 동일한 방문자 ID를 사용할 수 있는 기능이 있습니다. 여러 사이트가 있거나 파트너와 데이터를 공유하려는 경우 유용합니다. 하지만 경우에 따라 개인 정보 보호 이유로 이러한 것이 권장되지 않습니다.
