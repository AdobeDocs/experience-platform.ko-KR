...
아래 하위 섹션에서는 데이터 수집 UI 내에서 데이터를 매핑하는 기본 단계를 설명합니다. 이러한 단계에 대한 빠른 데모는 다음 비디오를 참조하십시오.

>[!VIDEO](https://video.tv.adobe.com/v/342120?quality=12&enable10seconds=on&speedcontrol=on)

#### [!UICONTROL 데이터 선택]

선택 **[!UICONTROL 매핑 저장 및 추가]** 완료 후 [기본 구성 단계](#configure), 및 **[!UICONTROL 데이터 선택]** 단계가 나타납니다. 여기에서 Platform으로 전송할 데이터의 구조를 나타내는 샘플 JSON 개체를 제공해야 합니다.

캡처할 데이터 계층에 속성을 매핑할 수 있도록 이 JSON 개체를 구성해야 합니다. 올바른 형식의 JSON 개체의 예를 보려면 아래 섹션을 선택하십시오.
...
>
>![배열 개체 매핑](../images/datastreams/array-object-mapping.png)
