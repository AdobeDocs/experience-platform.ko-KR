...
| 필드 | 설명 |
| --- | --- |
| [!UICONTROL 샌드박스] | **(필수)** 데이터를 보낼 Platform 샌드박스를 선택합니다. 샌드박스는 조직의 다른 샌드박스와 데이터 및 구현을 분리할 수 있는 Adobe Experience Platform의 가상 파티션입니다. 작동 방식에 대한 자세한 내용은 [샌드박스 설명서](../../sandboxes/home.md). |
