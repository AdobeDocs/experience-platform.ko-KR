...
화면의 오른쪽 위 영역에서 **[!UICONTROL New Edge Configuration]**&#x200B;을 클릭하여 가장자리 구성을 만듭니다. 이름과 설명을 입력하면 각 환경에 대한 기본 설정을 묻는 메시지가 표시됩니다. 사용 가능한 설정은 아래에 자세히 설명되어 있습니다.
...
에지 구성은 [!UICONTROL Experience Event] 클래스의 스키마가 있는 데이터 집합에 데이터 전송을 지원합니다.
