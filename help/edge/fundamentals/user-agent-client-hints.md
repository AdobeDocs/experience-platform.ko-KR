...
description: 웹 SDK에서 사용자 에이전트 클라이언트 힌트가 작동하는 방식을 알아봅니다. 클라이언트 힌트를 사용하면 웹 사이트 소유자는 사용자-에이전트 문자열에서 사용할 수 있는 동일한 정보의 상당 부분을 액세스할 수 있지만 개인 정보 보호 방식으로 액세스할 수 있습니다.
