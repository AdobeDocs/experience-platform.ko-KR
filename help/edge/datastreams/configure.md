...
| [!UICONTROL Adobe Journey Optimizer] | 이 확인란을 선택하여 [Adobe Journey Optimizer](https://experienceleague.adobe.com/docs/journey-optimizer/using/ajo-home.html?lang=ko-KR) 이 데이터 스트림에 대해 설명합니다. <br><br> 이 옵션을 활성화하면 데이터 스트림이 의 웹 및 앱 기반 인바운드 캠페인에서 개인화된 콘텐츠를 반환할 수 있습니다 [!DNL Adobe Journey Optimizer]. 이 옵션을 사용하려면 [!UICONTROL 에지 세그멘테이션] 활성화되어야 합니다. If [!UICONTROL 에지 세그멘테이션] 을 선택 취소하면 이 옵션이 회색으로 표시됩니다. |
