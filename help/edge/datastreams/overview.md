...
![데이터 수집 UI의 데이터 스트림 탭](../images/datastreams/overview/datastreams-tab.png)
...
이 안내서에서는 데이터 수집 UI에서 데이터 세트를 관리하는 방법을 다룹니다. 데이터 스트림을 설정한 후 Web SDK를 설치하고 구성하는 방법에 대한 자세한 내용은 [데이터 수집 E2E 안내서](../../rtcdp-connections/e2e.md#install).
