...
1. 먼저, 에서 데이터 스트림 구성 재정의를 정의해야 합니다. [데이터스트림 구성 페이지](../datastreams/configure.md).
...
![웹 SDK 태그 확장 페이지의 데이터 스트림 구성 재정의를 보여 주는 이미지입니다.](../assets/extension/overview/datastream-overrides.png)
