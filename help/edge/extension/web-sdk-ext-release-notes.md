...
* (베타) 추가됨 **[!UICONTROL 변수 업데이트]** 작업 및 **[!UICONTROL 변수]** 데이터 요소를 생성하지 않습니다.
* 에 대한 구성이 추가되었습니다. [`onBeforeLinkClickSend`](../fundamentals/configuring-the-sdk.md#onBeforeLinkClickSend) 콜백 함수입니다.

**수정 사항 및 개선 사항**

* 앵커 태그 내의 요소를 클릭해도 **[!UICONTROL ID를 사용하여 리디렉션]** 작업이 사용되었습니다.
* 스키마가 하나만 있는 경우 XDM 개체 데이터 요소가 작동하지 않는 문제를 해결했습니다.
* Adobe Experience Platform 웹 SDK 버전 2.15.0을 포함합니다.
