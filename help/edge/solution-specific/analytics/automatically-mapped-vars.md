...
seo-title: Adobe Experience Platform 웹 SDK를 사용하여 Analytics에 자동으로 매핑된 변수
...
| `commerce.purchaseID` | `pi` | AppMeasurement 쿼리 매개 변수 PURCHASEID 매핑입니다. |
