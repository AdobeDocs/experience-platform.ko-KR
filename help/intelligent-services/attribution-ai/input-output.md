...
UI에서 원시 점수의 경로를 볼 수 있습니다. 먼저 Platform UI에서 **[!UICONTROL 스키마를]** 선택한 다음 검색 *[!UICONTROL 탭 내에서 속성 AI 점수 스키마를 검색하고 선택합니다]* .
...
날짜 범위가 30일 미만인 경우 Platform UI에서 집계된 점수를 CSV 형식으로 다운로드할 수 있습니다.
...
날짜 범위가 30일 미만인 경우 Platform UI에서 집계된 점수를 CSV 형식으로 다운로드할 수 있습니다. 이러한 각 집계 열에 대한 자세한 내용은 아래 표를 참조하십시오.
