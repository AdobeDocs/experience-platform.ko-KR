...
기여도 AI의 모든 데이터 거버넌스 관련 설정은 Adobe Experience Platform에서 상속됩니다.

## 데이터 거버넌스 {#governance}

기여도 AI와 Adobe Experience Platform 데이터 거버넌스 간의 통합을 통해 Experience Platform을 통한 여정 전반에 걸쳐 데이터를 제어하고 이해할 수 있습니다. 여기에는 데이터 품질, 데이터 계보, 데이터 카탈로그 작성 등의 유지 관리가 포함됩니다.
