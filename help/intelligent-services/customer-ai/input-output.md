...
기본적으로, 고객 AI는 애플리케이션 구성 중에 자격 조건을 갖춘 인구 정의가 제공되지 않는 경우 지난 120일 동안 활동이 있었던 사용자를 찾습니다. 또한 고객 AI에는 예측된 목표 정의를 기반으로 한 기록 데이터의 최소 500개의 적격한 이벤트 및 500개의 비적격 이벤트(총 1000개)가 필요합니다.
