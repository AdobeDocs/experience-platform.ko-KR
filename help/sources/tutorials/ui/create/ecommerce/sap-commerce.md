...
[!DNL SAP Commerce] 소스 연결을 만들기 전에 먼저 소스에 사용할 Experience Platform 스키마를 만들어야 합니다. 스키마를 만드는 방법에 대한 포괄적인 단계를 보려면 [Experience Platform 스키마 만들기](../../../../../xdm/schema/composition.md)에 대한 자습서를 참조하십시오.
...
SAP Commerce 카드가 있는 카탈로그용 ![Experience Platform UI 스크린샷](../../../../images/tutorials/create/ecommerce/sap-commerce/catalog-card.png)
...
![SAP Commerce 계정을 기존 계정과 연결하는 Experience Platform UI 스크린샷](../../../../images/tutorials/create/ecommerce/sap-commerce/existing.png)
...
![SAP Commerce 계정을 새 계정에 연결하기 위한 Experience Platform UI 스크린샷](../../../../images/tutorials/create/ecommerce/sap-commerce/new.png)
...
![고객 옵션이 선택된 구성을 보여주는 SAP Commerce용 Experience Platform UI 스크린샷](../../../../images/tutorials/create/ecommerce/sap-commerce/configuration-customers.png)

>[!TAB 연락처]

연락처 데이터를 수집하려면 **[!UICONTROL 연락처]**&#x200B;를 개체 유형으로 선택한 다음 **[!UICONTROL 다음]**&#x200B;을 선택합니다.

![연락처 옵션이 선택된 구성을 보여주는 SAP Commerce용 Experience Platform UI 스크린샷](../../../../images/tutorials/create/ecommerce/sap-commerce/configuration-contacts.png)

>[!ENDTABS]

## 다음 단계 {#next-steps}

이 자습서에 따라 [!DNL SAP Commerce] 계정에 대한 연결을 설정했습니다. 이제 다음 자습서를 계속 진행하고 [데이터를 Experience Platform으로 가져오도록 데이터 흐름을 구성](../../dataflow/ecommerce.md)할 수 있습니다.
