...
이 자습서에서는 Google 사용자 인터페이스를 사용하여 Adobe Experience Platform Ads 소스 커넥터를 만드는 단계를 제공합니다.
...
![Experience Platform UI 소스 카탈로그의 Google 광고 소스 이미지](../../../../images/tutorials/create/ads/catalog.png).
...
![Google 광고 데이터 흐름을 만드는 데 사용할 수 있는 기존 계정 목록의 이미지입니다](../../../../images/tutorials/create/ads/existing.png).
...
![Experience Platform UI의 새 계정 연결 화면 이미지](../../../../images/tutorials/create/ads/connect.png).
