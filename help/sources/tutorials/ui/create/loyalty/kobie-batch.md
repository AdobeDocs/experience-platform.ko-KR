---
title: Ui를 사용하여 Kobie의 배치 데이터를 Experience Platform으로 수집
description: UI를 사용하여 Kobie에서 Adobe Experience Platform으로 일괄 데이터를 수집하는 방법을 알아봅니다.
badge: Beta
hide: true
hidefromtoc: true
...
# UI를 사용하여 [!DNL Kobie]에서 Experience Platform으로 일괄 처리 데이터 수집

UI의 소스 작업 영역을 사용하여 [!DNL Kobie] 계정의 일괄 처리 데이터를 Adobe Experience Platform으로 수집하는 방법에 대해 알아보려면 이 자습서를 참조하십시오.
...
[!DNL Kobie]에서 데이터를 수집하려면 **[!UICONTROL Kobie Batch Source Connector]**&#x200B;에서 *[!UICONTROL Loyalty]* 원본 카드를 선택한 다음 **[!UICONTROL Add data]**&#x200B;을(를) 선택하십시오.
...
[!DNL Kobie] 원본에 대한 새 계정을 만들려면 **[!UICONTROL New account]**&#x200B;을(를) 선택하고 계정에 대한 이름과 선택적 설명을 입력하십시오. 그런 다음 [!DNL Kobie] 도메인과 [!UICONTROL Kobie Management API Key]을(를) 제공하십시오. 완료되면 **[!UICONTROL Connect to source]**&#x200B;을(를) 선택하고 연결을 설정할 수 있도록 잠시 기다립니다.



### 기존 계정 사용

기존 계정을 사용하려면 **[!UICONTROL Existing account]**&#x200B;을(를) 선택하고 계정 인터페이스에서 사용할 [!DNL Kobie] 계정을 선택하십시오.
...
>[!IMPORTANT]
>
>[!DNL Kobie] 소스 데이터 매핑에 대한 추가 지침을 보려면 [[!DNL Kobie] 개요]를 읽어 보십시오.
