...
![Kobie 스트리밍 이벤트 카드가 선택된 UI의 소스 카탈로그입니다.](../../../../images/tutorials/create/kobie/catalog.png)
...
![원본 워크플로의 데이터 선택 단계](../../../../images/tutorials/create/kobie/select-data.png)
...
![데이터 흐름 세부 정보 인터페이스](../../../../images/tutorials/create/kobie/dataflow-details.png)
...
![워크플로의 매핑 단계](../../../../images/tutorials/create/kobie/mapping.png)
...
![소스 워크플로의 검토 단계입니다.](../../../../images/tutorials/create/kobie/review.png)

## 스트리밍 끝점 URL 검색

연결이 생성되면 소스 세부 정보 페이지가 나타납니다. 이 페이지에는 이전에 실행한 데이터 흐름, ID 및 스트리밍 끝점 URL을 포함하여 새로 생성된 연결의 세부 정보가 표시됩니다.

![스트리밍 끝점 URL입니다.](../../../../images/tutorials/create/kobie/streaming-endpoint.png)
