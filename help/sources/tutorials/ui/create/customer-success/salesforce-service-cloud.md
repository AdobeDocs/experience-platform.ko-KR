...
topic: overview
type: Tutorial
description: 이 자습서에서는 플랫폼 사용자 인터페이스를 사용하여 Salesforce Service Cloud(이하 "SSC") 소스 커넥터를 만드는 단계를 제공합니다.
...
시작하는 방법에 대한 자세한 내용은 이 문서 [ [!DNL Salesforce Service Cloud] 를 참조하십시오](https://developer.salesforce.com/docs/atlas.en-us.api_iot.meta/api_iot/qs_auth_access_token.htm).

## 계정 [!DNL Salesforce Service Cloud] 연결

필요한 자격 증명을 수집했으면 아래 절차에 따라 SSC 계정을 연결할 수 있습니다 [!DNL Platform].
...
고객 **[!UICONTROL 성공]** 카테고리 아래에서 **[!UICONTROL Salesforce 서비스 클라우드를 선택합니다]**. 이 커넥터를 처음 사용하는 경우 구성을 **[!UICONTROL 선택합니다]**. 그렇지 않은 경우 **[!UICONTROL 데이터]** 추가를 선택하여 새 SSC 커넥터를 만듭니다.
...
새 자격 증명을 사용 중인 경우 **[!UICONTROL 새 계정을 선택합니다]**. 표시되는 입력 양식에서 이름, 선택적 설명 및 SSC 자격 증명을 제공합니다. 완료되면 **[!UICONTROL Connect를]** 선택한 다음 새 연결이 설정될 때까지 잠시 기다립니다.
...
이 튜토리얼을 따라 SSC 계정에 대한 연결을 설정했습니다. 이제 다음 튜토리얼로 계속 이동하여 데이터 흐름을 [구성하여 고객 성공 데이터를 [!DNL Platform]](../../dataflow/customer-success.md)가져올 수 있습니다.