...
Adobe Experience Platform의 Source 커넥터는 일정에 따라 외부 소스 데이터를 수집하는 기능을 제공합니다. 이 자습서에서는 [!DNL Experience Platform] 사용자 인터페이스를 사용하여 [!DNL ServiceNow] 소스 커넥터를 만드는 단계를 제공합니다.
...
[!DNL Experience Platform]에서 [!DNL ServiceNow] 계정에 액세스하려면 다음 값을 제공해야 합니다.
...
필요한 자격 증명을 수집했으면 아래 단계에 따라 [!DNL ServiceNow] 계정을 [!DNL Experience Platform]에 연결할 수 있습니다.
...
이 자습서에 따라 [!DNL ServiceNow] 계정에 대한 연결을 설정했습니다. 이제 다음 자습서를 계속 진행하고 [데이터를 가져올 데이터 흐름을 구성 [!DNL Experience Platform]](../../dataflow/customer-success.md)할 수 있습니다.
