...
# UI를 통해 Experience Platform에 [!DNL PathFactory] 계정 연결
...
이미 [!DNL PathFactory] 계정이 있는 경우 이 문서의 나머지 부분을 건너뛰고 [UI를 사용하여 마케팅 자동화 데이터를 Experience Platform으로 가져오기](../../dataflow/marketing-automation.md)에 대한 자습서를 진행할 수 있습니다.
