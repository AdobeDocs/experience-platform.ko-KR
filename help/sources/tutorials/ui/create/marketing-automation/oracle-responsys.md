...
title: (Beta) Platform UI를 사용하여 Oracle Responsys 소스 연결 만들기
...
# (Beta) 플랫폼 UI를 사용하여 [!DNL Oracle Responsys] 소스 연결 만들기
...
플랫폼에서 인증된 [!DNL Oracle Responsys] 계정이 이미 있는 경우 이 문서의 나머지 부분을 건너뛰고 [마케팅 자동화 데이터를 플랫폼으로 가져오기 위한 데이터 흐름 만들기](../../dataflow/marketing-automation.md)에 대한 자습서로 진행할 수 있습니다.

### 필요한 자격 증명 수집

[!DNL Oracle Responsys]을(를) 플랫폼에 연결하려면 다음 인증 속성에 대한 값을 제공해야 합니다.
...
필요한 자격 증명을 수집했으면 아래 단계에 따라 [!DNL Oracle Responsys] 계정을 플랫폼에 연결할 수 있습니다.
...
[!UICONTROL 마케팅 자동화] 범주에서 **[!UICONTROL Responsys Oracle]**&#x200B;을 선택한 다음 **[!UICONTROL 데이터 추가]**&#x200B;를 선택합니다.

![Oracle Responsys 원본이 강조 표시된 Adobe Experience Platform 원본 카탈로그입니다.](../../../../images/tutorials/create/oracle-responsys/catalog.png)

**[!UICONTROL Connect Oracle Responsys 계정]** 페이지가 나타납니다. 이 페이지에서 새 자격 증명 또는 기존 자격 증명을 사용할 수 있습니다.
...
이 자습서에 따라 [!DNL Oracle Responsys] 계정과 플랫폼 간의 소스 연결을 인증하고 만들었습니다. 이제 다음 자습서를 계속 진행하고 [데이터 흐름을 만들어 플랫폼 자동화 데이터를 가져올 수 있습니다](../../dataflow/marketing-automation.md).
