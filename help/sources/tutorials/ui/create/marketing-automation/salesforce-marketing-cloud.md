...
# UI에서 [!DNL Salesforce Marketing Cloud] 소스 연결 만들기

>[!NOTE]
>
> [!DNL Salesforce Marketing Cloud] 소스가 베타에 있습니다. 베타 레이블이 지정된 소스 사용에 대한 자세한 내용은 [소스 개요](../../../../home.md#terms-and-conditions) 를 참조하십시오.

Adobe Experience Platform의 소스 커넥터는 예약된 방식으로 외부 소스 데이터를 수집할 수 있습니다. 이 자습서에서는 플랫폼 사용자 인터페이스를 사용하여 [!DNL Salesforce Marketing Cloud] 소스 커넥터를 만드는 단계를 제공합니다.
...
이미 [!DNL Salesforce Marketing Cloud] 연결이 있는 경우 이 문서의 나머지 부분을 건너뛰고 [데이터 흐름 구성](../../dataflow/marketing-automation.md)에서 자습서를 진행할 수 있습니다.
...
## [!DNL Salesforce Marketing Cloud] 계정을 연결합니다

필요한 자격 증명을 수집하면 아래 단계에 따라 [!DNL Salesforce Marketing Cloud] 계정을 Platform에 연결할 수 있습니다.
...
[!UICONTROL 마케팅 자동화] 카테고리에서 **[!UICONTROL Salesforce Marketing Cloud]**&#x200B;을 선택한 다음 **[!UICONTROL 설정]**&#x200B;을 선택합니다.

![카탈로그](../../../../images/tutorials/create/salesforce-marketing-cloud/catalog.png)

**[!UICONTROL Salesforce에 연결 Marketing Cloud]** 페이지가 나타납니다. 이 페이지에서 새 자격 증명 또는 기존 자격 증명을 사용할 수 있습니다.

### 새 계정

새 자격 증명을 사용하는 경우 **[!UICONTROL 새 계정]**&#x200B;을 선택합니다. 표시되는 입력 양식에서 이름, 선택적 설명 및 [!DNL Salesforce Marketing Cloud] 자격 증명을 제공합니다. 완료되면 **[!UICONTROL Connect]**&#x200B;를 선택한 다음 새 연결이 설정될 시간을 허용합니다.

![새](../../../../images/tutorials/create/salesforce-marketing-cloud/new.png)

### 기존 계정

기존 계정을 연결하려면 연결하려는 [!DNL Salesforce Marketing Cloud] 계정을 선택한 후 **[!UICONTROL 다음]**&#x200B;을 선택하여 계속 진행합니다.

![기존](../../../../images/tutorials/create/salesforce-marketing-cloud/existing.png)

## 다음 단계

이 자습서에 따라 [!DNL Salesforce Marketing Cloud] 계정에 대한 연결을 설정했습니다. 이제 다음 자습서를 계속 진행하고 [데이터 흐름을 구성하여 마케팅 자동화 시스템 데이터를 Platform](../../dataflow/marketing-automation.md)에 가져올 수 있습니다.
