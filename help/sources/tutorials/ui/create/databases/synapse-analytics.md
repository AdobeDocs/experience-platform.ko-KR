...
>[!IMPORTANT]
>
>[!DNL Azure Synapse Analytics] 원본은 Real-time Customer Data Platform Ultimate를 구입한 사용자가 소스 카탈로그에서 사용할 수 있습니다.

이 자습서에서는 [!DNL Platform] 사용자 인터페이스를 사용하여 [!DNL Azure Synapse Analytics](이하 &quot;[!DNL Synapse]&quot;) 소스 커넥터를 만드는 단계를 제공합니다.
...
**[!UICONTROL Azure synapse 분석에 연결]** 페이지가 나타납니다. 이 페이지에서 새 자격 증명 또는 기존 자격 증명을 사용할 수 있습니다.
...
이 자습서에 따라 [!DNL Synapse] 계정에 대한 연결을 설정했습니다. 이제 다음 자습서를 계속 진행하고 [데이터를 가져올 데이터 흐름을 구성 [!DNL Platform]](../../dataflow/databases.md)할 수 있습니다.
