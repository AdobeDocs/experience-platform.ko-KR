...
필요한 자격 증명을 수집했으면 아래 절차에 따라 연결할 새 DB2 계정을 만들 수 있습니다 [!DNL Platform].
...
데이터베이스 *[!UICONTROL 카테고리 아래에서]* IBM DB **[!UICONTROL 2]** 를 **[!UICONTROL 선택하고]** 데이터추가를 선택하여 새 DB2 커넥터를 만듭니다.
...
이 튜토리얼을 따라 DB2 계정에 대한 연결을 설정했습니다. 이제 다음 튜토리얼로 계속 진행하여 데이터 흐름을 [구성하여 Platform으로 데이터를 가져올 수 있습니다](../../dataflow/databases.md).