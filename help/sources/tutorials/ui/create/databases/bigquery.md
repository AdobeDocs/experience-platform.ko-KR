...
데이터베이스 *[!UICONTROL 카테고리]* 아래에서 **[!UICONTROL Google]** Big Query를 선택하여 화면 오른쪽에 정보 막대를 표시합니다. 정보 표시줄에는 선택한 소스에 대한 간단한 설명과 소스와 연결하거나 설명서를 보는 옵션이 제공됩니다. 새 인바운드 기본 연결을 만들려면 데이터 **[!UICONTROL 추가를 선택합니다]**.
