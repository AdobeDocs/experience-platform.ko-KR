...
필요한 자격 증명을 수집했으면 아래 단계에 따라 [!DNL MySQL] 계정을 [!DNL Platform]에 연결할 수 있습니다.
...
이 자습서를 따라 MySQL 계정에 대한 연결을 설정했습니다. 이제 다음 자습서를 계속 진행하고 [데이터를 가져올 데이터 흐름을 구성 [!DNL Platform]](../../dataflow/databases.md)할 수 있습니다.
