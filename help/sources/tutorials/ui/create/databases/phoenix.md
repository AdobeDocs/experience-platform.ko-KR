...
[ *[!UICONTROL 데이터베이스]* ] 범주 아래에서 **[!UICONTROL Phoenix]** 를 선택하여 화면 오른쪽에 정보 막대를 표시합니다. 정보 표시줄에는 선택한 소스에 대한 간단한 설명과 소스와 연결하거나 설명서를 보는 옵션이 제공됩니다. 새 인바운드 연결을 만들려면 데이터 **[!UICONTROL 추가를 선택합니다]**.
...
이 튜토리얼을 따라 계정에 대한 연결을 설정해 [!DNL Phoenix] 드렸습니다. 이제 다음 튜토리얼로 계속 진행하여 데이터 흐름을 [구성하여 Platform으로 데이터를 가져올 수 있습니다](../../dataflow/databases.md).