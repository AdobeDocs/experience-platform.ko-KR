...
Adobe Experience Platform의 소스 커넥터는 외부에서 가져온 데이터를 예약된 기준으로 인제스트하는 기능을 제공합니다. 이 자습서에서는 사용자 인터페이스를 사용하여 [!DNL Phoenix] 소스 커넥터를 만드는 단계를 [!DNL Platform] 제공합니다.
...
필요한 자격 증명을 수집했으면 아래 절차에 따라 연결할 새 [!DNL Phoenix] 계정을 만들 수 있습니다 [!DNL Platform].
...
[ *[!UICONTROL 데이터베이스]* ] 범주 아래에서 **[!UICONTROL Phoenix]** 를 선택하여 화면 오른쪽에 정보 막대를 표시합니다. 정보 표시줄에는 선택한 소스에 대한 간단한 설명과 소스와 연결하거나 설명서를 보는 옵션이 제공됩니다. 새 인바운드 연결을 만들려면 **[!UICONTROL Connect 소스를 선택합니다]**.
...
새 자격 증명을 사용 중인 경우 **[!UICONTROL 새 계정을 선택합니다]**. 표시되는 입력 양식에서 이름, 선택적 설명 및 자격 증명과 함께 연결을 [!DNL Phoenix] 제공합니다. 완료되면 **[!UICONTROL Connect를]** 선택한 다음 새 계정이 설정되기까지 약간의 시간이 소요됩니다.
...
이 튜토리얼을 따라 계정에 대한 연결을 설정해 [!DNL Phoenix] 드렸습니다. 이제 다음 튜토리얼로 계속 이동하여 데이터를 Platform으로 가져오도록 [데이터 흐름을 구성할 수 있습니다](../../dataflow/databases.md).