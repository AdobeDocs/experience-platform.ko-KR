...
플랫폼에서 [!DNL Teradata Vantage] 계정에 액세스하려면 다음 인증 값을 제공해야 합니다.
...
![Teradata Vantage 원본이 있는 원본 카탈로그를 선택했습니다.](../../../../images/tutorials/create/teradata/catalog.png)
...
이 자습서에 따라 Teradata Vantage 계정에 대한 연결을 설정했습니다. 이제 다음 자습서를 계속 진행하고 [데이터를 플랫폼으로 가져오도록 데이터 흐름을 구성](../../dataflow/databases.md)할 수 있습니다.
