...
**[!UICONTROL 데이터베이스]** 범주에서 **[!UICONTROL Oracle DB]**&#x200B;를 선택합니다. 이 커넥터를 처음 사용하는 경우 **[!UICONTROL 구성]**&#x200B;을 선택합니다. 그렇지 않은 경우 **[!UICONTROL 데이터 추가]**&#x200B;를 선택하여 새 [!DNL Oracle DB] 커넥터를 만듭니다.

![카탈로그](../../../../images/tutorials/create/oracle/catalog.png)

**[!UICONTROL Oracle DB에 연결]** 페이지가 나타납니다. 이 페이지에서 새 자격 증명이나 기존 자격 증명을 사용할 수 있습니다.

### 새 계정

새 자격 증명을 사용 중인 경우 **[!UICONTROL 새 계정]**&#x200B;을 선택합니다. 표시되는 입력 양식에서 이름, 선택적 설명 및 [!DNL Oracle DB] 자격 증명을 입력합니다. 완료되면 **[!UICONTROL Connect]**&#x200B;를 선택한 다음 새 연결이 설정될 때까지 잠시 기다려 주십시오.

![connect](../../../../images/tutorials/create/oracle/new.png)

### 기존 계정

기존 계정을 연결하려면 연결할 [!DNL Oracle DB] 계정을 선택한 다음 **[!UICONTROL 다음]**&#x200B;을 선택하여 계속 진행합니다.
