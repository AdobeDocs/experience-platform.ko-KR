...
Databases *[!UICONTROL 카테고리]* 아래에서 **[!UICONTROL HP Vertica]** 다음에 Add **[!UICONTROL data]** 를 선택하여 새 HP Vertica 커넥터를 만듭니다.
...
이 튜토리얼을 따라 HP [!DNL Vertica] 계정에 연결되었습니다. 이제 다음 튜토리얼로 계속 진행하여 데이터 흐름을 [구성하여 Platform으로 데이터를 가져올 수 있습니다](../../dataflow/databases.md).