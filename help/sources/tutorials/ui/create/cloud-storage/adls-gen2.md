...
Adobe Experience Platform의 소스 커넥터는 외부에서 가져온 데이터를 예약된 기준으로 인제스트하는 기능을 제공합니다. 이 자습서에서는 사용자 인터페이스를 사용하여 소스 커넥터 [!DNL Azure Data Lake Storage Gen2] (이하 &quot;ADLS Gen2&quot;라 한다)를 인증하는 단계를 [!DNL Platform] 제공합니다.
