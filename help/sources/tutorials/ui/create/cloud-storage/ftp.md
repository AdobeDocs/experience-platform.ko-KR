...
[!UICONTROL 클라우드 스토리지] 범주에서 **[!UICONTROL FTP]**&#x200B;를 선택합니다. 이 커넥터를 처음 사용하는 경우 **[!UICONTROL 구성]**&#x200B;을 선택합니다. 그렇지 않은 경우 **[!UICONTROL 데이터 추가]**&#x200B;를 선택하여 새 FTP 연결을 만듭니다.

![카탈로그](../../../../images/tutorials/create/ftp/catalog.png)

**[!UICONTROL FTP에 연결]** 페이지가 나타납니다. 이 페이지에서 새 자격 증명이나 기존 자격 증명을 사용할 수 있습니다.
...
기존 계정을 연결하려면 연결할 FTP 계정을 선택한 다음 **[!UICONTROL 다음]**&#x200B;을 선택하여 계속 진행합니다.
