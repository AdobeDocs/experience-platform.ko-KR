...
필요한 자격 증명을 수집했으면 아래 단계에 따라 Experience Platform에 연결할 새 Oracle 개체 스토리지 계정을 만들 수 있습니다.
...
이 자습서에 따라 [!DNL Oracle Object Storage] 계정에 대한 연결을 설정했습니다. 이제 [데이터 흐름을 구성하여 클라우드 저장소에서 Experience Platform으로 데이터를 가져오는 방법](../../dataflow/batch/cloud-storage.md)에 대한 다음 자습서로 진행할 수 있습니다.
