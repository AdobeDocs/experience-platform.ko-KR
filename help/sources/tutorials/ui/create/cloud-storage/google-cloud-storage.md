...
플랫폼에서 [!DNL Google Cloud Storage] 데이터에 액세스하려면 다음 값을 제공해야 합니다.

| 자격 증명 | 설명 |
| ---------- | ----------- |
| 액세스 키 ID | [!DNL Google Cloud Storage] 계정을 Platform에 인증하는 데 사용되는 61자의 영숫자 문자열입니다. |
| 비밀 액세스 키 | [!DNL Google Cloud Storage] 계정을 Platform에 인증하는 데 사용되는 40자의 Base64로 인코딩된 문자열입니다. |
...
필요한 자격 증명을 수집했으면 아래 단계에 따라 [!DNL Google Cloud Storage] 계정을 플랫폼에 연결할 수 있습니다.
...
![Google 클라우드 저장소 원본의 기존 계정 페이지를 표시하는 플랫폼 UI 화면](../../../../images/tutorials/create/google-cloud-storage/existing.png)
...
![Google 클라우드 저장소 원본의 새 계정 페이지를 표시하는 플랫폼 UI 화면입니다.](../../../../images/tutorials/create/google-cloud-storage/new.png)


## 다음 단계

이 자습서에 따라 [!DNL Google Cloud Storage] 계정에 대한 연결을 설정했습니다. 이제 다음 자습서를 계속 진행하고 [클라우드 저장소에서 플랫폼으로 데이터를 가져오도록 데이터 흐름을 구성](../../dataflow/batch/cloud-storage.md)할 수 있습니다.
