...
**[!UICONTROL Report suite]**&#x200B;을(를) 선택한 다음 *[!UICONTROL Analytics source add data]* 인터페이스를 사용하여 목록을 탐색하고 Experience Platform으로 수집할 Analytics 보고서 세트를 식별합니다. 계속하려면 **[!UICONTROL Next]**&#x200B;을(를) 선택하십시오.
