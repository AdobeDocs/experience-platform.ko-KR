...
>abstract="사용하려는 Adobe Campaign 환경의 이름입니다."
>text="Learn more in documentation"

>[!CONTEXTUALHELP]
>id="platform_sources_campaign_mapping"
>title="대상 매핑"
>abstract="Target 매핑은 메시지를 게재하기 위해 Campaign에서 사용하는 기술 개체로서, 게재를 보내는 데 필요한 모든 기술 설정(주소, 전화번호, 옵트인 표시기, 추가 식별자 등)을 포함합니다."
>text="Learn more in documentation"

>[!CONTEXTUALHELP]
>id="platform_sources_campaign_schema"
>title="스키마 이름"
>abstract="Adobe Campaign 데이터베이스에 정의된 엔티티의 이름입니다."
>text="Learn more in documentation"
