...
[!UICONTROL CRM] 범주에서 **[!UICONTROL Microsoft Dynamics]**&#x200B;을(를) 선택한 다음 **[!UICONTROL 데이터 추가]**&#x200B;를 선택합니다.

![Microsoft Dynamics가 포함된 소스 카탈로그를 선택했습니다.](../../../../images/tutorials/create/ms-dynamics/catalog.png)
...
기본 인증을 사용하여 [!DNL Dynamics] 계정을 만들려면 [!UICONTROL 기본 인증]을 선택한 다음 [!UICONTROL 서비스 URI], [!UICONTROL 사용자 이름] 및 [!UICONTROL 암호]에 대한 값을 제공하십시오. **참고**: [!DNL Dynamics]의 기본 인증은 현재 플랫폼에서 지원하지 않는 이중 인증으로 차단될 수 있습니다. 이 경우 [!DNL Dynamics]을(를) 사용하여 소스 커넥터를 만들려면 키 기반 인증을 사용하는 것이 좋습니다.
...
이 자습서에 따라 [!DNL Dynamics] 계정에 대한 연결을 설정했습니다. 이제 다음 자습서를 계속 진행하고 [데이터를 플랫폼으로 가져오도록 데이터 흐름을 구성](../../dataflow/crm.md)할 수 있습니다.
