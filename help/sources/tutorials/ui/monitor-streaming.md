...
>title="기록 수신됨"
>abstract="수신된 레코드 지표는 데이터 흐름에서 받은 총 레코드 수를 나타냅니다."
>text="Learn more in documentation"

>[!CONTEXTUALHELP]
>id="platform_sources_dataflow_records_ingested"
>title="수집된 레코드"
>abstract="수집된 레코드 지표는 데이터 레이크에 수집된 레코드의 총 수를 나타냅니다."
>text="Learn more in documentation"

>[!CONTEXTUALHELP]
>id="platform_sources_dataflow_records_failed"
>title="기록 실패"
>abstract="레코드 실패 지표는 데이터의 오류로 인해 데이터 레이크에 수집되지 않은 총 레코드 수를 나타냅니다."
>text="Learn more in documentation"

>[!CONTEXTUALHELP]
>id="platform_sources_dataflow_records_warnings"
>title="경고가 있는 레코드"
>abstract="경고가 있는 레코드는 매퍼 변형 경고와 함께 수집된 총 레코드 수를 나타냅니다. 모든 매퍼 변환 오류는 경고로 보고되며, 부분적으로 수집된 행은 경고와 함께 성공한 것으로 간주됩니다"
>text="Learn more in documentation"
