...
title: UI에서 결제 Source을 사용하여 데이터 흐름 만들기
type: Tutorial
...
>[!NOTE]
>
>* 데이터 흐름을 만들려면 이미 결제 출처가 있는 인증된 계정이 있어야 합니다. UI에서 다양한 결제 소스 계정을 만들기 위한 자습서 목록은 [소스 개요](../../../home.md#payments)에서 찾을 수 있습니다.
...
결제 원본 계정을 만든 후 **[!UICONTROL 데이터 추가]** 단계가 나타나며, 결제 원본 계정의 테이블 계층 구조를 살펴볼 수 있는 인터페이스를 제공합니다.
...
이 자습서를 따라 데이터 흐름을 만들어 결제 소스에서 플랫폼으로 데이터를 가져왔습니다. 이제 [!DNL Real-Time Customer Profile] 및 [!DNL Data Science Workspace] 등의 다운스트림 [!DNL Platform] 서비스에서 수신 데이터를 사용할 수 있습니다. 자세한 내용은 다음 문서를 참조하십시오.
