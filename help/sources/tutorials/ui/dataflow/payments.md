...
또한 이 자습서에서는 결제 계정을 이미 만들어야 합니다. UI에서 서로 다른 지불 커넥터를 만들기 위한 자습서 목록은 [소스 커넥터 개요에](../../../home.md)있습니다.

## 데이터 선택

결제 계정을 만든 *후 데이터* 선택 단계가 나타나 파일 계층 구조를 탐색할 수 있는 대화형 인터페이스를 제공합니다.
...
데이터 *집합 흐름 세부* 사항 단계가 나타나고, 여기에서 데이터 집합 흐름에 대한 이름과 선택적 설명을 제공해야 합니다. 완료되면 **다음을** 선택합니다.
