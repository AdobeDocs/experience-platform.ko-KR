...
[ *[!UICONTROL 매핑]* ] 화면에서는 *[!UICONTROL 델타 열을 설정할 수도 있습니다]*. 데이터 세트 흐름이 만들어지면 모든 타임스탬프 필드를 기준으로 설정하여 예약된 증분 인제스에서 인제스트할 레코드를 결정할 수 있습니다.
...
![예약](../../../images/tutorials/dataflow/payments/scheduling.png)
