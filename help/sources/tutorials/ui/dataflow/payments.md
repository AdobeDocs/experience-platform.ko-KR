...
또한 이 자습서에서는 이미 결제 계정을 만들어야 합니다. UI에서 다른 지불 커넥터를 만드는 자습서 목록은 [소스 커넥터 개요](../../../home.md)에 있습니다.

## 데이터 선택

결제 계정을 생성한 후 **[!UICONTROL 데이터 선택]** 단계가 나타나고 파일 계층을 탐색하기 위한 대화형 인터페이스를 제공합니다.
