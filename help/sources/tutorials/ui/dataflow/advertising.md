...
광고 계정을 만든 후 파일 계층 구조를 탐색할 수 있는 대화형 인터페이스를 제공하는 **[!UICONTROL Select data]** 단계가 나타납니다.
...
**[!UICONTROL Select schema]** 대화 상자가 나타납니다. 새 데이터 세트에 적용할 스키마를 선택한 다음 **[!DNL Done]**&#x200B;을 클릭합니다.
