...
또한 이 자습서에서는 광고 계정을 이미 만들어야 합니다. UI에서 다른 지불 커넥터를 만드는 자습서 목록은 [소스 커넥터 개요](../../../home.md)에 있습니다.

## 데이터 선택

광고 계정을 만든 후 **[!UICONTROL 데이터 선택]** 단계가 나타나고 파일 계층 구조를 탐색하기 위한 대화형 인터페이스를 제공합니다.
...
**[!UICONTROL 스키마 선택]** 대화 상자가 나타납니다. 새 데이터 세트에 적용할 스키마를 선택한 다음 **[!DNL Done]** 를 클릭합니다.
...
이 자습서를 따라 마케팅 자동화 시스템에서 데이터를 가져오기 위한 데이터 흐름을 성공적으로 만들어 모니터링 데이터 세트에 대한 통찰력을 얻을 수 있습니다. 이제 [!DNL Real-time Customer Profile] 및 [!DNL Data Science Workspace] 등의 다운스트림 [!DNL Platform] 서비스에서 들어오는 데이터를 사용할 수 있습니다. 자세한 내용은 다음 문서를 참조하십시오.
...
**[!UICONTROL 데이터 흐름]** 화면에서 비활성화할 데이터 흐름의 이름을 선택합니다.

![browse-dataset-flow](../../../images/tutorials/dataflow/advertising/view-dataset-flows.png)

**[!UICONTROL 속성]** 열이 화면 오른쪽에 나타납니다. 이 패널에는 **[!UICONTROL Enabled]** 전환 단추가 포함되어 있습니다. 데이터 흐름을 비활성화하려면 전환을 클릭하십시오. 동일한 전환을 사용하여 데이터 흐름을 비활성화한 후 다시 활성화할 수 있습니다.
