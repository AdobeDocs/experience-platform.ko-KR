...
title: UI에서 동의 및 환경 설정 Source을 사용하여 데이터 흐름 만들기
type: Tutorial
...
>[!NOTE]
>
>* 데이터 흐름을 만들려면 [!DNL OneTrust Integration] 원본이 있는 인증된 계정이 이미 있어야 합니다. 자세한 내용은 [UI에서  [!DNL OneTrust Integration] 소스 연결 만들기](../../ui/create/consent-and-preferences/onetrust.md)에 대한 자습서를 참조하십시오.
...
동의 및 환경 설정 소스 계정을 만든 후 **[!UICONTROL 데이터 추가]** 단계가 나타나며, 동의 및 환경 설정 계정의 테이블 계층 구조를 살펴볼 수 있는 인터페이스를 제공합니다.
...
이 자습서에 따라 동의 및 환경 설정 소스에서 Platform으로 데이터를 가져오는 데이터 흐름을 만들었습니다. 이제 [!DNL Real-Time Customer Profile] 및 [!DNL Data Science Workspace] 등의 다운스트림 [!DNL Platform] 서비스에서 수신 데이터를 사용할 수 있습니다. 자세한 내용은 다음 문서를 참조하십시오.
