...
title: UI에서 Marketing Automation Source을 사용하여 데이터 흐름 만들기
type: Tutorial
...
>[!NOTE]
>
>* 데이터 흐름을 만들려면 마케팅 자동화 소스가 있는 인증된 계정이 이미 있어야 합니다. UI에서 다양한 마케팅 자동화 소스 계정을 만드는 데 필요한 튜토리얼 목록은 [소스 개요](../../../home.md#marketing-automation)에서 찾을 수 있습니다.
...
Marketing Automation 소스 계정을 만든 후 **[!UICONTROL 데이터 추가]** 단계가 표시되어 Marketing Automation 소스 계정의 테이블 계층 구조를 살펴볼 수 있는 인터페이스를 제공합니다.
...
이 자습서에 따라 마케팅 자동화 소스에서 플랫폼으로 데이터를 가져오는 데이터 흐름을 만들었습니다. 이제 [!DNL Real-Time Customer Profile] 및 [!DNL Data Science Workspace] 등의 다운스트림 [!DNL Platform] 서비스에서 수신 데이터를 사용할 수 있습니다. 자세한 내용은 다음 문서를 참조하십시오.
