...
또한 *[!UICONTROL 매핑]* 화면에서는 *[!UICONTROL 델타 열을 설정할 수도 있습니다]*. 데이터 흐름을 만들 때 타임스탬프 필드를 기반으로 설정하여 예약된 증분 인제스에서 인제스트할 레코드를 결정할 수 있습니다.
...
데이터 흐름 세부 *[!UICONTROL 정보]* 단계가 나타나고 데이터 흐름에 대한 이름과 선택적 설명을 제공해야 합니다. 완료되면 **[!UICONTROL 다음]**&#x200B;을 클릭합니다.
