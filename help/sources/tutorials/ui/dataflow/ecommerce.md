---
keywords: Experience Platform;홈;인기 항목;e커머스 커넥터;e커머스;e커머스;DigitalCommerce;Careers
solution: Experience Platform
title: UI에서 전자 상거래 소스 연결에 대한 데이터 흐름 구성
topic: overview
type: Tutorial
description: 데이터 흐름(Dataflow)은 소스에서 데이터를 검색하고 데이터 집합으로 가져오는 예약된 작업입니다.  [!DNL Platform]  이 자습서에서는 eCommerce 계정을 사용하여 새 데이터 흐름을 구성하는 절차를 제공합니다.
...
# UI에서 전자 상거래 연결에 대한 데이터 흐름 구성

데이터 흐름(Dataflow)은 소스의 데이터를 검색하여 [!DNL Platform] 데이터 세트로 인제스트하는 예약된 작업입니다. 이 자습서에서는 **[!UICONTROL eCommerce]** 계정을 사용하여 새 데이터 흐름을 구성하는 절차를 제공합니다.
...
또한 이 자습서를 사용하려면 이미 **[!UICONTROL eCommerce]** 계정을 만들어야 합니다. UI에서 다른 **[!UICONTROL eCommerce]** 커넥터를 만들기 위한 자습서 목록은 [소스 커넥터 개요](../../../home.md)에서 찾을 수 있습니다.

## 데이터 선택

**[!UICONTROL eCommerce]** 계정을 만든 후 **[!UICONTROL 데이터 선택]** 단계가 나타나 파일 계층 구조를 탐색하기 위한 대화형 인터페이스를 제공합니다.
...
소스 데이터를 찾은 후 디렉토리를 선택한 다음 **[!UICONTROL 다음]**&#x200B;을 선택합니다.

![select-data](../../../images/tutorials/dataflow/ecommerce/select-data.png)

## 데이터 필드를 XDM 스키마에 매핑

소스 데이터를 [!DNL Platform] 데이터 세트에 매핑하기 위한 대화형 인터페이스를 제공하는 **[!UICONTROL 매핑]** 단계가 나타납니다.

수집할 인바운드 데이터의 데이터 세트를 선택합니다. 기존 데이터 집합을 사용하거나 새 데이터 집합을 만들 수 있습니다.

### 기존 데이터 세트 사용

데이터를 기존 데이터 세트에 인제스트하려면 **[!UICONTROL 기존 데이터 세트 사용]**&#x200B;을 선택한 다음 데이터 세트 아이콘을 클릭합니다.
...
데이터를 새 데이터 세트에 인제스트하려면 **[!UICONTROL 새 데이터 세트 만들기]**&#x200B;를 선택하고 제공된 필드에 데이터 세트에 대한 이름과 설명을 입력합니다.
...
![새로운 데이터 세트 만들기](../../../images/tutorials/dataflow/ecommerce/new-dataset.png)
...
![검토](../../../images/tutorials/dataflow/ecommerce/review.png)
...
이 자습서를 따라 데이터 흐름을 만들어 **[!UICONTROL eCommerce]** 데이터를 가져오고 데이터 집합 모니터링에 대한 통찰력을 얻었습니다. 이제 [!DNL Real-time Customer Profile] 및 [!DNL Data Science Workspace] 등의 다운스트림 [!DNL Platform] 서비스에서 들어오는 데이터를 사용할 수 있습니다. 자세한 내용은 다음 문서를 참조하십시오.
