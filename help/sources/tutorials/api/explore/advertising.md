...
이 튜토리얼을 따라 광고 시스템을 살펴보고 [!DNL Platform]에 가져오려는 테이블의 경로를 발견했으며 해당 구조에 대한 정보를 얻었습니다. 다음 자습서에서 이 정보를 사용하여 광고 시스템에서 데이터를 수집하고 플랫폼](../collect/advertising.md)으로 가져올 수 있습니다.[
