...
>[!AVAILABILITY]
>
>이제 VA6 데이터 센터에 연결되어 있는 동안 Amazon Web Services(AWS)에서 Adobe Experience Platform을 실행할 때 [!DNL Amazon S3] 및 [!DNL Data Landing Zone] 소스에 대한 변경 데이터 캡처를 사용할 수 있습니다. AWS에서 실행되는 Experience Platform은 현재 제한된 수의 고객이 사용할 수 있습니다. 지원되는 Experience Platform 인프라에 대한 자세한 내용은 [Experience Platform 멀티 클라우드 개요](../../../landing/multi-cloud.md)를 참조하세요.
