...
>[!AVAILABILITY]
>
>* 변경 데이터 캡처는 [!DNL Amazon S3], [!DNL Data Landing Zone], [!DNL Marketo Engage], [!DNL Microsoft Dynamics] 및 [!DNL Salesforce] 소스에 대해 지원됩니다.
>
>* VA6 데이터 센터에서 Amazon Web Services(AWS)의 Adobe Experience Platform을 사용하는 경우 [!DNL Amazon S3] 및 [!DNL Data Landing Zone] 소스에 대한 변경 데이터 캡처를 활성화할 수도 있습니다. AWS의 Experience Platform은 현재 제한된 대상자가 사용할 수 있습니다. 인프라 지원에 대한 자세한 내용은 [Experience Platform 멀티 클라우드 개요](../../../landing/multi-cloud.md)를 참조하십시오.
