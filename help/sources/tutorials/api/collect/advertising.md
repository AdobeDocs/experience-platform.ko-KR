...
title: 흐름 서비스 API를 사용하여 광고 소스에 대한 데이터 흐름 만들기
type: Tutorial
...
# 를 사용하여 광고 소스에 대한 데이터 흐름 만들기 [!DNL Flow Service] API

이 튜토리얼에서는 타사 광고 애플리케이션에서 데이터를 검색하고 소스 커넥터 및 을 통해 Adobe Experience Platform으로 수집하는 단계를 다룹니다. [[!DNL Flow Service]](https://www.adobe.io/experience-platform-apis/references/flow-service/) API.
...
이 자습서에 따라 일정에 따라 광고 시스템에서 데이터를 수집하는 소스 커넥터를 만들었습니다. 이제 다음과 같은 다운스트림 플랫폼 서비스에서 수신 데이터를 사용할 수 있습니다. [!DNL Real-Time Customer Profile] 및 [!DNL Data Science Workspace]. 자세한 내용은 다음 문서를 참조하십시오.
