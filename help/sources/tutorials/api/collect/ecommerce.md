...
이 자습서에서는 타사 **[!UICONTROL eCommerce]** 시스템에서 데이터를 검색하고 소스 커넥터 및 [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/)를 통해 [!DNL Platform]로 수집하는 단계를 설명합니다.
