...
이 자습서에서는 Flow Service API를 사용하여 Experience Platform을 ServiceNow 서버에 연결하는 단계를 단계별로 안내합니다.
...
ServiceNow 연결을 만들려면 ServiceNow 연결 사양이 Flow Service 내에 있어야 합니다. Platform과 ServiceNow를 연결하는 첫 번째 단계는 이러한 사양을 가져오는 것입니다.
