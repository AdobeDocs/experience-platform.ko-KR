---
title: 흐름 서비스 API를 사용하여 Salesforce 서비스 클라우드 Source 연결 만들기
...
기본 연결 ID를 만들려면 [!DNL Salesforce Service Cloud] 인증 자격 증명을 요청 매개 변수의 일부로 제공하는 동안 `/connections` 끝점에 POST 요청을 하십시오.
