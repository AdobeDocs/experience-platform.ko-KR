...
# API를 사용하여 [!DNL Microsoft] SQL Server 커넥터 [!DNL Flow Service] 만들기
...
이 자습서에서는 [!DNL Flow Service] API를 사용하여 [!DNL Experience Platform] [!DNL Microsoft] SQL Server(이하 &quot;SQL Server&quot;라 한다)에 연결하는 단계를 안내합니다.
...
이 자습서에 따라 API를 사용하여 SQL Server 연결을 만들고 연결 고유 ID 값을 [!DNL Flow Service] 얻게 됩니다. 다음 자습서에서는 Flow Service API를 사용하여 데이터베이스 또는 NoSQL 시스템을 [탐색하는 방법을 배울 때 이 연결 ID를 사용할 수 있습니다](../../explore/database-nosql.md).
