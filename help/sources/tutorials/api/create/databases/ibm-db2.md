...
title: Flow Service API를 사용하여 IBM DB2 커넥터를 만듭니다.
topic: overview
type: Tutorial
description: 이 자습서는 Flow Service API를 사용하여 IBM DB2(이하 "DB2"라 한다)를 Experience Platform에 연결하는 단계를 안내합니다.
...
# [!DNL Flow Service] API를 사용하여 IBM DB2 커넥터를 만듭니다.
