...
title: Flow Service API를 사용하여 Couchbase 소스 연결 만들기
...
# [!DNL Flow Service] API를 사용하여 [!DNL Couchbase] 소스 연결 만들기
...
[!DNL Couchbase]을(를) [!DNL Experience Platform]에 연결하는 방법을 알아봅니다.
