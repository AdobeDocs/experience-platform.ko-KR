...
>[!NOTE]
>Azure 테이블 저장소 커넥터가 베타 버전입니다. 기능 및 설명서는 변경될 수 있습니다.
...
이 자습서에서는 Flow Service API를 사용하여 Azure 테이블 저장소(이하 &quot;ATS&quot;라 한다)를 경험 플랫폼에 연결하는 단계를 안내합니다.
...
다음 섹션에서는 Flow Service API를 사용하여 ATS에 성공적으로 연결하기 위해 알아야 하는 추가 정보를 제공합니다.
...
이 튜토리얼을 따라 Flow Service API를 사용하여 ATS 연결을 만들고 연결의 고유 ID 값을 받았습니다. 다음 자습서에서는 Flow Service API를 사용하여 데이터베이스를 [탐색하는 방법을 배울 때 이 ID를 사용할 수 있습니다](../../explore/database-nosql.md).
