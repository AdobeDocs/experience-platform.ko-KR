...
topic: overview
type: Tutorial
description: 이 자습서에서는 흐름 서비스 API를 사용하여 Azure 테이블 저장소(이하 "ATS"라 한다)를 Experience Platform에 연결하는 단계를 안내합니다.
...
# [!DNL Flow Service] API를 사용하여 [!DNL Azure Table Storage] 커넥터를 만듭니다.
