...
이 자습서는 Flow Service API를 사용하여 Experience Platform을 Amazon Redshift(이하 &quot;Redshift&quot;라 한다)에 연결하는 단계를 단계별로 안내합니다.
...
Redshift 연결을 만들려면 Flow Service 내에 Redshift 연결 사양 세트가 있어야 합니다. Platform과 Redshift를 연결하는 첫 번째 단계는 이러한 사양을 가져오는 것입니다.
