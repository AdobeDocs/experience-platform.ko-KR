...
이 자습서에서는 [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/)를 사용하여 [!DNL Azure Synapse Analytics](이하 &quot;[!DNL Synapse]&quot;라 함)에 대한 기본 연결을 만드는 단계를 안내합니다.
