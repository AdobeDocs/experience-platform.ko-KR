...
연결 문자열 가져오기에 대한 자세한 내용은 [이 GreenPlum 문서](https://gpdb.docs.pivotal.io/580/security-guide/topics/Authenticate.html#topic_fzv_wb2_jr__config_ssl_client_conn).
...
이 자습서에 따라 다음을 만들었습니다 [!DNL GreenPlum] 를 사용하여 연결 [!DNL Flow Service] API를 사용하고 연결의 고유 ID 값을 받았습니다. 다음 자습서에서는 다음 ID를 사용하여 방법을 배울 수 있습니다 [흐름 서비스 API를 사용하여 데이터베이스 탐색](../../explore/database-nosql.md).
