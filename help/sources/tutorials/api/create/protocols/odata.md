...
title: Flow Service API를 사용하여 범용 OData 소스 연결 만들기
topic-legacy: overview
type: Tutorial
description: Flow Service API를 사용하여 범용 OData를 Adobe Experience Platform에 연결하는 방법을 알아봅니다.
...
# [!DNL Flow Service] API를 사용하여 [!DNL Generic OData] 소스 연결 만들기
