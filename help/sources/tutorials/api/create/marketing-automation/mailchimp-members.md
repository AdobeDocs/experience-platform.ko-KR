...
>[!TIP]
>
>`{SOURCE_PARAMS}`에 대해 허용되는 형식 유형을 검색하려면 base64에서 전체 `list_id` 문자열을 인코딩해야 합니다. 예를 들어 base64에서 인코딩된 `"list_id": "10c097ca71"`은(는) `eyJsaXN0SWQiOiIxMGMwOTdjYTcxIn0=`과(와) 같습니다.
