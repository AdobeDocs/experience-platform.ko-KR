...
기본 연결 ID를 만들려면 [!DNL Shopify] 인증 자격 증명을 요청 매개 변수의 일부로 제공하는 동안 `/connections` 끝점에 POST 요청을 하십시오.
...
* [ [!DNL Flow Service] API를 사용하여 E-Commerce 데이터를 플랫폼으로 가져오기 위한 데이터 흐름을 만듭니다.](../../collect/ecommerce.md)
