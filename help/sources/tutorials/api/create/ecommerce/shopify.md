...
title: Flow Service API를 사용하여 Shopify 커넥터 만들기
topic: overview
type: Tutorial
description: 이 자습서에서는 Flow Service API를 사용하여 Shopify를 Experience Platform에 연결하는 단계를 안내합니다.
...
# [!DNL Flow Service] API를 사용하여 [!DNL Shopify] 커넥터를 만듭니다.
