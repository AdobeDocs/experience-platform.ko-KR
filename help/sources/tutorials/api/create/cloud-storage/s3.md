...
# Flow Service API를 사용하여 Amazon S3 커넥터 만들기
...
이 자습서에서는 Flow Service API를 사용하여 Experience Platform을 Amazon S3(이하 &quot;S3&quot;) 스토리지에 연결하는 단계를 안내합니다.
...
다음 섹션에서는 Flow Service API를 사용하여 S3 스토리지에 성공적으로 연결하기 위해 알아야 할 추가 정보를 제공합니다.

### 필요한 자격 증명 수집

Flow Service가 S3 저장소에 연결하려면 다음 연결 속성에 대한 값을 제공해야 합니다.
