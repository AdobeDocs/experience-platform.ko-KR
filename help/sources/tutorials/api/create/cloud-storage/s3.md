...
## Azure의 Experience Platform에 [!DNL Amazon S3] 연결 {#azure}

[!DNL Amazon S3] 원본을 Azure의 Experience Platform에 연결하는 방법에 대한 자세한 내용은 아래 단계를 참조하세요.
...
[!DNL Amazon S3] 원본을 AWS의 Experience Platform에 연결하는 방법에 대한 자세한 내용은 아래 단계를 참조하세요.
