...
이 자습서를 따라 API를 사용하여 S3 연결을 만들고 고유한 ID를 응답 본문의 일부로 받았습니다. 이 연결 ID를 Flow Service API](../../explore/cloud-storage.md) 또는 [인제스트는 Flow Service API](../../cloud-storage-parquet.md)을 사용하여 [클라우드 스토리지 탐색에 사용할 수 있습니다.