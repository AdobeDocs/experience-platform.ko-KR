...
>[!NOTE]
>Amazon Kineses 커넥터가 베타에 있습니다. 베타 [레이블이 지정된 커넥터 사용에 대한 자세한 내용은 소스 개요를](../../../../home.md#terms-and-conditions) 참조하십시오.
...
이 자습서에서는 Flow Service API를 사용하여 Experience Platform을 Amazon Kinesis 계정에 연결하는 단계를 안내합니다.
...
| `auth.params.region` | Kinesis 계정의 영역입니다. |
| `connectionSpec.id` | Kinesis 연결 사양 ID: `86043421-563b-46ec-8e6c-e23184711bf6` |
