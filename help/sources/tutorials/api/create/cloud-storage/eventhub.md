...
소스 연결을 만드는 첫 번째 단계는 [!DNL Event Hubs] 소스 및 기본 연결 ID를 생성합니다. 기본 연결 ID를 사용하면 소스 내에서 파일을 탐색 및 탐색하고 해당 데이터 유형 및 형식에 대한 정보를 포함하여 수집할 특정 항목을 식별할 수 있습니다.
...
| `connectionSpec.id` | 에 대한 고정 연결 사양 ID [!DNL Event Hubs]. 이 ID는 입니다. `bf9f5905-92b7-48bf-bf20-455bc6b60a4e`. |
