...
이 자습서에서는 [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/)를 사용하여 [!DNL Azure Event Hubs](이하 &quot;[!DNL Event Hubs]&quot;라 함)을 Experience Platform에 연결하는 단계를 안내합니다.
