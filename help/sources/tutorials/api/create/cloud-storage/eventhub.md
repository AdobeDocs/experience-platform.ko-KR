...
이 튜토리얼에서는 [!DNL Azure Event Hubs] (이하 &quot;라고 한다)[!DNL Event Hubs]&quot;) Experience Platform 대상, 사용 [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
