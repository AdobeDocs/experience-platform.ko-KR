...
>[!IMPORTANT]
>
>[!DNL PayPal] 원본은 2025년 5월 말에 사용되지 않습니다. 또는 [[!DNL Data Landing Zone]](../cloud-storage/data-landing-zone.md) 소스를 사용할 수도 있습니다.
...
기본 연결 ID를 만들려면 [!DNL PayPal] 인증 자격 증명을 요청 매개 변수의 일부로 제공하는 동안 `/connections` 끝점에 POST 요청을 하십시오.
...
* [ [!DNL Flow Service] API를 사용하여 결제 데이터를 플랫폼으로 가져오기 위한 데이터 흐름을 만듭니다.](../../collect/payments.md)
