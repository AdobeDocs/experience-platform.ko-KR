...
| `data.format` | Experience Platform으로 가져올 [!DNL OneTrust Integration] 데이터의 형식입니다. |
...
[!DNL OneTrust Integration]에서 Experience Platform으로 데이터를 가져오는 마지막 단계는 데이터 흐름을 만드는 것입니다. 이제 다음 필수 값이 준비되었습니다.
