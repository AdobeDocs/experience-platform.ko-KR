...
| `auth.params.` | 소스를 인증하는 데 필요한 자격 증명을 포함합니다. API에 연결할 루트 호스트 및 액세스 토큰. |
| `auth.params.host` | Adobe Analytics Mobile Apps 또는 Analytics Premium이 [!DNL OneTrust Integration] 데이터를 가져와야 합니다. |
