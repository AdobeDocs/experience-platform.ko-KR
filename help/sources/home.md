...
다음 소스는 [Adobe Real-Time Customer Data Platform Ultimate](https://helpx.adobe.com/legal/product-descriptions/real-time-customer-data-platform-b2c-edition-prime-and-ultimate-packages.html) 또는 독립 실행형 Advanced Enterprise Source Connectors SKU에 라이선스를 부여한 고객에게만 제공됩니다.
