...
>[!NOTE]
>
>30일 동안 연속적으로 실패하는 Source 수집 데이터 흐름은 자동으로 비활성화됩니다. [모니터링 대시보드](/help/dataflows/ui/monitor-sources.md)를 사용하여 데이터 흐름을 검토하고 실패한 이유(예: 자격 증명, 권한, 스키마 또는 매핑 변경)를 확인하고 필요한 업데이트를 적용한 다음 해결되면 데이터 흐름을 다시 사용하도록 설정하십시오.
...
다음 소스는 [Adobe Real-Time Customer Data Platform Ultimate](https://helpx.adobe.com/kr/legal/product-descriptions/real-time-customer-data-platform-b2c-edition-prime-and-ultimate-packages.html) 또는 독립 실행형 Advanced Enterprise Source Connectors SKU에 라이선스를 부여한 고객에게만 제공됩니다.
...
| [[!DNL Azure Blob Storage]](connectors/cloud-storage/blob.md) | 배치 | Azure |
...
| 소스 | 수집 유형 | 클라우드 |
| --- | --- | --- |
| [[!DNL Didomi]](../sources/connectors/consent-and-preferences/didomi.md) | 스트리밍 | Azure |
...
| [[!DNL Oracle]](connectors/databases/oracle.md) | 배치 | Azure, AWS |
...
다음 소스를 사용하여 충성도 데이터를 Experience Platform으로 수집할 수 있습니다.

| 소스 | 수집 유형 | 클라우드 |
| --- | --- | --- |
| [[!DNL Capillary Streaming Events]](connectors/loyalty/capillary.md) | 스트리밍 | Azure |
| [[!DNL Talon.One]](connectors/loyalty/talon-one.md) | 일괄 처리, 스트리밍 | Azure |
...
| **[!UICONTROL Manage Sources]**&#x200B;일 | **[!UICONTROL View Sources]**&#x200B;에 포함된 함수 외에 **[!UICONTROL Catalog]**&#x200B;의 **[!UICONTROL Connect Source]** 옵션 및 **[!UICONTROL Browse]**&#x200B;의 **[!UICONTROL Select Data]** 옵션에 대한 액세스 권한을 부여합니다. **[!UICONTROL Manage Sources]**&#x200B;을(를) 사용하면 **[!UICONTROL DataFlows]**&#x200B;을(를) 활성화 또는 비활성화하고 일정을 편집할 수도 있습니다. |
