...
Experience Platform은 서드파티 동의 및 환경 설정 관리 플랫폼에서 데이터를 수집하는 기능을 지원합니다. 동의 및 환경 설정 공급자에 대한 지원은 다음과 같습니다 [!DNL OneTrust Integration].

아래 설명서는 연결 방법에 대한 정보를 제공합니다 [!DNL OneTrust Integration] API 또는 사용자 인터페이스를 사용하여 Platform으로

## 연결 [!DNL OneTrust Integration] API를 사용하여 플랫폼으로

- [만들기 [!DNL OneTrust Integration] 흐름 서비스 API를 사용한 소스 연결 및 데이터 흐름](../../tutorials/api/create/consent-and-preferences/onetrust.md)

## 연결 [!DNL OneTrust Integration] UI를 사용하여 플랫폼에 연결
