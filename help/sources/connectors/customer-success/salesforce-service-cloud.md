...
Adobe Experience Platform은 타사 고객 성공 시스템의 데이터 인제스트 지원을 제공합니다. 고객 성공 제공업체를 위한 지원에는 Salesforce Service Cloud가 포함됩니다.

아래 설명서에서는 API 또는 사용자 인터페이스를 사용하여 Salesforce Service Cloud를 플랫폼에 연결하는 방법에 대한 정보를 제공합니다.

## API를 사용하여 Salesforce Service Cloud를 플랫폼에 연결

- [Flow Service API 파섹](../../tutorials/api/create/customer-success/salesforce-service-cloud.md)
...
## UI를 사용하여 Salesforce Service Cloud를 플랫폼에 연결

- [UI에서 Salesforce Service Cloud 소스 커넥터 만들기](../../tutorials/ui/create/customer-success/salesforce-service-cloud.md)
