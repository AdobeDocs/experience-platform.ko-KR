...
# (베타) [!DNL Salesforce Service Cloud] 커넥터
...
[!DNL Experience Platform] 제3자 고객 성공 시스템에서 데이터 인제스트 지원을 제공합니다. 고객 성공 공급자에 대한 지원에는 [!DNL Salesforce Service Cloud]이 포함됩니다.
...
아래 설명서는 API 또는 사용자 인터페이스를 사용하여 [!DNL Salesforce Service Cloud]을 [!DNL Platform]에 연결하는 방법에 대한 정보를 제공합니다.

## API를 사용하여 [!DNL Salesforce Service Cloud ]을 [!DNL Platform]에 연결

- [Flow Service API를 사용하여 Salesforce 서비스 클라우드 소스 연결 만들기](../../tutorials/api/create/customer-success/salesforce-service-cloud.md)
...
## UI를 사용하여 [!DNL Salesforce Service Cloud]을 [!DNL Platform]에 연결

- [UI에서 Salesforce 서비스 클라우드 소스 연결 만들기](../../tutorials/ui/create/customer-success/salesforce-service-cloud.md)
