...
description: API 또는 사용자 인터페이스를 사용하여 Salesforce Service Cloud를 Adobe Experience Platform에 연결하는 방법에 대해 알아봅니다.
...
[!DNL Experience Platform]은(는) 서드파티 고객 성공 시스템에서 데이터를 수집하는 데 대한 지원을 제공합니다. 고객 성공 공급자에 대한 지원은 [!DNL Salesforce Service Cloud]입니다.
...
아래 설명서는 API 또는 사용자 인터페이스를 사용하여 [!DNL Salesforce Service Cloud]을(를) [!DNL Platform]에 연결하는 방법에 대한 정보를 제공합니다.

## API를 사용하여 [!DNL Salesforce Service Cloud]을(를) [!DNL Platform]에 연결

- [흐름 서비스 API를 사용하여 Salesforce 서비스 클라우드 기본 연결 만들기](../../tutorials/api/create/customer-success/salesforce-service-cloud.md)
...
## UI를 사용하여 [!DNL Salesforce Service Cloud]을(를) [!DNL Platform]에 연결
