...
title: ServiceNow Source Connector 개요
...
[!DNL Experience Platform] 는 서드파티 고객 성공 시스템에서 데이터 수집을 지원합니다. 고객 성공 공급업체에 대한 지원은 다음과 같습니다 [!DNL ServiceNow].
...
아래 설명서는 연결 방법에 대한 정보를 제공합니다 [!DNL ServiceNow] 끝 [!DNL Platform] api 또는 사용자 인터페이스 사용:

## 연결 [!DNL ServiceNow] 끝 [!DNL Platform] api 사용
...
## 연결 [!DNL ServiceNow] 끝 [!DNL Platform] UI 사용
