...
[!DNL Experience Platform] 에서는 타사 고객 성공 시스템에서 데이터 섭취를 지원합니다. 고객 성공 공급자를 지원하는 기능에는 다음이 포함됩니다 [!DNL ServiceNow].
...
아래 설명서에서는 연결 방법에 대한 정보를 제공합니다 [!DNL ServiceNow] to [!DNL Platform] api 또는 사용자 인터페이스 사용:

## Connect [!DNL ServiceNow] to [!DNL Platform] api 사용
...
## Connect [!DNL ServiceNow] to [!DNL Platform] ui 사용
