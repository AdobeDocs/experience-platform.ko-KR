...
Adobe Experience Platform은 타사 고객 성공 시스템의 데이터 인제스트 지원을 제공합니다. 고객 성공 제공업체를 위한 지원에는 ServiceNow가 포함됩니다.

아래 설명서에서는 API 또는 사용자 인터페이스를 사용하여 ServiceNow를 플랫폼에 연결하는 방법에 대한 정보를 제공합니다.

## API를 사용하여 ServiceNow를 플랫폼에 연결

- [Flow Service API 파섹](../../tutorials/api/create/customer-success/servicenow.md)
