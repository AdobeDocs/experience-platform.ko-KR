...
[!DNL Experience Platform] 제3자 고객 성공 시스템에서 데이터 인제스트 지원을 제공합니다. 고객 성공 공급자에 대한 지원에는 [!DNL ServiceNow]이 포함됩니다.
...
아래 설명서는 API 또는 사용자 인터페이스를 사용하여 [!DNL ServiceNow]을 [!DNL Platform]에 연결하는 방법에 대한 정보를 제공합니다.
