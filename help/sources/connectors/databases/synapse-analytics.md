---
keywords: Experience Platform;홈;인기 항목;Azure synapse 분석;azure synapse 분석;시냅스;시냅스
solution: Experience Platform
title: Azure synapse Analytics 소스 커넥터 개요
...
# [!DNL Azure Synapse Analytics] 커넥터
...
[!DNL Experience Platform] 는 타사 데이터베이스에서 데이터를 수집하는 기능을 지원합니다. [!DNL Platform] 관계형, NoSQL 또는 데이터 웨어하우스와 같은 다양한 유형의 데이터베이스에 연결할 수 있습니다. 데이터베이스 공급자에 대한 지원은 다음과 같습니다 [!DNL Azure Synapse Analytics].
...
아래 설명서는 연결 방법에 대한 정보를 제공합니다 [!DNL Azure Synapse Analytics] 끝 [!DNL Platform] api 또는 사용자 인터페이스 사용:

## 연결 [!DNL Azure Synapse Analytics] 끝 [!DNL Platform] api 사용

- [흐름 서비스 API를 사용하여 Azure synapse Analytics 기본 연결 만들기](../../tutorials/api/create/databases/synapse-analytics.md)
...
## 연결 [!DNL Azure Synapse Analytics] 끝 [!DNL Platform] UI 사용
