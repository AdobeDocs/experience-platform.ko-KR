---
keywords: Experience Platform;홈;인기 항목;그린플럼;GreenPlum
...
아래 설명서는 API 또는 사용자 인터페이스를 사용하여 [!DNL GreenPlum]을 [!DNL Platform]에 연결하는 방법에 대한 정보를 제공합니다.

## API를 사용하여 [!DNL GreenPlum]을 [!DNL Platform]에 연결

- [Flow Service API를 사용하여 GreenPlum 소스 연결 만들기](../../tutorials/api/create/databases/greenplum.md)
