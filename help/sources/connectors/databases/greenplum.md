...
관계형, NoSQL 또는 data warehouse을 비롯한 다양한 유형의 타사 데이터베이스가 지원됩니다. 데이터베이스 제공업체를 위한 지원에는 GreenPlum이 포함됩니다.

아래 설명서에서는 API 또는 사용자 인터페이스를 사용하여 GreenPlum을 Platform에 연결하는 방법에 대한 정보를 제공합니다.

## API를 사용하여 GreenPlum을 Platform에 연결
...
## UI를 사용하여 GreenPlum을 Platform에 연결
