...
아래 설명서에서는 IBM DB2를 [!DNL Platform] api 또는 사용자 인터페이스 사용:

## IBM DB2에 연결 [!DNL Platform] api 사용

- [Flow Service API를 사용하여 IBM DB2 기본 연결을 만듭니다](../../tutorials/api/create/databases/ibm-db2.md)
...
## IBM DB2에 연결 [!DNL Platform] ui 사용
