...
경험 플랫폼은 타사 데이터베이스의 데이터 인제스트를 지원합니다. 플랫폼은 관계형, NoSQL 또는 데이터 웨어하우스와 같은 다양한 유형의 데이터베이스에 연결할 수 있습니다. 데이터베이스 공급자에 대한 지원에는 Azure HDInsights의 Apache Hive가 포함되어 있습니다.
...
## Azure HDInsights의 Apache 하이브를 UI를 사용하여 플랫폼에 연결
