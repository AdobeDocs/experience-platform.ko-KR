---
keywords: Experience Platform;홈;자주 찾는 항목;Azure Data Explorer;azure 데이터 탐색기
...
## API를 사용하여 [!DNL Azure Data Explorer]을(를) [!DNL Experience Platform]에 연결
...
## UI를 사용하여 [!DNL Azure Data Explorer]을(를) [!DNL Experience Platform]에 연결
