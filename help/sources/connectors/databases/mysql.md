...
title: MySQL 커넥터
topic: overview
description: 아래 설명서에서는 API 또는 사용자 인터페이스를 사용하여 MySQL을 플랫폼에 연결하는 방법에 대한 정보를 제공합니다.
...
아래 설명서에서는 MySQL을 API나 사용자 인터페이스 [!DNL Platform] 를 사용하는 방법에 대한 정보를 제공합니다.

## MySQL을 API [!DNL Platform] 사용에 연결

- [Flow Service API를 사용하여 MySQL 커넥터 만들기](../../tutorials/api/create/databases/mysql.md)
...
## MySQL을 UI [!DNL Platform] 사용에 연결

- [UI에서 MySQL 소스 커넥터 만들기](../../tutorials/ui/create/databases/mysql.md)
