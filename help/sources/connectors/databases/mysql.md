...
아래 설명서에서는 MySQL을 [!DNL Platform] api 또는 사용자 인터페이스 사용:

## MySQL에 연결 [!DNL Platform] api 사용

- [Flow Service API를 사용하여 MySQL 기본 연결 만들기](../../tutorials/api/create/databases/mysql.md)
