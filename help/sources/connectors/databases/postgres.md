...
topic: overview
description: 아래 설명서에서는 API 또는 사용자 인터페이스를 사용하여 PostgreSQL을 플랫폼에 연결하는 방법에 대한 정보를 제공합니다.
...
아래 설명서에서는 API 또는 사용자 인터페이스 [!DNL PostgreSQL] 를 [!DNL Platform] 사용하여 연결하는 방법에 대해 설명합니다.

## API [!DNL PostgreSQL] 를 [!DNL Platform] 사용하는 데 연결
...
## UI [!DNL PostgreSQL] 를 [!DNL Platform] 사용하는 데 연결
