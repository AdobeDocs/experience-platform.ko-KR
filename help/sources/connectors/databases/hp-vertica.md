...
관계형, NoSQL 또는 데이터 웨어하우스를 비롯한 다양한 유형의 타사 데이터베이스가 지원됩니다. 데이터베이스 공급자에 대한 지원은 다음과 같습니다 [!DNL HP Vertica].
...
아래 설명서는 연결 방법에 대한 정보를 제공합니다 [!DNL HP Vertica] 끝 [!DNL Platform] api 또는 사용자 인터페이스 사용:

## 연결 [!DNL HP Vertica] 끝 [!DNL Platform] api 사용
...
## 연결 [!DNL HP Vertica] 끝 [!DNL Platform] UI 사용
