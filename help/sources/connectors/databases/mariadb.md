...
Experience Platform은 타사 데이터베이스에서 데이터를 수집하는 기능을 지원합니다. [!DNL Platform] 관계형, NoSQL 또는 데이터 웨어하우스와 같은 다양한 유형의 데이터베이스에 연결할 수 있습니다. 데이터베이스 공급자에 대한 지원은 다음과 같습니다 [!DNL MariaDB].
...
아래 설명서는 연결 방법에 대한 정보를 제공합니다 [!DNL MariaDB] 끝 [!DNL Platform] api 또는 사용자 인터페이스 사용:

## 연결 [!DNL MariaDB] 끝 [!DNL Platform] api 사용
...
## 연결 [!DNL MariaDB] 끝 [!DNL Platform] UI 사용
