...
[!DNL Experience Platform] 에서는 타사 데이터베이스에서 데이터를 수집하기 위한 지원을 제공합니다. [!DNL Platform] 관계형, NoSQL 또는 데이터 웨어하우스와 같은 다양한 유형의 데이터베이스에 연결할 수 있습니다. 데이터베이스 공급자에 대한 지원은 다음과 같습니다 [!DNL Phoenix].
...
아래 설명서에서는 연결 방법에 대한 정보를 제공합니다 [!DNL Phoenix] to [!DNL Platform] api 또는 사용자 인터페이스 사용:

## Connect [!DNL Phoenix] to [!DNL Platform] api 사용

- [Flow Service API를 사용하여 Phoenix 기본 연결을 만듭니다](../../tutorials/api/create/databases/phoenix.md)
...
## Connect [!DNL Phoenix] to [!DNL Platform] ui 사용
