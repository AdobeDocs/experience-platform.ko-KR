...
[!DNL Experience Platform] 타사 데이터베이스의 데이터 인제스트 지원을 제공합니다. [!DNL Platform] 관계형, NoSQL 또는 데이터 웨어하우스와 같은 다양한 유형의 데이터베이스에 연결할 수 있습니다. 데이터베이스 공급자에 대한 지원에는 [!DNL Amazon Redshift]이 포함됩니다.
...
아래 설명서는 API 또는 사용자 인터페이스를 사용하여 [!DNL Amazon Redshift]을 [!DNL Platform]에 연결하는 방법에 대한 정보를 제공합니다.

## API를 사용하여 [!DNL Amazon Redshift]을 [!DNL Platform]에 연결

- [Flow Service API를 사용하여 Amazon Redshift 소스 연결 만들기](../../tutorials/api/create/databases/redshift.md)
