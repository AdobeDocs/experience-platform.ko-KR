...
[!DNL Experience Platform] 는 타사 프로토콜 응용 프로그램에서 데이터를 수집하도록 지원합니다. 프로토콜 공급자에 대한 지원은 다음과 같습니다 [!DNL Generic OData].
...
아래 설명서는 연결 방법에 대한 정보를 제공합니다 [!DNL Generic OData] 끝 [!DNL Platform] api 또는 사용자 인터페이스 사용:

## 연결 [!DNL Generic OData] 끝 [!DNL Platform] api 사용
...
## 연결 [!DNL Generic OData] 끝 [!DNL Platform] UI 사용
