...
title: 범용 OData 커넥터
topic: overview
description: 아래 설명서에서는 API 또는 사용자 인터페이스를 사용하여 범용 OData를 플랫폼에 연결하는 방법에 대한 정보를 제공합니다.
...
[!DNL Experience Platform] 에서는 타사 프로토콜 응용 프로그램에서 데이터 인제스트를 지원합니다. 프로토콜 제공업체를 지원합니다 [!DNL Generic OData].
...
아래 설명서에서는 API 또는 사용자 인터페이스 [!DNL Generic OData] 를 [!DNL Platform] 사용하여 연결하는 방법에 대해 설명합니다.

## API [!DNL Generic OData] 를 [!DNL Platform] 사용하는 데 연결
...
## UI [!DNL Generic OData] 를 [!DNL Platform] 사용하는 데 연결
