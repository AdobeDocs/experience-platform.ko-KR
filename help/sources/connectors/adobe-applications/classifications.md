...
description: 사용자 인터페이스를 사용하여 Analytics 분류를 Experience Platform에 연결하는 방법을 알아봅니다
...
아래 설명서는 사용자 인터페이스를 사용하여 Analytics 분류를 Experience Platform에 연결하는 방법에 대한 정보를 제공합니다.

## UI를 사용하여 Analytics 분류를 Experience Platform에 연결
