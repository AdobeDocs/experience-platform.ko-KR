...
| `post_latitude` | `placeContext.geo._schema.latitude` | 번호 |   |
| `post_longitude` | `placeContext.geo._schema.longitude` | 번호 |   |
...
| `geo_latitude` | `placeContext.geo._schema.latitude` | 번호 |  |
| `geo_longitude` | `placeContext.geo._schema.longitude` | 번호 |  |
