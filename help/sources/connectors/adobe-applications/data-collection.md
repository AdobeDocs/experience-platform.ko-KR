...
Adobe Experience Platform 데이터 수집의 소스 통합을 사용하면 소스 카탈로그를 통해 데이터 수집에 대한 데이터 준비와 경고에 대한 향상된 지원을 포함하여 Edge Network에 있는 데이터에 액세스할 수 있습니다.
...
[!UICONTROL Adobe applications] 범주 아래에서 **[!UICONTROL Adobe Data Collection]**&#x200B;을(를) 선택한 다음 **[!UICONTROL Set up]**&#x200B;을(를) 선택합니다.

![데이터 수집](./images/data-collection/catalog.png)

데이터 수집 UI가 **[!UICONTROL Datastreams]** 탭에 나타납니다.
...
UI에서 데이터 수집을 구성하는 방법에 대한 포괄적인 단계는 [웹 SDK 태그 확장 시작하기](/help/tags/extensions/client/web-sdk/getting-started.md)를 참조하십시오.

## 다음 단계

이 문서를 읽고 소스 작업 영역을 사용하여 데이터 수집 UI에 액세스하는 방법에 대해 알아보았습니다. 데이터 수집에 대한 자세한 내용은 [데이터 수집 개요](/help/collection/home.md)를 참조하십시오.
