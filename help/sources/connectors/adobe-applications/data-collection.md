...
[!UICONTROL Adobe 응용 프로그램] 범주에서 **[!UICONTROL Adobe 데이터 수집]**&#x200B;을 선택한 다음 **[!UICONTROL 설정]**&#x200B;을 선택합니다.

![데이터 수집](./images/data-collection/catalog.png)

데이터 수집 UI가 **[!UICONTROL 데이터스트림]** 탭에 나타납니다.
...
UI에서 데이터 수집을 구성하는 방법에 대한 포괄적인 단계는 [데이터 수집 전체 개요](../../../collection/e2e.md)를 참조하십시오.

## 다음 단계

이 문서를 읽고 소스 작업 영역을 사용하여 데이터 수집 UI에 액세스하는 방법에 대해 알아보았습니다. 데이터 수집에 대한 자세한 내용은 [데이터 수집 개요](../../../collection/e2e.md)를 참조하십시오.
