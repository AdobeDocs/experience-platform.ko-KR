...
Experience Platform은 고객 속성 프로필 데이터를 Adobe Experience Platform으로 인제스트하는 지원을 제공합니다.

아래 설명서에서는 API 또는 사용자 인터페이스를 사용하여 고객 속성을 Platform에 연결하는 방법에 대한 정보를 제공합니다.

## UI를 사용하여 고객 속성을 Platform에 연결
