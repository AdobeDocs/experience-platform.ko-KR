...
`CORE`데이터 수집의 ID[, &#x200B;](/help/collection/identity/overview.md)Mobile SDK[&#x200B; 또는 &#x200B;](https://developer.adobe.com/client-sdks/documentation/mobile-core/identity/)Experience Cloud ID 서비스 API[를 사용하여 방문자에 대한 Experience Cloud ID를 설정하여 &#x200B;](https://experienceleague.adobe.com/docs/id-service/using/intro/overview.html?lang=ko-KR) 네임스페이스를 설정할 수 있습니다.
