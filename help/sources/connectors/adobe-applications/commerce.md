...
* [설치 [!DNL Data Connection] 확장](https://experienceleague.adobe.com/docs/commerce-merchant-services/data-connection/fundamentals/install.html) Adobe Commerce용 에서 커넥터 확장을 다운로드할 수 있습니다. [Adobe 마켓플레이스](https://commercemarketplace.adobe.com/magento-experience-platform-connector.html).
...
* 다음으로, Commerce별 필드 그룹으로 XDM(Experience Data Model) 스키마를 만들거나 업데이트합니다. XDM 스키마에 상거래 특정 필드 그룹을 추가하는 방법에 대한 자세한 단계는 의 안내서를 참조하십시오 [xdm 스키마에 필드 그룹 추가](https://experienceleague.adobe.com/docs/commerce-merchant-services/data-connection/fundamentals/update-xdm.html).
...
* 그런 다음 데이터 스트림을 만들고 Commerce 관련 필드 그룹이 포함된 XDM 스키마를 선택합니다. 데이터스트림에 대한 자세한 내용은 [데이터스트림 개요](https://experienceleague.adobe.com/docs/experience-platform/datastreams/overview.html).
...
* 앞에서 설명한 모든 구성이 완료되면 이제 Commerce Services 커넥터와 을 모두 구성하여 Experience Platform에 연결할 수 있습니다 [!DNL Data Connection] 확장을 사용할 때 [!DNL Commerce Admin]. 이 마지막 단계에 대한 자세한 내용은 의 안내서를 참조하십시오 [Experience Platform에 상거래 데이터 연결](https://experienceleague.adobe.com/docs/commerce-merchant-services/data-connection/fundamentals/connect-data.html).
