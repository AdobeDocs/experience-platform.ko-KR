...
title: Amazon S3 커넥터
topic: overview
description: 아래 설명서는 API 또는 사용자 인터페이스를 사용하여 S3를 플랫폼에 연결하는 방법에 대한 정보를 제공합니다.
...
아래 설명서는 API 또는 사용자 인터페이스를 사용하여 S3를 플랫폼에 연결하는 방법에 대한 정보를 제공합니다.
...
- [UI에서 Amazon S3 소스 커넥터 만들기](../../tutorials/ui/create/cloud-storage/s3.md)
