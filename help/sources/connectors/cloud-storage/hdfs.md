...
Adobe Experience Platform은 AWS, [!DNL Google Cloud Platform], 및 [!DNL Azure]를 사용하면 이러한 시스템에서 데이터를 가져올 수 있습니다. 수집된 데이터는 JSON, Parquet 또는 구분된 형식으로 지정할 수 있습니다. 클라우드 스토리지 공급자에 대한 지원은 다음과 같습니다 [!DNL Apache] HDFS.
...
## 연결 [!DNL Apache] HDFS 대상 [!DNL Platform]

아래 설명서는 연결 방법에 대한 정보를 제공합니다 [!DNL Apache] HDFS 대상 [!DNL Platform] api 또는 사용자 인터페이스 사용:

### API 사용

- [흐름 서비스 API를 사용하여 HDFS 기본 연결 만들기](../../tutorials/api/create/cloud-storage/hdfs.md)
