...
title: SFTP 커넥터
topic: overview
description: 아래 설명서에서는 API 또는 사용자 인터페이스를 사용하여 SFTP 서버를 플랫폼에 연결하는 방법에 대한 정보를 제공합니다.
...
아래 설명서에서는 API 또는 사용자 인터페이스를 사용하여 SFTP 서버를 연결하는 방법에 대한 정보를 [!DNL Platform] 제공합니다.

### API 사용

- [Flow Service API를 사용하여 SFTP 커넥터 만들기](../../tutorials/api/create/cloud-storage/sftp.md)
...
- [UI에서 SFTP 소스 커넥터 만들기](../../tutorials/ui/create/cloud-storage/sftp.md)
