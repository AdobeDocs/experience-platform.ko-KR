...
>[!IMPORTANT]
>
>연결하기 전에 SFTP 서버 구성에서 키보드 대화형 인증을 비활성화해야 합니다. 설정을 비활성화하면 서비스나 프로그램을 통한 입력과 대조적으로 수동으로 암호를 입력할 수 있습니다. 키보드 대화형 인증에 대한 자세한 내용은 [Component Pro 문서](https://doc.componentpro.com/ComponentPro-Sftp/authenticating-with-a-keyboard-interactive-authentication)를 참조하십시오.

아래 설명서에서는 API 또는 사용자 인터페이스를 사용하여 SFTP 서버를 [!DNL Platform]에 연결하는 방법에 대해 설명합니다.
