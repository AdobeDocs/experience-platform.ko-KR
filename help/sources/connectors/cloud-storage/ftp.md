...
>[!IMPORTANT]
>
>FTP 소스 커넥터를 사용하여 데이터 흐름을 만들 때 FTP 서버 내에서 발생하는 증분 업데이트 문제가 지속되는 경우 일회성 수집 일정을 설정하는 것이 좋습니다.
...
아래 설명서에서는 API 또는 사용자 인터페이스를 사용하여 FTP 서버를 연결하는 방법에 대한 정보를 [!DNL Platform] 제공합니다.
