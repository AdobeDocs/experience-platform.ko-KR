...
topic: overview
description: 아래 설명서는 API 또는 사용자 인터페이스를 사용하여 Azure Data Lake Storage Gen2를 플랫폼에 연결하는 방법에 대한 정보를 제공합니다.
...
- [UI에 ADLS-Gen2 소스 커넥터 만들기](../../tutorials/ui/create/cloud-storage/adls-gen2.md)
