...
아래 설명서는 API 또는 사용자 인터페이스를 사용하여 [!DNL Shopify]을(를) [!DNL Experience Platform]에 연결하는 방법에 대한 정보를 제공합니다.

## API를 사용하여 [!DNL Shopify]을(를) [!DNL Experience Platform]에 연결
...
## UI를 사용하여 [!DNL Shopify]을(를) [!DNL Experience Platform]에 연결
