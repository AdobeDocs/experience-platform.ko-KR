...
경험 플랫폼은 서드파티 결제 애플리케이션에서 데이터를 인제스트할 수 있도록 지원합니다. 결제 제공업체를 위한 지원에는 PayPal이 포함되어 있습니다.

아래 설명서에서는 API 또는 사용자 인터페이스를 사용하여 PayPal을 플랫폼에 연결하는 방법에 대한 정보를 제공합니다.

## API를 사용하여 PayPal을 플랫폼에 연결
