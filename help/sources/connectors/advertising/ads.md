---
keywords: Experience Platform;홈;인기 항목;Google 광고;google 광고
...
>[!NOTE]
>
>다음 [!DNL Google Ads] 소스는 베타 버전입니다. 다음을 참조하십시오. [소스 개요](../../home.md#terms-and-conditions) beta 레이블이 지정된 커넥터 사용에 대한 자세한 정보를 제공합니다.
...
[!DNL Experience Platform] 는 서드파티 광고 시스템에서 데이터 수집을 지원합니다. 광고 공급자에 대한 지원은 다음과 같습니다 [!DNL Google Ads].
...
## 연결 [!DNL Google Ads] 대상 플랫폼

아래 설명서는 연결 방법에 대한 정보를 제공합니다 [!DNL Google Ads] API 또는 사용자 인터페이스를 사용하여 Platform으로
