---
keywords: Experience Platform;홈;인기 항목;Google 애드워즈;google 애드워즈
...
[!DNL Experience Platform] 에서는 타사 광고 시스템에서 데이터 섭취를 지원합니다. 광고 공급자에 대한 지원에는 [!DNL Google AdWords]이 포함됩니다.
...
## 플랫폼에 [!DNL Google AdWords] 연결

아래 설명서는 API 또는 사용자 인터페이스를 사용하여 [!DNL Google AdWords]을 Platform에 연결하는 방법에 대한 정보를 제공합니다.
