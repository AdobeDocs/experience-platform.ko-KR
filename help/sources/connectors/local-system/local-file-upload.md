...
Adobe Experience Platform을 사용하면 외부 소스 및 로컬 시스템에서 데이터를 수집할 수 있으며 [!DNL Platform] 서비스를 사용하여 들어오는 데이터를 구조화하고 레이블을 지정하고 향상시킬 수 있습니다. Adobe 애플리케이션, 클라우드 기반 스토리지, 데이터베이스 및 기타 여러 소스와 같은 다양한 소스에서 데이터를 수집할 수 있습니다.
...
## UI를 사용하여 로컬 파일 업로드 [!DNL Platform]에 연결
