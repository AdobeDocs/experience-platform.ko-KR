...
[!DNL Experience Platform ]에서는 타사 마케팅 자동화 시스템에서 데이터 섭취를 지원합니다. 마케팅 자동화 공급자에 대한 지원에는 다음과 같습니다 [!DNL HubSpot].
...
아래 설명서에서는 연결 방법에 대한 정보를 제공합니다 [!DNL HubSpot] to [!DNL Platform] api 또는 사용자 인터페이스 사용:

## Connect [!DNL HubSpot] to [!DNL Platform] api 사용
...
## Connect [!DNL HubSpot] to [!DNL Platform] ui 사용
