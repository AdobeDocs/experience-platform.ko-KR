...
경험 플랫폼은 타사 CRM 시스템의 데이터 인제스트를 지원합니다. CRM 공급자에 대한 지원에는 Salesforce가 포함됩니다.

아래 설명서에서는 API 또는 사용자 인터페이스를 사용하여 Salesforce를 플랫폼에 연결하는 방법에 대한 정보를 제공합니다.

## API를 사용하여 Salesforce와 플랫폼 연결
