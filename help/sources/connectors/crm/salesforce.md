...
[!DNL Experience Platform] 제3자 CRM 시스템의 데이터 인제스트 지원을 제공합니다. CRM 공급자에 대한 지원에는 [!DNL Salesforce]이 포함됩니다.
...
아래 설명서는 API 또는 사용자 인터페이스를 사용하여 [!DNL Salesforce]을 [!DNL Platform]에 연결하는 방법에 대한 정보를 제공합니다.

## API를 사용하여 [!DNL Salesforce]을 [!DNL Platform]에 연결

- [Flow Service API를 사용하여 Salesforce 소스 연결 만들기](../../tutorials/api/create/crm/salesforce.md)
...
## UI를 사용하여 [!DNL Salesforce]을 [!DNL Platform]에 연결
