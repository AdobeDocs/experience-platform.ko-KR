...
topic: overview
description: Experience Platform은 타사 CRM 시스템의 데이터 인제스트를 지원합니다. CRM 공급자에 대한 지원에는 Salesforce가 포함됩니다.
...
[!DNL Experience Platform] 타사 CRM 시스템의 데이터 인제스트 지원을 제공합니다. CRM 공급자에 대한 지원에는 다음이 포함됩니다 [!DNL Salesforce].
...
아래 설명서에서는 API 또는 사용자 인터페이스 [!DNL Salesforce] 를 [!DNL Platform] 사용하여 연결하는 방법에 대해 설명합니다.

## API [!DNL Salesforce] 를 [!DNL Platform] 사용하는 데 연결

- [Flow Service API를 사용하여 Salesforce 커넥터 만들기](../../tutorials/api/create/crm/salesforce.md)
...
## UI [!DNL Salesforce] 를 [!DNL Platform] 사용하는 데 연결

- [UI에서 Salesforce 소스 커넥터 만들기](../../tutorials/ui/create/crm/salesforce.md)
