...
title: 셀프서비스 소스에 대한 사양 탐색 구성(일괄 SDK)
...
탐색 사양이 채워지면 [!DNL Flow Service] API를 사용하여 전체 연결 사양을 만들 수 있습니다. 자세한 내용은 [셀프 서비스 소스(일괄 SDK) API 안내서](../api/api-overview.md)를 참조하십시오.
