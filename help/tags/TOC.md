...
* 게시 {#publish}
   ...
   * 환경 {#environments}
      ...
      * [Adobe Experience Platform Debugger를 사용하여 포함 코드 테스트](./ui/publishing/embed-code-testing.md)
...
* 이벤트 전달 {#event-forwarding}
   ...
   * [모니터링(베타)](./ui/event-forwarding/monitoring.md)
* 관리 {#admin}
   ...
   * [권한 관리](./ui/administration/manage-permissions.md)
* 확장 {#extensions}
...
* 확장 개발 {#extension-dev}
   ...
   * 제출 프로세스 {#submit}
      ...
      * [회사 설정](./extension-dev/submit/setup.md)
...
* Reactor API {#api}
   ...
   * 엔드포인트 {#endpoints}
      ...
      * [감사 이벤트](./api/endpoints/audit-events.md)
   ...
   * 안내서 {#guides}
      ...
      * [응답 페이지 매김](./api/guides/pagination.md)
