...
회사 페이지로 이동한 다음 를 선택합니다 **[!UICONTROL 속성 추가]**&#x200B;또는 목록에서 기존 속성을 선택하고 를 선택합니다 **[!UICONTROL 구성]**.
...
1. (고급) **[!UICONTROL 누락된 데이터 요소에 대해 빈 문자열 반환:]** 라이브러리 내에 존재하지 않는 데이터 요소를 참조하는 경우 일반적으로 반환됩니다 `undefined`.  해당 시나리오가 빈 문자열을 대신 반환하려면 이 확인란을 선택하십시오.
