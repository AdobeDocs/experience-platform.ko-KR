...
확장을 선택한 다음 [!UICONTROL Configure]를 선택하여 확장에 대한 설정을 보고 변경합니다. 자세한 내용은 [새 확장 추가](#add-a-new-extension)에 대한 섹션을 참조하십시오.

>[!IMPORTANT]
>
>변경 사항은 [게시](../../publishing/overview.md)될 때까지 적용되지 않습니다.

기본적으로 Adobe은 일반적인 통합을 지원하는 확장을 제공합니다. 확장은 사용자 지정 구성으로 수정할 수 있습니다. 구성은 확장을 통해 제공됩니다. 구성을 만들려면 확장 카드를 선택한 다음 **[!UICONTROL Add New Configuration]**&#x200B;을 선택합니다.
...
설치된 모든 확장을 보려면 **[!UICONTROL Extensions]**&#x200B;를 선택합니다. 또한 카탈로그를 사용하여 사용 가능한 모든 확장 목록과 업데이트를 사용할 수 있는 확장을 확인할 수 있습니다.

Adobe 소유 확장에 대한 자세한 내용은 [확장 참조](../../../extensions/client/overview.md)를 참조하십시오.
...
1. 속성의 개요 페이지에서 **[!UICONTROL Extensions]** 탭을 엽니다.
1. 확장을 선택합니다.
...
설치된 확장을 마우스로 가리키고 **[!UICONTROL Configure]**&#x200B;를 선택합니다.

>[!NOTE]
>
>일부 확장은 구성이 필요 없으며, 구성 옵션을 제공하지 않습니다.

구성 가능한 각 확장에는 고유한 옵션이 있습니다. 각 Adobe 확장에서 사용할 수 있는 옵션에 대한 자세한 내용은 [확장 참조](../../../extensions/client/overview.md)를 참조하십시오.
