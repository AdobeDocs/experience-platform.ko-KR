...
* [**Experience Cloud JavaScript의 비동기 배포**](asynchronous-deployment.md)
  ...
  제품에 필요한 JavaScript 라이브러리의 성능과 비차단 배포는 Adobe Experience Cloud 사용자에게 점점 더 중요해지고 있습니다. [[!DNL Google PageSpeed]](https://developers.google.com/speed/pagespeed/insights/)과(와) 같은 도구는 사용자가 사이트에서 [!DNL Adobe] 라이브러리를 배포하는 방식을 변경할 것을 권장합니다. 이 문서에서는 비동기 방식으로 Adobe JavaScript 라이브러리를 사용하는 방법을 설명합니다.
