...
* **호스트: Adobe에서 관리, 보관: 해제:** Adobe 호스트에서 관리를 사용 중이며 라이브러리를 보관하지 않는 경우 이러한 이전 라이브러리를 다시 게시할 수 있습니다.

* **호스트: Adobe에서 관리, 보관: 켬:** Adobe 호스트에서 관리를 사용 중이며 라이브러리를 보관하는 경우 이러한 이전 라이브러리를 다운로드할 수 있습니다.
