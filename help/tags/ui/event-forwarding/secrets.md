...
>title="비밀을 위한 환경"
>abstract="이벤트 전달에서 암호를 사용하려면 기존 환경에 암호를 지정해야 합니다. 이벤트 전달 속성에 대해 환경을 만들지 않은 경우 계속하기 전에 환경을 구성해야 합니다."
...
다음 화면에서는 비밀의 세부 사항을 구성할 수 있습니다. 이벤트 전달에서 암호를 사용하려면 기존 환경에 암호를 지정해야 합니다. 이벤트 전달 속성에 대해 환경을 만들지 않은 경우에서 안내서를 참조하십시오. [환경](../publishing/environments.md) 계속하기 전에 구성 방법에 대한 지침을 참조하십시오.
