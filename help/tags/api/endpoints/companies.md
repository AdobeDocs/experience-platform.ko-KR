...
회사는 고객 조직(일반적으로 비즈니스)을 나타냅니다. Reactor API에서 이러한 회사는 1:1을 IMS 조직 ID와 일치시킵니다. API 사용자는 액세스 권한이 있는 회사에 대한 가시성만 갖습니다. 한 회사에 여러 항목이 있을 수 있습니다. [속성](./properties.md). 속성은 정확히 하나의 회사에 속합니다.
