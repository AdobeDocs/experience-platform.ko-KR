...
회사는 고객 조직(일반적으로 비즈니스)을 나타냅니다. Reactor API에서 이러한 회사는 IMS 조직 ID와 1:1을 일치시킵니다. API 사용자는 액세스 권한이 있는 회사만 볼 수 있습니다. 한 회사에 많은 것이 있을 수 있습니다 [속성](./properties.md). 재산은 정확히 하나의 회사에 속합니다.
