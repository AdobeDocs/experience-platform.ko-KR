...
| 키 유형 | 설명 | 예 |
| --- | --- | --- |
| [!DNL Braze] 인스턴스 | 와 연결된 REST 엔드포인트 [!DNL Braze] 계정입니다. 다음을 참조하십시오. [!DNL Braze] 설명서 [인스턴스](https://www.braze.com/docs/user_guide/administrative/access_braze/braze_instances) 지침을 참조하십시오. | `https://rest.iad-03.braze.com` |
