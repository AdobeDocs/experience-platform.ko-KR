...
다음 비디오는 다음에 대한 이해를 돕기 위한 것입니다. [!DNL Meta Conversions API].
...
다음 [!UICONTROL 유효성 검사 결과] 대화 상자에 메타 확장 구현 결과가 표시됩니다. 선택 **[!UICONTROL 다음]**. 다음을 선택하여 추가 유효성 검사 결과를 볼 수도 있습니다. **[!UICONTROL 보증]** 링크를 클릭합니다.
