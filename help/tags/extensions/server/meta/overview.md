...
>[!NOTE]
>
>가이드 설정 기능을 사용하면 쉽고 효율적으로 설정할 수 있습니다. 이 도구는 Adobe 태그 및 이벤트 전달에서 수행되는 여러 단계를 자동화합니다. 모든 사용 사례를 수용하는 완전한 기능의 엔드 투 엔드 구현을 제공하지 않습니다.

안내 설정을 시작하려면 [이벤트 전달 안내 설정](../../../ui/event-forwarding/guided-setup.md)의 지침을 따르십시오.
