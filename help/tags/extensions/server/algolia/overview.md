...
[!DNL Algolia] 이벤트 전달 확장을 사용하여 [!DNL Algolia]을(를) 통해 [!DNL Insights API]에 사용자 동작 이벤트를 보냅니다. 이 행동 데이터를 통해 AI 기반 권장 사항, 개인화된 경험 및 지능형 검색 기능을 사용할 수 있습니다.

## 전제 조건 {#prerequisites}

확장을 설치하기 전에 [!DNL Algolia]에 액세스할 수 있는 [!DNL Insights API] 계정이 있는지 확인하십시오. 계정이 없는 경우 [등록](https://dashboard.algolia.com/users/sign_up)하고 API에 대한 액세스를 활성화하세요.
...
**[!UICONTROL Data Collection]**&#x200B;의 [!DNL Adobe Experience Platform]&#x200B;(으)로 이동합니다. **[!UICONTROL Extensions]** 탭을 선택합니다. 

**[!UICONTROL Catalog]**&#x200B;을(를) 열고 **[!UICONTROL Algolia Event Forwarding]** 확장을 찾은 다음 **[!UICONTROL Install]**&#x200B;을(를) 선택합니다.
...
[!DNL Algolia] 이벤트 전달 확장을 구성하려면 **[!UICONTROL Extensions]** 탭으로 이동하여 **[!UICONTROL Algolia]** 확장을 선택한 다음 **[!UICONTROL Configure]**&#x200B;을(를) 선택합니다.
...
이벤트를 **[!UICONTROL Send event]**&#x200B;에 전달하도록 [!DNL Algolia] 작업을 구성하십시오.

**[!UICONTROL Rules]** > **[!UICONTROL Add Rule]**&#x200B;을(를) 선택하거나 기존 규칙을 선택합니다. 규칙의 **[!UICONTROL Then]** 부분에서 작업을 추가하고 **[!UICONTROL Extension]**: [!DNL Algolia] 이벤트 전달 > **[!UICONTROL Action Type]**: **[!UICONTROL Send Events]**&#x200B;을(를) 선택합니다.
...
### 스키마에 [!UICONTROL Algolia Event Details] 필드 그룹 추가 {#add-algolia-field-group}

[!UICONTROL Algolia Event Details] 필드 그룹을 추가하려면:

**[!UICONTROL Schemas]**(으)로 이동하여 **[!UICONTROL Browse]**&#x200B;을(를) 선택합니다.

웹 이벤트를 보내고 **[!UICONTROL Add]** 아이콘 위로 마우스를 가져가는 데 사용하는 새 스키마를 추가하거나 기존 스키마를 업데이트하십시오. 검색 상자에 *[!DNL Algolia]*&#x200B;을(를) 입력하여 결과 범위를 좁힙니다.

**[!UICONTROL Algolia Event Details]** 필드 그룹 > **[!UICONTROL Add field group]** 단추 > **[!UICONTROL Save]**&#x200B;을(를) 선택합니다.

Experience Platform의 ![Algolia 프로필 필드 그룹 구성](../../../images/extensions/server/algolia/algolia-profile-field-group.png)

### [!UICONTROL Data Collection] 태그를 사용하여 데이터 매핑 및 보내기
...
1. [!UICONTROL Data Element]을(를) 사용하여 **[!DNL Adobe Experience Platform Web SDK]**&#x200B;을(를) 만듭니다.
2. **[!UICONTROL XDM object]**&#x200B;을(를) 데이터 요소 유형으로 선택하십시오.
...
4. **[!UICONTROL Send event]**&#x200B;을(를) 작업 유형으로 선택합니다.
...
[!DNL Algolia] 대시보드로 이동하여 **[!UICONTROL Data Sources > Events > Debugger]**(으)로 이동합니다.
...
- **API 자격 증명 확인**: **[!UICONTROL Application ID]** 및 **[!UICONTROL API Key]**&#x200B;이(가) [!DNL Algolia] 대시보드의 값과 일치하는지 확인하십시오.
...
이 안내서에서는 [!DNL Algolia]을(를) 사용하여 [!DNL Algolia Event Forwarding Extension]에 데이터를 보내는 방법을 다룹니다. [!DNL Adobe Experience Platform]의 이벤트 전달 기능에 대한 자세한 내용은 [이벤트 전달 개요](../../../ui/event-forwarding/overview.md)를 참조하십시오.
