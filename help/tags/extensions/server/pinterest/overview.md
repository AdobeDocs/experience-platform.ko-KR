...
[!DNL Pinterest]에 있는 Edge Network의 데이터를 사용하여 Customer Analytics 기능을 이용하려면 이 확장을 사용해야 합니다.
...
왼쪽 탐색에서 **[!UICONTROL 확장]**&#x200B;을 선택합니다. **[!UICONTROL 카탈로그]** 탭의 [!DNL Pinterest] 확장 카드에서 **[!UICONTROL 설치]**&#x200B;를 선택합니다.

![[!UICONTROL Install]이 강조 표시된 [!DNL Pinterest] 확장을 표시하는 카탈로그.](../../../images/extensions/server/pinterest/install.png)
...
다음 화면에서는 [구성 세부 정보](#configuration-details) 섹션에서 이전에 수집한 [!UICONTROL 광고 계정 ID] 및 [!UICONTROL 전환 액세스 토큰]을(를) 입력합니다. 완료되면 **[!UICONTROL 저장]**&#x200B;을 선택합니다.

![[!UICONTROL 광고 계정 ID] 및 [!UICONTROL 전환 액세스 토큰] 입력 필드를 강조 표시하는 [!DNL Pinterest] [!UICONTROL 구성] 화면입니다.](../../../images/extensions/server/pinterest/input.png)

## 이벤트 전달 규칙 구성 {#config-rule}

모든 데이터 요소가 설정되면 이벤트가 [!DNL Pinterest]에 전송되는 시기와 방법을 결정하는 이벤트 전달 규칙을 만들 수 있습니다.

이벤트 전달 속성에 새 [규칙](../../../ui/managing-resources/rules.md)을(를) 만듭니다. **[!UICONTROL 작업]**&#x200B;에서 새 작업을 추가하고 확장을 **[!UICONTROL Pinterest]**(으)로 설정합니다. Edge Network 이벤트를 [!DNL Pinterest]에 보내려면 **[!UICONTROL 작업 유형]**&#x200B;을(를) **[!UICONTROL 이벤트 보내기].**(으)로 설정하십시오.

![[!DNL Pinterest] [!UICONTROL 이벤트 보내기] 규칙 만들기](../../../images/extensions/server/pinterest/rule.png)
...
| 필드 이름 | 설명 | 예 |
| --- | --- | --- | 
| [!UICONTROL 이벤트 이름] | 사용자 이벤트의 유형입니다. 모든 이벤트 유형일 수 있지만 [!DNL Pinterest Analytics]을(를) 활용하려면 [[!DNL Pinterest] 이벤트 코드](https://help.pinterest.com/en/business/article/add-event-codes)를 사용하는 것이 좋습니다. | * 체크아웃 <br> * add_to_cart <br> * page_visit <br> * 등록 <br> * [사용자 정의 이벤트] |
| [!UICONTROL 작업 Source] | 전환 이벤트가 발생한 위치를 나타내는 소스. | * app_android <br> * app_ios <br> * 웹 <br> * 오프라인 |
| [!UICONTROL 이벤트 시간] | 이벤트 시간을 나타냅니다. 사용되는 기본 시간 형식은 UNIX이며 로컬 시간대에 따라 `<seconds>.<miliseconds>` 형식입니다. 자세한 내용은 [[!DNL Pinterest] API](https://developers.pinterest.com/docs/api/v5/#operation/events/create)를 참조하세요. | 1433188255.500은 epoch 후 또는 2015년 6월 1일 월요일 오후 7:50:55분 GMT에서 1433188255초 및 500밀리초를 나타냅니다. |
...
![규칙 작업에 강조 표시된 [!DNL Pinterest] [!UICONTROL 이벤트 데이터]입니다.](../../../images/extensions/server/pinterest/event-data.png)
...
| [!UICONTROL 모바일 광고 ID] | 사용자의 &quot;Google Advertising ID&quot;(GAID) 또는 &quot;Apple의 광고주용 식별자&quot;(IDFA)의 Sha256 해시 | ebd543592...f2b7e1 |
...
![규칙 작업에 강조 표시된 [!DNL Pinterest] [!UICONTROL 사용자 데이터]입니다.](../../../images/extensions/server/pinterest/user-data.png)
...
![규칙 작업에 강조 표시된 [!DNL Pinterest] [!UICONTROL 사용자 지정 데이터]입니다.](../../../images/extensions/server/pinterest/custom-data.png)
