...
사용자가 기본 데이터 수집 UI를 활용하여 [getPageName 플러그인](https://experienceleague.adobe.com/docs/analytics/implementation/vars/plugins/getpagename.html). 다음 `getPageName` 데이터 요소는 현재 URL의 읽기 쉽고 친숙한 형식의 버전을 만듭니다.
