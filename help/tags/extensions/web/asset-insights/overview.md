...
이러한 보고서는 Analytics 관리자(**[!UICONTROL Analytics] > [!UICONTROL 관리] > [!UICONTROL 보고서 세트] > `<report suite>` > [!UICONTROL 설정 편집] > [!UICONTROL AEM] > [!UICONTROL AEM Assets 보고]**)를 사용하여 활성화해야만 이 확장을 사용할 수 있습니다.

Adobe Experience Platform용 &quot;*Adobe Analytics*&quot; 태그 확장은 동일한 웹 속성에 설치해야 합니다.

### AEM(Adobe Experience Manager)

1. [AEM 자산 통찰력](https://experienceleague.adobe.com/docs/experience-manager-65/assets/managing/touch-ui-configuring-asset-insights.html)을 사용합니다. AEM에서 **[!UICONTROL 도구 > 자산]**&#x200B;을 선택한 다음 **[!UICONTROL 인사이트 구성]** 패널을 엽니다.

1. UUID 추적을 비활성화합니다. 

   >[!IMPORTANT]
   >
   >AEM 자산 구성 설정 **[!UICONTROL UUID 추적 비활성화]**&#x200B;를 선택한 경우 이 확장 프로그램은 *이* 함수가 아닙니다. 기본적으로 선택되어 있지 않습니다.
...
1. [Adobe I/O ](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/integrations/experience-platform-launch/connect-aem-launch-adobe-io.html)를 사용하여 AEM과 태그를 연결합니다.
