...
이 섹션에서는 개인화된 콘텐츠가 로드되는 동안 페이지의 특정 부분을 숨기는 방법을 구성할 수 있습니다.

스타일 사전 숨김 편집기에서 숨길 요소를 지정할 수 있습니다. 그런 다음 제공된 기본 코드 조각 사전 숨김을 복사하여 내부에 붙여넣을 수 있습니다. `<head>` 사이트의 요소 [!DNL HTML] 코드.
