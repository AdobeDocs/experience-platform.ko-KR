...
왼쪽 탐색에서 **[!UICONTROL Extensions]**&#x200B;을(를) 선택한 다음 **[!UICONTROL Catalog]** 탭을 선택합니다. 검색 창을 사용하여 Adobe 개인 정보 보호 를 찾을 때까지 사용 가능한 확장 목록의 범위를 좁힙니다. 계속하려면 **[!UICONTROL Install]**&#x200B;을(를) 선택하십시오.
...
하나 이상의 솔루션을 선택한 다음 **[!UICONTROL Update]**&#x200B;을(를) 선택합니다.
...
선택한 솔루션에 대한 매개 변수 추가를 완료했으면 **[!UICONTROL Save]**&#x200B;을(를) 선택하여 구성을 저장합니다.
...
* **[!UICONTROL Retrieve Identities]**: 사용자의 저장된 ID 정보를 검색합니다.
* **[!UICONTROL Remove Identities]**: 사용자의 저장된 ID 정보가 제거되었습니다.
* **[!UICONTROL Retrieve Then Remove Identities]**: 사용자의 저장된 ID 정보를 검색한 다음 제거합니다.
...
왼쪽 탐색에서 **[!UICONTROL Data Elements]**&#x200B;을(를) 선택한 후 **[!UICONTROL Add Data Element]**&#x200B;을(를) 선택하여 새 데이터 요소를 만드는 프로세스를 시작합니다. 구성 화면에 표시되면 확장에 대해 **[!UICONTROL Core]**&#x200B;을(를) 선택하고 데이터 요소 유형에 대해 **[!UICONTROL Custom Code]**&#x200B;을(를) 선택합니다. 여기에서 오른쪽 패널의 **[!UICONTROL Open Editor]**&#x200B;을(를) 선택합니다.
...
규칙에 대한 작업을 구성할 때 확장에 대해 **[!UICONTROL Adobe Privacy]**&#x200B;을(를) 선택하십시오. 작업 유형에 대해 확장에서 제공하는 [3개의 함수](#using) 중 하나를 선택하십시오.

![작업 유형 선택](../../../images/extensions/client/privacy/action-type.png)

오른쪽 패널은 작업의 콜백 역할을 할 데이터 요소를 선택하라는 메시지를 표시합니다. 데이터베이스 아이콘(![데이터베이스 아이콘](/help/images/icons/database.png))을 선택하고 목록에서 이전에 만든 데이터 요소를 선택합니다. 계속하려면 **[!UICONTROL Keep Changes]**&#x200B;을(를) 선택하십시오.

![데이터 요소 선택](../../../images/extensions/client/privacy/add-data-element.png)

여기에서 필요한 이벤트 및 조건에 따라 Adobe 개인 정보 보호 작업이 실행되도록 규칙을 계속 구성할 수 있습니다. 만족하면 **[!UICONTROL Save]**&#x200B;을(를) 선택하십시오.
...
확장을 설치한 후에 확장을 비활성화하거나 삭제할 수 있습니다. 설치된 확장의 Adobe 개인 정보 보호 카드에서 **[!UICONTROL Configure]**&#x200B;를 선택한 다음 **[!UICONTROL Disable]** 또는 **[!UICONTROL Uninstall]**&#x200B;을 선택합니다.

## 다음 단계

이 안내서에서는 UI에서 Adobe 개인 정보 보호 태그 확장 사용에 대해 다룹니다. 원시 코드를 사용하여 사용하는 방법의 예를 포함하여 확장에서 제공하는 기능에 대한 자세한 내용은 Privacy Service 설명서의 [개인 정보 보호 JavaScript 라이브러리 개요](../../../../privacy-service/js-library.md)를 참조하십시오.
