...
* **설치 -** MA 확장을 설치하려면 확장 속성을 열고 **[!UICONTROL Extensions > Catalog]**&#x200B;를 선택하고 **[!UICONTROL Adobe Media Analytics for Audio and Video]** 확장을 마우스로 가리킨 다음 **[!UICONTROL Install]**&#x200B;를 선택합니다.
