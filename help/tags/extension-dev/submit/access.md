...
회사에서 태그에 대한 액세스 권한을 제공받고 사용자가 위에서 설명한 대로 설정되면,에서 데이터 수집 UI 및 Experience Platform UI에 액세스할 수 있어야 합니다. [Adobe Experience Cloud 대시보드](https://experience.adobe.com/). 위의 단계를 수행한 후에도 UI에 액세스할 수 없는 경우 Adobe 지원 담당자에게 문의하십시오.
