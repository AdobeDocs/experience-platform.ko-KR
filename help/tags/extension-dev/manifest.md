...
| `displayName` | 사용자가 읽을 수 있는 확장의 이름. Experience Platform 사용자에게 표시됩니다. 태그 또는 &quot;확장&quot;을 언급할 필요가 없습니다. 사용자는 이미 태그 확장을 보고 있음을 알 수 있습니다. |
...
>[!WARNING]
>
>확장 샌드박스 도구*에서는 `propertyPath` 속성에서 배열 표기법(예: `foo.baz[]`)을 아직 지원하지 않습니다.
