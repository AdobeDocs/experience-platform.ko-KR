...
이 문서에서는 Adobe Experience Platform에서 웹 확장에 대한 작업 유형을 정의하는 방법을 다룹니다.
...
예를 들어, Adobe Experience Platform 사용자가 메시지를 구성할 수 있도록 하기 위해 사용자가 메시지를 입력하고 설정 객체에 저장하도록 허용할 수 있습니다. 객체는 다음과 같습니다.
