...
>[!IMPORTANT]
>
>Edge 확장을 개발하는 경우 [edge 확장의 데이터 요소 유형](../edge/data-element-types.md) 대신,
>
...
1. A [보기](./views.md) 사용자가 데이터 요소에 대한 설정을 수정할 수 있도록 하는 Experience Platform UI 및 데이터 수집 UI 내에 표시됩니다.
