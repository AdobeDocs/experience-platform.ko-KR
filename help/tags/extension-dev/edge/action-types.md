...
작업 유형 라이브러리 모듈은 사전 정의된 작업을 수행하도록 설계되었습니다. 이 작업의 효과는 전적으로 작성자가 정의합니다. 모듈은 비콘으로 만들거나 이벤트에서 일부 데이터를 변형할 수 있습니다.

>[!IMPORTANT]
>
>이 문서에서는 Edge 확장의 작업 유형을 다룹니다. 웹 확장을 개발하는 경우 [웹 확장에 대한 작업 유형](../web/action-types.md)에 대한 안내서를 대신 참조하십시오.
>
