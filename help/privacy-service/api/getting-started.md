...
API _[!UICONTROL 추가]_화면이 나타납니다. 사용 가능한 API 목록에서**[!UICONTROL  Privacy Service API를&#x200B;]**선택한 다음**[!UICONTROL &#x200B;다음을&#x200B;]**클릭합니다.

![](../images/api/getting-started/add-privacy-service-api.png)

API _[!UICONTROL 구성]_화면이 나타납니다. 키 쌍**[!UICONTROL &#x200B;을 생성하는 옵션을 선택한 다음&#x200B;]**오른쪽 아래 모서리에서 키 쌍****생성을 클릭합니다.
