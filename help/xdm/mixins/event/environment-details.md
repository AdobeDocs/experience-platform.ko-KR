...
[!UICONTROL 환경 ] 세부 사항은  [[!DNL XDM ExperienceEvent] ](../../classes/individual-profile.md) 장치 세부 사항, 브라우저 정보, 현지 시간 및 기타 지리적 정보 등 경험 이벤트와 관련된 환경 세부 사항을 캡처하는 데 사용되는 클래스의 표준 혼합입니다.
