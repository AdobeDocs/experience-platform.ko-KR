...
# [!UICONTROL 작업 연락처 ] 세부 정보

>[!NOTE]
>
>여러 혼합물의 이름이 변경되었습니다. 자세한 내용은 [혼합 이름 업데이트](../name-updates.md)에 있는 문서를 참조하십시오.

[!UICONTROL 작업 연락처 ] 세부 사항은  [[!DNL XDM Individual Profile] 클래스의 표준 믹스인입니다](../../classes/individual-profile.md). 이 혼합은 직장 주소, 직장 이메일, 직장 전화 번호, 그 사람이 속한 조직 등 개인의 직업상 정보를 캡처하는 여러 가지 분야를 제공합니다.
