...
[!DNL Experience Platform]에서 ID는 해석되는 데이터의 소스와 관계없이 주체(일반적으로 개별 사용자)를 식별하는 데 사용됩니다. 키 필드를 &quot;ID&quot;로 표시하여 스키마에 정의됩니다. ID에 일반적으로 사용되는 필드에는 전자 메일 주소, 전화 번호, [[!DNL Experience Cloud ID (ECID)]](https://experienceleague.adobe.com/docs/id-service/using/home.html?lang=ko), CRM ID 및 기타 고유 ID 필드가 포함됩니다.
...
스키마 편집기에서 스키마를 연 상태에서 ID로 표시할 편집기의 **[!UICONTROL Structure]** 섹션에서 필드를 선택합니다. 오른쪽의 **[!UICONTROL Field Properties]**&#x200B;에서 **[!UICONTROL Identity]** 확인란을 선택합니다.
...
[!DNL Experience Platform]의 왼쪽 탐색에서 **[!UICONTROL Schemas]**&#x200B;을(를) 선택하고 스키마 목록에서 활성화하려는 스키마 이름을 선택합니다. 그런 다음 **[!UICONTROL Schema Properties]** 아래 편집기 오른쪽에서 **[!UICONTROL Profile]**&#x200B;을(를) 선택하여 켜십시오.

자세한 내용은 [&#x200B; 자습서에서 &#x200B;](./tutorials/create-schema-ui.md#profile)실시간 고객 프로필에서 사용[!UICONTROL Schema Editor]에 대한 섹션을 참조하십시오.
