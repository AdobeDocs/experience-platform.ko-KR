...
#  장치 데이터 유형
 ...
 장치는 식별된 장치를 설명하는 표준 XDM 데이터 유형입니다. 장치는 세션 간에 일반적으로 쿠키로 추적 가능한 애플리케이션 또는 브라우저 인스턴스입니다.
...
| `typeIDService` | 문자열 | 장치 유형을 식별하는 데 사용되는 서비스의 네임스페이스입니다. 허용되는 값에 대한 자세한 내용은 [부록](#typeIDService)을 참조하십시오. |
...
다음 표에서는 `typeIDService`에 대해 허용되는 값과 관련된 의미에 대해 설명합니다.
