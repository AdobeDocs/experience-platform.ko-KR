...
[!UICONTROL 통화] 통화 유형 및 전환 날짜를 포함하여 통화량을 설명하는 표준 XDM 데이터 유형입니다.

![](../images/data-types/currency.png)

| 속성 | 데이터 유형 | 설명 |
| --- | --- | --- |
| `amount` | 이중 | 에 정의된 통화 금액 `currencyCode`. |
| `conversionDate` | DateTime | 통화 전환이 이루어진 시간의 타임스탬프입니다. |
| `currencyCode` | 문자열 | 다음과 같은 통화 유형을 나타내는 ISO 4217 코드 `amount` 를 나타냅니다. |
