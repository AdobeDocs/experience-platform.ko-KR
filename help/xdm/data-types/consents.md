...
이 문서를 사용하려면 XDM을 이해하고 [!DNL Experience Platform]에서 스키마를 사용해야 합니다. 계속하기 전에 다음 설명서를 검토하십시오.
...
| 값 | Title | 설명 |
| --- | --- | --- |
| `y` | 예(옵트인) | 고객이 동의 또는 기본 설정을 선택했습니다. 즉, **은(는) 해당 동의 또는 기본 설정에 의해 표시된 대로 데이터 사용에 동의함을 의미합니다.** |
| `n` | 아니요(옵트아웃) | 고객이 동의 또는 기본 설정을 해제했습니다. 즉, **은(는) 해당 동의 또는 기본 설정에 의해 표시된 대로 데이터 사용에 동의하지 않습니다.** |
