...
title: 범용 개인화 기본 설정 필드 데이터 유형
topic-legacy: overview
description: 이 문서에서는 범용 개인화 기본 설정 필드 XDM 데이터 유형에 대한 개요를 제공합니다.
...
# [!UICONTROL Generic Personalization Preference Field] 데이터 유형

[!UICONTROL Generic Personalization Preference Field] 는 특정 개인화 기본 설정에 대한 고객의 선택을 설명하는 표준 XDM 데이터 유형입니다.
...
| 속성 | 데이터 유형 | 설명 |
| --- | --- | --- |
| `val` | 문자열 | 이 개인화 사용 사례에 대해 고객이 제공한 환경 설정을 선택합니다. 허용되는 값과 정의는 아래 표를 참조하십시오. |
...
* [채워진 예제](https://github.com/adobe/xdm/blob/master/components/datatypes/consent/personalization-field.example.1.json)
