...
스키마 편집기 내에서 빠른 작업을 수행하여 스키마의 JSON 구조를 복사하거나 스키마를 삭제할 수도 있습니다. 선택 [!UICONTROL 자세히] 빠른 작업과 함께 드롭다운을 표시하려면 보기 맨 위에 놓습니다.
...
>title="스키마를 삭제할 수 없음"
>abstract="프로필에 대해 활성화되었으며 연결된 데이터 세트가 있으므로 스키마를 삭제할 수 없습니다."
...
>title="스키마를 삭제할 수 없음"
>abstract="연결된 데이터 세트가 있으므로 스키마를 삭제할 수 없습니다."

스키마를 사용하여 스키마 편집기의 UI 내에서 삭제할 수 있습니다. [!UICONTROL 자세히] 작업 및 의 스키마 세부 정보에서 [!UICONTROL 찾아보기] 탭. 스키마가 삭제되지 않도록 하는 특정 조건이 있습니다. 다음과 같은 경우에는 스키마를 삭제할 수 없습니다.
...
선택 **[!UICONTROL JSON 구조 복사]** 스키마 라이브러리의 모든 스키마에 대한 내보내기 페이로드를 생성합니다. 이 작업은 JSON 구조를 클립보드에 복사합니다. 그런 다음 내보낸 JSON을 사용하여 스키마 및 관련 리소스를 다른 샌드박스 또는 조직으로 가져올 수 있습니다. 이를 통해 다양한 환경 간에 스키마를 단순하고 효율적으로 공유하고 재사용할 수 있습니다.
