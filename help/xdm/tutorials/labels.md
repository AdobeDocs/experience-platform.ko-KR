...
개별 필드의 레이블을 편집하려면 캔버스에서 필드를 선택한 다음 오른쪽 레일에서 **[!UICONTROL Manage access]**&#x200B;을(를) 선택할 수 있습니다.
...
**[!UICONTROL Labels]** 탭을 선택하고 목록에서 원하는 필드를 선택한 다음 오른쪽 레일에서 **[!UICONTROL Apply Access and Data Governance Labels]**&#x200B;을(를) 선택할 수도 있습니다.

![[!UICONTROL Labels] 탭에서 필드 선택](../images/tutorials/labels/select-field-on-labels-tab.png)

전체 스키마의 레이블을 편집하려면 **[!UICONTROL Labels]** 탭에서 필터 아이콘 아래의 확인란을 선택하십시오. 스키마에서 사용 가능한 모든 필드를 선택합니다. 그런 다음 오른쪽 레일에서 **[!UICONTROL Apply Access and Data Governance Labels]**&#x200B;을(를) 선택합니다.

![[!UICONTROL Labels] 탭에서 스키마 이름을 선택합니다](../images/tutorials/labels/select-schema-on-labels-tab.png)

>[!NOTE]
>
>스키마 또는 필드에 대한 레이블을 처음 편집할 때 조직의 정책에 따라 레이블 사용이 다운스트림 작업에 미치는 영향을 설명하는 면책조항 메시지가 나타납니다. 편집을 계속하려면 **[!UICONTROL Proceed]**&#x200B;을(를) 선택하십시오.
>
...
표시된 목록을 사용하여 스키마나 필드에 추가할 레이블을 선택합니다. 레이블을 선택하면 **[!UICONTROL Applied labels]** 섹션이 업데이트되어 지금까지 선택한 레이블을 표시합니다.

![적용된 레이블이 강조 표시된 액세스 및 데이터 거버넌스 레이블 적용 대화 상자.](../images/tutorials/labels/applied-labels.png)

표시된 레이블을 유형별로 필터링하려면 왼쪽 레일에서 원하는 카테고리를 선택합니다. 새 사용자 지정 레이블을 만들려면 **[!UICONTROL Create label]**&#x200B;을(를) 선택합니다.

![레이블 유형 필터가 적용된 액세스 및 데이터 거버넌스 레이블 적용 대화 상자와 레이블 만들기.](../images/tutorials/labels/filter-and-create-custom.png)

선택한 레이블이 만족스러우면 **[!UICONTROL Save]**&#x200B;을(를) 선택하여 필드 또는 스키마에 적용합니다.

![저장 이 강조 표시된 액세스 및 데이터 거버넌스 레이블 적용 대화 상자.](../images/tutorials/labels/save-labels.png)

스키마에 적용된 레이블을 표시하는 **[!UICONTROL Labels]** 탭이 다시 나타납니다.
