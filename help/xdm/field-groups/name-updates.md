---
keywords: Experience Platform;홈;인기 항목;스키마;스키마;XDM;ExperienceEvent;필드;스키마;스키마;필드 디자인;필드 그룹;필드 그룹;최종 사용자;id;업데이트
...
여러 XDM(경험 데이터 모델) 스키마 필드 그룹의 이름이 변경되었습니다. 이러한 필드 그룹의 필드 구조는 동일하므로 이름 변경만 이러한 필드 그룹을 사용하는 기존 스키마에 영향을 주지 않아야 합니다. 그러나 Adobe Experience Platform 사용자 인터페이스에서 이러한 필드 그룹을 조회하고 사용하려면 새 이름을 사용해야 합니다.

다음 표에서는 갱신된 기존 필드 그룹과 해당 새 이름을 보여 줍니다.
