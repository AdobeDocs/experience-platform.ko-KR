...
![필드 그룹 구조](../../images/field-groups/healthcare-goal/goal.png)
...
| [!UICONTROL 코드 가능한 개념 시작] | `startCodeableConcept` | [[!UICONTROL 코드 가능한 개념]](../../data-types/healthcare/codeable-concept.md) | 그 후에 목표가 설득되어야 하는 사건. |
