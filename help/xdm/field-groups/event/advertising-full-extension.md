---
title: Adobe Advertising ExperienceEvent 전체 확장 스키마 필드 그룹
description: Adobe Advertising ExperienceEvent 전체 확장 스키마 필드 그룹에 대해 알아봅니다.
...
# [!UICONTROL Adobe Advertising ExperienceEvent Full Extension] 스키마 필드 그룹

>[!AVAILABILITY]
>
>[!UICONTROL Adobe Advertising ExperienceEvent Full Extension] 필드 그룹이 현재 베타 버전입니다. 설명서 및 기능은 변경될 수 있습니다.

[!UICONTROL Adobe Advertising ExperienceEvent Full Extension]은(는) Adobe Advertising에서 수집하는 일반적인 지표(이전의 &quot;[[!DNL XDM ExperienceEvent] &quot;)를 캡처하는 &#x200B;](../../classes/experienceevent.md)class[!DNL Advertising Cloud]에 대한 표준 스키마 필드 그룹입니다.

이 문서에서는 [!DNL Advertising] 확장 필드 그룹의 구조 및 사용 사례를 설명합니다.
...
![&#x200B; 필드 그룹의 [!DNL Advertising]최상위 필드](../../images/field-groups/advertising-full-extension/full-schema.png "필드 그룹의  [!DNL Advertising] 최상위 필드")
...
| `dspId` | 문자열 | 캠페인이 정의된 Demand Side Platform(DSP)의 식별자입니다. 일반적으로 이 식별자는 Adobe Advertising DSP의 ID입니다. |
...
| `sspPartnerCode` | 문자열 | Adobe Advertising이 재고 기회를 받는 파트너(교환)입니다. |
...
| `inventorySourceId` | 문자열 | 해당 영업 기회가 제공된 Adobe Advertising 인벤토리 소스의 ID입니다. |
...
이 문서에서는 [!DNL Adobe Advertising] 확장 필드 그룹의 구조 및 사용 사례를 다룹니다. 필드 그룹 자체에 대한 자세한 내용은 [공개 XDM 저장소](https://github.com/adobe/xdm/blob/master/extensions/adobe/experience/adcloud/experienceevent-all.schema.json)를 참조하세요.
