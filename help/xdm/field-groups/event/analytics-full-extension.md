...
| `lists` | 오브젝트 | 최대 3개의 [목록](https://experienceleague.adobe.com/docs/analytics/implementation/vars/page-vars/list.html)을 캡처하는 개체입니다. 이 개체의 속성은 `list1`에서 `list3`(으)로 처리됩니다. 이러한 각 속성에는 `list` 데이터 형식의 단일 [[!UICONTROL Key Value Pair]](../../data-types/key-value-pair.md) 배열이 포함되어 있습니다. |
