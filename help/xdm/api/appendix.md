...
| date | type:<br>stringformat:date<br>(RFC 339, section 5.6) | INT32/날짜 | DateType | java.util.Date | java.util.Date | System.DateTime | 문자열 | date | 정수<br>(unix 밀리) | int64<br>(unix millis) |
