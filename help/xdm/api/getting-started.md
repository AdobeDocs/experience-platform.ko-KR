...
스키마 레지스트리 API를 사용하여 Adobe Experience Platform 내에서 사용 가능한 모든 스키마 및 관련 리소스를 보고 관리하기 위해 기본 CRUD 작업을 수행할 수 있습니다. 여기에는 애플리케이션을 사용하는 Adobe, 파트너 및 공급업체에서 정의한 애플리케이션이 포함됩니다. [!DNL Experience Platform] 또한 API 호출을 사용하여 조직의 새 스키마 및 리소스를 만들고, 이미 정의한 리소스를 보고 편집할 수도 있습니다.
