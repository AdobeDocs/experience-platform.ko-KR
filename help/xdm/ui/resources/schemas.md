...
이 문서에서는 Platform UI에서 스키마를 만들고 편집하는 기본 사항에 대해 설명합니다. 고유한 사용 사례에 대한 사용자 지정 필드 그룹 및 데이터 형식 만들기를 포함하여 UI에서 전체 스키마를 구축하기 위한 포괄적인 워크플로에 대해 [스키마 만들기 자습서](../../tutorials/create-schema-ui.md)를 검토하는 것이 좋습니다.
