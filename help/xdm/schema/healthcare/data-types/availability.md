...
![가용성 데이터 형식 구조](../../../images/healthcare/data-types/availability/availability.png)
...
![사용 가능한 시간 구조](../../../images/healthcare/data-types/availability/available-time.png)
...
![사용할 수 없는 시간 구조](../../../images/healthcare/data-types/availability/not-available-time.png)

| 표시 이름 | 속성 | 데이터 유형 | 설명 |
| --- | --- | --- | --- |
| [!UICONTROL 다음 기간 동안] | `during` | [[!UICONTROL 기간]](../data-types/period.md) | 항목 사용이 중지되는 기간입니다. |
