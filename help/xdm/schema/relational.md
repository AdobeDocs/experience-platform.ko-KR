...
관계형 스키마는 유니온 스키마 종속성을 제거하여 공유 필드 그룹에서 자동 업데이트를 제거하고 테넌트 네임스페이스 제한 없이 직접 필드 정의를 허용합니다. 기본 키, 관계 및 초기 스키마 디자인을 명시적으로 제어할 수 있으므로 생성 시 요구 사항에 맞게 데이터를 더 쉽게 모델링할 수 있습니다.
