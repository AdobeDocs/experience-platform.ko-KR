...
|------------------------------------|---------------------------------|
| <ul><li>기존 스키마에 새 필드 추가</li><li>필수 필드를 선택 사항으로 만들기</li></ul> | <ul><li>이전에 정의한 필드 제거</li><li>새 필수 필드 소개</li><li>기존 필드 이름 바꾸기 또는 재정의</li><li>이전에 지원되는 필드 값 제거 또는 제한</li><li>트리의 다른 위치로 속성 이동</li></ul> |

>[!NOTE]
>
>데이터를 [!DNL Experience Platform]에 수집하는 데 아직 스키마가 사용되지 않은 경우 해당 스키마에 대한 변경 사항이 적용될 수 있습니다. 그러나 스키마를 [!DNL Platform]에 사용한 후에는 추가 버전 관리 정책을 준수해야 합니다.
