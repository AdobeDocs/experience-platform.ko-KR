...
>
>또는 [용량 서비스](../landing/license-usage-and-guardrails/capacity.md)를 사용하여 Experience Platform 내에서 스트리밍 처리량 및 기타 데이터를 모니터링하고 설정할 수 있습니다.
...
| 샌드박스당 계정 대상자 | 50 | 시스템 강제 보호 | 샌드박스에서 최대 50개의 계정 대상을 만들 수 있습니다. 샌드박스에서 대상 50개에 도달하면 새 계정 대상을 만들 때 **[!UICONTROL Create audience]** 컨트롤이 비활성화됩니다. [계정 대상자](/help/segmentation/types/account-audiences.md)에 대해 자세히 알아보세요. |
...
| B2B 샌드박스당 세그먼트 정의 | 400 | 성능 보호 | 각 개별 B2B 샌드박스에 400개 미만의 세그먼트 정의가 있는 한 조직에는 총 400개 이상의 세그먼트 정의가 있을 수 있습니다. 추가 세그먼트 정의를 만들려고 하면 시스템 성능에 영향을 줄 수 있습니다. 자세한 내용은 [Real-Time Customer Data Platform B2B edition의 기본 보호 기능](../rtcdp/b2b-guardrails.md)을 참조하세요. |

{style="table-layout:auto"}

B2B 전용 보호 기능에 대한 자세한 내용은 [Real-Time Customer Data Platform B2B edition의 기본 보호 기능](../rtcdp/b2b-guardrails.md) 설명서를 참조하십시오.
