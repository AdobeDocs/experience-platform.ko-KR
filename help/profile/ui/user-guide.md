...
**[!UICONTROL Browse]** 탭에서 전환을 선택하여 **카드** 보기 또는 **테이블** 보기에서 프로필을 볼 수 있습니다.

![카드 및 표 보기 토글이 강조 표시되어 있습니다.](../images/user-guide/change-browse-view.png)
...
**[!UICONTROL Details]** 탭은 선택한 프로필에 대한 자세한 정보를 제공합니다. 세부 사항 탭은 카드 또는 그래프 보기의 경우에 따라 다양한 섹션으로 구분됩니다. 카드 보기의 경우 고객 프로필 인사이트, AI insight 위젯, 사용자 정의 가능한 위젯 및 자동 분류된 위젯이 표시되고 그래프 보기의 경우 프로필 속성 및 경험 이벤트 섹션이 표시됩니다.

![프로필 세부 정보 페이지가 표시됩니다.](../images/user-guide/profile-details.png)

또한 AI 생성 인사이트를 표시할지 여부를 전환하고, 에지와 비교하여 허브에 대한 세부 정보를 표시하며, 카드 또는 그래프 보기 중에서 선택할 수 있습니다.
...
**[!UICONTROL Profile attributes]** 섹션에는 프로필 데이터의 계층적 그래프 표현이 표시됩니다. 이 보기에서 중앙 노드는 프로필 자체를 나타내고 보조 노드는 필드 그룹을 나타내며 나머지 노드는 각 필드 그룹 내의 속성을 나타냅니다.

그래프 보기 내에서 노드를 드래그 앤 드롭하여 노드 순서를 다시 정렬하고, 노드를 축소 및 확장하여 속성에 대한 자세한 내용을 보고, 속성별로 검색 및 필터링하며, 속성 세부 정보를 더 잘 보기 위해 확대 및 축소할 수 있습니다.

![프로필에 대한 그래프 보기가 표시되어 프로필을 구성하는 다양한 노드를 표시합니다.](/help/profile/images/user-guide/profile-attribute-graph.png)

#### 경험 이벤트 {#experience-events}

**[!UICONTROL Experience events]** 섹션에는 프로필이 포함된 경험 이벤트의 타임라인이 표시됩니다. 기본적으로 이 섹션에는 지난 48시간 이내의 경험 이벤트가 표시됩니다. 그러나 최대 30일 동안 날짜 범위를 설정할 수 있습니다.

![경험 이벤트 섹션이 표시되어 프로필이 포함된 경험 이벤트의 타임라인을 보여 줍니다.](/help/profile/images/user-guide/experience-event-graph.png)

**[!UICONTROL View event]**&#x200B;을(를) 선택하면 선택한 이벤트에 연결된 이벤트 특성이 표시됩니다. 이러한 세부 사항에는 경로, 속성, 표시 이름 및 값이 포함됩니다.

![이벤트 특성 팝오버가 표시되어 이벤트와 관련된 추가 세부 정보를 표시합니다.](/help/profile/images/user-guide/event-attributes-graph.png)
...
>[!NOTE]
>
>이벤트 표시는 최대 15분 정도 지연될 수 있습니다.

기본적으로 **[!UICONTROL Events]** 탭에는 지난 48시간 동안 고객과 연결된 100개의 최신 ExperienceEvents가 있는 데이터가 포함되어 있습니다. 이 데이터에는 이메일 열림, 장바구니 활동 및 페이지 보기가 포함될 수 있습니다. 최대 30일 동안 날짜 범위를 설정할 수도 있습니다. 개별 이벤트에 대해 **[!UICONTROL View all]**&#x200B;을(를) 선택하면 이벤트의 일부로 캡처되는 추가 필드 및 값이 제공됩니다.
