...
언제든지 편집 내용을 제거하고 기본 보기로 되돌리려는 경우 모든 기본 카드와 속성을 빠르고 손쉽게 복원할 수 있습니다. 이렇게 하려면 UICONTROL 대시보드 **[수정을 선택한]**&#x200B;다음 UICONTROL **[기본 카드 복원을 선택합니다]**. 이렇게 하면 크기 조정을 포함한 모든 사용자 지정이 제거됩니다. 계속하려면 [UICONTROL **[저장]** ]을 선택하여 변경 내용을 저장하거나, 오류로 **[복원하도록 선택한 경우 [UICONTROL 취소]** 를 선택하여 변경 내용을 저장하지 않고 편집한 내용을 유지합니다.
