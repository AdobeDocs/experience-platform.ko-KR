...
# (베타) [!UICONTROL 프로필] 대시보드 {#profile-dashboard}
...
UI에서 [!UICONTROL 프로필] 대시보드에 액세스하고 상호 작용하는 방법에 대한 자세한 지침은 대시보드에 표시되는 사용 가능한 지표에 대해 자세히 알아보려면 [[!UICONTROL 프로필] 대시보드 안내서](../../dashboards/guides/profiles.md)를 참조하십시오.
