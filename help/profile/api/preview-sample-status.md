...
에 대해 GET 요청을 수행할 수 있습니다 `/previewsamplestatus` 엔드포인트 : 조직에 대해 실행된 마지막 성공 샘플 작업의 세부 정보를 볼 수 있습니다. 여기에는 샘플의 총 프로필 수, 프로필 수 지표 또는 조직이 Experience Platform 내에 가지고 있는 총 프로필 수가 포함됩니다.
