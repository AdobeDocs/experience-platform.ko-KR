...
[Adobe Experience Platform ID 서비스](../../identity-service/home.md) (Identity Service)는 전역 및 각 조직에 사용되는 ID 그래프를 관리합니다 [!DNL Experience Platform]. 병합 정책의 `identityGraph` 속성은 사용자의 관련 ID를 결정하는 방법을 정의합니다.
