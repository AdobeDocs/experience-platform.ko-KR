...
>[!NOTE]
>
>동일한 액세스 제한 사항을 적용하려는 경우 레이블이 지정된 속성을 사용하는 대상에도 마찬가지로 레이블이 지정되어야 합니다.
...
>[!NOTE]
>
> [!UICONTROL Permissions]개체 수준 액세스 제어[를 사용하여 &#x200B;](https://experienceleague.adobe.com/ko/docs/journey-optimizer/using/access-control/object-based-access) 작업 영역에서 만든 레이블(예: 위의 세그먼트 레이블)을 Adobe Journey Optimizer의 다양한 개체에 할당합니다.&quot;
