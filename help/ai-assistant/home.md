...
| 데이터 모델(Federated Audience Composition) | <ul><li>데이터 모델 카운트</li><li>이름 검색</li><li>데이터 모델 및 스키마 관계</li><li>링크 속성</li><li>상태</li><li>생성 및 수정 날짜</li><li>링크-데이터 모델 관계</li></ul> | |
| 대상 | <ul><li>구성된 대상 카운트</li><li>대상 - 대상 관계</li><li>대상 속성 관계</li></ul> | <ul><li>계정 설정</li><li>계정 자격 증명 정보</li><li>고유 프로필 활성화됨</li></ul> |
| 페더레이션 데이터베이스(페더레이션 대상 구성) | <ul><li>데이터베이스 수</li><li>데이터베이스 이름</li><li>데이터베이스 유형</li><li>생성/수정된 날짜</li><li>상태</li></ul> | |
...
| 스키마(Federated Audience 구성) | <ul><li>스키마 카운트</li><li>스키마 이름/레이블 검색</li><li>생성 및 수정 날짜</li><li>스키마-데이터베이스 관계</li><li>대상 유형 스키마</li></ul> | <ul><li>스키마-구성 관계</li><li>스키마 속성</li></ul> |
...
>[!VIDEO](https://video.tv.adobe.com/v/3444039?captions=kor&learn=on&enablevpops)
