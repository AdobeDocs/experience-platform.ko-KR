...
| 기능 | 설명 |
| --- | --- |
| 어두운 테마 | 어두운 테마 스위치를 사용하여 Experience Platform 인터페이스의 밝은 테마와 어두운 테마 사이를 전환합니다. 스위치는 사용자 이름 및 이메일 아래의 사용자 프로필에 있습니다. |
...
자세한 내용은 [Experience Platform UI 안내서](../../landing/ui-guide.md)를 참조하세요.
