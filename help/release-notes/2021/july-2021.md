...
| [!DNL Salesforce Marketing Cloud]&#x200B;(Beta) | 이제 [!DNL Salesforce Marketing Cloud] API 또는 UI를 사용하여 [!DNL Flow Service]을(를) Experience Platform에 연결할 수 있습니다. 자세한 내용은 [[!DNL Salesforce Marketing Cloud] 커넥터 개요](../../sources/connectors/marketing-automation/salesforce-marketing-cloud.md)를 참조하십시오. |
...
| 이전 용어 | 업데이트된 용어 |
| --- | --- |
| Experience Platform Launch (클라이언트측) | [태그](/help/tags/home.md) |
| Experience Platform Launch Server Side | [이벤트 전달](/help/tags/ui/event-forwarding/overview.md) |
