...
| 기능 | 설명 |
| ------- | ----------- |
| 여러 프로덕션 샌드박스 | 이제 조직에서 여러 프로덕션 샌드박스를 만들고 관리할 수 있으며 특정 프로덕션 샌드박스를 고유한 비즈니스 라인, 브랜드, 프로젝트 또는 지역에 할당할 수 있습니다. 프로덕션 샌드박스 만들기에 대한 튜토리얼을 참조하십시오 [UI에서](../../sandboxes/ui/user-guide.md) 또는 [api 사용](../../sandboxes/api/overview.md) 추가 정보. |
