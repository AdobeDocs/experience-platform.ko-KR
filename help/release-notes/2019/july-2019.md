...
Adobe Experience Platform [!DNL Segmentation Service] 을(를) 사용하면 마케팅 가능한 사용자 그룹의 속성 및 동작을 설명하는 규칙을 만든 다음, 프로필 스토어의 프로필을 사용하여 이러한 규칙을 기반으로 실행 가능한 대상을 구축할 수 있습니다.
