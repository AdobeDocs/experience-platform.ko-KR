...
| 대상 | 설명 |
| ----------- | ----------- |
| **[[!UICONTROL Mailchimp Interest Categories]](../../destinations/catalog/email-marketing/mailchimp-interest-categories.md)** | **[!UICONTROL Mailchimp]**&#x200B;은(는) 기업에서 메일링 목록 및 이메일 마케팅 캠페인을 사용하여 연락처(클라이언트, 고객 또는 기타 이해 당사자)를 관리하고 연락하는 데 사용하는 인기 있는 마케팅 자동화 플랫폼 및 이메일 마케팅 서비스입니다. 이 커넥터를 사용하여 관심사 및 선호도에 따라 연락처를 정렬합니다. |
...
| 필드 그룹 | [[!UICONTROL XDM Individual Prospect Profile]](https://github.com/adobe/xdm/pull/1721/files) | 메타데이터 태그에 대한 `partnerProspect` 옵션이 [!UICONTROL XDM Individual Prospect Profile] 클래스에 추가되었습니다. |
| 데이터 유형 | (다수) | [[!UICONTROL Media details information]](https://github.com/adobe/xdm/pull/1716/files) 데이터 형식에 대해 여러 필드를 추가했습니다. |
| 데이터 유형 | [[!UICONTROL Session details information]](https://github.com/adobe/xdm/pull/1716/files) | 리디렉션 발생 여부를 나타내는 새 필드가 추가되었습니다. |
| 필드 그룹 | [[!UICONTROL MediaAnalytics Interaction Details]](https://github.com/adobe/xdm/pull/1716/files) | 미디어 관련된 신규 필드가 추가되었습니다. |
...
| 기능 | 설명 |
| --- | --- |
| Adobe Experience Cloud [!BADGE Beta]{type=Informative} 애플리케이션 내 파트너 ID 지원 | 이제 ID 서비스에서 파트너 ID를 사용할 수 있습니다. 파트너 ID는 데이터 파트너가 사람을 나타내기 위해 사용하는 식별자입니다. Real-Time Customer Data Platform에서 파트너 ID는 주로 확장된 대상자 활성화 및 데이터 보강에 사용됩니다. 파트너 ID는 ID 그래프에 저장되지 않습니다. 자세한 내용은 [ID 유형](../../identity-service/features/namespaces.md#identity-types)에 관한 설명서를 참조하십시오. |
...
| 초안 모드용 UI 지원 | 이제 사용자 인터페이스를 통해 소스 워크플로 도중 진행을 일시 중지하고 저장할 수 있습니다. 워크플로의 데이터 흐름 세부 정보, 매핑 및 예약 단계 중에 **[!UICONTROL Save as draft]**&#x200B;을(를) 선택하여 나중에 완료할 수 있도록 데이터 흐름을 초안으로 저장할 수 있습니다. 자세한 내용은 [UI에서 데이터 흐름을 초안으로 저장](../../sources/tutorials/ui/draft.md)에 관한 안내서를 참조하십시오. |
