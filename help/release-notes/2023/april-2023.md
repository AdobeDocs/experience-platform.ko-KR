...
| 기능 | 설명 |
| --- | --- |
| Salesforce CRM 소스의 행 수준 데이터 필터링을 위한 API 지원. | 논리 및 비교 연산자를 사용하여 Salesforce CRM 원본에 대한 행 수준 데이터를 필터링합니다. 의 안내서 읽기 [api를 사용하여 소스에 대한 데이터 필터링](../../sources/tutorials/api/filter.md) 추가 정보. |
