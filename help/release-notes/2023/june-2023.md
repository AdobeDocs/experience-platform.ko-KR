...
| 구성 요소 유형 | 이름 | 설명 |
| --- | --- | --- |
| 확장(Prospect-Profile) | [[!UICONTROL Adobe Unified Profile Service Prospect-Profile Union Extension]](https://github.com/adobe/xdm/pull/1735/files) | 잠재 고객 프로필 공용 구조체 스키마에 대한 필수 필드를 추가했습니다. |
| 확장 기능 | [[!UICONTROL Decisioning Asset]](https://github.com/adobe/xdm/pull/1732/files) | 의사 결정에 사용되는 자산을 나타내는 데이터 유형을 추가합니다. [!UICONTROL Decisioning Asset]은(는) `decisionItems`을(를) 렌더링하는 데 사용되는 에셋에 대한 참조를 제공합니다. |
| 데이터 유형 | [[!UICONTROL Commerce]](https://github.com/adobe/xdm/pull/1747/files) | [!UICONTROL Commerce]에서 구매 및 판매 활동과 관련된 레코드를 저장합니다. |
| 필드 그룹 | [[!UICONTROL Profile Partner Enrichment(Sample)]](https://github.com/adobe/xdm/pull/1747/files) | 프로필 파트너 보강을 위해 샘플 스키마가 추가되었습니다. |
| 필드 그룹 | [[!UICONTROL Partner Prospect Details(Sample)]](https://github.com/adobe/xdm/pull/1747/files) | 데이터 공급업체의 잠재 고객 프로필 확장 기능에 대한 샘플 스키마가 추가되었습니다. |
| 데이터 유형 | [[!UICONTROL Commerce Scope]](https://github.com/adobe/xdm/pull/1747/files) | [!UICONTROL Commerce Scope]은(는) 이벤트가 발생한 위치를 식별합니다. 예를 들면 스토어 보기, 스토어 또는 웹 사이트 등이 있습니다. |
| 데이터 유형 | [[!UICONTROL Billing]](https://github.com/adobe/xdm/pull/1734/files) | 하나 이상의 지불에 대한 청구 정보가 [!UICONTROL Commerce] 스키마에 추가되었습니다. |
...
| 구성 요소 유형 | 이름 | 설명 업데이트 |
| --- | --- | --- |
| 필드 그룹 | [[!UICONTROL MediaAnalytics Interaction Details]](https://github.com/adobe/xdm/pull/1736/files) | `bitrateAverageBucket`이 100에서 “800-899”로 변경되었습니다. |
| 데이터 유형 | [[!UICONTROL Qoe Data details information]](https://github.com/adobe/xdm/pull/1736/files) | `bitrateAverageBucket` 데이터 유형이 문자열로 변경되었습니다. |
| 필드 그룹 | [[!UICONTROL Segment Membership Details]](https://github.com/adobe/xdm/pull/1735/files) | 잠재 고객 프로필 클래스에 추가되었습니다. |
| 스키마 | [[!UICONTROL Computed Attributes System Schema]](https://github.com/adobe/xdm/pull/1735/files) | ID 맵이 [!UICONTROL Computed Attributes System Schema]에 추가되었습니다. |
| 데이터 유형 | [[!UICONTROL Content Delivery Network]](https://github.com/adobe/xdm/pull/1733/files) | 사용된 콘텐츠 전달 네트워크를 설명하는 필드가 [!UICONTROL Session details information]에 추가되었습니다. |
| 확장 기능 | [[!UICONTROL Adobe Unified Profile Service Account Union Extension]](https://github.com/adobe/xdm/pull/1731/files) | ID 맵이 [!UICONTROL Adobe Unified Profile Service Account Union Extension]에 추가되었습니다. |
| 데이터 유형 | [[!UICONTROL Order]](https://github.com/adobe/xdm/pull/1730/files) | `discountAmount`이(가) [!UICONTROL Order]에 추가되었습니다. 이는 일반 주문 가격과 특별 가격 간의 차이를 나타냅니다. 개별 상품이 아닌 전체 주문에 적용됩니다. |
| 스키마 | [[!UICONTROL AEP Hygiene Operation Request]](https://github.com/adobe/xdm/pull/1728/files) | 데이터 위생 작업을 처리하는 서비스 이름을 제공하기 위해 `targetServices` 필드가 추가되었습니다. |
| 데이터 유형 | [[!UICONTROL Shipping]](https://github.com/adobe/xdm/pull/1727/files) | `currencyCode`가 하나 이상의 제품에 대한 배송 정보에 추가되었습니다. 제품 가격 책정에 사용되는 ISO 4217 알파벳 통화 코드입니다. |
| 데이터 유형 | [[!UICONTROL Application]](https://github.com/adobe/xdm/pull/1726/files) | 애플리케이션에 사용자의 언어적, 지리적 또는 문화적 환경 설정을 제공하기 위해 `language` 필드가 추가되었습니다. |
| 확장 기능 | [[!UICONTROL AJO Entity Fields]](https://github.com/adobe/xdm/pull/1746/files) | 메시지를 마지막으로 수정한 시간을 나타내기 위해 [!UICONTROL AJO Timestamp Entity]을(를) 추가했습니다. |
...
| 예약된 쿼리 UI 업데이트 | [[!UICONTROL Scheduled Queries tab]](../../query-service/ui/monitor-queries.md#inline-actions)을(를) 사용하여 UI의 한 위치에서 모든 예약된 쿼리를 관리합니다. 인라인 쿼리 작업과 새 쿼리 상태 열을 추가하여 [!UICONTROL Scheduled Queries] UI가 개선되었습니다. 최근 추가 기능에는 [!UICONTROL Scheduled Queries] 보기에서 예정된 쿼리 실행에 대한 경고를 직접 구독하거나 일정을 활성화, 비활성화 및 삭제하는 기능이 포함됩니다. <p>![인라인 작업이 [!UICONTROL Scheduled Queries] 보기에서 강조 표시되었습니다.](../../query-service/images/ui/monitor-queries/inline-actions.png "인라인 작업이 [!UICONTROL Scheduled Queries] 보기에서 강조 표시되었습니다."){width="100" zoomable="yes"}</p> |
...
| 기능 | 설명 |
| --- | --- |
| Adobe Analytics 분류 소스 데이터 흐름 삭제 지원 | 이제 Adobe Analytics 분류를 소스로 사용하는 소스 데이터 흐름을 삭제할 수 있습니다. **[!UICONTROL Sources]** > **[!UICONTROL Dataflows]**&#x200B;에서 원하는 데이터 흐름을 선택한 다음 삭제를 선택합니다. 자세한 내용은 [Adobe Analytics 분류 데이터의 소스 연결을 만드는 방법](../../sources/tutorials/ui/create/adobe-applications/classifications.md)에 관한 안내서를 참조하십시오. |
...
| [!BADGE 에 대한 ]{type=Informative}Beta[!DNL RainFocus] 지원 | 이제 [!DNL RainFocus] 소스 통합을 사용해 Experience Platform [!DNL RainFocus] 계정의 이벤트 관리 및 분석 데이터를 가져올 수 있습니다. 자세한 내용은 [[!DNL RainFocus] 소스 개요](../../sources/connectors/analytics/rainfocus.md)를 참조하십시오. |
