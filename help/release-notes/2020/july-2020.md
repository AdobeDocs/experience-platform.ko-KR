...
| Adobe Audience Manager 통합 | [!DNL Platform]의 [!DNL Audience Manager]과(와) 공유되는 모든 세그먼트는 적용된 데이터 사용 레이블을 [!DNL Data Export Controls](으)로 상속하며 그 반대의 경우도 마찬가지입니다. 사용 레이블과 데이터 내보내기 제어 간의 특정 [매핑에 대한 [!DNL Audience Manager] 설명서를 참조하십시오](https://experienceleague.adobe.com/docs/audience-manager/user-guide/implementation-integration-guides/integration-experience-platform/aam-aep-audience-sharing.html). |
...
| 기능 | 설명 |
| ------- | ----------- |
| 스트리밍 세분화 | 스트리밍 세분화는 데이터가 [!DNL Platform]에 도달하므로 세그먼트를 통해 사용자 자격을 얻을 수 있으므로 세그먼트 자격 시간을 크게 줄일 수 있습니다. 스트리밍 세그먼테이션을 사용하면 세그먼테이션 작업을 수동으로 실행해야 하는 불편함도 줄일 수 있습니다. |
