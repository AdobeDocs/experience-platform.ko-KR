...
| Adobe Audience Manager 통합 | [!DNL Audience Manager]의 [!DNL Experience Platform]과(와) 공유되는 모든 세그먼트는 적용된 데이터 사용 레이블을 [!DNL Data Export Controls]&#x200B;(으)로 상속하며 그 반대의 경우도 마찬가지입니다. 사용 레이블과 데이터 내보내기 제어 간의 특정 [!DNL Audience Manager]매핑에 대한 [ 설명서를 참조하십시오](https://experienceleague.adobe.com/docs/audience-manager/user-guide/implementation-integration-guides/integration-experience-platform/aam-aep-audience-sharing.html). |
...
| 기능 | 설명 |
| ------- | ----------- |
| 데이터 사용 정책 시행 | [!DNL Real-Time Customer Data Platform] 작업 영역에서 위반 작업이 시도되면 [!UICONTROL Profile]에서 데이터 사용 정책 위반이 자동으로 표시됩니다. 자동 정책 적용에 대한 자세한 내용은 [데이터 거버넌스에 대한 릴리스 정보](#governance)를 참조하십시오. |
...
| 데이터 사용 정책 시행 | [!DNL Real-Time Customer Data Platform] 작업 영역에서 위반 작업이 시도되면 [!UICONTROL Segments]에서 데이터 사용 정책 위반이 자동으로 표시됩니다. 자동 정책 적용에 대한 자세한 내용은 [데이터 거버넌스에 대한 릴리스 정보](#governance)를 참조하십시오. |
