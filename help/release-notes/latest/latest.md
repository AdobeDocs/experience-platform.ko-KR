...
| 계산된 통계의 별칭 이름 | 이제 별칭 이름을 제공하여 SQL 쿼리에서 계산된 통계의 결과를 설명적으로 참조할 수 있습니다. COMPUTE STATISTICS 명령에 대한 이 업데이트 및 기타 업데이트에 대한 내용은 설명서를 참조하십시오. 자세한 내용은 [설명서](../../query-service/essential-concepts/dataset-statistics.md#alias-name)를 참조하십시오. |
