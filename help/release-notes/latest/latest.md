...
프로필 데이터 보강 모니터링 방법에 대한 안내서는 다음 문서를 참조하십시오 [UI에서 프로필 보강 모니터링](../../dataflows/ui/b2b/monitor-profile-enrichment.md). 실시간 CDP B2B Edition에 대한 자세한 내용은 [실시간 CDP B2B 개요](../../rtcdp/overview.md).
