...
| 자사 디바이스 ID | 이제 Experience Platform Web SDK을 사용하여 고객 데이터를 수집할 때 자신의 장치 ID를 Adobe Experience Platform Edge Network으로 보낼 수 있습니다. 이렇게 하면 서드파티 쿠키 수명 주기에 대한 최근 브라우저 제한 사항에 대한 해결 방법을 제공합니다. 자세한 내용은 [자사 장치 ID](/help/collection/identity/fpid.md)의 안내서를 참조하십시오. |
