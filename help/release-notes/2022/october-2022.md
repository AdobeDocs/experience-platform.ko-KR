...
| 기능 | 설명 |
| --- | --- |
| 데이터스트림에 대한 중요한 데이터 처리 | 이제 데이터 스트림은 여러 플랫폼 기술을 활용하여 HIPAA(Health Insurance Portability and Accountability Act)와 같은 규정에 따라 민감한 데이터를 적절하게 처리합니다. 자세한 내용은 [데이터 스트림에서 중요 데이터 처리](../../datastreams/overview.md#sensitive)에 대한 섹션을 참조하십시오. |
| 이벤트 전달을 위한 [!DNL Splunk] 확장 | 이제 [이벤트 전달](../../tags/ui/event-forwarding/overview.md) 확장을 사용하여 [!DNL Splunk]에 데이터를 보낼 수 있습니다. 자세한 내용은 [[!DNL Splunk] 확장 개요](../../tags/extensions/server/splunk/overview.md)를 참조하십시오. |
| 이벤트 전달을 위한 [!DNL Zendesk] 확장 | 이제 [이벤트 전달](../../tags/ui/event-forwarding/overview.md) 확장을 사용하여 [!DNL Zendesk]에 데이터를 보낼 수 있습니다. 자세한 내용은 [[!DNL Zendesk] 확장 개요](../../tags/extensions/server/zendesk/overview.md)를 참조하십시오. |
