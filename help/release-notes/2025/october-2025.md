...
| [!DNL Azure Event Hubs] 가상 네트워크 지원 | Adobe은 이제 [[!DNL Azure Event Hubs]](../../sources/connectors/cloud-storage/eventhub.md)에 대한 가상 네트워크 연결을 명시적으로 지원하므로 공용 네트워크가 아닌 개인 네트워크를 통해 데이터를 전송할 수 있습니다. 고객은 Experience Platform VNet를 통해 이벤트 백본을 비공개로 라우팅하여 데이터 수집 워크플로우에 대한 향상된 보안 및 규정 준수를 제공할 수 있습니다. |
