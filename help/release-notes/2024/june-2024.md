...
| 기능 | 설명 |
| --- | --- |
| Experience Platform의 AI 어시스턴트 | 이제 Experience Platform에서 AI 어시스턴트를 사용할 수 있습니다. AI 어시스턴트는 Experience Platform, Real-Time CDP, Adobe Journey Optimizer 및 Customer Journey Analytics를 지원합니다. <br> Exprience Experience Platform의 ![AI 길잡이.Exprience Experience Platform의 ](../2024/assets/june/ai-assistant-full.png "AI 길잡이."){width="100" zoomable="yes"} <br> 이 기능에 대한 자세한 내용은 [AI 어시스턴트 UI 안내서](../../ai-assistant/ui-guide.md)를 참조하십시오. |
