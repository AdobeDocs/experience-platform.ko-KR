...
- [!BADGE 제한된 가용성]{type=Informative} [페더레이션 대상 구성](#federated-audience-composition)
...
| 유형 | 기능 | 설명 |
| --- | --- | --- |
| Web SDK | 제안 상호작용 자동 추적 | 이제 Web SDK의 `autoCollectPropositionInteractions` 속성을 사용하여 Web SDK가 제안 상호작용을 자동으로 수집해야 하는지 여부를 결정할 수 있습니다. 자세한 내용은 [`autoCollectPropositionInteractions`](/help/collection/js/commands/configure/autocollectpropositioninteractions.md) 설명서를 참조하십시오. |
