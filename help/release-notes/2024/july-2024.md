...
통합 태그를 사용하면 Adobe Experience Platform 내에서 비즈니스 오브젝트를 분류하고 관리할 수 있습니다. 통합 태그 API를 사용하면 폴더와 태그를 모두 만들어 대상이나 데이터 세트와 같은 Experience Platform 개체를 보다 효율적으로 구성할 수 있습니다.
