...
| 기능 | 설명 |
| --- | --- |
| 확장된 앱 보고를 위한 SQL Insights | [SQL 분석 결과를 이해하기 쉽고 비즈니스 친화적인 시각적 형식으로 원활하게 전환](../../dashboards/data-distiller/sql-insights/overview.md)합니다. 사용자 정의 SQL 쿼리를 사용하여 정확한 데이터 조작과 다양한 구조화 데이터 세트에서 동적 차트를 생성합니다. 쿼리 프로 모드를 사용하여 SQL로 복잡한 분석을 수행한 후 사용자 정의 대시보드의 차트를 통해 비기술 사용자와 이 분석을 공유하거나 CSV 파일로 내보낼 수 있습니다. |
