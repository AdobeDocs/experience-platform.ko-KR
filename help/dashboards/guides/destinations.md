...
* [[!UICONTROL 가장 많이 사용한 대상]](#most-used-destinations)
...
>title="가장 많이 사용한 대상"
>abstract="이 위젯은 매핑된 세그먼트의 수별로 조직의 가장 활성 대상을 표시합니다. 이 수치는 마지막 스냅샷 시 정확합니다. 이 등급은 현재 가장 많이 사용되는 대상에 대한 통찰력을 제공하는 동시에 활용도가 낮을 수 있는 대상을 강조 표시합니다."
...
>title="최근에 활성화된 세그먼트"
>abstract="이 위젯은 대상에 가장 최근에 매핑된 세그먼트의 목록을 제공합니다. 이 목록은 시스템에서 사용 중인 세그먼트 및 대상의 스냅샷을 제공하며 잘못된 매핑을 해결하는 데 도움이 됩니다."

다음 **[!UICONTROL 최근에 활성화된 세그먼트]** 위젯은 대상에 가장 최근에 매핑된 세그먼트의 목록을 제공합니다. 이 목록은 시스템에서 사용 중인 세그먼트 및 대상의 스냅샷을 제공하며 잘못된 매핑을 해결하는 데 도움이 됩니다.
...
>title="대상자 크기 트렌드"
>abstract="이 위젯은 매일 대상 계정으로 전송되는 세그먼트에 포함된 프로필 수를 보여줍니다. 첫 번째 드롭다운 메뉴는 대상 트렌드에 대한 기간을 조정합니다. 두 번째 위젯 드롭다운 메뉴에서 분석할 세그먼트를 선택합니다. 개요 드롭다운에서 대상을 선택합니다."
...
>abstract="이 위젯은 상위 5개를 나열합니다. **매핑되지 않음** 지정된 대상 및 id에 대한 id 수를 내림차순으로 순위를 매긴 세그먼트입니다. 위젯 드롭다운에 나열된 필터 ID는 개요 페이지의 맨 위에서 선택한 대상 계정에 따라 변경됩니다."
...
>title="ID별로 매핑된 세그먼트"
>abstract="이 위젯은 의 상위 5개 목록을 제공합니다. **매핑됨** 세그먼트. 세그먼트 내에 포함된 소스 ID의 수에 따라 목록이 높음에서 낮음 순으로 정렬됩니다. 위젯 제목 아래의 드롭다운 메뉴에서 계산할 대상 ID가 선택됩니다. 위젯 드롭다운에서 사용할 수 있는 대상 ID는 개요 대시보드 맨 위에서 선택한 대상에 따라 다릅니다."

이 위젯은 의 상위 5개 목록을 제공합니다. **매핑됨** 세그먼트. 세그먼트 내에 포함된 소스 ID의 수에 따라 목록이 높음에서 낮음 순으로 정렬됩니다. 위젯 제목 아래의 드롭다운 메뉴에서 계산할 대상 ID가 선택됩니다. 위젯의 드롭다운에서 사용할 수 있는 대상 ID는 개요 대시보드 맨 위에서 선택한 대상 계정 필터에 따라 변경됩니다.
...
### 일반 대상자 {#common-audiences}

>[!CONTEXTUALHELP]
>id="platform_dashboards_destinations_commonaudiences"
>title="일반 대상자"
>abstract="이 위젯은 페이지 상단에서 선택한 대상 계정 전체에 걸쳐 활성화된 상위 5개 세그먼트 목록과 위젯 드롭다운에서 선택한 대상을 제공합니다. 세그먼트 목록은 활성화된 최근 정도에 따라 순서가 지정됩니다. 가장 최근에 활성화된 세그먼트가 맨 위에 표시됩니다."

다음 **[!UICONTROL 일반 대상자]** 위젯 은 페이지 상단에 선택된 대상 계정 간에 활성화된 상위 5개 세그먼트 목록과 위젯 드롭다운에서 선택된 대상을 제공합니다. 세그먼트 목록은 활성화된 최근 정도에 따라 순서가 지정됩니다. 가장 최근에 활성화된 세그먼트가 맨 위에 표시됩니다.
...
>title="매핑된 대상자 상태"
>abstract="이 위젯에서는 총 프로필 수가 해당 대상에 매핑된 30일 평균 대상 크기에서 최소 하나 이상의 표준 편차 배율로 벗어난 최대 20개의 매핑된 세그먼트 목록을 제공합니다. 지난 30일 동안의 평균에서 대상 크기의 분산에 대해 계산된 지표를 제공합니다. 대상자 크기는 높음에서 낮음순으로 정렬됩니다."
...
>title="대상 개수"
>abstract="이 위젯은 시스템 내에서 대상을 활성화하고 전달할 수 있는 총 사용 가능한 엔드포인트 수를 제공합니다. 이 숫자는 활성 및 비활성 대상을 모두 포함합니다."

다음 [!UICONTROL 대상 개수] 위젯은 시스템 내에서 대상을 활성화하고 전달할 수 있는 총 사용 가능한 엔드포인트 수를 제공합니다. 이 숫자는 활성 및 비활성 대상을 모두 포함합니다.
