...
플랫폼 UI 내의 라이센스 사용 대시보드로 이동하려면 왼쪽 레일에서 **[!UICONTROL License usage]**&#x200B;을 선택합니다. 대시보드가 표시되는 **[!UICONTROL Overview]** 탭으로 열립니다.

![](../images/license-usage/dashboard-overview.png)

### 샌드박스 선택

대시보드에서 볼 샌드박스를 선택하려면 [!UICONTROL Production] 또는 [!UICONTROL Development] 중 하나를 선택합니다. 선택한 샌드박스는 샌드박스 이름 옆에 있는 라디오 버튼으로 표시됩니다.

>[!NOTE]
>
>샌드박스에 대한 소비 보고는 동일한 유형의 모든 샌드박스에 대해 누적됩니다. 즉, [!UICONTROL Production] 또는 [!UICONTROL Development]을 선택하면 모든 프로덕션 또는 개발 샌드박스에 대한 소비 보고서가 각각 제공됩니다.

![](../images/license-usage/select-sandbox.png)

### 날짜 범위 선택

샌드박스를 선택한 후 날짜 범위 드롭다운을 사용하여 대시보드에 표시할 기간을 선택할 수 있습니다. 다음 3가지 옵션을 사용할 수 있습니다.[!UICONTROL Last 30 days], [!UICONTROL Last 90 days] 및 [!UICONTROL Last 12 months]. 최근 30일은 기본적으로 선택됩니다.
...
* [!UICONTROL Addressable Audience] (프로필 수로 측정됨)
