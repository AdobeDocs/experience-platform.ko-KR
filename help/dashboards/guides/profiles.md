...
>title="프로필 개수"
>abstract="이 위젯은 스냅샷이 생성된 시간에 프로필 저장소 내에서 병합된 총 프로필 수를 표시합니다. 숫자는 프로필 데이터에 적용되는 선택한 병합 정책에 따라 다릅니다."
...
>title="프로필 개수 변경"
>abstract="이 위젯은 마지막 스냅샷이 생성된 시간에 프로필 저장소에 **추가된** 병합 프로필의 총 개수를 표시합니다. 숫자는 프로필 데이터에 적용되는 선택한 병합 정책에 따라 다릅니다."
...
>title="ID별 프로필"
>abstract="이 위젯은 프로필 저장소에 있는 모든 병합된 프로필의 분석을 ID별로 표시합니다."
...
>title="ID 중첩"
>abstract="이 위젯은 벤 다이어그램을 사용하여 선택한 두 ID를 포함하는 프로필 저장소의 프로필 중첩을 표시합니다."
