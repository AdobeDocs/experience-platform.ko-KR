...
대시보드를 보고 관리하려면 다음 위치로 이동하십시오 **[!UICONTROL 대시보드]** Experience Platform UI(사용자 인터페이스)에서 **[!UICONTROL 찾아보기]** 탭 을 클릭하여 대시보드 인벤토리에 액세스합니다.

보려는 대시보드에 대해 UI 내의 적절한 섹션으로 이동하여 대시보드에 액세스할 수도 있습니다. 예를 들어 프로필에 대한 대시보드를 보려면 다음 위치로 이동합니다. **[!UICONTROL 프로필]** 작업 영역을 선택하고 **[!UICONTROL 개요]** 탭.
...
사용 방법에 대한 자세한 단계는 **[!UICONTROL 대시보드]** 사용 가능한 모든 대시보드를 보려면 작업 영역 을 참조하십시오. [대시보드 인벤토리 안내서](./inventory.md).
