...
Power BI 보고서 템플릿 기능을 사용하면 Adobe Experience Platform의 데이터로 채워진 강력한 보고서를 작성할 수 있습니다. 간소화된 설치 프로세스는 실시간 고객 프로필, 세그멘테이션 및 대상에 대한 표준 위젯을 자동으로 설치합니다. 이러한 설치를 통해 Power BI가 데이터 모델에 연결되므로 보고서 템플릿을 손쉽게 맞춤화하고 확장할 수도 있습니다. 이러한 보고서는 Platform에서 조직에 대한 자격 증명을 필요로 하는 수신자 없이 전체 조직에서 공유할 수 있습니다.
