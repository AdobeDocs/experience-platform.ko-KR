...
![새 위젯 추가 가 강조 표시된 빈 대시보드입니다.](./images/user-defined-dashboards/add-new-widget.png)
...
![선택 항목이 강조 표시된 데이터 선택 대화 상자입니다.](./images/user-defined-dashboards/select-a-table.png)
...
![위젯에서 값을 필터링하는 필터 대화 상자입니다.](./images/user-defined-dashboards/filter-dialog.png)
...
![필터: date_key] 대화 상자에 [!UICONTROL 최근 날짜] 및 [!UICONTROL 적용]이 강조 표시되어 있습니다.](./images/user-defined-dashboards/recent-date.png)[!UICONTROL 
...
![일별 확인란이 있는 [!UICONTROL 필터: date_key] 대화 상자를 선택하고 선택하지 않습니다.](./images/user-defined-dashboards/select-dates.png)
...
![사용자 지정 위젯과 저장 단추가 강조 표시된 사용자 정의 대시보드입니다.](./images/user-defined-dashboards/user-defined-dashboard.png)
...
![줄임표 및 중복 위젯이 강조 표시된 사용자 지정 대시보드의 위젯입니다.](./images/user-defined-dashboards/duplicate.png)
