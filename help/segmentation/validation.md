...
>title="쿼리 효율성 경고"
>abstract="대상자에 쿼리가 너무 많아 불필요한 논리적 복잡성이 발생합니다. 계속하기 전에 대상자 정의를 단순화합니다."
...
>title="이벤트 시퀀스 제한"
>abstract="대상자에 순차적 이벤트가 너무 많습니다. 대상자 정의 내에서 최대 6개의 순차 이벤트만 가질 수 있습니다. 계속하기 전에 대상자 정의에서 일부 순차적 이벤트를 제거합니다."
...
### [!BADGE 성과 최적화]{type=Caution} 집계된 수 {#aggregated-count}

>[!CONTEXTUALHELP]
>id="platform_segmentation_segmentbuilder_countaggregationcheck"
>title="카운트 필터 경고"
>abstract="대상자에 집계 이벤트가 너무 많습니다. 대상자 내에서 최대 3개의 집계 이벤트를 사용해야 합니다. 성과 문제를 방지하려면 대상자 정의에서 일부 집계 이벤트를 제거해야 합니다."
...
### [!BADGE 성과 최적화]{type=Caution} 중첩된 데이터 복잡성 {#nested-data-complexity}

>[!CONTEXTUALHELP]
>id="platform_segmentation_segmentbuilder_arraydepthcheck"
>title="중첩 데이터 경고"
>abstract="대상자에 중첩된 데이터 레이어가 너무 많습니다. 대상자 내에서 최대 2개의 데이터 레이어를 사용해야 합니다. 성과 문제를 방지하려면 대상자 정의를 평면화해야 합니다."
...
### [!BADGE 성과 최적화]{type=Caution} 대상자 수 {#audience-size}

>[!CONTEXTUALHELP]
>id="platform_segmentation_segmentbuilder_profilestorecheck"
>title="대상자 수 경고"
>abstract="대상자가 너무 광범위하게 작성되었습니다. 샌드박스에서 전체 프로필의 30% 이상을 충족하는 대상자 정의를 작성하지 마십시오. 성과 문제를 방지하려면 대상자 정의를 강화해야 합니다."
