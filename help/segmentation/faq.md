...
세그먼트 빌더가 대상자에게 더 적합합니다. **생성** (처음부터 대상을 작성할 경우), 대상 구성은 대상에 더 적합합니다. **큐레이션** (기존 대상을 기반으로 새 대상을 만드는 경우).

다음 표는 두 서비스의 차이점을 보여 줍니다.

| 세그먼트 빌더 | 대상자 구성 |
| --------------- | -------------------- |
| <ul><li>단일 스테이지 대상자 생성</li><li>프로필, 시계열 및 다중 엔티티 데이터에서 대상의 기본 블록을 만듭니다</li><li>을 만드는 데 사용됨 **1** 대상자</li></ul> | <ul><li>집합 기반 작업을 사용하는 다단계 대상 생성</li><li>세그먼트 빌더에서 만든 대상자를 사용하고 프로필 속성 순위 지정과 같은 데이터 보강 옵션을 적용합니다</li><li>을 만드는 데 사용됨 **복수** 한 번에 대상 수</li></ul> |
