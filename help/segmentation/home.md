...
>[!NOTE] 스키마가 확장되는 경우 모든 향후 업로드가 그에 따라 새로 추가된 필드를 업데이트해야 합니다. XDM(Experience Data Model) 사용자 지정에 대한 자세한 내용은 [스키마 편집기 자습서를 참조하십시오](../xdm/tutorials/create-schema-ui.md).
...
>[!NOTE] 세그먼트를 계획할 때는 다른 세그먼트에서 세그먼트를 참조하고 결합할 수 있습니다. 이름을 선택할 때 세그먼트에 재사용 가능한 부분이 포함될 수 있습니다.
