...
스트리밍 세분화를 사용하면 스트리밍 데이터가 플랫폼으로 들어올 때 대상 자격이 발생하여 세분화 작업을 예약하고 실행해야 할 필요가 줄어듭니다. 이렇게 하면 Platform으로 전달된 데이터를 평가할 수 있으므로 대상 멤버십을 자동으로 최신 상태로 유지할 수 있습니다.
...
플랫폼에서 대상을 보는 방법에 대한 자세한 내용은 [대상 포털 안내서](../ui/audience-portal.md)를 참조하십시오.
