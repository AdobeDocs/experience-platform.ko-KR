...
| 프로필만 | 프로필 속성만 참조하는 모든 세그먼트 정의. | `homeAddress.country.equals("Canada", false)` | ![프로필 특성의 예제가 표시됩니다.](../images/methods/streaming/profile-attribute.png) |
...
- 세그먼트 정의는 다음 규칙 세트와 일치합니다.
   - 기간이 24시간을 초과하는 단일 이벤트
      - 예를 들어 &quot;지난 3일 동안 웹 페이지를 본 모든 프로필로 대상자 활성화&quot;가 있습니다.
   - 시간 창이 없는 단일 이벤트
      - 예를 들어 &quot;웹 페이지를 본 모든 프로필로 대상자 활성화&quot;가 있습니다.
...
세그먼트 빌더 내에서 [적격 규칙 세트](#eligible-rulesets) 중 하나와 일치하는 세그먼트 정의를 만듭니다. 세그먼트 정의가 스트리밍 세분화에 적합한 경우 **[!UICONTROL Streaming]**&#x200B;을(를) **[!UICONTROL Evaluation method]**(으)로 선택할 수 있습니다.
...
**[!UICONTROL New audience updated]** 지표는 스트리밍 세분화를 통해 대상 크기의 변화를 보여 주는 선 그래프로 표시됩니다. 드롭다운을 조정하여 지난 24시간, 지난 주 또는 지난 30일을 표시할 수 있습니다.
...
이 섹션에서는 스트리밍 세분화에 대한 보충 정보를 제공합니다.

### 2025년 5월 20일 자격 업데이트 {#may-20-eligibility-update}

다음 섹션에서는 2025년 5월 Experience Platform 릴리스 동안 발생한 스트리밍 세분화 자격 업데이트에 대한 전체 세부 사항을 간략하게 설명합니다.
...
>[!NOTE]
>
>일괄 데이터를 사용할 때 스트리밍 세분화를 정확하게 유지하려면 일괄 처리 데이터가 일괄 처리 대상 내에 **만**&#x200B;이고 스트리밍 대상 내에서 참조되었는지 확인하십시오.
