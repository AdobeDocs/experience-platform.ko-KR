...
날짜 데이터를 사용하면 특정 시작/종료 날짜를 사용하거나 아래 표에 표시된 대로 날짜 관련 문을 사용하여 세그먼트 정의에 시간 기반 컨텍스트를 할당할 수 있습니다. 한 가지 구현으로 인해 언제든지 브랜드와 상호 작용한 고객 대상자를 만들 수 있습니다 *올해* 및 도 활성화되었습니다 *within* 지난 며칠 동안
...
Adobe Experience Platform 스키마로, [!DNL XDM ExperienceEvents] 명시적 및 암시적 고객 상호 작용 [!DNL Platform]-상호 작용 발생 당시 시스템의 스냅샷을 포함한 통합 애플리케이션 [!DNL ExperienceEvents] 는 사실 레코드입니다. 따라서 세그먼트 정의 중에 사용할 수 있는 데이터 소스입니다.
...
현재, Adobe Audience Manager만 외부 대상자로 지원되며, 차후에 추가 소스가 활성화됩니다. Platform에서 Adobe Audience Manager 대상 사용에 대한 자세한 내용은 [Adobe Audience Manager 설명서 내의 대상 공유 안내서](https://experienceleague.adobe.com/docs/audience-manager/user-guide/implementation-integration-guides/integration-experience-platform/aam-aep-audience-sharing.html).

### 세그먼트 공유

Platform에서 생성된 세그먼트는 다른 세그먼트 내에서 사용할 수 있습니다 [Adobe Experience Cloud 핵심 서비스](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html?lang=ko-KR). 이 기능을 사용하려면 솔루션 설계자 또는 컨설턴트에게 문의해야 합니다.
