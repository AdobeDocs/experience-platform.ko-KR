...
| `metrics.segmentProfileByStatusCounter` | 각 상태에 대한 프로필 수입니다. 지원되는 세 가지 상태는 다음과 같습니다. <ul><li>&quot;실현됨&quot; - 세그먼트에 적합한 프로필 수입니다.</li><li>&quot;종료한&quot; - 세그먼트에 더 이상 존재하지 않는 프로필 세그먼트의 수입니다.</li></ul> |
