...
성공적인 응답은 JSON으로 지정된 IMS 조직에 대한 일정 목록과 함께 HTTP 상태 200을 반환합니다.
...
| `value` | 일정 상태의 업데이트된 값. 이 값은 일정을 활성화하거나 비활성화하기 위해 &quot;활성&quot; 또는 &quot;비활성&quot;으로 설정할 수 있습니다. 다음을 참고하십시오. **할 수 없음** ims 조직이 스트리밍에 대해 활성화된 경우 일정을 비활성화합니다. |
