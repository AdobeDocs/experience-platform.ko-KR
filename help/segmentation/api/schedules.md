...
성공적인 응답은 지정된 조직의 일정 목록이 JSON인 HTTP 상태 200을 반환합니다.
...
| `value` | 일정 상태의 업데이트된 값입니다. 이 값을 &quot;활성&quot; 또는 &quot;비활성&quot;으로 설정하여 일정을 활성화하거나 비활성화할 수 있습니다. 참고 사항 **사용할 수 없음** 조직에서 스트리밍을 사용하도록 설정한 경우 예약을 비활성화합니다. |
