...
>[!NOTE]
>
>스트리밍 세그먼테이션은 플랫폼으로 스트리밍되는 데이터를 평가하는 데에만 사용할 수 있습니다. 즉, 일괄 처리를 통해 수집되는 데이터는 스트리밍 세그멘테이션을 통해 평가되지 않고 일괄 평가가 트리거되어야 합니다.
...
- [[!DNL 세그멘테이션]](../home.md):데이터에서 세그먼트 및 대상을 만들 수 있는 기능을 [!DNL Real-time Customer Profile] 제공합니다.
