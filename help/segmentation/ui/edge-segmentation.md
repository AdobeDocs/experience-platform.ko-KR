...
title: Edge 세그먼트 지정 UI 가이드
topic-legacy: ui guide
description: Edge 세그먼트화는 Platform의 세그먼트를 엣지에 즉시 평가하여 동일한 페이지 및 다음 페이지 개인 설정 사용 사례를 가능하게 하는 기능입니다.
...
# Edge 세그먼트화 UI 가이드(베타)

>[!IMPORTANT]
>
>에지 세그먼트가 현재 베타에 있습니다. 설명서 및 기능은 변경될 수 있습니다.
...
다음 쿼리 형식은 **현재 에지 세그먼트화에 지원되지 않는**&#x200B;입니다.
...
이 안내서에서는 Adobe Experience Platform에서 가장자리 세그먼트화를 사용하여 세그먼트를 평가하는 방법에 대해 설명합니다. 경험 플랫폼 사용자 인터페이스 사용에 대한 자세한 내용은 [세그먼트 지정 사용 설명서](./overview.md)를 참조하십시오. 유사한 작업을 수행하고 Experience Platform API를 사용하여 세그먼트를 작업하는 방법에 대해 알아보려면 [edge segmentation API 안내서](../api/edge-segmentation.md)를 참조하십시오.
