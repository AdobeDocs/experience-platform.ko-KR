...
>title="데이터 만료"
>abstract="대상자 멤버십이 만료되는 기간(일)입니다. 이 값은 1일에서 180일까지 설정할 수 있습니다. 대상 멤버십이 만료되면 평가가 중지되고 모든 프로필이 대상 멤버십을 종료합니다. 대상자 멤버십이 7일 미만 남은 경우 만료 창을 새로 고칠 수 있습니다. 그러나 0일이 남으면 만료 창을 새로 고칠 수 없습니다."
