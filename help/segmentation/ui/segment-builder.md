...
![설정 아이콘](/help/images/icons/settings.png)을 선택하여 표시되는 필드에 대한 설정을 조정할 수 있습니다.

**[!UICONTROL Available fields]**&#x200B;의 경우 데이터가 포함된 필드 또는 전체 XDM 스키마만 표시할 수 있습니다.

**[!UICONTROL Data sources]**&#x200B;의 경우 지정된 수집 유형에서 가져온 특성을 표시하도록 필터링할 수 있습니다. 지원되는 값은 **[!UICONTROL Show batch data]**, **[!UICONTROL Show streaming/edge data]** 및 **[!UICONTROL Show fields with no ingested data]**&#x200B;입니다.

**[!UICONTROL Merge policy]**&#x200B;의 경우 필드가 속한 병합 정책을 선택할 수 있습니다.

![세그먼트 빌더 내에 설정 영역이 표시됩니다.](../images/ui/segment-builder/settings.png)
...
특성을 선택하면 [정보 아이콘](../../images/icons/info.png)을 선택하여 요약 데이터를 볼 수 있습니다. 요약 데이터에는 필드 내용, 값의 레코드 수 및 이 속성에 대한 값이 포함된 계정의 백분율 설명과 같은 정보가 포함됩니다.

**[!UICONTROL Top values]** 섹션에는 특성에 대해 가장 자주 발생하는 값이 표시되며 값, 값이 있는 레코드 수 및 값이 나타내는 총 레코드 비율과 같은 세부 정보가 포함됩니다.

![특성에 대한 요약 데이터를 표시하는 팝오버](/help/segmentation/images/ui/segment-builder/summary-data.png)

특성이 프로필의 25% 미만으로 채워지는 경우에는 대신 ![데이터 알림 아이콘](../../images/icons/data-notice.png)이 표시됩니다. 속성에 관계없이 동일한 요약 데이터가 표시됩니다.

>[!NOTE]
>
>필드가 **not**&#x200B;에 너무 많은 다른 값을 포함하고 해당 필드의 값이 일반적으로 반복되는 경우에만 맨 위 값이 표시됩니다. 또한 이 요약 데이터는 **일별**&#x200B;로 업데이트됩니다.
...
![특성에 대한 수집 유형이 표시됩니다.](/help/segmentation/images/ui/segment-builder/ingestion-type.png)
