...
>title="외부 대상자"
>abstract="대상자 탭을 통해 가져온 대상자는 이제 대상자 포털을 통해 자동으로 표시됩니다. Audience Manager, Customer Journey Analytics, 세그먼트 매치 및 기타 사용자 정의 통합에서 수집된 대상자는 먼저 세그먼트 빌더에서 구성하지 않고도 쉽게 사용할 수 있습니다. 2025년 9월 1일부터 모든 대상자는 통합 검색을 통해서만 검색되며, 이전 워크플로는 더 이상 지원되지 않습니다."
...
>title="대상자 속성"
>abstract="대상 속성 섹션에는 예상 결과 대상 크기가 표시되며, 총 프로필 수와 비교하여 적격 프로필의 수가 표시됩니다. 이렇게 하면 대상 자체를 빌드하기 전에 필요에 따라 대상을 조정할 수 있습니다."
...
>title="적격 프로필"
>abstract="적격 프로필은 대상자의 규칙과 일치하는 실제 프로필 수를 나타냅니다. 이 숫자는 세그먼트 평가 작업이 실행된 후 24시간마다 업데이트됩니다."

>[!CONTEXTUALHELP]
>id="platform_segments_createsegment_segmentbuilder_estimatedprofiles"
>title="예상 프로필"
>abstract="예상 프로필은 샘플 작업을 기반으로 대상자의 규칙에 적합한 프로필의 대략적인 수를 나타냅니다."
