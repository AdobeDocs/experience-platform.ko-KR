...
>
>* 미국, 캐나다, 호주 및 뉴질랜드의 고객을 위해: Adobe은 Real-Time CDP Prime 및 Ultimate 고객이 데이터 공동 작업 사용 사례를 [!DNL Segment Match]에서 Real-Time CDP Collaboration으로 전환할 것을 권장합니다. Real-Time CDP Collaboration에 대한 [설명서](https://experienceleague.adobe.com/ko/docs/real-time-cdp-collaboration/using/home) 및 [빠른 시작 안내서](https://experienceleague.adobe.com/ko/docs/real-time-cdp-collaboration/using/quick-start-guide)를 보고 자세한 내용을 알아보려면 Adobe 계정 팀에 문의하십시오.
...
Experience Platform UI의 왼쪽 탐색에서 **[!UICONTROL Segments]**&#x200B;을(를) 선택한 다음 상단 헤더에서 **[!UICONTROL Feeds]**&#x200B;을(를) 선택합니다.

![segments-feed.png](./images/segments-feed.png)

[!UICONTROL Feeds] 페이지에는 파트너로부터 받은 피드 목록과 공유한 피드가 포함되어 있습니다. 기존 파트너 목록을 보거나 새 파트너와 연결하려면 **[!UICONTROL Manage partners]**&#x200B;을(를) 선택하십시오.
...
[!UICONTROL connect ID]을(를) 사용하여 파트너를 연결하려면 [!UICONTROL Connect partner] 아래의 입력란에 고유 ID 값을 입력한 다음 **[!UICONTROL Request]**&#x200B;을(를) 선택하십시오.
...
마지막으로 피드에 적합한 ID 네임스페이스를 선택합니다. [!DNL Segment Match]에서 지원하는 특정 네임스페이스에 대한 자세한 내용은 [ID 데이터 및 네임스페이스 테이블](#namespaces)을(를) 참조하십시오. 완료되면 **[!UICONTROL Next]**&#x200B;을(를) 선택합니다.

![audience-sharing.png](./images/audience-sharing.png)

피드의 설정이 설정되면 자사 세그먼트 목록에서 공유할 세그먼트를 선택합니다. 목록에서 두 개 이상의 세그먼트를 선택할 수 있으며 오른쪽 레일을 사용하여 선택한 세그먼트 목록을 관리할 수 있습니다. 완료되면 **[!UICONTROL Next]**&#x200B;을(를) 선택합니다.

![select-segments.png](./images/select-segments.png)

피드를 공유할 파트너를 선택할 수 있는 인터페이스를 제공하는 [!UICONTROL Share] 페이지가 나타납니다. 이 단계에서는 공유 전 중복 예상 보고서를 확인하고 사용자와 파트너 간의 네임스페이스별 중복 ID 수, 데이터 공유에 동의한 중복 ID 수를 볼 수도 있습니다.

예상 보고서를 보려면 **[!UICONTROL Analyze by segment]**&#x200B;을(를) 선택하십시오.
...
완료되면 **[!UICONTROL Close]**&#x200B;을(를) 선택합니다.

![overlap-report.png](./images/overlap-report.png)

파트너를 선택하고 중복 예상 보고서를 열람했으면 **[!UICONTROL Next]**&#x200B;을(를) 선택하여 계속 진행하십시오.

![share.png](./images/share.png)

[!UICONTROL Review] 단계가 표시되어 새 피드를 공유 및 게시하기 전에 검토할 수 있습니다. 이 단계에는 적용한 ID 설정에 대한 세부 정보와 선택한 마케팅 사용 사례, 세그먼트 및 파트너에 대한 정보가 포함됩니다.

계속하려면 **[!UICONTROL Finish]**&#x200B;을(를) 선택하십시오.
...
세그먼트 목록이 나타납니다. 여기에서 피드에 새 세그먼트를 추가할 수 있으며 오른쪽 레일을 사용하여 더 이상 필요하지 않은 세그먼트를 제거할 수 있습니다. 피드의 세그먼트 관리를 완료했으면 **[!UICONTROL Next]**&#x200B;을(를) 선택한 다음 위에 설명된 단계에 따라 업데이트된 피드를 완료합니다.
