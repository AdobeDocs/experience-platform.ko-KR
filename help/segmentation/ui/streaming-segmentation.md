---
keywords: Experience Platform;홈;인기 항목;스트리밍 세그먼테이션;세그먼테이션;세그먼테이션 서비스;세그먼테이션 서비스;ui 안내서;
...
![세그먼트 세부 정보 페이지가 표시됩니다.](../images/ui/streaming-segmentation/monitoring-streaming-segment.png)
...
>[!NOTE]
>
>상태가 없음에서 실현됨으로 전환되거나 종료됨에서 실현됨으로 전환되는 세그먼트는 적격으로 간주됩니다. 세그먼트가 실현에서 종료로 또는 기존 세그먼트에서 종료로 전환되는 경우 부적격 세그먼트로 간주됩니다.
>
