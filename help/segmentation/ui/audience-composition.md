...
**[!UICONTROL Composition properties]** 팝오버가 나타납니다. 여기에 제목과 설명을 포함하여 컴포지션의 세부 정보를 삽입할 수 있습니다.
...
컴포지션의 세부 정보를 업데이트한 후 **[!UICONTROL Save]**&#x200B;을(를) 선택하여 업데이트를 확인합니다. 대상자 구성 캔버스가 다시 나타납니다.

대상 컴포지션 캔버스는 **[[!UICONTROL Audience]](#audience-block)**, **[[!UICONTROL Exclude]](#exclude-block)**, **[[!UICONTROL Rank]](#rank-block)** 및 **[[!UICONTROL Split]](#split-block)** 블록의 네 가지 다른 유형으로 구성됩니다.
...
**[!UICONTROL Audience]** 블록 형식을 사용하면 더 큰 새 대상을 구성하는 데 사용할 하위 대상을 추가할 수 있습니다. 기본적으로 **[!UICONTROL Audience]** 블록은 컴포지션 캔버스의 맨 위에 포함됩니다.

**[!UICONTROL Audience]** 블록을 선택하면 오른쪽 레일에 대상자 레이블을 지정하고, 대상자를 블록에 추가하고, 대상자 블록에 대한 사용자 지정 규칙을 작성하는 컨트롤이 표시됩니다.
...
대상 블록에 대상을 추가하려면 **[!UICONTROL Add Audience]**&#x200B;을(를) 선택합니다.
...
대상자 목록이 나타납니다. 포함할 대상을 선택한 다음 **[!UICONTROL Add]**&#x200B;을(를) 선택하여 대상 블록에 추가합니다.

![대상자 목록이 나타납니다. 이 대화 상자에서 추가할 대상을 선택할 수 있습니다.](../images/ui/audience-composition/select-audience.png)

**[!UICONTROL Audience]** 블록을 선택하면 선택한 대상자가 이제 오른쪽 레일 내에 표시됩니다. 여기에서 결합된 대상자의 병합 유형을 변경할 수 있습니다.

![대상에 대해 가능한 병합 유형이 강조 표시됩니다.](../images/ui/audience-composition/merge-types.png)

| 병합 유형 | 설명 |
| ---------- | ----------- |
| [!UICONTROL Union] | 대상은 하나의 대상으로 결합됩니다. 이는 OR 작업과 동일합니다. |
| [!UICONTROL Intersection] | 대상은 결합되어 **모두**&#x200B;에서 공유된 대상만 추가됩니다. 이는 AND 작업과 동일합니다. |
| [!UICONTROL Exclude overlap] | 대상자가 결합되어 **one에서 공유되는 대상자만**&#x200B;이(가) 모두 추가되지 않습니다. 이것은 XOR 연산과 같은 결과가 될 것이다. |
...
대상 블록에 사용자 지정 규칙을 추가하려면 **[!UICONTROL Build rule]**&#x200B;을(를) 선택합니다.
...
사용자 지정 규칙을 추가한 후 **[!UICONTROL Save]**&#x200B;을(를) 선택하여 대상자에 규칙을 추가합니다.
...
**[!UICONTROL Exclude]** 블록 형식을 사용하면 지정된 하위 대상이나 특성을 더 큰 새 대상에서 제외할 수 있습니다.

**[!UICONTROL Exclude]** 블록을 추가하려면 **+** 아이콘을 선택한 후 **[!UICONTROL Exclude]**&#x200B;을(를) 선택하십시오.
...
대상별로 제외하는 경우 **[!UICONTROL Add Audience]**&#x200B;을(를) 선택하여 제외할 대상을 선택할 수 있습니다.

![제외할 대상을 선택할 수 있는 [!UICONTROL Add audience] 단추가 선택되어 있습니다.](../images/ui/audience-composition/add-excluded-audience.png)

>[!IMPORTANT]
>
>세그먼트 빌더를 사용하여 만든 **게시된** 대상만 사용할 수 있습니다. 대상 구성을 사용하여 만든 대상 및 외부에서 생성된 대상은 **사용할 수 없습니다**.

대상자 목록이 나타납니다. 제외할 대상을 제외 블록에 추가하려면 **[!UICONTROL Add]**&#x200B;을(를) 선택하십시오.
...
**[!UICONTROL Enrich]** 블록 형식을 사용하면 데이터 집합의 추가 특성으로 대상을 강화할 수 있습니다. 개인화 사용 사례에서 이러한 속성을 사용할 수 있습니다.

**[!UICONTROL Enrich]** 블록을 추가하려면 **+** 아이콘을 선택한 후 **[!UICONTROL Enrich]**&#x200B;을(를) 선택하십시오.

![[!UICONTROL Enrich] 옵션을 선택했습니다.](../images/ui/audience-composition/add-enrich-block.png)

**[!UICONTROL Enrich]** 블록이 추가되었습니다. 이 블록을 선택하면 데이터 보강에 대한 세부 정보가 오른쪽 레일에 표시됩니다. 여기에는 블록의 레이블 및 데이터 보강 세트가 포함됩니다.

대상자를 보강할 데이터 집합을 선택하려면 ![필터](/help/images/icons/project-edit.png) 아이콘을 선택하십시오.

![필터 단추가 강조 표시되어 있습니다. 이 옵션을 선택하면 [!UICONTROL Select dataset] 팝오버가 표시됩니다.](../images/ui/audience-composition/enrich-select-dataset.png)

**[!UICONTROL Select dataset]** 팝오버가 나타납니다. 데이터 강화를 위해 추가할 데이터 집합을 선택한 다음 데이터 강화를 위해 데이터 집합을 추가하려면 **[!UICONTROL Select]**&#x200B;을(를) 선택하십시오.
...
이제 **[!UICONTROL Enrichment criteria]** 섹션이 오른쪽 레일에 나타납니다. 이 섹션에서는 데이터 보강 데이터 세트를 만들려는 대상자와 연결할 수 있는 **[!UICONTROL Source join key]** 및 **[!UICONTROL Enrichment dataset join key]**&#x200B;을(를) 선택할 수 있습니다.

![[!UICONTROL Enrichment criteria] 영역이 강조 표시되어 있습니다.](../images/ui/audience-composition/enrichment-criteria.png)

**[!UICONTROL Source join key]**&#x200B;을(를) 선택하려면 ![필터](/help/images/icons/project-edit.png) 아이콘을 선택하십시오.

**[!UICONTROL Select a profile attribute]** 팝오버가 나타납니다. 소스 조인 키로 사용할 프로필 특성을 선택한 다음 **[!UICONTROL Select]**&#x200B;을(를) 선택하여 해당 특성을 소스 조인 키로 선택합니다.

![원본 조인 키로 사용할 특성이 강조 표시됩니다.](../images/ui/audience-composition/select-source-join-key.png)

**[!UICONTROL Enrichment dataset join key]**&#x200B;을(를) 선택하려면 ![필터](/help/images/icons/project-edit.png) 아이콘을 선택하십시오.

**[!UICONTROL Enrichment attributes]** 팝오버가 나타납니다. 데이터 보강 데이터 집합 조인 키로 사용할 특성을 선택한 다음 **[!UICONTROL Select]**&#x200B;을(를) 선택하여 데이터 보강 데이터 집합 조인 키로 해당 특성을 선택합니다.

![데이터 보강 데이터 집합 조인 키로 사용할 특성이 강조 표시됩니다.](../images/ui/audience-composition/select-enrichment-dataset-join-key.png)

조인 키를 모두 추가했으므로 **[!UICONTROL Enrichment attributes]** 섹션이 나타납니다. 이제 대상자를 향상시킬 특성을 추가할 수 있습니다. 이러한 특성을 추가하려면 **[!UICONTROL Add attribute]**&#x200B;을(를) 선택하십시오.

**[!UICONTROL Enrichment attributes]** 팝오버가 나타납니다. 데이터 집합에서 특성을 선택하여 대상자를 강화한 다음 **[!UICONTROL Select]**&#x200B;을(를) 선택하여 대상자에 특성을 추가할 수 있습니다.
...
**[!UICONTROL Rank]** 블록 형식을 사용하면 지정된 특성에 따라 프로필의 등급을 매기고 정렬할 수 있으며 이러한 등급 프로필을 컴포지션에 포함할 수 있습니다.

**[!UICONTROL Rank]** 블록을 추가하려면 **+** 아이콘을 선택한 후 **[!UICONTROL Rank]**&#x200B;을(를) 선택하십시오.
...
프로필 속성 목록이 나타납니다. 이 팝오버에서는 대상 순위를 지정할 속성 유형을 선택할 수 있습니다. **[!UICONTROL Select]**&#x200B;을(를) 선택하여 등급 블록에 추가하십시오. 선택한 특성은 **만**&#x200B;일 수 있습니다.
...
또한 **[!UICONTROL Add profile limit]** 전환을 활성화하여 반환되는 프로필 수를 제한할 수 있습니다. 이 토글이 활성화되면 **[!UICONTROL Included profiles]** 필드 내에서 반환되는 최대 프로필 수를 설정할 수 있습니다.
...
>[!NOTE]
>
>**[!UICONTROL Split]** 블록을 사용하려면 **은(는) 대상에 최소 10개의 프로필이 있어야**&#x200B;합니다.

**[!UICONTROL Split]** 블록 형식을 사용하면 새 대상을 다양한 하위 대상으로 분할할 수 있습니다. 백분율이나 속성에 따라 이 대상을 분할할 수 있습니다.

**[!UICONTROL Split]** 블록을 추가하려면 **+** 아이콘을 선택한 후 **[!UICONTROL Split]**&#x200B;을(를) 선택하십시오.
...
속성별로 분할하면 제공된 속성을 기준으로 대상자가 분할됩니다. 분할할 특성을 선택하려면 **[!UICONTROL Split]** 블록 다음에 ![필터](/help/images/icons/project-edit.png) 아이콘을 선택합니다.
...
특성을 선택한 후 **[!UICONTROL Values]** 필드 내에 값을 추가하여 어떤 하위 대상에 속할 프로필을 선택할 수 있습니다.

![특성을 분할하려는 값이 추가됩니다.](../images/ui/audience-composition/attribute-split-values.png)

또한 **[!UICONTROL Other profiles]** 토글을 활성화하여 선택되지 않은 모든 프로필로 구성된 하위 대상을 만들 수 있습니다.
