...
자세한 내용 [!DNL Segmentation Service]을 살펴보려면 설명서를 계속 읽고 아래 비디오를 시청하여 학습 내용을 보완해 주십시오. API 사용 작업에 대한 단계별 지침 [!DNL Segmentation Service] 은 API를 사용하여 대상 세그먼트 [!DNL Segmentation Service] 만들기 [](../tutorials/create-a-segment.md) 자습서를 참조하십시오.
