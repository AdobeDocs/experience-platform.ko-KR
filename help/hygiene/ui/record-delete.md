...
모든 데이터 세트에서 삭제하려면 **[!UICONTROL All datasets]**&#x200B;을(를) 선택하십시오. 이 옵션은 작업 범위를 늘리며 모든 관련 ID 유형을 제공해야 합니다.

![선택한 [!UICONTROL Select dataset] 옵션이 있는 [!UICONTROL All datasets] 대화 상자입니다.](../images/ui/record-delete/all-datasets.png)

>[!WARNING]
>
>**[!UICONTROL All datasets]**&#x200B;을(를) 선택하면 조직의 모든 데이터 세트로 작업이 확장됩니다. 각 데이터 세트는 다른 기본 ID 유형을 사용할 수 있습니다. 정확한 일치를 위해 **모든 필수 ID 유형**&#x200B;을 제공해야 합니다.
>
