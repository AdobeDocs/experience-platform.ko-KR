...
| get_url_encoded | 이 함수는 URL을 입력으로 사용하고 특수 문자를 ASCII 문자로 바꾸거나 인코딩합니다. 특수 문자에 대한 자세한 내용은 [특수 문자 목록](#special-characters) 이 문서의 부록에. | <ul><li>URL: **필수 여부** 입력 URL을 특수 문자로 바꾸거나 ASCII 문자로 인코딩할 수 있습니다.</li></ul> | get_url_encoded(URL) | get_url_encoded(&quot;https</span>/example.com) | https%3A%2F%2Fexample.com%2Fpartneralliance_asia-pacific_2022 |
| get_url_decoded | 이 함수는 URL을 입력으로 사용하고 ASCII 문자를 특수 문자로 디코딩합니다.  특수 문자에 대한 자세한 내용은 [특수 문자 목록](#special-characters) 이 문서의 부록에. | <ul><li>URL: **필수 여부** 특수 문자로 디코딩할 ASCII 문자가 있는 입력 URL입니다.</li></ul> | get_url_decoded(URL) | get_url_decoded(&quot;https%3A%2F%2Fexample.com%2Fpartneralliance_asia-pacific_2022&quot;) | https</span>://example.com/partneralliance_asia-pacific_2022 |
...
| date_part | 날짜의 부분을 검색합니다. 지원되는 구성 요소 값은 다음과 같습니다. <br><br>&quot;year&quot;<br>&quot;yyyy&quot;<br>&quot;yy&quot;<br><br>&quot;quarter&quot;<br>&quot;qq&quot;<br>&quot;q&quot;<br><br>&quot;month&quot;<br>&quot;mm&quot;<br>&quot;m&quot;<br><br>&quot;dayofyear&quot;<br>&quot;dy&quot;<br>&quot;y&quot;<br><br>&quot;day&quot;<br>&quot;dd&quot;<br>&quot;d&quot;<br><br>&quot;week&quot;<br>&quot;ww&quot;<br>&quot;w&quot;<br><br>&quot;weekday&quot;<br>&quot;dw&quot;<br>&quot;w&quot;<br><br>&quot;hour&quot;<br>&quot;hh&quot;<br>&quot;hh24&quot;<br>&quot;hh12&quot;<br><br>&quot;minute&quot;<br>&quot;mi&quot;<br>&quot;n&quot;<br><br>&quot;second&quot;<br>&quot;ss&quot;<br>&quot;s&quot;<br><br>&quot;ms&quot;<br>&quot;SSS&quot; | <ul><li>구성 요소: **필수 여부** 날짜의 부분을 나타내는 문자열입니다. </li><li>날짜: **필수 여부** 표준 형식으로 된 날짜입니다.</li></ul> | date_&#x200B;part(COMPONENT, DATE) | date_part(&quot;MM&quot;, date(&quot;2019-10-17 11&quot;:55:12형) | 10 |
...
| `fpid_to_ecid ` | 이 함수는 FPID 문자열을 사용하여 Adobe Experience Platform 및 Adobe Experience Cloud 애플리케이션에서 사용할 ECID로 변환합니다. | <ul><li>문자열: **필수 여부** ECID로 변환할 FPID 문자열입니다.</li></ul> | `fpid_to_ecid(STRING)` | `fpid_to_ecid("4ed70bee-b654-420a-a3fd-b58b6b65e991")` | `"28880788470263023831040523038280731744"` |
...
장치 필드 값에 대한 자세한 내용은 [장치 필드 값 목록](#device-field-values) 이 문서의 부록에.
...
다음은 데이터 준비 매핑 기능 사용에 대한 추가 정보를 제공합니다

### 특수 문자 {#special-characters}

아래 표는 예약된 문자 및 해당 인코딩된 문자 목록에 대해 간략하게 설명합니다.
...
아래 표에는 장치 필드 값 목록과 해당 설명이 요약되어 있습니다.

| 디바이스 | 설명 |
| --- | --- |
| 데스크톱 | 데스크탑 또는 랩톱 장치 유형입니다. |
| 익명 처리 | 익명 장치 경우에 따라 다음과 같습니다 `useragents` 익명화 소프트웨어에 의해 변경된 것입니다. |
| 알 수 없음 | 알 수 없는 장치입니다. 이것들은 보통 `useragents` 장치에 대한 정보가 포함되어 있지 않습니다. |
| 모바일 | 아직 식별되지 않은 모바일 장치입니다. 이 모바일 장치는 eReader, 태블릿, 휴대폰, 시계 등이 될 수 있습니다. |
| 태블릿 | 큰 화면이 있는 모바일 장치(일반적으로 7&quot; 이상). |
| 전화 | 작은 화면이 있는 모바일 장치(일반적으로 &lt; 7&quot;). |
| 보기 | 작은 화면이 있는 모바일 장치(일반적으로 &lt; 2&quot;) 이러한 장치는 일반적으로 휴대폰/태블릿 유형의 장치에 대한 추가 화면으로 작동합니다. |
| 증강현실 | AR 기능이 있는 모바일 장치입니다. |
| 가상 현실 | VR 기능을 갖춘 모바일 장치입니다. |
| eReader | 태블릿과 유사하지만 일반적으로 [!DNL eInk] 화면. |
| 셋톱 박스 | TV 크기의 화면을 통해 상호 작용을 가능하게 하는 연결된 장치. |
| TV | 셋톱 박스와 유사하지만 TV에 내장된 장치입니다. |
| Home Appliance | 냉장고 같은 (보통 큰) 가전 제품. |
| 게임 콘솔 | 고정 게임 시스템 [!DNL Playstation] 또는 [!DNL XBox]. |
| 휴대용 게임 콘솔 | 모바일 게임 시스템 [!DNL Nintendo Switch]. |
| 음성 | 와 같은 음성 제어 장치 [!DNL Amazon Alexa] 또는 [!DNL Google Home]. |
| 자동차 | 차량 기반 브라우저. |
| 로봇 | 웹 사이트를 방문하는 로봇 |
| 로봇 모바일 | 웹 사이트를 방문하지만 모바일 방문자로 표시되기를 원하는 것을 표시하는 로봇입니다. |
| 로봇 이미터 | 마치 로봇인 척 하면서 웹사이트를 방문하는 로봇 [!DNL Google]하지만 그렇지 않습니다. **참고**: 대부분의 경우 로봇 고정자는 실제 로봇입니다. |
| 클라우드 | 클라우드 기반 애플리케이션입니다. 이들은 로봇도 해커도 아닌, 연결되어야 하는 애플리케이션입니다. 여기에는 다음이 포함됩니다 [!DNL Mastodon] 서버. |
