...
UI에서 표준 네임스페이스를 보려면 왼쪽 탐색 영역에서 **[!UICONTROL Identity]**&#x200B;을 선택한 다음 **[!UICONTROL 찾아보기]** 탭을 선택하여 조직에서 액세스할 수 있는 표준 ID 네임스페이스 목록을 표시합니다. 네임스페이스는 **[!UICONTROL 표시 이름]**, **[!UICONTROL ID 기호]** 또는 **[!UICONTROL 소유자]**&#x200B;별로 알파벳순으로 정렬할 수 있습니다. 또는 네임스페이스의 최신 업데이트 날짜별로 시간순으로 정렬할 수 있습니다.

오른쪽 레일에 대한 자세한 정보를 보려면 네임스페이스를 선택하십시오.

>[!NOTE]
>
>또한 플랫폼은 통합 용도로 네임스페이스를 제공합니다. 이러한 네임스페이스는 다른 시스템과 연결하는 데 사용되고 ID를 연결하는 데 사용되지 않으므로 기본적으로 숨겨집니다. 통합 네임스페이스를 보려면 **[!UICONTROL 통합 ID 보기]**&#x200B;를 선택합니다.
...
UI를 사용하여 사용자 정의 네임스페이스를 만들려면 **[!UICONTROL ID]** 작업 영역으로 이동하여 **[!UICONTROL 찾아보기]**&#x200B;를 선택한 다음 **[!UICONTROL ID 네임스페이스 만들기]**&#x200B;를 선택합니다.

![](./images/create.png)

**[!UICONTROL ID 네임스페이스 만들기]** 대화 상자가 나타납니다. 고유한 **[!UICONTROL 표시 이름]** 및 **[!UICONTROL ID 기호]**&#x200B;를 입력한 다음 만들려는 ID 유형을 선택합니다. 네임스페이스에 대한 추가 정보에 선택적 설명을 추가할 수도 있습니다. 완료되면 **[!UICONTROL 만들기]**&#x200B;를 선택합니다.
...
표준 네임스페이스와 유사하게 **[!UICONTROL 찾아보기]** 탭에서 사용자 정의 네임스페이스를 선택하여 세부 사항을 볼 수 있습니다. 그러나 사용자 정의 네임스페이스를 사용하면 세부 사항 영역에서 표시 이름과 설명을 편집할 수도 있습니다.
