...
이 오류 메시지는 조직에 대한 적절한 권한이 제공되지 않은 경우 표시됩니다 [!DNL Identity Service]. 이 문제를 해결하려면 시스템 관리자에게 문의하십시오.
...
다음은 와 관련된 오류 메시지 목록입니다. [!DNL Identity Service] 을 사용할 때 다음과 같은 상황이 발생할 수 있습니다. [일괄 처리 수집 API](https://developer.adobe.com/experience-platform-apis/references/batch-ingestion/).
...
배치 데이터를 수집할 때 이 오류 메시지는 조직에 적절한 권한이 제공되지 않은 경우 표시됩니다 [!DNL Identity Service]. 이 문제를 해결하려면 시스템 관리자에게 문의하십시오.
