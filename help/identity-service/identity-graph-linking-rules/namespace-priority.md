...
계산된 속성은 네임스페이스 우선 순위를 사용하여 값을 계산하지 않습니다. 계산된 속성을 사용하는 경우 CRMID가 WebSDK에 대한 기본 ID로 지정되어 있는지 확인해야 합니다. 이 한계는 2024년 8월에 해결될 것으로 예상됩니다.

자세한 내용은 [연산 특성 UI 안내서](../../profile/computed-attributes/ui.md)를 참조하십시오.
