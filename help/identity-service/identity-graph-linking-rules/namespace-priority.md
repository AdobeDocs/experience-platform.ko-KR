...
계산된 속성은 네임스페이스 우선 순위를 사용하여 계산된 속성 값을 저장합니다. 주어진 이벤트에 대해 네임스페이스 우선 순위가 가장 높은 ID는 계산된 속성 값을 해당 이벤트에 대해 기록합니다. 자세한 내용은 [연산 특성 UI 안내서](../../profile/computed-attributes/ui.md)를 참조하십시오.
