...
* Web SDK에서 기본 ID를 구성하는 방법에 대한 자세한 내용은 [데이터 요소 유형](/help/tags/extensions/client/web-sdk/data-element-types.md) 및 [데이터 수집의 ID](/help/collection/identity/overview.md)에 대한 설명서를 참조하십시오.
