...
| 수집 유형 | 지침 | 참고 |
| --- | --- | --- |
| 스트리밍 수집 | <ul><li>최대 레코드 크기는 1MB이며 권장 크기는 10KB입니다.</li><li>프로필에서 초당 최대 2500개의 요청을 처리할 수 있습니다.</li><li>데이터 레이크에 대한 초당 최대 20000개의 요청을 15분 이내에 처리할 수 있습니다.</li></ul> | 더 높은 데이터 처리량이 필요한 경우 일괄 처리 수집 API를 사용하십시오. |
