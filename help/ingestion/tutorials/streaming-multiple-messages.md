...
**[!UICONTROL 데이터 세트]** 탭으로 이동하여 스트리밍 중인 데이터 세트를 클릭하고 **[!UICONTROL 데이터 세트 활동]** 탭을 확인하여 [Experience Platform UI](https://platform.adobe.com)를 사용하여 [!DNL Experience Platform]에 성공적으로 스트리밍된 일괄 처리 메시지의 상태를 볼 수 있습니다.
