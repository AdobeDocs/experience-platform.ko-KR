...
메시지를 수집하지 못한 이유에 대한 자세한 내용 [[!DNL Experience Platform UI]](https://platform.adobe.com) 을 보려면 아이콘을 사용하십시오. 왼쪽 탐색 **[!UICONTROL 에서 모니터링]** 을 클릭한 다음 **[!UICONTROL 전체]** 스트리밍 탭을 확인하여 선택한 기간 동안 스트리밍된 메시지 배치를 볼 수 있습니다.
