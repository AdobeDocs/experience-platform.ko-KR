...
type: Documentation
description: 데이터 수집 API 시작 안내서에서는 API를 사용하여 Experience Platform으로 데이터를 수집하기 전에 알아야 하는 주요 개념과 기본 기능에 대해 설명합니다.
...
요청 본문(POST, PUT 및 PATCH 호출 등)에 페이로드가 있는 모든 요청에는 `Content-Type` 헤더가 포함되어야 합니다. 각 호출에 대해 허용되는 값은 호출 매개 변수에 제공됩니다.
