...
모든 파일이 배치에 업로드된 후 배치를 완료하도록 신호를 보낼 수 있습니다. 이렇게 하면 완료된 파일에 [!DNL Catalog] 대해 DataSetFile 항목이 만들어지고 위에서 생성된 일괄 처리에 연결됩니다. 그런 다음 일괄 처리 [!DNL Catalog] 가 성공으로 표시되어 사용 가능한 데이터를 인제스트하는 다운스트림 흐름을 트리거합니다.
...
| 중단됨 | 지정된 일괄 처리에 대해 **명시적으로** 중단 작업이 호출되었습니다(일괄 처리 인제스트 API를 통해). 일괄 처리가 &quot;불러오기&quot; 상태에 있으면 중단될 수 없습니다. |
| 활성 | 배치가 성공적으로 홍보되었으며 다운스트림 소비에 사용할 수 있습니다. 이 상태를 &quot;성공&quot;과 함께 혼용하여 사용할 수 있습니다. |
| 삭제됨 | 일괄 처리에 대한 데이터가 완전히 제거되었습니다. |
| 실패 | 잘못된 구성 및/또는 잘못된 데이터에서 발생하는 터미널 상태입니다. 실패한 일괄 처리에 대한 데이터가 **표시되지 않습니다** . 이 상태는 &quot;실패&quot;와 혼용하여 사용할 수 있습니다. |
| 비활성 | 배치가 성공적으로 홍보되었지만 되돌려졌거나 만료되었습니다. 이제 일괄 처리를 다운스트림 소비에 사용할 수 없습니다. |
