...
Luma 마케터는 Adobe Experience Platform을 사용하여 실시간 CDP 대시보드에서 선물 보호자 세그먼트를 봅니다. 그들은 시간이 지남에 따라 이 계획의 결과를 보고 그것이 성장하고 있다는 것을 봅니다. 고객들은 제안에 반응하고 더 많은 돈을 쓰고 있다.

이러한 인사이트를 통해 마케터는 CDP에서 이 데이터를 사용할 수 있고 Sarah와 같은 고객이 세그먼트에 연결됨으로써 이 신호에 대한 조치를 취할 수 있습니다.
