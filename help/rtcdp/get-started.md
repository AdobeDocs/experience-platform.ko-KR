...
1. XDM 사전 매핑 테이블의 권장 목록에서 가져올 항목을 선택합니다.
   ...
   예를 들어 **[!UICONTROL Contacts]**&#x200B;을(를) 선택합니다. 연락처 데이터의 미리 보기가 자동으로 로드되므로 모든 것이 예상대로 보이는지 확인할 수 있습니다.
...
**[!UICONTROL Send to destinations]**&#x200B;를 선택합니다.
...
다음 페이지로 이동하려면 **[!UICONTROL Save]**&#x200B;을(를) 선택하십시오.
