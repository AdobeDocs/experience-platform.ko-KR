...
* **대상으로 데이터 보내기**: 이 위젯은 대상 카탈로그로 이동합니다. 대상 카탈로그를 사용하여 연결할 수 있는 대상을 선택한 다음 대상자를 보낼 수 있습니다. 대상 카탈로그로 이동하려면 **[!UICONTROL 대상 설정]**&#x200B;을 선택하십시오. 자세한 내용은 [대상 개요](../destinations/home.md)를 참조하십시오.
...
* **최근 대상**: **[!UICONTROL 최근 대상]** 지표 카드는 조직 내에서 만든 5개의 최근 대상을 보여줍니다. 이 목록은 새 대상을 만들 때 업데이트됩니다. 대상을 선택하여 해당 항목에 대한 세부 정보를 보거나 **[!UICONTROL 모두 보기]**&#x200B;를 선택하여 대상 목록을 확인하십시오. 자세한 내용은 [대상 개요](../destinations/home.md)를 참조하십시오.
