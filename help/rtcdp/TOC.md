...
* 시작하기 {#intro}
   ...
   * Real-Time CDP B2B 에디션 {#rtcdpb2b-intro}
      ...
      * [Real-Time CDP B2B 에디션 보호 기능](b2b-guardrails.md)
* Audience Manager 및 실시간 CDP {#evolution}
   * [Audience Manager의 진화](aam-to-rtcdp.md)
* 계정 프로필 {#account}
...
* 데이터 세트 {#datasets}
   ...
   * [플랫폼에서 데이터 품질](datasets/data-quality.md)
* 대상 {#destinations}
...
* Real-Time CDP B2B 에디션 AI/ML 서비스 {#b2b-cdp-ai-ml}
   ...
   * [리드-계정 일치](b2b-ai-ml-services/lead-to-account-matching.md)
...
* 세그먼트 {#segmentation}
   ...
   * [Real-Time CDP B2B 에디션의 세그멘테이션](segmentation/b2b.md)
