...
* [실시간 CDP B2B Edition 개요(베타)](b2b-overview.md)
* 시작하기 {#intro}
   * 실시간 CDP {#rtcdp-intro}
...
* 대상 {#destinations}
   ...
   * [실시간 CDP B2B Edition(베타)의 대상](destinations/b2b.md)
* ID {#identity}
