...
XDM 및 UI에서 스키마를 관리하는 방법에 대한 자세한 내용은 [XDM 설명서](../../xdm/home.md)를 참조하세요. Real-Time Customer Platform B2B 에디션을 사용 중인 경우, XDM용 B2B 관련 애플리케이션에 대한 정보는 [Real-Time CDP B2B 에디션의 스키마](./b2b.md)에 대한 문서를 참조하십시오.
