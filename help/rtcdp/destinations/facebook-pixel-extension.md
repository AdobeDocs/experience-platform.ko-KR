...
description: Facebook Pixel 익스텐션은 Adobe 실시간 고객 데이터 플랫폼의 광고 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
...
# Facebook 픽셀 확장 {#facebook-pixel-extension}

## 개요 {#overview}

Facebook 픽셀은 사람들이 웹 사이트에서 취하는 동작을 파악하여 광고의 효과를 측정할 수 있는 분석 도구입니다.

Facebook Pixel은 Adobe 실시간 고객 데이터 플랫폼의 광고 확장입니다. 확장 기능에 대한 자세한 내용은 Facebook Pixel 웹 [사이트를](https://developers.facebook.com/docs/facebook-pixel/)참조하십시오.
