...
description: Marketing Munchkin 익스텐션은 Adobe 실시간 고객 데이터 Platform에서 개인화를 위한 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
seo-description: Marketing Munchkin 익스텐션은 Adobe 실시간 고객 데이터 Platform에서 개인화를 위한 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
...
리드 관리에서 계정 기반 마케팅에 이르기까지 고객 경험의 모든 단계에서 고객 및 잠재 고객과의 교류를 계획, 조정 및 측정하는 방법을 간소화할 수 있습니다. [!DNL Marketo Engagement Platform]

[!DNL Marketo’s Munchkin][!DNL Marketo] JavaScript를 사용하면 랜딩 페이지 및 외부 웹 페이지에 대한 최종 사용자 페이지 방문 수 및 클릭 수를 추적할 수 있습니다.

[!DNL Marketo Munchkin] 은 Adobe 실시간 고객 데이터 Platform의 이메일 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange의 확장 페이지를 참조하십시오](https://exchange.adobe.com/experiencecloud.details.101054.marketo-munchkin.html).
...
![Marketo Munchkin 확장 프로그램](assets/marketo-munchkin-extension.png)
...
익스텐션을 설치하려면 [!DNL Marketo Munchkin] 다음을 수행하십시오.
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 Adobe Exchange의 [Marketing To Munkin 페이지를 참조하십시오](https://exchange.adobe.com/experiencecloud.details.101054.marketo-munchkin.html).
