...
1. Connect 대상 마법사에서 저장소 위치에 **[!UICONTROL Connection type]** 대한 을 선택합니다. Oracle Fura의 경우, 암호를 사용하는 **SFTP와 SSH 키를** 사용하는 **SFTP를 선택할 수 있습니다**. 연결 유형에 따라 아래 정보를 입력하고 **[!UICONTROL Connect]**&#x200B;선택합니다.
