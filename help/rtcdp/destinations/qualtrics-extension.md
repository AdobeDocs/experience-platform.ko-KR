...
description: EQualtrics 웹 사이트 피드백 익스텐션은 Adobe 실시간 고객 데이터 플랫폼의 설문 조사 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
...
# Qualtrics 웹 사이트 피드백 확장 {#qualtrics-extension}

## 개요 {#overview}

Qualtrics 웹 사이트 피드백을 사용하면 웹 사이트 방문자에게 적절한 메시지를 적시에 전달할 수 있습니다. 웹 사이트 피드백 설문 조사를 통해 방문자 경험을 개선하거나 전환율을 높이고자 하는 경우 Qualtrics 웹 사이트 피드백을 통해 이러한 문제를 해결할 수 있습니다.

포인트-클릭 방식의 직관적인 인터페이스를 사용하여 브랜드화된 브랜드화된 고도로 타겟팅된 웹 메시지를 몇 분 안에 제작 및 배포할 수 있습니다. 웹 사이트에서 수집한 데이터와 인사이트는 모든 채널에서 고객 경험을 종합적으로 파악하는 데이터와 함께 하나의 플랫폼에서 확인할 수 있습니다.

Qualtrics 웹 사이트 피드백은 Adobe 실시간 고객 데이터 플랫폼의 설문 조사 확장입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 [참조하십시오](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html).
...
![Qualtrics 웹 사이트 피드백 확장](assets/qualtrics-extension.png)
...
Qualtrics 웹 사이트 피드백 익스텐션을 설치하려면:
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 Adobe Exchange의 [Qualtrics 웹 사이트 피드백 페이지를 참조하십시오](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html).
