...
* Google 광고 대상으로 다음 [ID를](../../identity-service/namespaces.md) 보낼 수 있습니다.Google **쿠키 ID, IDFA, GAID, Roku ID, Microsoft ID, Amazon Fire TV ID**.
...
* **[!UICONTROL Account ID]**:Google 광고로 계정 ID를 입력합니다. ID 형식은 일반적으로 123-456-7890입니다.
