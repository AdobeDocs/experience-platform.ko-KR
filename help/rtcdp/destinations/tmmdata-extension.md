...
seo-description: TMMData 확장은 Adobe 실시간 고객 데이터 Platform의 분석 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
...
[!DNL TMMData's] Adobe Marketing Cloud 기반의 플랫폼은 자동화된 캠페인 설정을 통해 Adobe 및 기타 분석 및 BI 툴로 직접 가져올 수 있으므로 마케팅 팀은 내부/외부 및 온라인/오프라인 데이터를 비롯한 모든 중요한 데이터 소스를 액세스하고 혼합하여 안전하고 포괄적인 크로스채널 분석을 수행할 수 있는 툴을 제공합니다.
