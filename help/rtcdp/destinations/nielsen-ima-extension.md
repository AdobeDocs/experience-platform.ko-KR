...
description: THe Nielsen IMA 처리기 확장은 Adobe 실시간 고객 데이터 플랫폼의 분석 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
...
[!DNL Nielsen IMA Handler] 는 Adobe 실시간 고객 데이터 플랫폼의 분석 확장입니다.
