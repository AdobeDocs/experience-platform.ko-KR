...
title: 메달리아 익스텐션
seo-title: 메달리아 익스텐션
description: THe Medallia 익스텐션은 Adobe 실시간 고객 데이터 Platform의 고객 대상 음성입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
seo-description: Medallia 익스텐션은 Adobe 실시간 고객 데이터 Platform의 고객 대상 음성입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
...
웹 속성에 [!DNL Medallia] 빠르고 매끄럽게 배포할 수 있습니다. 또한 확장 기능을 통해 설문 조사 이벤트를 탐지하고 데이터 요소를 통해 실시간으로 고객 피드백을 수집하며 규칙에 따라 고객의 경험을 개인화하고 데이터를 Adobe Analytics과 공유할 수 있습니다.

[!DNL Medallia] 은 Adobe 실시간 고객 데이터 Platform의 고객 확장 기능에 대한 목소리입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange의 확장 페이지를 참조하십시오](https://exchange.adobe.com/experiencecloud.details.103279.medallia-for-adobe-launch.html).
...
![Medallia 익스텐션](assets/medallia-extension.png)
...
익스텐션을 설치하려면 [!DNL Medallia] 다음을 수행하십시오.
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 [Adobe Exchange의 Medallia 페이지를 참조하십시오](https://exchange.adobe.com/experiencecloud.details.103279.medallia-for-adobe-launch.html).
