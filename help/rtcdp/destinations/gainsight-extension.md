---
title: Gainsight 확장
seo-title: Gainsight 확장
description: Gainsight 익스텐션은 Adobe 실시간 고객 데이터 플랫폼의 개인화 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
seo-description: Gainsight 익스텐션은 Adobe 실시간 고객 데이터 플랫폼의 개인화 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
...
# Gainsight 확장 {#gainsight-extension}

## 개요 {#overview}

Gainsight를 사용하면 제품 소유자는 사용자 행동을 심층적으로 파악하고 제품 채택률을 높이며 사용자 피드백을 수집할 수 있습니다.

Gainsight는 Adobe 실시간 고객 데이터 플랫폼의 개인화 익스텐션입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 [참조하십시오](https://www.adobeexchange.com/experiencecloud.details.103343.html).
...
![Gainsight 확장](assets/gainsight-extension.png)
