...
title: 승자 연장
seo-title: 승자 연장
description: Gainsight 익스텐션은 Adobe 실시간 고객 데이터 Platform의 개인화 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
seo-description: Gainsight 익스텐션은 Adobe 실시간 고객 데이터 Platform의 개인화 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
...
# [!DNL Gainsight] 확장 프로그램 {#gainsight-extension}

## 개요 {#overview}

[!DNL Gainsight] 제품 소유자가 사용자 행동을 깊이 이해하고, 제품 채택률을 높이며, 사용자 피드백을 수집할 수 있도록 툴을 제공합니다.

[!DNL Gainsight] 은 Adobe 실시간 고객 데이터 Platform의 개인화 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange의 확장 페이지를 참조하십시오](https://www.adobeexchange.com/experiencecloud.details.103343.html).
...
![승자 연장](assets/gainsight-extension.png)
...
익스텐션을 설치하려면 [!DNL Gainsight] 다음을 수행하십시오.
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 Adobe Exchange의 [Gainsight 페이지를 참조하십시오](https://www.adobeexchange.com/experiencecloud.details.103343.html).
