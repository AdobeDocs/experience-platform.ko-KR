...
>[!NOTE]
>
>Adobe Real-Time Customer Data Platform B2B edition을 사용하지 않는 경우 대신 [대상 개요](../../destinations/home.md)를 참조하세요.

Real-Time CDP B2B edition에서 완전히 지원하는 Experience Platform 대상에는 Google Customer Match, Facebook, LinkedIn, Marketo Engage, Amazon S3, Google Display &amp; Video 360, Google Ads 및 Google Ad Manager가 있습니다.

대상이 B2B 워크플로우에 어떻게 적합한지 이해하려면 [전체 튜토리얼](../b2b-tutorial.md#activate-your-evaluated-data-to-a-destination)을 참조하세요.

Adobe Real-Time Customer Data Platform B2B edition을 사용하면 Marketo Engage 대상 커넥터를 통해 B2B 데이터를 내보낼 수 있습니다. Marketo Engage 대상을 사용하면 Adobe Experience Platform에서 만든 대상을 Marketo으로 푸시하여 정적 목록으로 표시할 수 있습니다.
