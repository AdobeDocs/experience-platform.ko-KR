...
>[!NOTE]
>
>Adobe Real-time Customer Data Platform B2B 에디션을 사용하지 않는 경우 대신 [대상 개요](../../destinations/home.md)를 참조하십시오.
...
- Real-time Customer Data Platform B2B 버전에서 사용할 수 있는 대상에 대한 자세한 내용을 보려면 [대상 카탈로그](../../destinations/catalog/overview.md)를 검색하십시오.
