---
title: Quantum 지표 확장
seo-title: Quantum 지표 확장
description: Quantum Metric 익스텐션은 Adobe 실시간 고객 데이터 플랫폼의 분석 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
...
Quantum Metric은 Adobe Launch와 통합되어 있어 Quantum Metric의 데이터 수집 태그를 손쉽게 배포할 수 있습니다. 또한 이 익스텐션은 Quantum 지표 API의 유용한 정보가 포함된 론치 데이터 요소를 캡처하는 기능을 제공합니다.

Quantum Metric은 Adobe 실시간 고객 데이터 플랫폼의 분석 익스텐션입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 [참조하십시오](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html).
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 Adobe Exchange [의 Quantum 지표 페이지를 참조하십시오](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html).
