...
title: 양자계 확장
seo-title: 양자계 확장
description: The Quantum Metric 익스텐션은 Adobe 실시간 고객 데이터 Platform의 분석 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
seo-description: Quantum Metric 익스텐션은 Adobe 실시간 고객 데이터 Platform의 분석 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
...
[!DNL Quantum Metric's] Adobe Launch와의 통합을 통해 [!DNL Quantum Metric's] 데이터 수집 태그의 원활한 배포를 용이하게 합니다. 또한 이 익스텐션은 [!DNL Quantum Metric] API의 유용한 정보가 포함된 론치 데이터 요소를 캡처하는 기능을 제공합니다.

[!DNL Quantum Metric] 는 Adobe 실시간 고객 데이터 Platform의 분석 확장입니다. 확장 기능에 대한 자세한 내용은 [Adobe Exchange의 확장 페이지를 참조하십시오](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html).
...
![양자 지표 확장](assets/quantum-metric-extension.png)
...
익스텐션을 설치하려면 [!DNL Quantum Metric] 다음을 수행하십시오.
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 Exchange Adobe의 [Quantum 지표 페이지를 참조하십시오](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html).
