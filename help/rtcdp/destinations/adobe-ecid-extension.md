...
# Experience Cloud ID 서비스 확장 {#adobe-ecid-extension}

## 개요 {#overview}

이 익스텐션은 모든 Experience Cloud 솔루션에서 방문자를 식별하는 Experience Cloud ID 서비스를 구현합니다.

Experience Cloud ID Service는 Adobe 실시간 고객 데이터 플랫폼의 개인화 익스텐션입니다. 확장 기능에 대한 자세한 내용은 Experience Platform [시작 설명서의 Experience Cloud ID 서비스 확장 페이지를](https://docs.adobe.com/content/help/ko-KR/launch/using/extensions-ref/adobe-extension/id-service-extension/overview.html) 참조하십시오.
...
Experience Cloud ID 서비스 확장을 설치하려면:
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 Experience [Cloud ID 서비스 확장 페이지](https://docs.adobe.com/content/help/ko-KR/launch/using/extensions-ref/adobe-extension/id-service-extension/overview.html) (Experience Launch 설명서)를 참조하십시오.
