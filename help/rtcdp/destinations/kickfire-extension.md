...
# KickFire 확장 {#kickfire-extension}

## 개요 {#overview}

KickFire의 IP 주소 인텔리전스 및 B2B 퍼스트 모그래픽 데이터를 사용하면 IP 주소를 회사로 변환하고 익명의 웹 방문자를 식별하며 계정 데이터를 기술 스택에 통합할 수 있습니다. 이 모든 것은 회사의 IP 주소를 기반으로 합니다.

KickFire는 Adobe 실시간 고객 데이터 플랫폼의 개인화 익스텐션입니다. 확장 기능에 대한 자세한 내용은 Kickfire 웹 [사이트를](https://www.kickfire.com/)참조하십시오.
...
![킥파이어 익스텐션](/help/rtcdp/destinations/assets/kickfire-extension.png)
