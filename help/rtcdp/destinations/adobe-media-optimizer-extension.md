...
확장 구성 옵션에 대한 자세한 내용은 설명서의 [Adobe Analytics 확장 페이지](https://docs.adobe.com/content/help/en/core-services-learn/implementing-in-websites-with-launch/implement-solutions/analytics.html) 를 [!DNL Experience Launch] 참조하십시오.
