...
# Beemray 확장 {#beemray-extension}

## 개요 {#overview}

Beemray를 사용하면 상황에 맞는 상황에 따라 제품을 신속하게 만들 수 있습니다. 인사이트를 확보하고 새로운 경험을 구축하며 인터랙션을 주도하며 중요한 순간에 참여할 수 있습니다. Beemray는 머신 러닝을 사용하여 컨텍스트 기반의 인텔리전스를 자동화합니다. Beemray는 Adobe Experience Cloud 및 기타 기술 파트너에 연결됩니다. 모든 것이 실시간으로 이루어집니다. 이 익스텐션은 사이트에 Beemray SDK를 설치합니다.
