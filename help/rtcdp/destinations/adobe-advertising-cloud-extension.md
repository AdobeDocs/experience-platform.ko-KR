...
Advertising Cloud 확장을 통해 Advertising Cloud 전환을 구현하고 DSP와 검색(DCO는 현재 지원되지 않음) 모두에 대한 세그먼트 태그를 제공합니다.

Adobe Advertising Cloud는 Adobe 실시간 고객 데이터 플랫폼의 광고 확장입니다.
