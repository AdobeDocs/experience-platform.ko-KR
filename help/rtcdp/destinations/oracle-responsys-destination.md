...
1. 연결 **[!UICONTROL >대상에서]** Oracle Responsys를 선택한 다음 Connect 대상을 **[!UICONTROL 선택합니다]**.

   ![Responsys에 연결](/help/rtcdp/destinations/assets/connect-oracle-responsys.png)

1. Connect 대상 마법사에서 저장소 **[!UICONTROL 위치에 대한 연결 유형을]** 선택합니다. Oracle Responsys의 경우 비밀번호가 있는 SFTP와 **SSH 키가 있는** SFTP 중에서 **선택할 수 있습니다**. 연결 유형에 따라 아래 정보를 입력하고 Connect를 **[!UICONTROL 선택합니다]**.
