---
title: PebblePost 익스텐션
seo-title: PebblePost 익스텐션
description: TheE PebblePost 익스텐션은 Adobe 실시간 고객 데이터 플랫폼의 이메일 대상입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 참조하십시오.
...
# 페블포스트 익스텐션 {#pebblepost-extension}

## 개요 {#overview}

PebblePost의 프로그래머틱 DM(Programming Direct Mail) 솔루션을 사용하면 디지털 마케터는 온라인 관심사와 의도를 오프라인, 유형 매체 간에 전환하여 사용할 수 있습니다. 마케터는 Adobe에서 만든 사용자 지정 데이터 세그먼트를 활용하여 고객과 연관성 있고 오래 지속되는 홈 미디어 효과를 통해 소비자를 타겟팅할 수 있습니다. 응답 경로 활동 및 온사이트 전환을 기반으로 실시간으로 성능을 분석할 수 있습니다.

PebblePost는 Adobe 실시간 고객 데이터 플랫폼의 이메일 확장자입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 [참조하십시오](https://exchange.adobe.com/experiencecloud.details.100315.programmatic-direct-mail.html).
...
![페블포스트 익스텐션](assets/pebblepost-extension.png)
...
확장 구성 옵션 및 설치 지원에 대한 자세한 내용은 Adobe Exchange의 [PebblePost 페이지를 참조하십시오](https://exchange.adobe.com/experiencecloud.details.100315.programmatic-direct-mail.html).
