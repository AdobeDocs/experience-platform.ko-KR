...
# 대화 상자 기술 확장 {#dialogtech-extension}

## 개요 {#overview}

Adobe Launch에 DialogTech SourceTrak javascript 코드 조각 포함

DialogTech는 Adobe 실시간 고객 데이터 플랫폼의 분석 익스텐션입니다. 확장 기능에 대한 자세한 내용은 Dialogtech [웹 사이트를](https://www.dialogtech.com/)참조하십시오.
...
![대화 상자 기술 확장](assets/dialogtech-extension.png)
