...
# Twitter 범용 웹 사이트 태그 확장 {#twitter-uwt-extension}

## 개요 {#overview}

Twitter 범용 웹 사이트 태그는 Twitter UWT 태그로 비콘을 전송하는 작업을 제공합니다.

Twitter 범용 웹 사이트 태그는 Adobe 실시간 고객 데이터 플랫폼의 광고 확장입니다. 확장 기능에 대한 자세한 내용은 고급 전환 [추적을 참조하십시오](https://business.twitter.com/en/solutions/twitter-ads/website-clicks/advanced-conversion-tracking.html).
