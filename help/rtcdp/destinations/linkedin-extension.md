...
# LinkedIn Insight 태그 확장 {#linkedin-insights-extension}

## 개요 {#overview}

전환 추적, 리타겟팅 및 웹 사이트 인구 통계 기능을 사용하려면 LinkedIn Insight 태그를 설치합니다.

LinkedIn Insight Tag는 Adobe 실시간 고객 데이터 플랫폼의 광고 익스텐션입니다. 확장 기능에 대한 자세한 내용은 LinkedIn Insight [태그를 참조하십시오](https://business.linkedin.com/marketing-solutions/insight-tag).
