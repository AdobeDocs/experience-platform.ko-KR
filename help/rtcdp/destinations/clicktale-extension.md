...
# 클릭 확장 {#clicktale-extension}

## 개요 {#overview}

Clicktale은 Experience Platform Launch와의 통합을 통해 Clicktale 코드를 배포하고 Clicktale의 시각적 편집기를 사용하여 Launch 내에서 데이터 요소를 매핑할 수 있습니다.

Clicktale은 Adobe 실시간 고객 데이터 플랫폼의 분석 확장입니다. 확장 기능에 대한 자세한 내용은 Adobe Exchange의 확장 페이지를 [참조하십시오](https://exchange.adobe.com/experiencecloud.details.100082.html).
...
확장 구성 옵션에 대한 자세한 내용은 Adobe Exchange의 [Clicktale 확장 페이지를](https://exchange.adobe.com/experiencecloud.details.100082.html) 참조하십시오.
