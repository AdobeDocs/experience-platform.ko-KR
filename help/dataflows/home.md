...
데이터 흐름 모니터링은 Platform API 또는 Platform UI를 사용하여 수행할 수 있습니다. API를 사용하여 데이터 흐름을 모니터링하는 방법은 [데이터 흐름 모니터링 API 자습서](./api/monitor.md)를 참조하십시오. Platform UI에서 데이터 흐름을 모니터링하는 방법에 대해 알아보려면 [소스에 대한 데이터 흐름 모니터링](./ui/monitor-sources.md) 및 [대상에 대한 데이터 흐름 모니터링](./ui/monitor-destinations.md)에 대한 튜토리얼을 참조하십시오.
