...
>title="받은 프로필"
>abstract="데이터 흐름 실행에서 받은 총 프로필 수입니다. 예약된 내보내기의 경우 여기에는 최신 대상 스냅샷의 프로필과 스냅샷 생성 시간과 내보내기 시간 사이에 대상 멤버십 또는 ID가 변경된 프로필이 포함됩니다. 따라서 이 수는 대상자의 프로필 수보다 높을 수 있습니다."
