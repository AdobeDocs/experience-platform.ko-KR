...
>title="ID 처리"
>abstract="ID 처리 보기에는 추가된 ID 수, 만들어진 그래프 및 업데이트된 그래프를 포함하여 ID 서비스에 수집된 레코드에 대한 정보가 포함되어 있습니다. 지표 및 그래프에 대한 자세한 내용은 지표 정의 안내서를 검토하십시오."
...
| **[!UICONTROL 수집된 레코드]** | 에 수집된 레코드 수 [!DNL Identity Service]. |
