...
Adobe Experience Platform 사용자 인터페이스의 모니터링 대시보드를 사용하여 데이터 레이크에서 데이터 수집 및 데이터 보존 프로세스에 대한 지표를 검색할 수 있습니다. 인터페이스의 그래프를 사용하여 시간에 따른 수집 및 보존 트렌드를 모니터링하고 모든 소스 데이터 흐름의 성능을 요약할 수 있습니다.

모니터링 대시보드를 사용하여 수집 및 보존을 포함한 데이터 레이크의 모든 데이터 처리를 모니터링하는 방법에 대해 알아보려면 이 문서 를 참조하십시오.
...
데이터 레이크 수집 비율을 보려면 모니터링 대시보드의 기본 헤더에서 **[!UICONTROL Data lake]**&#x200B;을(를) 선택하십시오.

![소스 카드가 있는 모니터링 대시보드를 선택했습니다.](../assets/ui/monitor-sources/data-lake.png)

[!UICONTROL Ingestion rate] 그래프는 구성된 시간대에 따라 데이터 수집 속도를 표시합니다. 기본적으로 모니터링 대시보드에는 지난 24시간 동안의 수집 비율이 표시됩니다. 시간대를 구성하는 방법에 대한 단계는 [모니터링 시간대를 구성](monitor.md#configure-monitoring-time-frame)하는 방법에 대한 안내서를 참조하십시오.

그래프는 기본적으로 표시되도록 활성화되어 있습니다. 그래프를 숨기려면 **[!UICONTROL Metrics and graphs]**&#x200B;을(를) 선택하여 토글을 비활성화하고 그래프를 숨깁니다.
...
| 삭제된 레코드 | 데이터 레이크 보존 설정 또는 변경 데이터 캡처 작업으로 인해 삭제된 총 레코드 수입니다. |
...
| 소스 | 소스 유형별로 보기를 필터링하고 지표 데이터를 표시하려면 **[!UICONTROL Sources]**&#x200B;을(를) 선택하십시오. 모니터링 대시보드에서 사용하는 기본 표시입니다. |
| 데이터 흐름 | 데이터 흐름별로 보기를 필터링하고 지표 데이터를 표시하려면 **[!UICONTROL Dataflows]**&#x200B;을(를) 선택하십시오. |
| 실패만 표시 | 보기를 필터링하고 수집 실패를 보고한 데이터 흐름만 표시하려면 **[!UICONTROL Show failures only]**&#x200B;을(를) 선택하십시오. |
| 내 소스 | [!UICONTROL My sources] 드롭다운 메뉴를 사용하여 보기를 추가로 필터링할 수 있습니다. 드롭다운 메뉴를 사용하여 범주별로 보기를 필터링합니다. 또는 **[!UICONTROL All sources]**&#x200B;을(를) 선택하여 모든 또는 소스에 지표를 표시하거나 **[!UICONTROL My sources]**&#x200B;을(를) 선택하여 해당 계정이 있는 소스만 표시할 수 있습니다. |

{style="table-layout:auto"}

열 표시를 사용자 지정하려면 열 설정 아이콘 ![열-아이콘](/help/images/icons/column-settings.png)을 선택합니다.

![열 설정 아이콘이 선택된 모니터링 대시보드입니다.](../assets/ui/monitor-sources/edit-columns.png)

*[!UICONTROL Customize table]* 창을 사용하여 대시보드에 표시할 열을 선택합니다. 완료되면 **[!UICONTROL Apply]**&#x200B;을(를) 선택합니다.

![모니터링 대시보드의 열 팝업 맞춤화 창](../assets/ui/monitor-sources/customize-table.png)

특정 데이터 흐름에서 수집되는 데이터를 모니터링하려면 소스 옆에 있는 필터 아이콘 ![filter](/help/images/icons/filter-add.png)을(를) 선택하십시오.

>[!TIP]
>
>모니터링 대시보드를 사용하여 데이터 보존 정책을 사용하여 삭제된 레코드에 대한 데이터 삭제 지표를 모니터링할 수 있습니다. 데이터 보존에 대한 자세한 내용은 [데이터 보존 정책 설정](../../catalog/datasets/user-guide.md#data-retention-policy)에 대한 안내서를 참조하십시오.
...
데이터 흐름 실행에서 오류가 보고되면 [!UICONTROL Dataflow run errors] 인터페이스를 사용하여 페이지 아래쪽으로 스크롤할 수 있습니다.

오류로 인해 수집되지 않은 레코드에 대한 지표를 보려면 [!UICONTROL Records failed] 섹션을 사용하십시오. 포괄적인 오류 보고서를 보려면 **[!UICONTROL Preview error diagnostics]**&#x200B;을(를) 선택하십시오. 오류 진단 및 파일 매니페스트의 복사본을 다운로드하려면 **[!UICONTROL Download]**&#x200B;을(를) 선택한 다음 [!DNL Data Access] API와 함께 사용할 예제 API 호출을 복사합니다.
...
이 자습서를 통해 **[!UICONTROL Monitoring]** 대시보드를 사용하여 데이터 레이크 수집 속도를 모니터링하는 방법을 배웠습니다. 또한 수집 중에 데이터 흐름 실패를 유발하는 오류를 식별하는 방법에 대해 알아보았습니다. 자세한 내용은 다음 문서를 참조하십시오.
