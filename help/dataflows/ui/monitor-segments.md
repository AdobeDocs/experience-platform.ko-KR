...
>title="세그먼트"
>abstract="세그먼트 보기에는 모든 IMS 조직의 세그먼트에 대한 정보와 활성화 및 평가 작업에 대한 추가 정보가 포함되어 있습니다."
...
![세그먼트 대시보드. IMS 조직과 샌드박스의 다른 세그먼트에 대한 정보가 표시됩니다.](../assets/ui/monitor-segments/segment-monitoring-dashboard.png)
