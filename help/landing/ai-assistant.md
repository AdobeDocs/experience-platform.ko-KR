...
## AI Assistant를 통해 달성할 수 있는 목표 {#objectives}
...
### 사용 데이터 질문 예 {#example-usage-data-questions}

+++예제 사용 데이터 질문 목록을 보려면 선택

사용 데이터 질문 및 그 각각의 사용 사례에 대한 예는 아래 표를 참조하십시오.
...
AI Assistant에 질문을 할 때 따라야 할 모범 사례에 대한 추가 지침은 아래 표를 참조하십시오.
...
| 맥락이 없는 지식을 가정하십시오. | <ul><li>지난 6개월 동안의 대상자입니다.</li><li>나를 위해 쿼리를 만듭니다.</li></ul> |
