...
description: 이 비디오에서는 Experience Cloud Applications&mdash;Real-time Customer Data Platform, Journey Orchestration, Customer Journey Analytics, Attribution AI 및 고객 AI를 보완하는 Adobe Experience Platform을 기반으로 구축된 애플리케이션 서비스와 지능형 서비스에 대한 개요를 제공합니다.
kt: 4333
audience: all
doc-type: video
activity: understand
