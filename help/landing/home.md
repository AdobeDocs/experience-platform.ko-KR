...
RESTful API를 기반으로 [!DNL Experience Platform] 개발자에게 시스템의 전체 기능을 제공하여 익숙한 툴을 사용하여 기업 솔루션을 손쉽게 통합할 수 있도록 지원합니다. [!DNL Experience Platform] 또한 파트너가 필요에 따라 자체 제품과 기술을 구축하여 통합할 수 있도록 지원합니다. 이러한 기능과 유연성은 시장 [!DNL Experience Platform] 에서 독보적인 존재입니다. 파트너, 고객 및 개발자 커뮤니티에서는 경험 비즈니스를 주도하는 혁신적인 솔루션을 구축할 수 있는 기반을 제공합니다.고객의 전체 상황 및 개별 고객의 취향에 따라 완벽하게 개인화된 경험을 지속적으로 개선하여 고객의 기대치를 높입니다.

## [!DNL Experience Platform] 설명서

[!DNL Experience Platform] 설명서는 다양한 기능 및 서비스를 위해 다양한 형식으로 제공됩니다. 사용 가능한 문서 유형에 대한 자세한 내용은 [플랫폼 설명서 개요를 참조하십시오](documentation/overview.md).

특정 [!DNL Platform] 서비스에 대해 자세히 알아보려면 [설명서 랜딩 페이지로](https://experienceleague.adobe.com/docs/experience-platform.html) 돌아가서 적절한 안내서를 선택하십시오.

### 애플리케이션 서비스 설명서 [!DNL Experience Platform]

Adobe은 Experience Platform 위에 다양한 애플리케이션 서비스를 구축했습니다. 아래 링크되어 있는 고유 안내서에서 이러한 서비스에 대한 설명서를 찾을 수 있습니다.
...
데이터를 수집하기 위한 준비, 고급 기계 학습 알고리즘에 이르는 모든 과정을 다루는 단계별 튜토리얼과 함께 [!DNL Platform] 빠르고 손쉽게 시작할 수 있습니다. 이러한 자습서는 설명서에 있는 정보를 보완하도록 설계되었으므로 최상의 결과를 얻으려면 자습서를 완성하면서 설명서를 항상 [!DNL Experience Platform] 사용하십시오. 시작하려면 [Experience Platform 자습서를](https://experienceleague.adobe.com/docs/platform-learn/tutorials/overview.html) 참조하십시오.
...
* [**릴리스 노트**](https://www.adobe.com/go/platform-release-notes.en)\
   최신 릴리스에 대한 정보를 [!DNL Experience Platform] 확인하고 이전 릴리스를 검토할 수 있습니다.

* [**문제 해결 가이드**](troubleshooting.md)\
   일반적인 오류에 대한 해결 방법과 FAQ를 찾아봅니다.