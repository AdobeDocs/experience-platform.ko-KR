...
**병합 메서드**: 플랫폼 UI를 사용하여 병합 정책을 정의할 때 병합 메서드는 충돌이 발생할 때 데이터 조각의 우선 순위를 지정하는 방법을 지정합니다. 실시간 고객 프로필 API를 사용하여 병합 정책을 정의하는 경우 병합 방법은 를 사용하여 결정합니다 `attributeMerge` 개체.
