...
Experience Platform은 주로 [!DNL data lake] 및 프로필 저장소, 이렇게 두 개의 데이터 저장소로 구성됩니다.
...
| [라이선스 사용 대시보드 UI](../../dashboards/guides/license-usage.md#license-usage-dashboard-data) | Experience Platform에 대한 조직 라이선스 관련 데이터의 스냅숏 보기 |
