...
사용 가능한 문서 유형에 대한 자세한 내용은 [플랫폼 설명서 유형 개요를 참조하십시오](overview.md).

특정 [!DNL Platform] 기능 또는 서비스에 대한 자세한 내용을 보려면 [Experience Platform 설명서 랜딩 페이지에서 안내서를 선택합니다](https://experienceleague.adobe.com/docs/experience-platform.html).