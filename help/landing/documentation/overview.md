...
Adobe Experience Platform 문서는 현재 다양한 플랫폼 서비스에 사용할 수 있습니다. 플랫폼 설명서에 액세스하려면 [설명서 랜딩 페이지로](https://experienceleague.adobe.com/docs/experience-platform.html) 돌아가서 보고 싶은 가이드를 선택하십시오.

## Experience Platform 설명서 유형

Experience Platform 설명서는 개요, 자습서, 사용자 인터페이스(UI) 및 API 모두에 대한 안내선 등 다양한 형식으로 제공됩니다. 가장 일반적인 문서 유형은 다음 목록에 요약되어 있습니다.
