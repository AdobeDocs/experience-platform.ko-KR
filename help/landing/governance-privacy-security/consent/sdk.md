...
>[!NOTE]
>
>와 함께 다른 동의 표준을 사용하는 경우 `Adobe` (예: `IAB TCF`)에 추가 개체를 추가할 수 있습니다. `consent` 각 표준에 대한 배열입니다. 각 객체에는 다음에 대한 적절한 값이 포함되어야 합니다. `standard`, `version`, 및 `value` 을 대표하는 동의 표준입니다.
