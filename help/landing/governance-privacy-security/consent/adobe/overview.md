...
다음의 자습서를 따르십시오 [XDM에 CSV 파일 매핑](../../../../ingestion/tutorials/map-csv/overview.md) 데이터 필드를 XDM으로 변환하여 플랫폼으로 수집하는 방법을 살펴볼 수 있습니다. 을(를) 선택할 때 [!UICONTROL 대상] 매핑에 대해 **[!UICONTROL 기존 데이터 세트 사용]** 옵션을 선택하고 [!DNL Profile]-이전에 만든 동의 데이터 세트에 활성화되어 있습니다.
