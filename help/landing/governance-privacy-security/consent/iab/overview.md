...
>[!NOTE]
>
>이 메서드를 사용하려면 경험 이벤트 개인 정보 필드 그룹을 [!DNL Profile] 사용 [!DNL XDM ExperienceEvent] 스키마에 추가해야 합니다. 이를 구성하는 방법에 대한 단계는 데이터 세트 준비 안내서에서 [ExperienceEvent 스키마](./dataset.md#event-schema)의 섹션을 참조하십시오.
