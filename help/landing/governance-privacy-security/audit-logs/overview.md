...
| [기여도 AI 인스턴스](../../../intelligent-services/attribution-ai/overview.md) | <ul><li>만들기</li><li>업데이트</li><li>삭제</li><li>활성화</li><li>비활성화</li></ul> |
...
>[!NOTE]
>
>Experience Platform UI는 적용된 필터에 관계없이 각각 해당 향상된 이벤트를 사용한 지난 90일 최대 1000개의 핵심 이벤트만 표시합니다. 최대 365일 동안 로그가 필요한 경우 [감사 로그를 내보내기](#export-audit-logs)해야 합니다.
