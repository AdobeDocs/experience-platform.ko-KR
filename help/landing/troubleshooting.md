...
| Adobe Experience Platform 데이터 수집 | [[!DNL Batch Ingestion API]](https://developer.adobe.com/experience-platform-apis/references/batch-ingestion/) | [일괄 수집 문제 해결 안내서](../ingestion/batch-ingestion/troubleshooting.md) |
