...
* 거버넌스, 개인 정보 및 보안 {#governance-privacy-security}
   ...
   * [개인 정보 콘솔](./governance-privacy-security/privacy-console.md)
   * 동의 관리 {#consent}
      * Adobe 표준 {#adobe}
...
* 라이센스 사용 및 보호 기능 {#license}
   * [데이터 관리 라이선스 자격 모범 사례](./license-usage-and-guardrails/data-management-best-practices.md)
