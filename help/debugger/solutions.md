...
Adobe Experience Platform 태그 섹션을 사용하여 태그 요청을 봅니다. 선택할 수도 있습니다 **[!UICONTROL 구성]** 를 [포함 코드](../tags/ui/publishing/environments.md#embed-code). Experience Platform Debugger 내에서 임베드 코드를 편집, 대체 또는 추가할 수 있습니다 . 로그인하는 경우 드롭다운을 사용하여 대체 속성을 선택할 수 있습니다.
