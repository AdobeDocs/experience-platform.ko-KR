...
Adobe Experience Platform Debugger에서는 **[!UICONTROL Auditor]** 탭을 사용하여 페이지에서 일련의 감사 테스트를 실행할 수 있습니다.

이 기능을 사용하려면 다음 작업을 수행하십시오.

1. 왼쪽 탐색에서 **[!UICONTROL Auditor]**&#x200B;을(를) 선택합니다.
1. **[!UICONTROL Run Auditor Tests]**&#x200B;을(를) 선택합니다. 테스트가 완료되면 결과는 아래에 표시됩니다.
