...
결합된 제약 조건이 모든 좁힌 옵션을 분해할 때 사용할 수 있는 컨텐츠 경험을 나타내기 위해 활동에 폴백 오퍼가 지정됩니다. 런타임 컨텍스트 또는 프로필에 종속되지 않으므로 활동이 어셈블되는 시간에 앞서 배치 제약 조건을 확인할 수 있습니다. 대체 오퍼를 사용하면 질문에 대한 답변은 항상 있습니다. 현재 가장 좋은 제안은 무엇입니까?
