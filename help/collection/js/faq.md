...
**현대적이고 미래 지향적:** 웹 SDK과 Edge Network에 대한 연결을 통해 Adobe은 데이터 수집, 개인화, 동의 및 서드파티 쿠키의 미래를 처리하는 방법을 현대화할 수 있습니다. (Adobe에서 관리하는 자사 도메인을 활성화합니다.)
...
예. Adobe Experience Platform Web SDK은 ID 마이그레이션 기능을 제공합니다. 자세한 내용은 [`idMigrationEnabled`](/help/collection/js/commands/configure/idmigrationenabled.md)의 지침을 따르십시오.
