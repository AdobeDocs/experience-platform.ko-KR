...
## 웹 SDK 태그 확장을 사용하여 Media Analytics 추적기 가져오기

이 명령에 해당하는 웹 SDK 태그 확장은 [**[!UICONTROL Get Media Analytics tracker]**](/help/tags/extensions/client/web-sdk/actions/get-media-analytics-tracker.md) 작업입니다.
