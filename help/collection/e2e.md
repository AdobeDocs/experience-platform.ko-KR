...
이 안내서에서 언급된 다양한 데이터 수집 제품을 사용하려면 데이터 세트에 대한 액세스 권한과 스키마를 만들고 관리하는 기능도 있어야 합니다. 이러한 기능 중 하나에 액세스할 수 있어야 하는 경우에는 Adobe 계정 팀에 문의하여 필요한 액세스 권한을 받으십시오. Adobe Experience Platform을 구매하지 않은 경우 Adobe은 추가 비용 없이 SDK를 사용하기 위해 필요한 액세스 권한을 제공합니다.
