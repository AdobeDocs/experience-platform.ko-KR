...
또한 웹 SDK은 [Adobe Target](/help/destinations/catalog/personalization/adobe-target-connection.md) 및 [사용자 지정 개인화 연결](/help/destinations/catalog/personalization/custom-personalization.md)과 같은 Adobe Experience Platform 개인화 대상을 통해 동일 페이지 및 다음 페이지 개인화 기능을 지원합니다. 동일 페이지 및 다음 페이지 개인화를 위해 Experience Platform을 구성하는 방법에 대해 알아보려면 [전용 안내서](/help/destinations/ui/activate-edge-personalization-destinations.md)를 참조하십시오.
