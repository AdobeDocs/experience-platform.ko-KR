...
이 개발자 가이드는 [Sensei 머신 러닝 API](https://www.adobe.io/apis/experienceplatform/home/api-reference.html#!acpdr/swagger-specs/sensei-ml-api.yaml) 사용을 시작하는 데 도움이 되는 단계를 제공하며 다양한 데이터 과학 Workspace 리소스에서 CRUD 작업을 수행하기 위한 API 호출을 보여 줍니다.
