---
keywords: Experience Platform;JupyterLab;notebooks;Data Science Workspace;인기 항목;데이터 노트북 분석;eda;탐색 데이터 분석;데이터 과학
...
Experience Platform의 [!DNL JupyterLab]을(를) 사용하면 [!DNL Python] 전자 필기장의 SQL을 사용하여 [쿼리 서비스](https://www.adobe.com/go/query-service-home-en)를 통해 데이터에 액세스할 수 있습니다. [!DNL Query Service]을(를) 통해 데이터에 액세스하면 실행 시간이 길어 대용량 데이터 세트를 처리하는 데 유용할 수 있습니다. [!DNL Query Service]을(를) 사용하여 데이터를 쿼리하는 데 10분의 처리 시간 제한이 있습니다.
...
데이터를 분석하는 동안 인사이트를 발견하는 것은 드문 일이 아닙니다. 다음 예제는 대상 이벤트에 대한 최신성과 통화 값을 매핑하는 insight입니다.
...
![insight 예제](../images/jupyterlab/eda/insight.PNG)
