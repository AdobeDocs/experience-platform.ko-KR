...
모델 작성 SDK를 사용하면 [!DNL Adobe Experience Platform] 데이터 과학 작업 공간에서 사용할 수 있는 맞춤형 기계 학습 레서피 및 기능 파이프라인을 개발할 수 있으며 PySpark 및 Spark(Scala)에서 구현 가능한 템플릿을 제공할 수 있습니다.
