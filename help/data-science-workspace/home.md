...
- [!DNL Git]과(와) [!DNL Data Science Workspace] 사이에 사용 가능한 인증 및 통합을 사용하여 Adobe Experience Platform 외부에서 작성된 레시피를 [!DNL Data Science Workspace]에 업로드하거나 [!DNL Git]과(와) 같은 저장소에서 레시피 코드를 가져옵니다.
...
>[!VIDEO](https://video.tv.adobe.com/v/3412914?quality=12&amp;enable10seconds=on&amp;speedcontrol=on&captions=kor)