...
Adobe Experience Platform [!DNL Data Science Workspace] 는 머신 러닝과 인공 지능을 사용하여 데이터를 통해 인사이트를 도출합니다. Adobe Experience Platform에 통합되어 Adobe 솔루션 간에 컨텐츠 및 데이터 자산을 사용하여 예측할 수 [!DNL Data Science Workspace] 있습니다.

모든 기술 수준에 속한 데이터 과학자는 복잡한 AI 기술을 통해 얻을 수 있는 모든 이점을 비롯하여 신속한 머신 러닝 레시피 개발, 트레이닝 및 조정을 지원하는 세련되고 사용하기 쉬운 툴을 찾을 수 있습니다.

데이터 [!DNL Data Science Workspace]과학자들은 머신 러닝을 기반으로 지능적인 서비스 API를 손쉽게 제작할 수 있습니다. 이러한 서비스는 Adobe Target, Adobe Analytics Cloud를 비롯한 다른 Adobe 서비스와 연동되므로 웹, 데스크탑 및 모바일 앱에서 개인화된 타깃팅된 디지털 경험을 자동화할 수 있습니다.

이 안내서에서는 관련 주요 개념을 간략하게 설명합니다 [!DNL Data Science Workspace].
...
Adobe Experience Platform [!DNL Data Science Workspace]를 통해 기업 전반에 경험 중심의 AI를 도입하여 데이터를 인사이트 코드로 변환하는 데 걸리는 시간을 단축할 수 있습니다.
- 머신 러닝 프레임워크 및 런타임
...
| 용어 | 정의 |
|---------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [!DNL Data Science Workspace] | [!DNL Data Science Workspace] within [!DNL Experience Platform] 을 사용하면 고객은 Adobe Solutions [!DNL Experience Platform] 와 관련된 데이터를 활용하여 머신 러닝 모델을 작성하여 지능적인 인사이트와 예측을 도출하여 매력적인 최종 사용자 디지털 경험을 만들 수 있습니다. |
...
| [!DNL Sensei] ML 프레임워크 | [!DNL Sensei] ML Framework는 Adobe의 통합 머신 러닝 프레임워크로, 데이터 과학자들이 머신 러닝 기반의 인텔리전스 서비스를 신속하고 확장 가능하고 재사용 가능한 방식으로 개발할 수 있도록 데이터 [!DNL Experience Platform] 를 활용합니다. |
| [!DNL Experience Data Model] | [!DNL Experience Data Model] (XDM)은 Adobe가 고객 경험 관리를 위해 및 [!DNL Profile] 과 같은 표준 스키마 [!DNL ExperienceEvent]를 정의하는 표준화 노력을 주도합니다. |
...
데이터 [!DNL Data Science Workspace]과학자는 이를 통해 대규모 데이터 세트에서 인사이트를 찾는 번거로운 프로세스를 간소화할 수 있습니다. 일반적인 머신 러닝 프레임워크 및 런타임을 기반으로 구축된 [!DNL Data Science Workspace] 고급 워크플로우 관리, 모델 관리 및 확장성을 제공합니다. 지능형 서비스는 기계 학습 레서피 재사용을 지원하여 Adobe 제품 및 솔루션을 사용하여 만든 다양한 응용 프로그램을 활성화합니다.

### 원스톱 데이터 액세스

데이터는 AI와 머신 러닝의 토대가 됩니다.

[!DNL Data Science Workspace] Data Lake, 및 Data Lake를 비롯한 Adobe Experience Platform과 완벽하게 통합됩니다 [!DNL Real-time Customer Profile]. [!DNL Unified Edge] ML 및 DBS와 같은 일반적인 빅데이터 및 딥 러닝 라이브러리와 함께 Adobe Experience Platform에 저장된 모든 조직 데이터를 한 번에 살펴볼 수 [!DNL Spark] [!DNL TensorFlow]있습니다. 필요한 항목을 찾지 못하면 XDM 표준화된 스키마를 사용하여 데이터 세트를 인제스트합니다.
...
적합한 데이터를 찾아 준비하는 것은 효과적인 레시피를 구축하는 데 있어 가장 많은 노력을 기울여야 합니다. [!DNL Data Science Workspace] Adobe Experience Platform을 통해 데이터를 보다 신속하게 통찰력으로 전환할 수 있습니다.
...
Adobe 보안 제품 수명주기의 일부로 소프트웨어 및 서비스에 보안이 기본으로 제공됩니다.
...
Adobe Experience Platform의 모든 데이터는 표준화된 XDM 스키마를 준수하므로 복잡한 모델을 만들어 데이터를 결합하거나 데이터 엔지니어의 도움을 받을 필요가 없습니다.

필요한 데이터를 바로 찾지 않아도 Adobe Experience Platform 외부에 존재하는 경우, 추가 데이터 세트를 수집하는 것은 비교적 간단한 작업이므로 표준 XDM 스키마로 변환할 수 있습니다.\
...
모델 트레이닝 및 평가 방법에 대한 자습서는 [이 섹션을](https://www.adobe.io/apis/experienceplatform/home/tutorials/data-science-workspace/dsw-tutorials/trainmodel.html) 참조하십시오 [!DNL Data Science Workspace].
...
더욱 중요한 점은 엔터프라이즈 데이터 [!DNL Data Science Workspace] 과학자의 손에 Adobe의 선도적인 마케팅 플랫폼의 데이터 과학 및 알고리즘 최적화 기능을 활용할 수 있다는 점입니다. 기업은 Adobe의 강력한 머신 러닝 및 AI 기능을 활용하여 광범위한 규모의 개인화된 고객 경험을 제공할 수 있으므로 처음으로 플랫폼에 독점 알고리즘을 활용할 수 있습니다.

브랜드 전문 지식과 Adobe의 머신 러닝 및 AI 기량이 결합된 기업은 고객이 요구하는 대로 고객을 제공함으로써 비즈니스 가치와 브랜드 충성도를 높일 수 있습니다.
