...
검색할 때 R, [!DNL Python] 또는 Scala를 통합 호스트된 [!DNL Jupyter Notebook]과(와) 함께 사용하여 [!DNL Platform]의 데이터 카탈로그를 검색하십시오. 이러한 언어 중 하나를 사용하면 [!DNL Spark] ML과 TensorFlow를 활용할 수도 있습니다. 처음부터 새로 시작하거나 특정 비즈니스 문제에 대해 제공된 노트북 템플릿 중 하나를 사용하십시오.
