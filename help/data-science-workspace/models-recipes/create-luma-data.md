...
이 자습서에서는 다른 모든 작업에 필요한 사전 요구 사항과 에셋을 제공합니다 [!DNL Adobe Experience Platform] [!DNL Data Science Workspace] 튜토리얼. 완료되면 사용자와 IMS 조직에서 다음 스키마와 데이터 세트를 사용할 수 있습니다.
