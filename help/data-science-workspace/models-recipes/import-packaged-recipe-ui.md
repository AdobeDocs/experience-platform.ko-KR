...
먼저 [!DNL Platform] UI의 왼쪽 상단에 있는 **[!UICONTROL 워크플로우]**&#x200B;를 탐색하고 선택합니다. 그런 다음 **레서피 가져오기**&#x200B;를 선택하고 **[!UICONTROL 시작]**&#x200B;을 클릭합니다.

![](../images/models-recipes/import-package-ui/launch-import.png)

**레서피 가져오기** 작업 과정에 대한 **구성** 페이지가 나타납니다. 레서피에 대한 이름과 설명을 입력한 다음 오른쪽 위 모서리에서 **[!UICONTROL 다음]**&#x200B;을 선택합니다.
...
**소스 선택** 페이지에 있으면 **[!UICONTROL 소스 URL]** 필드에 [!DNL Python] 소스 파일을 사용하여 패키지된 레서피에 해당하는 Docker URL을 붙여 넣습니다. 그런 다음 드래그 앤 드롭하여 제공된 구성 파일을 가져오거나 파일 시스템 **Browser**&#x200B;을 사용합니다. 제공된 구성 파일은 `experience-platform-dsw-reference/recipes/python/retail/retail.config.json`에서 찾을 수 있습니다. **유형** 드롭다운에서 **Runtime** 드롭다운에서 **[!UICONTROL Python]**, **[!UICONTROL 분류]**&#x200B;를 선택합니다. 모든 것이 채워지면 오른쪽 위 모서리의 **[!UICONTROL 다음]**&#x200B;을 클릭하여 **스키마 관리**&#x200B;로 진행합니다.

>[!NOTE]
>
> 유형은 **[!UICONTROL 분류]** 및 **[!UICONTROL 회귀]**&#x200B;를 지원합니다. 모델이 이러한 유형 중 하나에 해당하지 않으면 **[!UICONTROL 사용자 지정]**&#x200B;을 선택합니다.
...
**기능 관리** 섹션에서 스키마 뷰어에서 테넌트 ID를 클릭하여 소매 판매 입력 스키마를 확장합니다. 원하는 기능을 강조 표시하고 오른쪽 **[!UICONTROL 필드 속성]** 창에서 **[!UICONTROL 입력 기능]** 또는 **[!UICONTROL Target 기능]**&#x200B;을 선택하여 입력 및 출력 기능을 선택합니다. 이 자습서를 위해 **[!UICONTROL weeklySales]**&#x200B;을 **[!UICONTROL Target 기능]**&#x200B;으로 설정하고 그 외의 모든 것을 **[!UICONTROL 입력 기능]**&#x200B;으로 설정합니다. 새로 구성된 레서피를 검토하려면 **[!UICONTROL 다음]**&#x200B;을 클릭합니다.

필요에 따라 레시피를 검토하고 구성을 추가, 수정 또는 제거합니다. **[!UICONTROL 완료]**&#x200B;를 클릭하여 레서피를 만듭니다.
...
**소스 선택** 페이지에 있으면 **[!UICONTROL 소스 URL]** 필드에 R 소스 파일을 사용하여 패키지된 레서피에 해당하는 Docker URL을 붙여 넣습니다. 그런 다음 드래그 앤 드롭하여 제공된 구성 파일을 가져오거나 파일 시스템 **Browser**&#x200B;을 사용합니다. 제공된 구성 파일은 `experience-platform-dsw-reference/recipes/R/Retail\ -\ GradientBoosting/retail.config.json`에서 찾을 수 있습니다. **유형** 드롭다운에서 **[!UICONTROL R**, **[!UICONTROL 분류]**&#x200B;를 선택합니다. ]**** 모든 것이 채워지면 오른쪽 위 모서리의 **[!UICONTROL 다음]**&#x200B;을 클릭하여 **스키마 관리**&#x200B;로 진행합니다.

>[!NOTE]
>
> *유형* 은 분류  **** 및 회귀 **[!UICONTROL 를 지원합니다]**. 모델이 이러한 유형 중 하나에 해당하지 않으면 **[!UICONTROL 사용자 지정]**&#x200B;을 선택합니다.
...
*기능 관리* 섹션에서 스키마 뷰어에서 테넌트 ID를 클릭하여 소매 판매 입력 스키마를 확장합니다. 원하는 기능을 강조 표시하고 오른쪽 **[!UICONTROL 필드 속성]** 창에서 **[!UICONTROL 입력 기능]** 또는 **[!UICONTROL Target 기능]**&#x200B;을 선택하여 입력 및 출력 기능을 선택합니다. 이 자습서를 위해 **[!UICONTROL weeklySales]**&#x200B;을 **[!UICONTROL Target 기능]**&#x200B;으로 설정하고 그 외의 모든 것을 **[!UICONTROL 입력 기능]**&#x200B;으로 설정합니다. **[!UICONTROL 다음]**&#x200B;을 클릭하여 새 구성된 레서피를 검토합니다.

필요에 따라 레시피를 검토하고 구성을 추가, 수정 또는 제거합니다. **완료**&#x200B;를 클릭하여 레서피를 만듭니다.
...
**레서피 가져오기** 작업 과정에 대한 **구성** 페이지가 나타납니다. 레서피에 대한 이름과 설명을 입력한 다음 오른쪽 위 모서리에서 **[!UICONTROL 다음]**&#x200B;을 선택하여 계속 진행합니다.
...
**소스 선택** 페이지에 있으면 **[!UICONTROL 소스 URL]** 필드에 PySpark 소스 파일을 사용하여 만든 패키지화된 레서피에 해당하는 Docker URL을 붙여 넣습니다. 그런 다음 드래그 앤 드롭하여 제공된 구성 파일을 가져오거나 파일 시스템 **Browser**&#x200B;을 사용합니다. 제공된 구성 파일은 `experience-platform-dsw-reference/recipes/pyspark/retail/pipeline.json`에서 찾을 수 있습니다. **Runtime** 드롭다운에서 **[!UICONTROL PySpark]**&#x200B;을 선택합니다. PySpark 런타임을 선택하면 기본 가공물이 **[!UICONTROL Docker]**&#x200B;에 자동으로 채워집니다. 그런 다음 **유형** 드롭다운에서 **[!UICONTROL 분류]**&#x200B;를 선택합니다. 모든 것이 채워지면 오른쪽 위 모서리의 **[!UICONTROL 다음]**&#x200B;을 클릭하여 **스키마 관리**&#x200B;로 진행합니다.
...
**소스 선택** 페이지에 있는 경우 소스 URL 필드에 Scala 소스 파일을 사용하여 패키지화된 레서피에 해당하는 Docker URL을 붙여 넣습니다. 그런 다음 드래그 앤 드롭하여 제공된 구성 파일을 가져오거나 파일 시스템 브라우저를 사용합니다. 제공된 구성 파일은 `experience-platform-dsw-reference/recipes/scala/retail/pipelineservice.json`에서 찾을 수 있습니다. **Runtime** 드롭다운에서 **[!UICONTROL Spark]**&#x200B;을 선택합니다. [!DNL Spark] 런타임을 선택하면 기본 가공물은 **[!UICONTROL Docker]**&#x200B;에 자동으로 채워집니다. 그런 다음 **유형** 드롭다운에서 **[!UICONTROL 회귀]**&#x200B;를 선택합니다. 모든 것이 채워지면 오른쪽 위 모서리의 **[!UICONTROL 다음]**&#x200B;을 클릭하여 **스키마 관리**&#x200B;로 진행합니다.
...
**기능 관리** 섹션에서 스키마 뷰어에서 테넌트 ID를 클릭하여 소매 판매 입력 스키마를 확장합니다. 원하는 기능을 강조 표시하고 오른쪽 **[!UICONTROL 필드 속성]** 창에서 **[!UICONTROL 입력 기능]** 또는 **[!UICONTROL Target 기능]**&#x200B;을 선택하여 입력 및 출력 기능을 선택합니다. 이 자습서의 목적을 위해 &quot;[!UICONTROL weeklySales]&quot;를 **[!UICONTROL Target 기능]**&#x200B;으로 설정하고 그 외의 모든 것을 **[!UICONTROL 입력 기능]**&#x200B;으로 설정합니다. 새로 구성된 레서피를 검토하려면 **[!UICONTROL 다음]**&#x200B;을 클릭합니다.
